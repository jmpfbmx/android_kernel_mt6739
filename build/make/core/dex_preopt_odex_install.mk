...
#Begin modified by Huasheng.Qiu for Task 6140556 Speed-profile 20180323
LOCAL_DEX_PREOPT_PROFILE := $(PRODUCT_PROFILES_DIR)/$(LOCAL_MODULE).prof
ifneq (,$(wildcard $(LOCAL_DEX_PREOPT_PROFILE_CLASS_LISTING)))
# Profile listing exists, use it to generate the profile.
LOCAL_DEX_PREOPT_GENERATE_PROFILE := true
else ifneq (,$(wildcard $(LOCAL_DEX_PREOPT_PROFILE)))
$(warning "Found prifiles for " $(LOCAL_MODULE) " at " $(PRODUCT_PROFILES_DIR))
LOCAL_DEX_PREOPT_GENERATE_PROFILE := false
LOCAL_DEX_PREOPT_APP_IMAGE := true
LOCAL_DEX_PREOPT_FLAGS += --compiler-filter=speed-profile
my_built_profile := $(LOCAL_DEX_PREOPT_PROFILE)
#End modified by Huasheng.Qiu for Task 6140556 Speed-profile 20180323
endif
endif
...
#Begin modified by Huasheng.Qiu for Task 6140556 Speed-profile 20180326
else ifneq (,$(wildcard $(LOCAL_DEX_PREOPT_PROFILE)))
$(built_odex): PRIVATE_PROFILE_PREOPT_FLAGS := --profile-file=$(my_built_profile)
#End modified by Huasheng.Qiu for Task 6140556 Speed-profile 20180326
else
