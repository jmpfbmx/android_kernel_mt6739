...
#modify by yaosen.lin for task:5327087 2017-09-20  begin
ifeq ($(TARGET_BUILD_MMITEST),true)
    WITH_DEXPREOPT := true
    WITH_DEXPREOPT_PIC := true
endif
#modify by yaosen.lin for task:5327087 2017-09-20  End
...
#add by dongwei.zhang for baseline migration
# Begin added by xi.peng for XR5819523 on 2017/12/27
...
# End added by xi.peng for XR5819523 on 2017/12/27
#add by dongwei.zhang for baseline migration end
...
# and still allows a simple workflow: building in frameworks/base and syncing.
  ifeq (eng,$(TARGET_BUILD_VARIANT))
    #modified by ruihuai.wu for task 5932706 on 2018.02.02 begin
    #WITH_DEXPREOPT_BOOT_IMG_AND_SYSTEM_SERVER_ONLY ?= true
      ifeq ($(TARGET_BUILD_MMITEST),true)
       ...
       #modified by ruihuai.wu for task 5932706 on 2018.02.02 end
  endif
