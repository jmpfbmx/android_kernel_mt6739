...
ifndef BUILD_NUMBER
  ...
  #Begin-20171107-jrdhz-linyaosen-modify-for t5424668 to display software version
  #BUILD_NUMBER := eng.$(shell echo $${USER:0:6}).$(shell $(DATE) +%Y%m%d.%H%M%S)
  BUILD_NUMBER := $(shell awk '/ANDROID_SYS_VER/ {print "v"substr($$NF, 3,4)"-"substr($$NF, 9,1)}' development/version/include/version.inc)
  #End-20171107-jrdhz-linyaosen-modify-for t5424668 to display software version
endif
