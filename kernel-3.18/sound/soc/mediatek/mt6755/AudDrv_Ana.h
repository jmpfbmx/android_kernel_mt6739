...
#define EN_STATUS1          ((UINT32)(PMIC_REG_BASE+0x020E))
#define EN_STATUS2          ((UINT32)(PMIC_REG_BASE+0x0210))
/*#define OCSTATUS0           ((UINT32)(PMIC_REG_BASE+0x0214)) */
#define OCSTATUS1           ((UINT32)(PMIC_REG_BASE+0x0212))
#define OCSTATUS2           ((UINT32)(PMIC_REG_BASE+0x0214))
#define PGDEBSTATUS0        ((UINT32)(PMIC_REG_BASE+0x0216))
#define PGDEBSTATUS1        ((UINT32)(PMIC_REG_BASE+0x0218))
#define PGSTATUS0           ((UINT32)(PMIC_REG_BASE+0x021A))
#define PGSTATUS1           ((UINT32)(PMIC_REG_BASE+0x021C))
#define THERMALSTATUS       ((UINT32)(PMIC_REG_BASE+0x021E))
...
/*#define RGS_ANA_MON         ((UINT32)(PMIC_REG_BASE+0x0236)) */
...
#define INT_CON0            ((UINT32)(PMIC_REG_BASE+0x02C2))
#define INT_CON0_SET        ((UINT32)(PMIC_REG_BASE+0x02C4))
#define INT_CON0_CLR        ((UINT32)(PMIC_REG_BASE+0x02C6))
#define INT_CON1            ((UINT32)(PMIC_REG_BASE+0x02C8))
#define INT_CON1_SET        ((UINT32)(PMIC_REG_BASE+0x02CA))
#define INT_CON1_CLR        ((UINT32)(PMIC_REG_BASE+0x02CC))
#define INT_CON2            ((UINT32)(PMIC_REG_BASE+0x02CE))
#define INT_CON2_SET        ((UINT32)(PMIC_REG_BASE+0x02D0))
#define INT_CON2_CLR        ((UINT32)(PMIC_REG_BASE+0x02D2))
#define INT_CON3            ((UINT32)(PMIC_REG_BASE+0x02D4))
#define INT_CON3_SET        ((UINT32)(PMIC_REG_BASE+0x02D6))
#define INT_CON3_CLR        ((UINT32)(PMIC_REG_BASE+0x02D8))
#define INT_MISC_CON        ((UINT32)(PMIC_REG_BASE+0x02DA))
#define INT_MISC_CON_SET    ((UINT32)(PMIC_REG_BASE+0x02DC))
#define INT_MISC_CON_CLR    ((UINT32)(PMIC_REG_BASE+0x02DE))
#define INT_STATUS0         ((UINT32)(PMIC_REG_BASE+0x02E0))
#define INT_STATUS1         ((UINT32)(PMIC_REG_BASE+0x02E2))
#define INT_STATUS2         ((UINT32)(PMIC_REG_BASE+0x02E4))
#define INT_STATUS3         ((UINT32)(PMIC_REG_BASE+0x02E6))
#define OC_GEAR_0           ((UINT32)(PMIC_REG_BASE+0x02E8))
#define FQMTR_CON0          ((UINT32)(PMIC_REG_BASE+0x02EA))
#define FQMTR_CON1          ((UINT32)(PMIC_REG_BASE+0x02EC))
#define FQMTR_CON2          ((UINT32)(PMIC_REG_BASE+0x02EE))
#define RG_SPI_CON          ((UINT32)(PMIC_REG_BASE+0x02F0))
#define DEW_DIO_EN          ((UINT32)(PMIC_REG_BASE+0x02F2))
#define DEW_READ_TEST       ((UINT32)(PMIC_REG_BASE+0x02F4))
#define DEW_WRITE_TEST      ((UINT32)(PMIC_REG_BASE+0x02F6))
#define DEW_CRC_SWRST       ((UINT32)(PMIC_REG_BASE+0x02F8))
#define DEW_CRC_EN          ((UINT32)(PMIC_REG_BASE+0x02FA))
#define DEW_CRC_VAL         ((UINT32)(PMIC_REG_BASE+0x02FC))
#define DEW_DBG_MON_SEL     ((UINT32)(PMIC_REG_BASE+0x02FE))
#define DEW_CIPHER_KEY_SEL  ((UINT32)(PMIC_REG_BASE+0x0300))
#define DEW_CIPHER_IV_SEL   ((UINT32)(PMIC_REG_BASE+0x0302))
#define DEW_CIPHER_EN       ((UINT32)(PMIC_REG_BASE+0x0304))
#define DEW_CIPHER_RDY      ((UINT32)(PMIC_REG_BASE+0x0306))
#define DEW_CIPHER_MODE     ((UINT32)(PMIC_REG_BASE+0x0308))
#define DEW_CIPHER_SWRST    ((UINT32)(PMIC_REG_BASE+0x030A))
#define DEW_RDDMY_NO        ((UINT32)(PMIC_REG_BASE+0x030C))
#define INT_TYPE_CON0       ((UINT32)(PMIC_REG_BASE+0x030E))
#define INT_TYPE_CON0_SET   ((UINT32)(PMIC_REG_BASE+0x0310))
#define INT_TYPE_CON0_CLR   ((UINT32)(PMIC_REG_BASE+0x0312))
#define INT_TYPE_CON1       ((UINT32)(PMIC_REG_BASE+0x0314))
#define INT_TYPE_CON1_SET   ((UINT32)(PMIC_REG_BASE+0x0316))
#define INT_TYPE_CON1_CLR   ((UINT32)(PMIC_REG_BASE+0x0318))
#define INT_TYPE_CON2       ((UINT32)(PMIC_REG_BASE+0x031A))
#define INT_TYPE_CON2_SET   ((UINT32)(PMIC_REG_BASE+0x031C))
#define INT_TYPE_CON2_CLR   ((UINT32)(PMIC_REG_BASE+0x031E))
#define INT_TYPE_CON3       ((UINT32)(PMIC_REG_BASE+0x0320))
#define INT_TYPE_CON3_SET   ((UINT32)(PMIC_REG_BASE+0x0322))
#define INT_TYPE_CON3_CLR   ((UINT32)(PMIC_REG_BASE+0x0324))
#define INT_STA             ((UINT32)(PMIC_REG_BASE+0x0326))
...
/* SPK related register is dummy in MT6351 */
#define SPK_CON0            ((UINT32)(PMIC_REG_BASE+0x09C2))
#define SPK_CON1            ((UINT32)(PMIC_REG_BASE+0x09C4))
#define SPK_CON2            ((UINT32)(PMIC_REG_BASE+0x09C6))
#define SPK_CON3            ((UINT32)(PMIC_REG_BASE+0x09C8))
#define SPK_CON4            ((UINT32)(PMIC_REG_BASE+0x09CA))
#define SPK_CON5            ((UINT32)(PMIC_REG_BASE+0x09CC))
#define SPK_CON6            ((UINT32)(PMIC_REG_BASE+0x09CE))
#define SPK_CON7            ((UINT32)(PMIC_REG_BASE+0x09D0))
#define SPK_CON8            ((UINT32)(PMIC_REG_BASE+0x09D2))
#define SPK_CON9            ((UINT32)(PMIC_REG_BASE+0x09D4))
#define SPK_CON10           ((UINT32)(PMIC_REG_BASE+0x09D6))
#define SPK_CON11           ((UINT32)(PMIC_REG_BASE+0x09D8))
#define SPK_CON12           ((UINT32)(PMIC_REG_BASE+0x09DA))
#define SPK_CON13           ((UINT32)(PMIC_REG_BASE+0x09DC))
#define SPK_CON14           ((UINT32)(PMIC_REG_BASE+0x09DE))
#define SPK_CON15           ((UINT32)(PMIC_REG_BASE+0x09E0))
#define SPK_CON16           ((UINT32)(PMIC_REG_BASE+0x09E2))
#define SPK_ANA_CON0        ((UINT32)(PMIC_REG_BASE+0x09E4))
#define SPK_ANA_CON1        ((UINT32)(PMIC_REG_BASE+0x09E6))
#define SPK_ANA_CON3        ((UINT32)(PMIC_REG_BASE+0x09E8))
