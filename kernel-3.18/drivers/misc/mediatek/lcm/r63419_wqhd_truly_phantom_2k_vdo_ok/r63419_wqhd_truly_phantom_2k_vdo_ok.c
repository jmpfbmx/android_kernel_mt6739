...
static struct LCM_setting_table lcm_initialization_setting[] = {
	...
	/*#Display setting 1 */
	/* {0xC1, 35, {0x00, 0x61, 0x00, 0x20, 0x8C, 0xA4, 0x16, 0xFB, 0xBF, 0x98, 0x83, 0xDC,
	    0x7B, 0xCF, 0x35, 0x74, 0x4C, 0xF9, 0x9F, 0x2D, 0x95, 0x88, 0x00, 0x00, 0x00, 0x00,
	    0x00, 0x00, 0x02, 0x60, 0x23, 0x03, 0x00, 0xFF, 0x11}}, */
	...
	/*#LTPS timing setting */
	{0xC6, 21, {0x5A, 0x29, 0x29, 0x01, 0x01, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			   0x00, 0x00, 0x00, 0x00, 0x06, 0x15, 0x08, 0x5A} },
	/* #Panel pin control */
	{0xCB, 15, {0x7F, 0xE0, 0x07, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x54, 0xE0, 0x07, 0x2A,
			   0xC8, 0x00, 0x00} },
	...
	{0xC7, 30, {0x00, 0x0C, 0x14, 0x1D, 0x2C, 0x3A, 0x44, 0x54, 0x38, 0x40, 0x4C, 0x59, 0x63,
			   0x6B, 0x7F, 0x00, 0x0C, 0x14, 0x1D, 0x2C, 0x3A, 0x44, 0x54, 0x38, 0x40,
			   0x4C, 0x59, 0x63, 0x6B, 0x7F} },
	{0xC8, 19, {0x01, 0x00, 0x00, 0x00, 0x00, 0xFC, 0xEF, 0x00, 0x00, 0x00, 0x00, 0xFC, 0xEF,
	...
	{0xCE, 25, {0x55, 0x40, 0x49, 0x53, 0x59, 0x5E, 0x63, 0x68, 0x6E, 0x74, 0x7E, 0x8A, 0x98,
			   0xA8, 0xBB, 0xD0, 0xFF, 0x04, 0x00, 0x04, 0x04, 0x00, 0x00, 0x69, 0x5A} },
	/*self check module */
...
#else
	pr_debug("%s, kernel R63419 backlight: level = %d\n", __func__, level);
#endif
	/* Refresh value of backlight level. */

	dsi_set_cmd_by_cmdq_dual(handle, cmd, count, &value, 1);
	/*lcm_backlight_level_setting[0].para_list[0] = level; */
	/*push_table(lcm_backlight_level_setting, sizeof(lcm_backlight_level_setting)
