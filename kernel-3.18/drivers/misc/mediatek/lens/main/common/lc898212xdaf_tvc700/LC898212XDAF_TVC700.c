...
static int s4AF_ReadReg_LC898212XD_TVC820(u8 *a_pSendData, u16 a_sizeSendData, u8 *a_pRecvData,
...
static int s4AF_WriteReg_LC898212XD_TVC820(u8 *a_pSendData, u16 a_sizeSendData, u16 i2cId)
{
	int i4RetValue = 0;
...
static void RamWriteA(unsigned short addr, unsigned short data)
{
	...
	s4AF_WriteReg_LC898212XD_TVC820(puSendCmd, sizeof(puSendCmd), DeviceAddr);
...
static void RamReadA(unsigned short addr, unsigned short *data)
{
	...
	s4AF_ReadReg_LC898212XD_TVC820(puSendCmd, sizeof(puSendCmd), buf, 2, DeviceAddr);
...
static void RegReadA(unsigned short addr, unsigned char *data)
{
	...
	s4AF_ReadReg_LC898212XD_TVC820(puSendCmd, sizeof(puSendCmd), data, 1, DeviceAddr);
...
static int s4EEPROM_ReadReg(u16 addr, u8 *data)
{
	...
	i4RetValue = s4AF_ReadReg_LC898212XD_TVC820(puSendCmd, sizeof(puSendCmd), data, 1, EEPROM_I2C_SLAVE_ADDR);
	if (i4RetValue < 0)
...
static void s4AF_WriteReg(unsigned short addr, unsigned char data)
{
	...
	s4AF_WriteReg_LC898212XD_TVC820(puSendCmd, sizeof(puSendCmd), AF_I2C_SLAVE_ADDR);
}
...
static inline int moveAF(unsigned long a_u4Position)
{
	...
	LOG_INF("moveAF : %d - %04x\n", (int)a_u4Position, AF_convert((int)a_u4Position));
...
/* ////////////////////////////////////////////////////////////// */
long LC898212XD_TVC700_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int LC898212XD_TVC700_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
