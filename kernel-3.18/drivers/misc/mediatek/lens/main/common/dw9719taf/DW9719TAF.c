...
#define AF_DRVNAME "DW9719TAF_DRV"
...
static int s4DW9719TAF_ReadReg(unsigned short *a_pu2Result)
{
...
static inline int moveAF(unsigned long a_u4Position)
{
	...
	if (*g_pAF_Opened == 1) {
		...
		initdrv();
		ret = s4DW9719TAF_ReadReg(&InitPos);
...
/* ////////////////////////////////////////////////////////////// */
long DW9719TAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int DW9719TAF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
