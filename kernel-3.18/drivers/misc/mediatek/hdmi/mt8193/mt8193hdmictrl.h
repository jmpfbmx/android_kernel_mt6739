...
#define HDMI_AV_INFO_T struct _HDMI_AV_INFO_T
/* ///////////////////////////////////////////////////////// */
...
extern unsigned int mt8193_hdmidrv_read(unsigned short u2Reg);
extern void mt8193_hdmidrv_write(unsigned short u2Reg, unsigned int u4Data);
extern unsigned int mt8193_hdmisys_read(unsigned short u2Reg);
extern void mt8193_hdmisys_write(unsigned short u2Reg, unsigned int u4Data);
extern unsigned int mt8193_hdmidgi_read(unsigned short u2Reg);
extern void mt8193_hdmidgi_write(unsigned short u2Reg, unsigned int u4Data);
extern unsigned int mt8193_pad_read(unsigned short u2Reg);
extern void mt8193_pad_write(unsigned short u2Reg, unsigned int u4Data);
...
#define vWriteHdmiGRLMsk(dAddr, dVal, dMsk) (vWriteByteHdmiGRL((dAddr),\
	(bReadByteHdmiGRL(dAddr) & (~(dMsk))) | ((dVal) & (dMsk))))

#define vWriteHdmiSYS(dAddr, dVal)  (mt8193_hdmisys_write(dAddr, dVal))
#define dReadHdmiSYS(dAddr)         (mt8193_hdmisys_read(dAddr))
#define vWriteHdmiSYSMsk(dAddr, dVal, dMsk) (vWriteHdmiSYS((dAddr),\
	(dReadHdmiSYS(dAddr) & (~(dMsk))) | ((dVal) & (dMsk))))

#define vWriteHdmiDGI(dAddr, dVal)  (mt8193_hdmidgi_write(dAddr, dVal))
#define dReadHdmiDGI(dAddr)         (mt8193_hdmidgi_read(dAddr))
#define vWriteHdmiDGIMsk(dAddr, dVal, dMsk) (vWriteHdmiDGI((dAddr),\
	(dReadHdmiDGI(dAddr) & (~(dMsk))) | ((dVal) & (dMsk))))

#define vWriteIoPad(dAddr, dVal)  (mt8193_pad_write(dAddr, dVal))
#define dReadIoPad(dAddr)         (mt8193_pad_read(dAddr))
#define vWriteIoPadMsk(dAddr, dVal, dMsk) vWriteIoPad((dAddr),\
	(dReadIoPad(dAddr) & (~(dMsk))) | ((dVal) & (dMsk)))
...
extern void vChgHDMIVideoResolution(unsigned char ui1resindex,
...
extern unsigned char hdmi_port_status(void);
