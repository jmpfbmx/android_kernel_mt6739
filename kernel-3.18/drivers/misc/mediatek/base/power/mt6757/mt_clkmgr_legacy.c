...
/* apmixed */
	node = of_find_compatible_node(NULL, NULL, "mediatek,mt6757-apmixedsys");
	if (!node)
...
/* cksys_base */
	node = of_find_compatible_node(NULL, NULL, "mediatek,mt6757-topckgen");
	if (!node)
...
/* pericfg_base */
	node = of_find_compatible_node(NULL, NULL, "mediatek,mt6757-perisys");
	if (!node)
...
/* audio */
	node = of_find_compatible_node(NULL, NULL, "mediatek,mt6757-audiosys");
	if (!node)
...
/* mfgcfg */
	node = of_find_compatible_node(NULL, NULL, "mediatek,mt6757-mfgsys");
	if (!node)
...
/* mmsys_config */
	node = of_find_compatible_node(NULL, NULL, "mediatek,mt6757-mmsys");
	if (!node)
...
/* imgsys */
	node = of_find_compatible_node(NULL, NULL, "mediatek,mt6757-imgsys");
	if (!node)
