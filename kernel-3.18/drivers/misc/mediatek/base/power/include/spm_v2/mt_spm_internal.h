...
enum dyna_load_pcm_index {
	...
	DYNA_LOAD_PCM_SUSPEND_R,
	DYNA_LOAD_PCM_SUSPEND_BY_MP1_R,
	DYNA_LOAD_PCM_SODI_R,
	DYNA_LOAD_PCM_SODI_BY_MP1_R,
	DYNA_LOAD_PCM_DEEPIDLE_R,
	DYNA_LOAD_PCM_DEEPIDLE_BY_MP1_R,
#endif
	DYNA_LOAD_PCM_MAX,
};
#endif
