...
static struct pmic_wrap_setting pw = {
	...
	.set[PMIC_WRAP_PHASE_NORMAL] = {
		...
		._[IDX_NM_PWM_BEF1] = { MT6351_VCORE_ANA_CON1, 0x7800,},
		._[IDX_NM_PWM_BEF2] = { MT6351_VCORE_ANA_CON2, 0x5602,},
		._[IDX_NM_AUTO_AFT1] = { MT6351_VCORE_ANA_CON1, 0x7804,},
		._[IDX_NM_AUTO_AFT2] = { MT6351_VCORE_ANA_CON2, 0x560A,},
		.nr_idx = NR_IDX_NM,
	},
