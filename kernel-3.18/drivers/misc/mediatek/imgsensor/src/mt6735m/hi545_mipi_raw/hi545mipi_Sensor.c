...
static SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	...
	{2592, 1944, 0, 0, 2592, 1944, 1296, 972, 0000, 0000, 1296, 972, 0, 0, 1296, 972}
};				/* slim video */
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x0C00, 0x3BC1);
	write_cmos_sensor(0x0C0E, 0x0500);
	write_cmos_sensor(0x0C10, 0x0510);	/* dig_blc_offset_h */
	write_cmos_sensor(0x0C16, 0x0000);
	write_cmos_sensor(0x0C18, 0x0000);
	...
	write_cmos_sensor(0x0500, 0x0000);
	...
	write_cmos_sensor(0x0A04, 0x011A);
	/* ----------------------------------------// */
...
static void hs_video_setting(void)
{
	...
	/* ---< Frame/Line Length >-----// */
	write_cmos_sensor(0x0006, 0x01FA);
	write_cmos_sensor(0x0008, 0x0B40);	/* line_length_h 2880 */
	write_cmos_sensor(0x000A, 0x0DB0);	/* line_length for binning 3504 */

	/* ---< ETC set >---------------// */
/* write_cmos_sensor(0x0000, 0x0000); */
	write_cmos_sensor(0x0700, 0x215A);
