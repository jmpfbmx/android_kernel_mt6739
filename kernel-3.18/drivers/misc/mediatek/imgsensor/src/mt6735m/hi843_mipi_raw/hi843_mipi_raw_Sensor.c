...
#include "hi843_mipi_raw_Sensor.h"

#define PFX "HI843_camera_sensor"
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
			...
			do {
				*sensor_id =return_sensor_id();
                                    LOG_INF("HI843 get_imgsensor_id sensor id: 0x%x\n",*sensor_id);
                                    printk("HI843 get_imgsensor_id sensor id: 0x%x\n",*sensor_id);
