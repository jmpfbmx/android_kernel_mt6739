...
void GC0310_Sensor_Init(void)
{
    ...
    CamWriteCmosSensor(0xf3,0x00); //ff//1f//01 data output
    ...
    CamWriteCmosSensor(0xfa,0x32); //10: 2-lane, 32:1-lane ,ic.hsu
    ...
    /////////////////////////////////////////////////
        /////////////////   CISCTL reg  /////////////////
    /////////////////////////////////////////////////
    CamWriteCmosSensor(0x00,0x2f); //2f//0f//02//01£gA1U2DO¢X
    ...
    CamWriteCmosSensor(0x24,0xff); //Cy?¡ÂAUA|//15
    ...
    CamWriteCmosSensor(0x17,0x03); //01:2-lqne, 03:1-lane, ic.hsu
    CamWriteCmosSensor(0x04,0x10);
    CamWriteCmosSensor(0x05,0x00);
    CamWriteCmosSensor(0x40,0x00);
    CamWriteCmosSensor(0x51,0x03);
    CamWriteCmosSensor(0x52,0x00); //a2 //a0//80//00
...
UINT32 GC0310GetSensorID(UINT32 *sensorID)
{
    ...
    SENSORDB("GC0310 Sensor Read ID(0x%x)\r\n", *sensorID);
    return ERROR_NONE;
}
