...
#define LOG_1 LOG_INF("IMX258 MIPI 4 LANE\n")
#define LOG_2 LOG_INF("preview 2080*1560@30fps,324Mbps/lane; ")
#define LOG_3 LOG_INF("video 4160*3120@30fps,1266Mbps/lane; video 2080*1560@30fps,324Mbps/lane;\n")
/****************************   Modify end    *******************************************/
...
static imgsensor_info_struct imgsensor_info =
{
    ...
    .checksum_value = 0x16d8abef,	/* checksum value for Camera Auto Test£¬last value is 0x16d8abef */
...
static SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] =
{
    ...
    { 4208, 3120,	  0,	0, 4208, 3120, 2100,  1560, 0000, 0000, 2100,  1560,	  0,	0, 2100, 1560}
};// slim video
//{ 4208, 2688,	  0,  432, 4208, 2256, 1400,  752 , 0000, 0000, 1400,	752,	  0,	0, 1400,  752}};// slim video

static SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info_Binning[10] = /* @20151214 refer to LE settings */
{
    {4208, 3120, 4, 0, 4160, 3120, 2080, 1560, 0000, 0000, 2080, 1560, 0, 0, 2080, 1560},	/* Preview */
    {4208, 3120, 4, 0, 4160, 3120, 4160, 3120, 0000, 0000, 4160, 3120, 0, 0, 4160, 3120},	/* capture */
    {4208, 3120, 4, 0, 4160, 3120, 2080, 1560, 0000, 0000, 2080, 1560, 0, 0, 2080, 1560},	/* video */
    /* { 4208, 3120,   0,  592, 4208, 1920, 1048,  480 , 0000, 0000, 1048,   480,      0,    0, 1048,  480},
    	//hight speed video */
    ...
    if (write_cmos_sensor(0x0A02, 0x0F) == 0)
    {
        ...
        while (retry--)
        {
            if (read_cmos_sensor(0x0A01) == 0x01)
            {
                ...
                LOG_INF("imx258 type = 0x%x(0x00=HDR,0x10=binning,0x30=No PDAF)", imx258_type);
...
static void set_max_framerate(UINT16 framerate, kal_bool min_framelength_en)
{
    ...
    LOG_INF("framerate = %d, min framelength should enable? current_enable_bit = %d\n", framerate, min_framelength_en);
...
{
    if ((imx258_type == IMX258_HDR_TYPE) || (imx258_type == IMX258_NOPDAF_TYPE))
    {
...
static void sensor_init(void)
{
    ...
    if (imx258_type != IMX258_NOPDAF_TYPE)
    {
...
#if 0
static void PIP24fps_capture_setting(void)
{
    LOG_INF("PIP24fps capture E\n");
    write_cmos_sensor(0x0100, 0x00);
    mdelay(10);
