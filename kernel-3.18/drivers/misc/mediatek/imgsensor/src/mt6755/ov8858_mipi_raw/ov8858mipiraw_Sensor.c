...
{{ 3296, 2480,	  12,	12, 3272, 2456, 1632, 1228,   0,	0, 1632, 1224,	 0, 0, 1632, 1224}, // Preview
...
//@@3264*2448 30fps 2lane 1.25Gbps/lane
//;;MIPI=1.25Gbps/lane, SysClk=144Mhz,Dac Clock=360Mhz
//;;1940x2556x30
//100 99 3264 2448 ; Resolution
    ...
    write_cmos_sensor(0x4022, 0x0c);
    write_cmos_sensor(0x4023, 0x60);
	...
	if (currefps == 150) {
// @@33264*2448 15fps 2lane 720Mbps/lane
// 100 99 3264 2448 ; Resolution
// ;;MIPI=720Mbps/lane, SysClk=72Mhz,Dac Clock=360Mhz
// ;;1940x2474x15
  ...
  write_cmos_sensor(0x0100, 0x01);
	...
	if (currefps == 240) {
// @@3264*2448 24fps 2lane 1.104Gbps/lane
// ;;MIPI=1.104Gbps/lane, SysClk=144Mhz,Dac Clock=360Mhz
// ;;2344x2556x24
// 100 99 3264 2448 ; Resolution
  write_cmos_sensor(0x0100, 0x00);
  write_cmos_sensor(0x0302, 0x2e);
