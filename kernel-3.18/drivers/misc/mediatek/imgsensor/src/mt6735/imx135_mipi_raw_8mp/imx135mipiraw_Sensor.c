...
#define PFX "IMX135_camera_sensor_8mp"

#define LOG_1 LOG_INF("IMX135_8MP,MIPI 4LANE\n")
...
static imgsensor_info_struct imgsensor_info = {
    ...
    .pre = {
        ...
        .grabwindow_width = 1632,//2096,        //record different mode's width of grabwindow
        .grabwindow_height = 1224,//1552,       //record different mode's height of grabwindow
    ...
    .cap = {   // 30  fps  capture
        ...
        .startx = 4,
        .starty = 4,
        .grabwindow_width = 3264,//4192,
        .grabwindow_height = 2448,//3104,
        .mipi_data_lp2hs_settle_dc = 30,
        .max_framerate = 300,
    },
    .cap1 = {    // 24 fps  capture
...
{{ 4208, 3120, 0000, 0000, 4208, 3120, 2104, 1560, 0000, 0000, 2104, 1560, 236, 168, 1632, 1224}, // Preview 2112*1558
 { 4208, 3120, 0000, 0000, 4208, 3120, 4208, 3120, 0000, 0000, 4208, 3120, 472, 336, 3264, 2448}, // capture 4206*3128
 { 4208, 3120, 0000, 0000, 4208, 3120, 4208, 3120, 0000, 0000, 4208, 3120, 472, 336, 3264, 2448}, // video
...
SENSOR_DPCM_TYPE_ENUM imgsensor_dpcm_info[10] =
...
extern int read_imx135_otp_mtk_fmt(void);
#else
...
kal_uint32 return_sensor_id(void)
{
...
static void capture_setting_15fps(kal_uint16 currefps)  // IMX135MIPI_set_13M
{
...
LOG_INF("E! currefps:%d\n",currefps);
    write_cmos_sensor(0x0100,0x00);// STREAM STop
    //ClockSetting
    if(currefps == 300 || currefps == 280) // default 30.0 fps
    {
        write_cmos_sensor(0x011E,0x18);
        write_cmos_sensor(0x011F,0x00);
        write_cmos_sensor(0x0301,0x05);
...
if(imgsensor.update_sensor_otp_lsc != 0){}
    ...
    if(currefps == 300 || currefps == 280)
    {
        ...
        write_cmos_sensor(0x0202,0x06);// set as preview shutter
        write_cmos_sensor(0x0203,0x64);//
    }
    else    // for PIP
    {
                          ...
                          MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    if (imgsensor.current_fps == 300) {
        ...
        imgsensor.pclk = imgsensor_info.cap3.pclk;
        imgsensor.line_length = imgsensor_info.cap3.linelength;
        imgsensor.frame_length = imgsensor_info.cap3.framelength;
        imgsensor.min_frame_length = imgsensor_info.cap3.framelength;
        imgsensor.autoflicker_en = KAL_FALSE;
    }
    spin_unlock(&imgsensor_drv_lock);
                      ...
                      MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    switch (scenario_id) {
        case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
            ...
            sensor_info->DPCM_INFO = imgsensor_dpcm_info[0];
        ...
        case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
            ...
            sensor_info->DPCM_INFO = imgsensor_dpcm_info[1];
            break;
        case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
            sensor_info->SensorGrabStartX = imgsensor_info.normal_video.startx;
            sensor_info->SensorGrabStartY = imgsensor_info.normal_video.starty;
            sensor_info->MIPIDataLowPwr2HighSpeedSettleDelayCount = imgsensor_info.normal_video.mipi_data_lp2hs_settle_dc;
            sensor_info->DPCM_INFO = imgsensor_dpcm_info[2];
            break;
        case MSDK_SCENARIO_ID_HIGH_SPEED_VIDEO:
            sensor_info->SensorGrabStartX = imgsensor_info.hs_video.startx;
            sensor_info->SensorGrabStartY = imgsensor_info.hs_video.starty;
            sensor_info->MIPIDataLowPwr2HighSpeedSettleDelayCount = imgsensor_info.hs_video.mipi_data_lp2hs_settle_dc;
            sensor_info->DPCM_INFO = imgsensor_dpcm_info[3];
            break;
        case MSDK_SCENARIO_ID_SLIM_VIDEO:
            sensor_info->SensorGrabStartX = imgsensor_info.slim_video.startx;
            sensor_info->SensorGrabStartY = imgsensor_info.slim_video.starty;
            sensor_info->MIPIDataLowPwr2HighSpeedSettleDelayCount = imgsensor_info.slim_video.mipi_data_lp2hs_settle_dc;
            sensor_info->DPCM_INFO = imgsensor_dpcm_info[4];
            break;
        case MSDK_SCENARIO_ID_CUSTOM1:
            sensor_info->SensorGrabStartX = imgsensor_info.custom1.startx;
            sensor_info->SensorGrabStartY = imgsensor_info.custom1.starty;
            sensor_info->MIPIDataLowPwr2HighSpeedSettleDelayCount = imgsensor_info.custom1.mipi_data_lp2hs_settle_dc;
            sensor_info->DPCM_INFO = imgsensor_dpcm_info[5];
            break;
        case MSDK_SCENARIO_ID_CUSTOM2:
            sensor_info->SensorGrabStartX = imgsensor_info.custom2.startx;
            sensor_info->SensorGrabStartY = imgsensor_info.custom2.starty;
            sensor_info->MIPIDataLowPwr2HighSpeedSettleDelayCount = imgsensor_info.custom1.mipi_data_lp2hs_settle_dc;
            sensor_info->DPCM_INFO = imgsensor_dpcm_info[6];
            break;
        case MSDK_SCENARIO_ID_CUSTOM3:
            sensor_info->SensorGrabStartX = imgsensor_info.custom3.startx;
            sensor_info->SensorGrabStartY = imgsensor_info.custom3.starty;
            sensor_info->MIPIDataLowPwr2HighSpeedSettleDelayCount = imgsensor_info.custom1.mipi_data_lp2hs_settle_dc;
            sensor_info->DPCM_INFO = imgsensor_dpcm_info[7];
            break;
        case MSDK_SCENARIO_ID_CUSTOM4:
            sensor_info->SensorGrabStartX = imgsensor_info.custom4.startx;
            sensor_info->SensorGrabStartY = imgsensor_info.custom4.starty;
            sensor_info->MIPIDataLowPwr2HighSpeedSettleDelayCount = imgsensor_info.custom1.mipi_data_lp2hs_settle_dc;
            sensor_info->DPCM_INFO = imgsensor_dpcm_info[8];
            break;
        case MSDK_SCENARIO_ID_CUSTOM5:
            sensor_info->SensorGrabStartX = imgsensor_info.custom5.startx;
            sensor_info->SensorGrabStartY = imgsensor_info.custom5.starty;
            sensor_info->MIPIDataLowPwr2HighSpeedSettleDelayCount = imgsensor_info.custom1.mipi_data_lp2hs_settle_dc;
            sensor_info->DPCM_INFO = imgsensor_dpcm_info[9];
            break;
        default:
            sensor_info->SensorGrabStartX = imgsensor_info.pre.startx;
            sensor_info->SensorGrabStartY = imgsensor_info.pre.starty;
...
static kal_uint32 set_max_framerate_by_scenario(MSDK_SCENARIO_ID_ENUM scenario_id, MUINT32 framerate)
{
    ...
    switch (scenario_id) {
        ...
        case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
            ...
            else{ /*imgsensor.current_fps == 280*/
                    frame_length = imgsensor_info.cap3.pclk / framerate * 10 / imgsensor_info.cap3.linelength;
                    spin_lock(&imgsensor_drv_lock);
                    imgsensor.dummy_line = (frame_length > imgsensor_info.cap3.framelength) ? (frame_length - imgsensor_info.cap3.framelength) : 0;
                    imgsensor.frame_length = imgsensor_info.cap3.framelength + imgsensor.dummy_line;
                    spin_unlock(&imgsensor_drv_lock);
            }
            //set_dummy();
            break;
            ...
            switch (segment_code) {
                ...
                case 0x49:
                    *framerate = imgsensor_info.cap1.max_framerate; /*24fps*/
                    break;
                case 0x51:
                    *framerate = imgsensor_info.cap3.max_framerate; /*28fps*/
                    break;
                default:
