...
static int als_batch(int flag, int64_t samplingPeriodNs, int64_t maxBatchReportLatencyNs)
{
	...
	APS_LOG("apds9930 als set delay = (%d) ok.\n", value);
...
static int ps_batch(int flag, int64_t samplingPeriodNs, int64_t maxBatchReportLatencyNs)
{
	...
	APS_LOG("apds9930 ps set delay = (%d) ok.\n", value);
	return 0;
}
...
static int APDS9930_als_factory_enable_sensor(bool enable_disable, int64_t sample_periods_ms)
{
	int err = 0;
...
static int APDS9930_als_factory_get_data(int32_t *data)
{
	int status;
...
static int APDS9930_als_factory_clear_cali(void)
{
	return 0;
}
static int APDS9930_als_factory_set_cali(int32_t offset)
{
	return 0;
}
static int APDS9930_als_factory_get_cali(int32_t *offset)
{
	return 0;
}
static int APDS9930_ps_factory_enable_sensor(bool enable_disable, int64_t sample_periods_ms)
{
	int err = 0;
...
static int APDS9930_ps_factory_get_data(int32_t *data)
{
	int err = 0, status = 0;
...
static int APDS9930_ps_factory_get_raw_data(int32_t *data)
{
	int err = 0, status = 0;
...
static int APDS9930_ps_factory_enable_calibration(void)
{
	return 0;
}
static int APDS9930_ps_factory_clear_cali(void)
{
	struct APDS9930_priv *obj = APDS9930_obj;
...
static int APDS9930_ps_factory_set_cali(int32_t offset)
{
	struct APDS9930_priv *obj = APDS9930_obj;
...
static int APDS9930_ps_factory_get_cali(int32_t *offset)
{
	struct APDS9930_priv *obj = APDS9930_obj;
...
static int APDS9930_ps_factory_set_threashold(int32_t threshold[2])
{
	int err = 0;
	struct APDS9930_priv *obj = APDS9930_obj;
...
static int APDS9930_ps_factory_get_threashold(int32_t threshold[2])
{
	struct APDS9930_priv *obj = APDS9930_obj;
...
static struct alsps_factory_fops APDS9930_factory_fops = {
	.als_enable_sensor = APDS9930_als_factory_enable_sensor,
	.als_get_data = APDS9930_als_factory_get_data,
	.als_get_raw_data = APDS9930_als_factory_get_raw_data,
	.als_enable_calibration = APDS9930_als_factory_enable_calibration,
	.als_clear_cali = APDS9930_als_factory_clear_cali,
	.als_set_cali = APDS9930_als_factory_set_cali,
	.als_get_cali = APDS9930_als_factory_get_cali,

	.ps_enable_sensor = APDS9930_ps_factory_enable_sensor,
	.ps_get_data = APDS9930_ps_factory_get_data,
	.ps_get_raw_data = APDS9930_ps_factory_get_raw_data,
	.ps_enable_calibration = APDS9930_ps_factory_enable_calibration,
	.ps_clear_cali = APDS9930_ps_factory_clear_cali,
	.ps_set_cali = APDS9930_ps_factory_set_cali,
	.ps_get_cali = APDS9930_ps_factory_get_cali,
	.ps_set_threashold = APDS9930_ps_factory_set_threashold,
	.ps_get_threashold = APDS9930_ps_factory_get_threashold,
};

static struct alsps_factory_public APDS9930_factory_device = {
	.gain = 1,
	.sensitivity = 1,
	.fops = &APDS9930_factory_fops,
};
/*----------------------------------------------------------------------------*/
static int APDS9930_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	err = alsps_factory_device_register(&APDS9930_factory_device);
	if (err) {
...
static int APDS9930_i2c_remove(struct i2c_client *client)
{
	...
	alsps_factory_device_deregister(&APDS9930_factory_device);
	gpio_free(alsps_int_gpio_number);
	APDS9930_i2c_client = NULL;
