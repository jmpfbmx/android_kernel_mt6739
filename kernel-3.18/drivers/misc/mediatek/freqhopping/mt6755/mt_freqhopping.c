...
#define ARMCA15PLL_DEF_FREQ     1976000
...
static const unsigned int g_default_freq[] = {
	ARMCA15PLL_DEF_FREQ, ARMCA7PLL_DEF_FREQ,
	MAINPLL_DEF_FREQ, MEMPLL_DEF_FREQ, MMPLL_DEF_FREQ, MPLL_DEF_FREQ,
	VENCPLL_DEF_FREQ, MSDCPLL_DEF_FREQ, TVDPLL_DEF_FREQ,
};
...
static const unsigned long g_reg_pll_con1[] = {
	REG_ARMCA15PLL_CON1, REG_ARMCA7PLL_CON1, REG_MAINPLL_CON1,
	REG_MEMPLL_CON1, REG_MMPLL_CON1, REG_MPLL_CON1,
...
static void fh_sync_ncpo_to_fhctl_dds(enum FH_PLL_ID pll_id)
{
	...
	if (pll_id == FH_MEM_PLLID) {
		/* Jade mempll con1 field definition is not same as other. [30:10] */
...
static int mt_fh_hal_dvfs(enum FH_PLL_ID pll_id, unsigned int dds_value)
{
	...
	*/
	...
	/* FH_MSG("5. write back to ncpo"); */
	{
		...
		if (pll_id == FH_MEM_PLLID) {
			/* Jade MEMPLL CON1 reg is not same as other CON1. */
...
static int mt_fh_hal_dfs_armpll(unsigned int pll, unsigned int dds)
{
	...
	if (g_fh_pll[pll].fh_status == FH_FH_ENABLE_SSC) {
		...
		if (pll == FH_ARMCA15_PLLID)
			p_setting = &ssc_armca15pll_setting[2];
		else
			p_setting = &ssc_armca7pll_setting[2];
...
static int fh_dumpregs_proc_read(struct seq_file *m, void *v)
{
	...
	seq_printf(m, "ARMCA15:0x%08x ARMCA7:0x%08x M:0x%08x MAIN:0x%08x MEM:0x%08x ",
			fh_read32(REG_ARMCA15PLL_CON0),	fh_read32(REG_ARMCA7PLL_CON0),	fh_read32(REG_MPLL_CON0),
	...
	seq_puts(m, "\r\nPLL_CON1 :\r\n");
	seq_printf(m, "ARMCA15:0x%08x ARMCA7:0x%08x M:0x%08x MAIN:0x%08x MEM:0x%08x ",
			fh_read32(REG_ARMCA15PLL_CON1),	fh_read32(REG_ARMCA7PLL_CON1),	fh_read32(REG_MPLL_CON1),
...
static void __reg_tbl_init(void)
{
	...
	*/
	...
	g_reg_pll_con1[0] = REG_ARMCA15PLL_CON1;
	g_reg_pll_con1[1] = REG_ARMCA7PLL_CON1;
	g_reg_pll_con1[2] = REG_MAINPLL_CON1;
	g_reg_pll_con1[3] = REG_MEMPLL_CON1;
	g_reg_pll_con1[4] = REG_MMPLL_CON1;
	g_reg_pll_con1[5] = REG_MPLL_CON1;
	g_reg_pll_con1[6] = REG_VENCPLL_CON1;
	g_reg_pll_con1[7] = REG_MSDCPLL_CON1;
	g_reg_pll_con1[8] = REG_TVDPLL_CON1;
#endif
#endif
}
...
static int __reg_base_addr_init(void)
{
	...
	if (!apmixed_node) {
		...
		g_apmixed_base = (void *)(0xF0209000);
	} else {
...
static int __fh_debug_proc_read(struct seq_file *m, void *v, fh_pll_t *pll)
{
	...
	seq_printf(m, "  =%04d==%04d==%04d==%04d==%04d==%04d==%04d==%04d==%04d=\r\n",
				pll[FH_ARMCA15_PLLID].fh_status, pll[FH_ARMCA7_PLLID].fh_status,
	...
	seq_printf(m, "  =%04d==%04d==%04d==%04d==%04d==%04d==%04d==%04d==%04d=\r\n",
				pll[FH_ARMCA15_PLLID].setting_id, pll[FH_ARMCA7_PLLID].setting_id,
