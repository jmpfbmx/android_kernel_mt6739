...
unsigned int MT6351_PMIC_REG_gs_flightmode_suspend_mode_len = 207;

const unsigned int MT6351_PMIC_REG_gs_suspend_mode_data[] = {
	/* Address     Mask        Golden Setting Value */
	0x0016, 0x0080, 0x0000,	/* STRUP_CON11 */
	0x0204, 0x0270, 0x0070,	/* TOP_CON */
	0x0240, 0x1FFF, 0x00AC,	/* TOP_CKPDN_CON1 */
...
const unsigned int *MT6351_PMIC_REG_gs_suspend_mode = MT6351_PMIC_REG_gs_suspend_mode_data;
