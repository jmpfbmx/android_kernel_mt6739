...
typedef enum {
	...
	DISP_OPT_MUTEX_SOF_RESERVED_FOR_CMD_MODE,
	DISP_OPT_SHADOW_FORCE_COMMIT,
	DISP_OPT_READ_SHADOW_REG,
	DISP_OPT_SHADOW_BYPASS,
	DISP_OPT_DCM_ENBLE,
...
struct disp_help_info {
	DISP_HELPER_OPT opt_enum;
	int opt_value;
	unsigned char opt_string[64];
};

extern struct disp_help_info help_info[];
extern const int help_info_cnt;
