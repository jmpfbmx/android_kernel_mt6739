...
static int compat_get_disp_session_layer_num_config(compat_disp_session_layer_num_config __user *data32,
...
static int compat_put_disp_session_layer_num_config(compat_disp_session_layer_num_config __user *data32,
						    disp_session_layer_num_config __user *data)
{
	compat_uint_t u;
	int err = 0;
...
#if 0 /* defined but not used */
static int compat_put_disp_output_config(compat_disp_output_config __user *data32,
					disp_output_config __user *data)
{
	compat_uint_t u;
	compat_uptr_t p;
...
#if 0 /* defined but not used */
static int compat_put_disp_session_output_config(compat_disp_session_output_config __user *data32,
						 disp_session_output_config __user *data)
{
	compat_uint_t u;
	int err = 0;
...
#if 0 /* defined but not used */
static int compat_put_disp_input_config(compat_disp_input_config __user *data32,
					disp_input_config __user *data)
{
	compat_uint_t u;
	compat_int_t i;
...
static int compat_put_disp_session_input_config(compat_disp_session_input_config __user *data32,
						disp_session_input_config __user *data)
{
	compat_uint_t u;
	compat_int_t i;
