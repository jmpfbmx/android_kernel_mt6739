...
struct layering_rule_ops {
	bool (*resizing_rule)(disp_layer_info *disp_info);
	void (*scenario_decision)(disp_layer_info *disp_info);
	...
	bool (*rollback_to_gpu_by_hw_limitation)(disp_layer_info *disp_info);
};
...
int layering_rule_start(disp_layer_info *disp_info, int debug_mode);
