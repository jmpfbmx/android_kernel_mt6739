...
unsigned int pmic_Read_Efuse_HPOffset(int i)
{
	...
	pmic_config_interface(PMIC_RG_EFUSE_CK_PDN_HWEN_ADDR, 0x00,
	PMIC_RG_EFUSE_CK_PDN_HWEN_MASK, PMIC_RG_EFUSE_CK_PDN_HWEN_SHIFT);
	pmic_config_interface(PMIC_RG_EFUSE_CK_PDN_ADDR, 0x00,
		PMIC_RG_EFUSE_CK_PDN_MASK, PMIC_RG_EFUSE_CK_PDN_SHIFT);
	/*2. */
	...
	pmic_config_interface(PMIC_RG_EFUSE_CK_PDN_HWEN_ADDR, 0x01,
		PMIC_RG_EFUSE_CK_PDN_HWEN_MASK, PMIC_RG_EFUSE_CK_PDN_HWEN_SHIFT);
	pmic_config_interface(PMIC_RG_EFUSE_CK_PDN_ADDR, 0x01,
		PMIC_RG_EFUSE_CK_PDN_MASK, PMIC_RG_EFUSE_CK_PDN_SHIFT);
