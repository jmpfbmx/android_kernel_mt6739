...
{
	SSW_DBG("[ccci/ssw]COMBO_FXLA2203_V3\n");
...
static int extern_ssw_init(void)
{
	...
	SSW_DBG("extern_ssw_init: ch_swap=(%x %d %d), en=(%x %d %d)\n",
		GPIO_SSW_CH_SWAP_PIN, GPIO_SSW_CH_SWAP_PIN_M_GPIO,
		mt_get_gpio_out(GPIO_SSW_CH_SWAP_PIN), GPIO_SSW_EN_PIN,
		GPIO_SSW_EN_PIN_M_GPIO, mt_get_gpio_out(GPIO_SSW_EN_PIN));
