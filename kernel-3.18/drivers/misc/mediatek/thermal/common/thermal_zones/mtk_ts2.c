...
void mtkts_allts_cancel_ts2_timer(void)
{
...
void mtkts_allts_start_ts2_timer(void)
{
	if (!isTimerCancelled)
		return;
...
{
	seq_printf(m, "[ tsallts_read_ts2] trip_0_temp=%d,trip_1_temp=%d,trip_2_temp=%d,trip_3_temp=%d,\n",
