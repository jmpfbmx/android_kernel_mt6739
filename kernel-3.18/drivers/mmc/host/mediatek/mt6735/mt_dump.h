...
#define ACMD6_ARG_EMMC		  ((0x03 << 24) | (183 << 16) | (1 << 8) | (1<<0))
#ifdef MTK_MSDC_USE_CACHE
#define ACMD6_ARG_DISABLE_CACHE	  ((0x03 << 24) | (33 << 16) | (0 << 8) | (1<<0))
#endif
...
#define CMD_RAW(cmd, rspt, dtyp, rw, len, stop) \
	  ((cmd) | (rspt << 7) | (dtyp << 11) | (rw << 13) | (len << 16) | (stop << 14))
...
#define REG_VEMC33_VOLSEL	(0x0A64)
#define REG_VEMC33_EN		(0x0A24)
#define REG_VMC_VOLSEL		(0x0A6A)
#define REG_VMC_EN			(0x0A20)
#define REG_VMCH_VOLSEL		(0x0A66)
#define REG_VMCH_EN			(0x0A1C)


#define MASK_VEMC33_VOLSEL	(0x3 << 4)
#define MASK_VEMC33_EN		(0x1 << 1)
#define MASK_VMC_VOLSEL		(0x3 << 4)
#define MASK_VMC_EN			(0x1 << 1)
#define MASK_VMCH_VOLSEL	(0x3 << 4)
#define MASK_VMCH_EN		(0x1 << 1)

#define VEMC33_VOLSEL_3V3	(1)
#define VMC_VOLSEL_1V8		(0)
#define VMC_VOLSEL_3V3		(3)
#define VMCH_VOLSEL_3V3		(2)
