...
static const struct mtk_pinctrl_devdata mt6755_pinctrl_data = {
	.pins = mtk_pins_mt6755,
	.npins = ARRAY_SIZE(mtk_pins_mt6755),
	.grp_desc = NULL,
	.n_grp_cls = 0,
	.pin_drv_grp = NULL,
	.n_pin_drv_grps = 0,
...
static int mt6755_pinctrl_probe(struct platform_device *pdev)
{
	pr_warn("mt6755 pinctrl probe\n");
	return mtk_pctrl_init(pdev, &mt6755_pinctrl_data, NULL);
}

static struct of_device_id mt6755_pctrl_match[] = {
	{
		.compatible = "mediatek,mt6755-pinctrl",
	}, {
	}
};
MODULE_DEVICE_TABLE(of, mt6755_pctrl_match);

static struct platform_driver mtk_pinctrl_driver = {
	.probe = mt6755_pinctrl_probe,
	.driver = {
		.name = "mediatek-mt6755-pinctrl",
		.owner = THIS_MODULE,
		.of_match_table = mt6755_pctrl_match,
	},
};
