...
static const char *f52m_mfg_parents[] __initconst = {
	clk26m,
	univpll2_d2,
	univpll2_d4,
	univpll2_d8
...
static const char *disp_pwm_parents[] __initconst = {
	clk26m,
	univpll2_d4,
	osc_d4,
	osc_d8
...
static const char *ssusb_top_xhci_parents[] __initconst = {
	clk26m,
	univpll3_d2
};
...
static const char *img_parents[] __initconst = {
	mm_sel,
};

#define MUX_CLR_SET_UPD(_id, _name, _parents, _mux_ofs, _mux_set_ofs, _mux_clr_ofs, _shift, _width, _gate,	\
			_upd_ofs, _upd) {				\
		.id = _id,						\
		.name = _name,						\
		.mux_ofs = _mux_ofs,					\
...
/* CLK_CFG_0 */
	MUX_CLR_SET_UPD(TOP_MUX_AXI, axi_sel, axi_parents, CLK_CFG_0,
			CLK_CFG_0_SET, CLK_CFG_0_CLR, 0, 2, 7, CLK_CFG_UPDATE, 0),
...
/* CLK_CFG_3 */
	...
	MUX_CLR_SET_UPD(TOP_MUX_MSDC50_0_HCLK, msdc50_0_hclk_sel, msdc50_0_hclk_parents, CLK_CFG_3,
			CLK_CFG_3_SET, CLK_CFG_3_CLR, 8, 2, 15, CLK_CFG_UPDATE, 12),
...
/* CLK_CFG_5 */
	MUX_CLR_SET_UPD(TOP_MUX_PMICSPI, pmicspi_sel, pmicspi_parents, CLK_CFG_5,
			CLK_CFG_5_SET, CLK_CFG_5_CLR, 0, 2, 7, CLK_CFG_UPDATE, 19),
	/* no SCP */
	...
	MUX_CLR_SET_UPD(TOP_MUX_ATB, atb_sel, atb_parents, CLK_CFG_5,
			CLK_CFG_5_SET, CLK_CFG_5_CLR, 16, 2, 23, CLK_CFG_UPDATE, 21),
...
/* CLK_CFG_8 */
	MUX_CLR_SET_UPD(TOP_MUX_SPM, spm_sel, spm_parents, CLK_CFG_8,
			CLK_CFG_8_SET, CLK_CFG_8_CLR, 0, 1, 7, CLK_CFG_UPDATE, 31),
	MUX_CLR_SET_UPD(TOP_MUX_BSI_SPI, bsi_spi_sel, bsi_spi_parents, CLK_CFG_8,
			CLK_CFG_8_SET, CLK_CFG_8_CLR, 8, 2, 15, CLK_CFG_UPDATE1, 0),
...
static struct mtk_gate_regs camsys_camsys_cg_regs = {
	.set_ofs = 0x4,
	.clr_ofs = 0x8,
	.sta_ofs = 0x0,
};

static struct mtk_gate camsys_clks[] __initdata = {
	/* CAMSYS_CG */
...
static struct mtk_gate_regs infracfg_ao_module_sw_cg_0_regs = {
	.set_ofs = 0x80,
	.clr_ofs = 0x84,
	.sta_ofs = 0x90,
};

static struct mtk_gate_regs infracfg_ao_module_sw_cg_1_regs = {
	.set_ofs = 0x88,
	.clr_ofs = 0x8c,
	.sta_ofs = 0x94,
};

static struct mtk_gate_regs infracfg_ao_module_sw_cg_2_regs = {
	.set_ofs = 0xa4,
	.clr_ofs = 0xa8,
	.sta_ofs = 0xac,
};

static struct mtk_gate infracfg_ao_clks[] __initdata = {
	/* MODULE_SW_CG_0 */
...
static struct mtk_gate_regs mmsys_cg_con0_regs = {
	.set_ofs = 0x104,
	.clr_ofs = 0x108,
	.sta_ofs = 0x100,
};

static struct mtk_gate_regs mmsys_cg_con1_regs = {
	.set_ofs = 0x114,
	.clr_ofs = 0x118,
	.sta_ofs = 0x110,
};

static struct mtk_gate_regs mmsys_dummy_cg_con0_regs = {
	.set_ofs = 0x08a8,
	.clr_ofs = 0x08a8,
	.sta_ofs = 0x08a8,
};

static struct mtk_gate_regs mmsys_dummy_cg_con1_regs = {
	.set_ofs = 0x08ac,
	.clr_ofs = 0x08ac,
	.sta_ofs = 0x08ac,
};
...
static struct mtk_gate_regs vdec_gcon_vdec_larb1_cken_regs = {
	.set_ofs = 0x8,
	.clr_ofs = 0xc,
	.sta_ofs = 0x8,
};
...
CLK_OF_DECLARE(mtk_vdecsys, "mediatek,vdec_gcon", mt_vdecsys_init);
...
CLK_OF_DECLARE(mtk_vencsys, "mediatek,venc_gcon", mt_vencsys_init);
