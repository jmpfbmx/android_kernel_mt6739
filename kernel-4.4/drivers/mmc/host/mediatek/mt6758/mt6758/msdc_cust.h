...
#ifndef _MSDC_CUST_MT6758_H_
#define _MSDC_CUST_MT6758_H_

#include <dt-bindings/mmc/mt6758-msdc.h>
...
#endif
/* #define CONFIG_MTK_MSDC_BRING_UP_WORKAROUND */
...
#define MSDC0_IOCFG_NAME        "mediatek,io_cfg_2"
#define MSDC1_IOCFG_NAME        "mediatek,io_cfg_5"
...
#define MSDC0_GPIO_RDSEL1   (MSDC0_IO_PAD_BASE + 0x90)
...
#define MSDC1_GPIO_IES     (MSDC1_IO_PAD_BASE + 0x40)
#define MSDC1_GPIO_SMT     (MSDC1_IO_PAD_BASE + 0xe0)
#define MSDC1_GPIO_TDSEL   (MSDC1_IO_PAD_BASE + 0x100)
#define MSDC1_GPIO_RDSEL   (MSDC1_IO_PAD_BASE + 0xb0)
#define MSDC1_GPIO_DRV     (MSDC1_IO_PAD_BASE + 0)
#define MSDC1_GPIO_SR     (MSDC1_IO_PAD_BASE + 0xf0)
#define MSDC1_GPIO_PUPD   (MSDC1_IO_PAD_BASE + 0x70)
#define MSDC1_GPIO_R0   (MSDC1_IO_PAD_BASE + 0x90)
#define MSDC1_GPIO_R1   (MSDC1_IO_PAD_BASE + 0xa0)
