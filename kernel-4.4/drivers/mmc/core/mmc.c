...
/* Begin add smart info by yinghe for XR5424656 on 2017/12/29 */
#ifdef CONFIG_TCT_BIGLOG
#include <linux/smart_info.h>
#endif
/* End add smart info by yinghe for XR5424656 on 2017/12/29 */
...
static int mmc_decode_ext_csd(struct mmc_card *card, u8 *ext_csd)
{
	...
	if (card->ext_csd.rev >= 7) {
		...
		/* Begin add smart info by yinghe for XR5424656 on 2017/12/29 */
		#ifdef CONFIG_TCT_BIGLOG
		write_life_time(card->ext_csd.device_life_time_est_typ_a);
		#endif
		/* End add smart info by yinghe for XR5424656 on 2017/12/29 */
	}
