...
static struct device_attribute power_supply_attrs[] = {
	...
	POWER_SUPPLY_ATTR(ISenseCurrent),// Added by rongxiao.deng for task 5424620 on 2017/11/27
	POWER_SUPPLY_ATTR(batt_id),//Added by hailong.chen for task 5662647 adding batt_id on 2017/11/28
