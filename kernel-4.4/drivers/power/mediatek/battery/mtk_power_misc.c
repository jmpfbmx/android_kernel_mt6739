...
bool first_check_battery_shutdown_temp = true; //added by shiqiang.chen.hz for defect 6101538 on 2018.03.13, High & low temperature test.
...
//Begin added by shiqiang.chen.hz for defect 6101538 on 2018.03.13, High & low temperature test.
	if(first_check_battery_shutdown_temp){
		if (strcmp(psy->desc->name, "battery") == 0) {
			...
			first_check_battery_shutdown_temp = false;
			}
		}
	}
//End added by shiqiang.chen.hz for defect 6101538 on 2018.03.13, High & low temperature test.
	return NOTIFY_DONE;
}
