...
static int bq25890_set_current(struct charger_device *chg_dev, u32 current_value)
{
	int status = 0;
...
static int bq25890_set_input_current(struct charger_device *chg_dev, u32 current_value)
{
	int status = 0;
	unsigned int set_chr_current;
	unsigned int array_size;
...
static int bq25890_get_is_power_path_enable(struct charger_device *chg_dev, bool *en)
{
	int ret = 0;
	u32 reg_vindpm = 0;
...
static int bq25890_set_vindpm_voltage(struct charger_device *chg_dev, u32 vindpm)
{
	int status = 0;
	unsigned int array_size;
...
static int bq25890_get_charging_status(struct charger_device *chg_dev, bool *is_done)
{
	int status = 0;
	unsigned char reg_value;
...
static int bq25890_set_boost_current_limit(struct charger_device *chg_dev, u32 uA)
{
	int ret = 0;
	u32 array_size = 0;
	u32 boost_ilimit = 0;
...
static int bq25890_get_is_safetytimer_enable(struct charger_device *chg_dev, bool *en)
{
	int ret = 0;
...
static int bq25890_set_ta_current_pattern(struct charger_device *chg_dev, bool is_increase)
{
...
static int bq25890_set_ta20_current_pattern(struct charger_device *chg_dev, u32 chr_vol)
{
	int value;
	int i, j = 0;
	int flag;
