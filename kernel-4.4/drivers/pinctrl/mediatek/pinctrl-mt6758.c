...
static const struct mtk_pinctrl_devdata mt6758_pinctrl_data = {
	.pins = mtk_pins_mt6758,
	.npins = ARRAY_SIZE(mtk_pins_mt6758),
...
static int mt6758_pinctrl_probe(struct platform_device *pdev)
{
	pr_warn("mt6758 pinctrl probe\n");
	return mtk_pctrl_init(pdev, &mt6758_pinctrl_data, NULL);
}

static const struct of_device_id mt6758_pctrl_match[] = {
	{
		.compatible = "mediatek,mt6758-pinctrl",
	}, {
	}
};
MODULE_DEVICE_TABLE(of, mt6758_pctrl_match);

static struct platform_driver mtk_pinctrl_driver = {
	.probe = mt6758_pinctrl_probe,
	.driver = {
		.name = "mediatek-mt6758-pinctrl",
		.owner = THIS_MODULE,
		.of_match_table = mt6758_pctrl_match,
	},
};
