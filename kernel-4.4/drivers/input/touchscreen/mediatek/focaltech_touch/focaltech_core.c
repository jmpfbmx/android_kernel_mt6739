...
/*** begin: added by liuhe.zhong for auto upgrade when normal boot on 2017.12.7 ***/
#include <mt-plat/mtk_boot_common.h>
/*** end:   added by liuhe.zhong for auto upgrade when normal boot on 2017.12.7 ***/
/*****************************************************************************
...
/*** begin: added by liuhe.zhong for getting touchpanel hardware information on 2017.12.08 ***/
extern unsigned char tp_info[128];
static void fts_tpfwver(void)
{
...
/*** begin: modified by liuhe.zhong for optimizing ctp hardware information on 2018.01.20 ***/
        num_read_chars = sprintf(tp_info, "FT6336U:WALLYPANEL:V00\n");
/*** end:   modified by liuhe.zhong for optimizing ctp hardware information on 2018.01.20 ***/
    ...
    if ((fwver == 0xFF) || (fwver == 0x00))
        num_read_chars = sprintf(tp_info, "FT6336U:WALLYPANEL:V%02X\n", fwver);
    else
        num_read_chars = sprintf(tp_info, "FT6336U:WALLYPANEL:V%02X\n", fwver);
    FTS_INFO("tp_info = %s", tp_info);
    mutex_unlock(&input_dev->mutex); 
}
/*** end:   added by liuhe.zhong for getting touchpanel hardware information on 2017.12.08 ***/ 
/*****************************************************************************
