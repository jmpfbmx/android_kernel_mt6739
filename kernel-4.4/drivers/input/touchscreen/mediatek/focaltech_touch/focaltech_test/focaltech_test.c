...
* Static variables
*****************************************************************************/
/*** begin: added by liuhe.zhong for rawdata test on 2017.12.7 ***/
static unsigned char *fts_test_result = FTS_TEST_FAIL;
/*** end:   added by liuhe.zhong for rawdata test on 2017.12.7 ***/
/*****************************************************************************
...
/*** begin: modified by liuhe.zhong for fts rawdata test on 2017.12.07 ***/
    if (true == fts_test_start()) {
        FTS_TEST_SAVE_INFO("\n=======Tp test pass. \n\n");
		fts_test_result = FTS_TEST_PASS;
    } else {
        FTS_TEST_SAVE_INFO("\n=======Tp test failure. \n\n");
        fts_test_result = FTS_TEST_FAIL;
    }
/*** end:   modified by liuhe.zhong for fts rawdata test on 2017.12.07 ***/
