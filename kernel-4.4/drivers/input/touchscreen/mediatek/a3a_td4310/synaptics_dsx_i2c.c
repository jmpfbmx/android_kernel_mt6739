...
#endif
{
	...
	tp_firmware_version=1;
          //Added by llf
	snprintf(ctp_module_name, PAGE_SIZE, "TD4310:%s:0x%x\n", "TDT",  tp_firmware_version); 
...
static const struct of_device_id  synaptics_rmi4_of_match[] = {
   {.compatible = "mediatek,cap_touch"},
   {},
   };
...
static struct i2c_driver tpd_i2c_driver = {
	...
	.driver.of_match_table = of_match_ptr(synaptics_rmi4_of_match),
