...
int ccu_trigger_i2c_hw(enum CCU_I2C_CHANNEL channel, int transac_len, MBOOL do_dma_en)
{
/*trigger i2c start from n3d_a*/
	...
	case CCU_I2C_CHANNEL_MAINCAM:
		{
			n3d_a_writew(0x0000017C, g_n3d_base, OFFSET_CTL);
			n3d_a_writew(0x00000002, g_n3d_base, OFFSET_TRIG);
			break;
		}
	case CCU_I2C_CHANNEL_SUBCAM:
		{
			n3d_a_writew(0x04000054, g_n3d_base, OFFSET_CTL);
