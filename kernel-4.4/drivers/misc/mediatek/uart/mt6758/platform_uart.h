...
#define MSGERR(fmt, args...)    pr_info("  [UART%d]:E:%4d: " fmt, uart->nport, __LINE__, ##args)
...
#endif /**/
#define MSG_ERR(fmt, args...)   pr_info("[UARTX]:E:%4d: " fmt, __LINE__, ##args)
