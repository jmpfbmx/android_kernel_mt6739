...
#define CHA_EMI_DRS_MON0	(CHA_EMI_BASE + 0x016C)
...
#define CHB_EMI_DRS_MON0	(CHB_EMI_BASE + 0x016C)
...
enum {
#define X_CON_SCE(con_sce, arba, arbc, arbd, arbe, \
arbf, arbg, conm) con_sce,
...
extern void __iomem *mt_emi_elm_dbg_base_get(void);
