...
#define RTC_IRQ_EN            (RTC_BASE + 0x0006)
...
#define RTC_CII_EN            (RTC_BASE + 0x0008)
...
#define RTC_AL_MASK            (RTC_BASE + 0x000A)
...
#define RTC_TC_SEC            (RTC_BASE + 0x000C)
#define RTC_TC_SEC_MASK 0x003f

#define RTC_TC_MIN            (RTC_BASE + 0x000E)
#define RTC_TC_MIN_MASK 0x003f

#define RTC_TC_HOU            (RTC_BASE + 0x0000)
#define RTC_TC_HOU_MASK 0x001f

#define RTC_TC_DOM            (RTC_BASE + 0x0012)
#define RTC_TC_DOM_MASK 0x001f

#define RTC_TC_DOW            (RTC_BASE + 0x0014)
#define RTC_TC_DOW_MASK 0x0007

#define RTC_TC_MTH            (RTC_BASE + 0x0016)
#define RTC_TC_MTH_MASK 0x000f

#define RTC_TC_YEA            (RTC_BASE + 0x0018)
#define RTC_TC_YEA_MASK 0x007f

#define RTC_AL_SEC            (RTC_BASE + 0x001A)
...
#define RTC_AL_MIN            (RTC_BASE + 0x001C)
...
#define RTC_AL_DOM            (RTC_BASE + 0x0010)
#define RTC_NEW_SPARE1    0xff00
#define RTC_AL_DOM_MASK 0x001f

#define RTC_AL_DOW            (RTC_BASE + 0x0022)
...
#define RTC_OSC32CON            (RTC_BASE + 0x0028)
...
#define RTC_POWERKEY1            (RTC_BASE + 0x002A)
#define RTC_POWERKEY2            (RTC_BASE + 0x002C)
#define RTC_POWERKEY1_KEY        0xa357
#define RTC_POWERKEY2_KEY        0x67d2
#define RTC_PDN1            (RTC_BASE + 0x002E)
...
#define RTC_PDN2                (RTC_BASE + 0x0020)
...
#define RTC_SPAR1            (RTC_BASE + 0x0034)

#define RTC_PROT            (RTC_BASE + 0x0038)
#define RTC_PROT_UNLOCK1         0x586a
#define RTC_PROT_UNLOCK2         0x9136

#define RTC_DIFF            (RTC_BASE + 0x003A)
...
#define RTC_CALI            (RTC_BASE + 0x003C)
...
#define RTC_WRTGR            (RTC_BASE + 0x003E)

#define RTC_CON                (RTC_BASE + 0x0040)
