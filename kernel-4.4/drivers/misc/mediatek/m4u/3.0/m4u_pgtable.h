...
#define F_PTE_PA_LARGE_MSK            F_MSK_L(32, 16)
#define F_PTE_PA_LARGE_SET(val)       F_VAL(val, 32, 16)
#define F_PTE_PA_LARGE_GET(regval)    F_MSK_SHIFT(regval, 32, 16)
#define F_PTE_PA_SMALL_MSK            F_MSK_L(32, 12)
#define F_PTE_PA_SMALL_SET(val)       F_VAL(val, 32, 12)
#define F_PTE_PA_SMALL_GET(regval)    F_MSK_SHIFT(regval, 32, 12)
...
#define F_PGD_PA_PAGETABLE_MSK            F_MSK_L(32, 10)
#define F_PGD_PA_PAGETABLE_SET(val)       F_VAL(val, 32, 10)
#define F_PGD_PA_SECTION_MSK            F_MSK_L(32, 20)
#define F_PGD_PA_SECTION_SET(val)       F_VAL(val, 32, 20)
#define F_PGD_PA_SUPERSECTION_MSK            F_MSK_L(32, 24)
#define F_PGD_PA_SUPERSECTION_SET(val)       F_VAL(val, 32, 24)
