...
struct m4u_port_t gM4uPort[] = {
	...
	/*Larb3*/
	M4U0_PORT_INIT("CAM_IPUO", 0, 3, 7, 0),
	M4U0_PORT_INIT("CAM_IPU2O", 0, 3, 7, 1),
	M4U0_PORT_INIT("CAM_IPU3O", 0, 3, 7, 2),
	M4U0_PORT_INIT("CAM_IPUI", 0, 3, 7, 3),
	M4U0_PORT_INIT("CAM_IPU2I", 0, 3, 7, 4),
	/*Larb4*/
	...
	M4U0_PORT_INIT("CAM_SMXI", 0, 5, 3, 5),
	M4U0_PORT_INIT("CAM_SMXO", 0, 5, 3, 6),
	M4U0_PORT_INIT("CAM_WPE0_RDMA1", 0, 5, 3, 7),
	M4U0_PORT_INIT("CAM_WPE0_RDMA0", 0, 5, 3, 8),
	M4U0_PORT_INIT("CAM_WPE0_WDMA", 0, 5, 3, 9),
	M4U0_PORT_INIT("CAM_FD_RP", 0, 5, 3, 10),
	M4U0_PORT_INIT("CAM_FD_WR", 0, 5, 3, 11),
	M4U0_PORT_INIT("CAM_FD_RB", 0, 5, 3, 12),
	M4U0_PORT_INIT("CAM_WPE1_RDMA1", 0, 5, 3, 13),
	M4U0_PORT_INIT("CAM_WPE1_RDMA0", 0, 5, 3, 14),
	M4U0_PORT_INIT("CAM_WPE1_WDMA", 0, 5, 3, 15),
	M4U0_PORT_INIT("CAM_DPE_RDMA", 0, 5, 3, 16),
	M4U0_PORT_INIT("CAM_DPE_WDMA", 0, 5, 3, 17),
	M4U0_PORT_INIT("CAM_MFB_RDMA0", 0, 5, 3, 18),
	M4U0_PORT_INIT("CAM_MFB_RDMA1", 0, 5, 3, 19),
	M4U0_PORT_INIT("CAM_MFB_WDMA", 0, 5, 3, 20),
	M4U0_PORT_INIT("CAM_RSC_RDMA0", 0, 5, 3, 21),
	M4U0_PORT_INIT("CAM_RSC_WDMA", 0, 5, 3, 22),
	M4U0_PORT_INIT("CAM_OWE_RDMA", 0, 5, 3, 23),
	M4U0_PORT_INIT("CAM_OWE_WDMA", 0, 5, 3, 24),
	/*Larb6*/
	...
	M4U0_PORT_INIT("CAM_AFO_1", 0, 6, 4, 9),
	M4U0_PORT_INIT("CAM_PSO", 0, 6, 4, 10),
	M4U0_PORT_INIT("CAM_LSCI2", 0, 6, 4, 11),
	M4U0_PORT_INIT("CAM_SOCO", 0, 6, 4, 12),
	M4U0_PORT_INIT("CAM_SOC1", 0, 6, 4, 13),
	M4U0_PORT_INIT("CAM_SOC2", 0, 6, 4, 14),
	M4U0_PORT_INIT("CAM_CCUI", 0, 6, 2, 15),/*ccu smi_select_larb_id = 2*/
	M4U0_PORT_INIT("CAM_CCUO", 0, 6, 2, 16),/*ccu smi_select_larb_id = 2*/
	M4U0_PORT_INIT("CAM_UFEO", 0, 6, 4, 17),
	M4U0_PORT_INIT("CAM_RAWI_A", 0, 6, 4, 18),
	M4U0_PORT_INIT("CAM_RSSO_A", 0, 6, 4, 19),
	M4U0_PORT_INIT("CAM_CCUG", 0, 6, 2, 20),/*ccu smi_select_larb_id = 2*/
	M4U0_PORT_INIT("CAM_PDI", 0, 6, 4, 21),
	M4U0_PORT_INIT("CAM_FLKO", 0, 6, 4, 22),
	M4U0_PORT_INIT("CAM_IMVO", 0, 6, 4, 23),
	M4U0_PORT_INIT("CAM_UFGO", 0, 6, 4, 24),
	M4U0_PORT_INIT("CAM_SPARE", 0, 6, 4, 25),
	M4U0_PORT_INIT("CAM_SPARE2", 0, 6, 4, 26),
	M4U0_PORT_INIT("CAM_SPARE3", 0, 6, 4, 27),
	M4U0_PORT_INIT("CAM_SPARE4", 0, 6, 4, 28),
	M4U0_PORT_INIT("CAM_SPARE5", 0, 6, 4, 29),
	M4U0_PORT_INIT("CAM_SPARE6", 0, 6, 4, 30),
	/*Larb7*/
	...
	M4U0_PORT_INIT("VPU0", 0, 8, 6, 0),
	M4U0_PORT_INIT("VPU1", 0, 8, 7, 1),
