...
#ifndef _MT6775_M4U_REG_H__
#define _MT6775_M4U_REG_H__
...
#define F_VICT_TLB_SEL_EN		 F_BIT_SET(30)
...
#define REG_MMU_VICT_TAG_VAL 0x10c
...
#define F_MMU_VICT_TLB_EN(en)    F_BIT_VAL(en, 12)
...
#define F_MMU_PFH_VLD_BIT(set, way)      F_BIT_SET((set)&0x7f)  /* set%64 -> set%128 for cannon*/
