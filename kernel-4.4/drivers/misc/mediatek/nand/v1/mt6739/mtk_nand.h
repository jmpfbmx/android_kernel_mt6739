...
#define NFIIO_BASE		mtk_io_base

#define NFI_CNFG_REG16          ((u16 *)(NFI_BASE+0x0000))
...
#define NFI_ADDRNOB_REG16       ((u16 *)(NFI_BASE+0x0030))
#define NFI_COLADDR_REG32       ((u32 *)(NFI_BASE+0x0034))
#define NFI_ROWADDR_REG32       ((u32 *)(NFI_BASE+0x0038))

#define NFI_STRDATA_REG16       ((u16 *)(NFI_BASE+0x0040))
#define NFI_CNRNB_REG16         ((u16 *)(NFI_BASE+0x0044))

#define NFI_DATAW_REG32         ((u32 *)(NFI_BASE+0x0050))
#define NFI_DATAR_REG32         ((u32 *)(NFI_BASE+0x0054))
#define NFI_PIO_DIRDY_REG16     ((u16 *)(NFI_BASE+0x0058))

#define NFI_STA_REG32           ((u32 *)(NFI_BASE+0x0060))
#define NFI_FIFOSTA_REG16       ((u16 *)(NFI_BASE+0x0064))

#define NFI_ADDRCNTR_REG32      ((u32 *)(NFI_BASE+0x0070))

#define NFI_STRADDR_REG32       ((u32 *)(NFI_BASE+0x0080))
#define NFI_BYTELEN_REG32       ((u32 *)(NFI_BASE+0x0084))

#define NFI_CSEL_REG16          ((u16 *)(NFI_BASE+0x0090))
#define NFI_IOCON_REG16         ((u16 *)(NFI_BASE+0x0094))

#define NFI_FDM0L_REG32         ((u32 *)(NFI_BASE+0x00A0))
#define NFI_FDM0M_REG32         ((u32 *)(NFI_BASE+0x00A4))

#define NFI_CRC01_REG32         ((u32 *)(NFI_BASE+0x0120))
#define NFI_CRC23_REG32         ((u32 *)(NFI_BASE+0x0124))
#define NFI_CRC45_REG32         ((u32 *)(NFI_BASE+0x0128))
#define NFI_CRC67_REG32         ((u32 *)(NFI_BASE+0x012C))
#define NFI_CRC89_REG32         ((u32 *)(NFI_BASE+0x0130))
#define NFI_CRCAB_REG32         ((u32 *)(NFI_BASE+0x0134))
#define NFI_CRCCD_REG32         ((u32 *)(NFI_BASE+0x0138))
#define NFI_CRCEF_REG32         ((u32 *)(NFI_BASE+0x013C))

#define NFI_FIFODATA0_REG32     ((u32 *)(NFI_BASE+0x0190))
#define NFI_FIFODATA1_REG32     ((u32 *)(NFI_BASE+0x0194))
#define NFI_FIFODATA2_REG32     ((u32 *)(NFI_BASE+0x0198))
#define NFI_FIFODATA3_REG32     ((u32 *)(NFI_BASE+0x019C))

#define NFI_DEBUG_CON1_REG32    ((u32 *)(NFI_BASE+0x0220))
#define NFI_MASTERSTA_REG32     ((u32 *)(NFI_BASE+0x0224))
#define NFI_MASTERRST_REG32     ((u32 *)(NFI_BASE+0x0228))
#define NFI_SPIDMA_REG32        ((u32 *)(NFI_BASE+0x022C))

#define NFI_RANDOM_CNFG_REG32       ((u32 *)(NFI_BASE+0x0238))
#define NFI_EMPTY_THRESHOLD         ((u32 *)(NFI_BASE+0x023C))
#define NFI_NAND_TYPE_CNFG_REG32    ((u32 *)(NFI_BASE+0x0240))
...
#define NFI_DQS_CMP_MODE        ((u16 *)(NFI_BASE+0x0308))

#define NFI_FLUSH_REG32         ((u32 *)(NFI_BASE+0x0490))

#define NFI_DQS_DELAY_SEL_SHIFT	16
#define NFI_DQS_DELAY_MUX_SHIFT	4
...
#define ECC_ENCCON_REG16        ((u16 *)(NFIECC_BASE+0x0000))
#define ECC_ENCCNFG_REG32       ((u32 *)(NFIECC_BASE+0x0004))
#define ECC_ENCDIADDR_REG32     ((u32 *)(NFIECC_BASE+0x0008))
#define ECC_ENCIDLE_REG32       ((u32 *)(NFIECC_BASE+0x000C))



#define ECC_ENCSTA_REG32        ((u32 *)(NFIECC_BASE+0x007C))
#define ECC_ENCIRQEN_REG16      ((u16 *)(NFIECC_BASE+0x0080))
#define ECC_ENCIRQSTA_REG16     ((u16 *)(NFIECC_BASE+0x0084))

#define ECC_DECCON_REG16        ((u16 *)(NFIECC_BASE+0x0100))
#define ECC_DECCNFG_REG32       ((u32 *)(NFIECC_BASE+0x0104))
#define ECC_DECDIADDR_REG32     ((u32 *)(NFIECC_BASE+0x0108))
#define ECC_DECIDLE_REG16       ((u16 *)(NFIECC_BASE+0x010C))
#define ECC_DECFER_REG16        ((u16 *)(NFIECC_BASE+0x0110))
#define ECC_DECENUM0_REG32      ((u32 *)(NFIECC_BASE+0x0114))
#define ECC_DECENUM1_REG32      ((u32 *)(NFIECC_BASE+0x0118))
#define ECC_DECENUM2_REG32      ((u32 *)(NFIECC_BASE+0x011C))
#define ECC_DECENUM3_REG32      ((u32 *)(NFIECC_BASE+0x0120))
#define ECC_DECDONE_REG16       ((u16 *)(NFIECC_BASE+0x0124))

#define ECC_DECIRQEN_REG16      ((u16 *)(NFIECC_BASE+0x0200))
#define ECC_DECIRQSTA_REG16     ((u16 *)(NFIECC_BASE+0x0204))
#define ECC_DECFSM_REG32        ((u32 *)(NFIECC_BASE+0x0208))
#define ECC_BYPASS_REG32        ((u32 *)(NFIECC_BASE+0x020C))

#define ECC_ENCPAR0_REG32       ((u32 *)(NFIECC_BASE+0x0300))
#define ECC_ENCPAR1_REG32       ((u32 *)(NFIECC_BASE+0x0304))
#define ECC_ENCPAR34_REG32      ((u32 *)(NFIECC_BASE+0x0388))

#define ECC_DECEL0_REG32        ((u32 *)(NFIECC_BASE+0x0500))
#define ECC_DECEL1_REG32        ((u32 *)(NFIECC_BASE+0x0504))
#define ECC_DECEL39_REG32       ((u32 *)(NFIECC_BASE+0x059C))
