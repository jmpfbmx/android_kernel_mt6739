...
int g_mt6311_driver_ready;
int g_mt6311_hw_exist;

unsigned int g_mt6311_cid;
unsigned int g_mt6311_logger;
unsigned int g_mt6311_dbgaddr;
unsigned char g_reg_value_mt6311;
...
void mt6311_eint_init(void)
{
	/*---------------------*/
#if defined(CONFIG_FPGA_EARLY_PORTING)
	PMICLOG("[MT6311_EINT] disable when CONFIG_FPGA_EARLY_PORTING\n");
#else
