...
/* MT6351 E3 AP initial setting, update at 2016-06-29 */
...
ret = pmic_config_interface(0x12, 0x1, 0x1, 9);
...
ret = pmic_config_interface(0x44A, 0x2, 0x3, 8);
ret = pmic_config_interface(0x44A, 0x3, 0x3, 10);
...
ret = pmic_config_interface(0x478, 0x0, 0x7, 0);
...
ret = pmic_config_interface(0x48C, 0x0, 0x7, 0);
...
ret = pmic_config_interface(0x4A0, 0x0, 0x7, 0);
...
ret = pmic_config_interface(0x606, 0xB, 0x7F, 8);
ret = pmic_config_interface(0x60C, 0x8, 0x7F, 0);
...
ret = pmic_config_interface(0x61E, 0x20, 0x7F, 0);
ret = pmic_config_interface(0x620, 0x0, 0x7F, 0);
...
ret = pmic_config_interface(0x65A, 0x30, 0x7F, 0);
...
ret = pmic_config_interface(0x6AC, 0x0, 0x7F, 0);
