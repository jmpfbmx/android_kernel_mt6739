...
#define ACCDET_HW_MODE_DFF		((unsigned int)(ACCDET_BASE+0x1C30))/* accdet eint HW mode */
/* auxadc need check */
...
#define RG_AUDMICBIAS1LOWPEN	(0x01<<7)/* Mic bias1: 0,Normal mode; 1, Lowpower mode */
#define RG_AUDMICBIAS1VREF	(0x07<<4)/* Micbias1 voltage output: 000, 1.7V;010,1.9V;101,2.5V;111,2.7V */
#define RG_AUDMICBIAS1DCSW1PEN	(0x01<<1)/* 1,Mic bias1 DC couple switch 1P, for mode6 */
#define RG_AUDMICBIAS1DCSW1NEN	(0x01<<2)/* 1,Mic bias1 DC couple switch 1N */
...
#define RG_AUDACCDETMICBIAS1PULLLOW	(0x01<<1)/* Mic bias1: 0,Normal mode; 1, Lowpower mode */
#define RG_AUDACCDETMICBIAS2PULLLOW	(0x01<<2)/* Micbias1 voltage output:010,1.9V;101,2.5V;111,2.7V */
#define RG_AUDACCDETVIN1PULLLOW		(0x01<<3)
#define RG_AUDACCDETPULLLOW		(0x0F)/* Pull low Mic bias pads when MICBIAS is off */
#define RG_ACCDETSEL			(0x01<<8)
#define RG_EINTTHIRENB			(0x00<<4)
#define RG_EINTCONFIGACCDET	(0x01<<12)/* 1,enable Internal connection between ACCDET and EINT */
...
/* Bit Define: analog bias, ACCDET_MICBIAS_REG */
#define RG_AUDMICBIAS1LOWPEN	(0x01<<7)/* Mic bias1: 0,Normal mode; 1, Lowpower mode */
#define RG_AUDMICBIAS1VREF	(0x07<<4)/* Micbias1 voltage output:010,1.9V;101,2.5V;111,2.7V */
#define RG_AUDMICBIAS1DCSW3PEN	(0x01<<8)/* 1,Mic bias1 DC couple switch 3P, for 5-pole detect */
#define RG_AUDMICBIAS1DCSW3NEN	(0x01<<9)/* 1,Mic bias1 DC couple switch 3N */
#define RG_AUDMICBIAS1DCSW1PEN	(0x01<<2)/* 1,Mic bias1 DC couple switch 1P, for mode6 */
...
/* #define RG_EINTTHIRENB		(0x00<<4)  ???*/
#define RG_EINTCONFIGACCDET	(0x01<<11)/* 1,enable Internal connection between ACCDET and EINT */
