...
#define TOP_CON			((unsigned int)(ACCDET_BASE + 0x001C))

/* 32k clock  bit15 */
#define TOP_CKPDN_CON0			((unsigned int)(ACCDET_BASE + 0x010A))
#define TOP_CKPDN_CON0_SET		((unsigned int)(ACCDET_BASE + 0x010C))
#define TOP_CKPDN_CON0_CLR		((unsigned int)(ACCDET_BASE + 0x010E))

/* clock TOP_CKPDN*/
#define AUD_TOP_CKPDN_CON0		((unsigned int)(ACCDET_BASE + 0x154A))
/* reset TOP_RST_ACCDET */
#define AUD_TOP_RST_CON0		((unsigned int)(ACCDET_BASE + 0x1550))
/* top eint/int en INT_CON_ACCDET */
#define AUD_TOP_INT_CON0		((unsigned int)(ACCDET_BASE + 0x1554))
/* set INT_CON_ACCDET */
#define AUD_TOP_INT_CON0_SET	((unsigned int)(ACCDET_BASE + 0x1556))
/* clear INT_CON_ACCDET */
#define AUD_TOP_INT_CON0_CLR	((unsigned int)(ACCDET_BASE + 0x1558))
/* top eint/int mask en, needn't set INT_CON_ACCDET_MASK */
#define AUD_TOP_INT_MASK_CON0	((unsigned int)(ACCDET_BASE + 0x155A))
/* set INT_CON_ACCDET_MASK */
#define AUD_TOP_INT_MASK_CON0_SET	((unsigned int)(ACCDET_BASE + 0x155C))
/* clear INT_CON_ACCDET_MASK */
#define AUD_TOP_INT_MASK_CON0_CLR	((unsigned int)(ACCDET_BASE + 0x155E))
/* int eint/int status issue INT_STATUS_ACCDET */
#define AUD_TOP_INT_STATUS0		((unsigned int)(ACCDET_BASE + 0x1560))

/* digital RG */
#define ACCDET_CON00			((unsigned int)(ACCDET_BASE + 0x16C6))	/* ACCDET_RSV */
#define ACCDET_CON01			((unsigned int)(ACCDET_BASE + 0x16C8))	/* ACCDET_CTRL */
#define ACCDET_CON02			((unsigned int)(ACCDET_BASE + 0x16CA))	/* ACCDET_STATE_SWCTRL */
#define ACCDET_CON03			((unsigned int)(ACCDET_BASE + 0x16CC))	/* ACCDET_PWM_WIDTH */
#define ACCDET_CON04			((unsigned int)(ACCDET_BASE + 0x16CE))	/* ACCDET_PWM_THRESH */
#define ACCDET_CON05			((unsigned int)(ACCDET_BASE + 0x16D0))	/* ACCDET_EN_DELAY_NUM */
#define ACCDET_CON06			((unsigned int)(ACCDET_BASE + 0x16D2))	/* ACCDET_DEBOUNCE0 */
#define ACCDET_CON07			((unsigned int)(ACCDET_BASE + 0x16D4))	/* ACCDET_DEBOUNCE1 */
#define ACCDET_CON08			((unsigned int)(ACCDET_BASE + 0x16D6))	/* ACCDET_DEBOUNCE2 */
#define ACCDET_CON09			((unsigned int)(ACCDET_BASE + 0x16D8))	/* ACCDET_DEBOUNCE3 */
#define ACCDET_CON10			((unsigned int)(ACCDET_BASE + 0x16DA))	/* ACCDET_DEBOUNCE4 */
#define ACCDET_CON11			((unsigned int)(ACCDET_BASE + 0x16DC))	/* ACCDET_DEFAULT_STATUS */
#define ACCDET_CON12			((unsigned int)(ACCDET_BASE + 0x16DE))	/* ACCDET_IRQ_STATUS */
#define ACCDET_CON13			((unsigned int)(ACCDET_BASE + 0x16E0))	/* ACCDET_SW_CONTROL */
#define ACCDET_CON14			((unsigned int)(ACCDET_BASE + 0x16E2))	/* ACCDET_STATE_RG */
#define ACCDET_CON15			((unsigned int)(ACCDET_BASE + 0x16E4))	/* ACCDET_EINT0_CONTROL */
#define ACCDET_CON16			((unsigned int)(ACCDET_BASE + 0x16E6))	/* ACCDET_EINT0_PWM_DELAY */
#define ACCDET_CON17			((unsigned int)(ACCDET_BASE + 0x16E8))	/* ACCDET_TEST_DEBUG */
#define ACCDET_CON18			((unsigned int)(ACCDET_BASE + 0x16EA))	/* ACCDET_EINT0_FSM_STATE */
#define ACCDET_CON19			((unsigned int)(ACCDET_BASE + 0x16EC))	/* ACCDET_CUR_DEB */
#define ACCDET_CON20			((unsigned int)(ACCDET_BASE + 0x16EE))	/* ACCDET_EINT0_CUR_DEB */
#define ACCDET_CON21			((unsigned int)(ACCDET_BASE + 0x16F0))	/* ACCDET_MONITOR_FLAG */
#define ACCDET_CON22			((unsigned int)(ACCDET_BASE + 0x16F2))	/* ACCDET_RSV_CON1 */
#define ACCDET_CON23			((unsigned int)(ACCDET_BASE + 0x16F4))	/* ACCDET_AUXADC_CONNECT_TIME */
#define ACCDET_CON24			((unsigned int)(ACCDET_BASE + 0x16F6))	/* ACCDET_HW_SET */
#define ACCDET_CON25			((unsigned int)(ACCDET_BASE + 0x16F8))	/* ACCDET_EINT1_CONTROL */
#define ACCDET_CON26			((unsigned int)(ACCDET_BASE + 0x16FA))	/* ACCDET_EINT1_PWM_DELAY */
#define ACCDET_CON27			((unsigned int)(ACCDET_BASE + 0x16FC))	/* ACCDET_EINT1_FSM_STATE */
#define ACCDET_CON28			((unsigned int)(ACCDET_BASE + 0x16FE))	/* ACCDET_EINT1_CUR_DEB */
#define ACCDET_ELR_NUM		((unsigned int)(ACCDET_BASE + 0x1700))	/* ACCDET_ELR_LEN--no used */
...
/* analog RG */
#define AUDENC_ANA_CON10	((unsigned int)(ACCDET_BASE + 0x161A))	/* ACCDET_MICBIAS_REG */
#define AUDENC_ANA_CON11	((unsigned int)(ACCDET_BASE + 0x161C))	/* ACCDET_ADC_REG */
/* efuse RG */
#define AUXADC_RQST0			((unsigned int)(ACCDET_BASE + 0x07EC))	/* AUXADC_CHN_RQST0 */
#define AUXADC_RQST0_SET	((unsigned int)(ACCDET_BASE + 0x07EE))	/* AUXADC_RQST0_CH_SET */
#define AUXADC_RQST0_CLR	((unsigned int)(ACCDET_BASE + 0x07F0))	/* AUXADC_RQST0_CH_CLR */
#define AUXADC_ACCDET		((unsigned int)(ACCDET_BASE + 0x083C))/* ACCDET_AUXADC_AUTO_SPL */
#define AUXADC_ADC5			((unsigned int)(ACCDET_BASE + 0x0790))	/* ACCDET_AUXADC_REG CH5 */
#define AUXADC_CON2			((unsigned int)(ACCDET_BASE + 0x0808))	/* AUXADC_AVG_NUM_SEL */

#define PMIC_REG_BASE_START		((unsigned int)(0x0000))/* MT6356 register base address start */
#define PMIC_REG_BASE_END		((unsigned int)(ACCDET_BASE+0x1706))/* MT6356 register base address end */
...
#define RG_ACCDET_MODE_ANA11				(0x0887)
