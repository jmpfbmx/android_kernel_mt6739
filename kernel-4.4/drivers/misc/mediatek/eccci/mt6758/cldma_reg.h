...
/* INFRA */
#define INFRA_RST0_REG_PD (0x0120)/* rgu reset cldma reg */
#define INFRA_RST1_REG_PD (0x0124)/* rgu clear cldma reset reg */
#define CLDMA_PD_RST_MASK (1<<13)
#define INFRA_RST0_REG_AO (0x0140)
#define INFRA_RST1_REG_AO (0x0144)
#define CLDMA_AO_RST_MASK (1<<5)
...
#define CLDMA_AP_SO_CHECKSUM_CHANNEL_ENABLE (0x0474)	/* Per-channel checksum checking function enable */
#define CLDMA_AP_SO_START_ADDR_0            (0x0478)	/* The start address of first RGPD descriptor */
#define CLDMA_AP_SO_START_ADDR_1            (0x047C)	/* The start address of first RGPD descriptor */
#define CLDMA_AP_SO_START_ADDR_2            (0x0480)	/* The start address of first RGPD descriptor */
#define CLDMA_AP_SO_START_ADDR_3            (0x0484)	/* The start address of first RGPD descriptor */
#define CLDMA_AP_SO_START_ADDR_4            (0x0488)	/* The start address of first RGPD descriptor */
#define CLDMA_AP_SO_START_ADDR_5            (0x048C)	/* The start address of first RGPD descriptor */
#define CLDMA_AP_SO_START_ADDR_6            (0x0490)	/* The start address of first RGPD descriptor */
#define CLDMA_AP_SO_START_ADDR_7            (0x0494)	/* The start address of first RGPD descriptor */
#define CLDMA_AP_SO_CURRENT_ADDR_0          (0x0498)	/* The address of current processing RGPD descriptor. */
#define CLDMA_AP_SO_CURRENT_ADDR_1          (0x049C)	/* The address of current processing RGPD descriptor. */
#define CLDMA_AP_SO_CURRENT_ADDR_2          (0x04A0)	/* The address of current processing RGPD descriptor. */
#define CLDMA_AP_SO_CURRENT_ADDR_3          (0x04A4)	/* The address of current processing RGPD descriptor. */
#define CLDMA_AP_SO_CURRENT_ADDR_4          (0x04A8)	/* The address of current processing RGPD descriptor. */
#define CLDMA_AP_SO_CURRENT_ADDR_5          (0x04AC)	/* The address of current processing RGPD descriptor. */
#define CLDMA_AP_SO_CURRENT_ADDR_6          (0x04B0)	/* The address of current processing RGPD descriptor. */
#define CLDMA_AP_SO_CURRENT_ADDR_7          (0x04B4)	/* The address of current processing RGPD descriptor. */
#define CLDMA_AP_SO_STATUS                  (0x04B8)	/* SME OUT SBDMA operation status. */
#define CLDMA_AP_DEBUG_ID_EN                (0x04C8)	/* DEBUG_ID Enable */
#define CLDMA_AP_SO_LAST_UPDATE_ADDR_0      (0x04D0)	/* The address of last updated TGPD descriptor. */
#define CLDMA_AP_SO_LAST_UPDATE_ADDR_1      (0x04D4)	/* The address of last updated TGPD descriptor. */
#define CLDMA_AP_SO_LAST_UPDATE_ADDR_2      (0x04D8)	/* The address of last updated TGPD descriptor. */
#define CLDMA_AP_SO_LAST_UPDATE_ADDR_3      (0x04DC)	/* The address of last updated TGPD descriptor. */
#define CLDMA_AP_SO_LAST_UPDATE_ADDR_4      (0x04E0)	/* The address of last updated TGPD descriptor. */
#define CLDMA_AP_SO_LAST_UPDATE_ADDR_5      (0x04E4)	/* The address of last updated TGPD descriptor. */
#define CLDMA_AP_SO_LAST_UPDATE_ADDR_6      (0x04E8)	/* The address of last updated TGPD descriptor. */
#define CLDMA_AP_SO_LAST_UPDATE_ADDR_7      (0x04EC)	/* The address of last updated TGPD descriptor. */
...
/*Support >32 bit address access, such as 6GBM*/
#define CLDMA_AP_SO_START_ADDR_4MSB         (0x0530)	/* MSB 4 bits(35~32) of first RGPD */
#define CLDMA_AP_SO_CURRENT_ADDR_4MSB       (0x0534)	/* MSB 4 bits(35~32) of current processing RGPD*/
#define CLDMA_AP_SO_LAST_ADDR_4MSB          (0x0538)	/* MSB 4 bits(35~32) of last updated RGPD*/
#define CLDMA_AP_SO_NEXT_BUF_PTR_4MSB       (0x053C)	/* Next data buffer pointer MSB4 bits(35~32) */
/*=======================CLDMA_AO_MISC:  10014858-10014950==================================*/
#define CLDMA_AP_L2RIMR0                    (0x0858)	/* Level 2 Interrupt Mask Register (RX Part) */
#define CLDMA_AP_L2RIMR1                    (0x085C)	/* Level 2 Interrupt Mask Register (RX Part) */
#define CLDMA_AP_L2RIMCR0                   (0x0860)	/* Level 2 Interrupt Mask Clear Register (RX Part) */
#define CLDMA_AP_L2RIMCR1                   (0x0864)	/* Level 2 Interrupt Mask Clear Register (RX Part) */
#define CLDMA_AP_L2RIMSR0                   (0x0868)	/* Level 2 Interrupt Mask Set Register (RX Part) */
#define CLDMA_AP_L2RIMSR1                   (0x086C)	/* Level 2 Interrupt Mask Set Register (RX Part) */
...
#define CLDMA_AP_SO_OUTDMA_CODA_VERSION     (0x0400)	/* SOOUTDMA Version Control Register */
...
#define CLDMA_AP_L2TISAR0		(0x0810) /* Level 2 Interrupt Status and Acknowledgment Register (TX Part) */
#define CLDMA_AP_L2TISAR1		(0x0814) /* Level 2 Interrupt Status and Acknowledgment Register (TX Part) */
#define CLDMA_AP_L2TIMR0		(0x0818) /* Level 2 Interrupt Mask Register (TX Part) */
#define CLDMA_AP_L2TIMR1		(0x081C) /* Level 2 Interrupt Mask Register (TX Part) */
#define CLDMA_AP_L2TIMCR0		(0x0820) /* Level 2 Interrupt Mask Clear Register (TX Part) */
#define CLDMA_AP_L2TIMCR1		(0x0824) /* Level 2 Interrupt Mask Clear Register (TX Part) */
#define CLDMA_AP_L2TIMSR0		(0x0828) /* Level 2 Interrupt Mask Set Register (TX Part) */
#define CLDMA_AP_L2TIMSR1		(0x082C) /* Level 2 Interrupt Mask Set Register (TX Part) */
#define CLDMA_AP_L3TISAR0		(0x0830) /* Level 3 Interrupt Status and Acknowledgment Register (TX Part) */
#define CLDMA_AP_L3TISAR1		(0x0834) /* Level 3 Interrupt Status and Acknowledgment Register (TX Part) */
#define CLDMA_AP_L3TIMR0		(0x0838) /* Level 3 Interrupt Mask Register (TX Part) */
#define CLDMA_AP_L3TIMR1		(0x083C) /* Level 3 Interrupt Mask Register (TX Part) */
#define CLDMA_AP_L3TIMCR0		(0x0840) /* Level 3 Interrupt Mask Clear Register (TX Part) */
#define CLDMA_AP_L3TIMCR1		(0x0844) /* Level 3 Interrupt Mask Clear Register (TX Part) */
#define CLDMA_AP_L3TIMSR0		(0x0848) /* Level 3 Interrupt Mask Set Register (TX Part) */
#define CLDMA_AP_L3TIMSR1		(0x084C) /* Level 3 Interrupt Mask Set Register (TX Part) */
#define CLDMA_AP_L2RISAR0		(0x0850) /* Level 2 Interrupt Status and Acknowledgment Register (RX Part) */
#define CLDMA_AP_L2RISAR1		(0x0854) /* Level 2 Interrupt Status and Acknowledgment Register (RX Part) */
#define CLDMA_AP_L3RISAR0		(0x0870) /* Level 3 Interrupt Status and Acknowledgment Register (RX Part) */
#define CLDMA_AP_L3RISAR1		(0x0874) /* Level 3 Interrupt Status and Acknowledgment Register (RX Part) */
#define CLDMA_AP_L3RIMR0		(0x0878) /* Level 3 Interrupt Mask Register (RX Part) */
#define CLDMA_AP_L3RIMR1		(0x087C) /* Level 3 Interrupt Mask Register (RX Part) */
#define CLDMA_AP_L3RIMCR0		(0x0880) /* Level 3 Interrupt Mask Clear Register (RX Part) */
#define CLDMA_AP_L3RIMCR1		(0x0884) /* Level 3 Interrupt Mask Clear Register (RX Part) */
#define CLDMA_AP_L3RIMSR0		(0x0888) /* Level 3 Interrupt MaskSet Register (RX Part) */
#define CLDMA_AP_L3RIMSR1		(0x088C) /* Level 3 Interrupt Mask Set Register (RX Part) */
...
#define CLDMA_AP_DBG_RDATA		(0x08A4) /* Debug information (rdata) of ltel2_axi_master */
#define CLDMA_AP_DBG_WADDR		(0x08A8) /* Debug information (waddr) of ltel2_axi_master */
#define CLDMA_AP_DBG_WDATA		(0x08AC) /* Debug information (wdata) of ltel2_axi_master */
...
#define CLDMA_AP_DBG_ADDR_4MSB          (0x08BC) /* Debug info(waddr/raddr MSB 4bits) of ltel2_axi_master*/

#define CLDMA_AP_L3TISAR2		(0x08C0) /* Level3 Interrupt Status and Acknowldgement Register(TX Part) */
#define CLDMA_AP_L3TIMR2		(0x08C4) /* Level3 Interrupt Mask Register(TX Part) */
#define CLDMA_AP_L3TIMCR2		(0x08C8) /* Level3 Interrupt Mask Clear Register(TX Part) */
#define CLDMA_AP_L3TIMSR2		(0x08CC) /* Level3 Interrupt Mask Set Register(TX Part) */
