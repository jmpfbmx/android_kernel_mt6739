...
#define MD1_CFG_BOOT_STATS0 (MD1_CFG_BASE+0x04)	/*warning: bianco status0 offset is 4*/
#define MD1_CFG_BOOT_STATS1 (MD1_CFG_BASE+0x00)	/*warning: bianco status1 offset is 0*/
