...
typedef struct {
	...
	long (*set_gpio_lcd_vci_bias)(unsigned int value);
	long (*set_gpio_lcd_vdd_bias)(unsigned int value);
...
// Add by llf for LCD LDO I2C control begain
int nt50358_write_bytes(unsigned char addr, unsigned char value);
// Add by llf for LCD LDO I2C control end
#endif /* __LCM_DRV_H__ */
