...
#define SET_TE_PIN()	(lcm_util.set_te_pin())
...
LCM_DRIVER nt35595_fhd_dsi_cmd_truly_nt50358_2th_lcm_drv = {
	.name = "nt35595_fhd_dsi_cmd_truly_nt50358_2th_drv",
