...
//Begin added by yang.liu.hz for FR5597245 on 20171101,add new lcm driver.
#if defined(U5APLUS_ILI9806E_FWVGA_DSI_VDO_HOLITECH_SM5109)
	&u5aplus_ili9806e_fwvga_dsi_vdo_holitech_sm5109_lcm_drv,
#endif
//End added by yang.liu.hz for FR5597245 on 20171101,add new lcm driver.

/*** begin: add by liuhe.zhong for jd9161 lcm driver on 2017.12.4 ***/
#if defined(U5APLUS_JD9161_FWVGA_DSI_VDO_SKYWORTH)
	&u5aplus_jd9161_fwvga_dsi_vdo_skyworth_lcm_drv,
#endif
/*** end:   add by liuhe.zhong for jd9161 lcm driver on 2017.12.4 ***/

#if defined(A3A_TD4310_HD_DSI_TDT)
	&a3a_td4310_hd_dsi_tdt_lcm_drv,
#endif

#if defined(A3A_FT8613_HD_DSI_TDT)
	&a3a_ft8613_hd_dsi_tdt_lcm_drv,
#endif
//End added by longfang.liu
