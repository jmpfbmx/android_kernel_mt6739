...
#if (LCM_DSI_CMD_MODE)
LCM_DRIVER nt36672_fhdp_dsi_cmd_lcm_drv = {
	.name = "nt36672_fhdp_dsi_cmd_lcm_drv",
#else

LCM_DRIVER nt36672_fhdp_dsi_vdo_auo_lcm_drv = {
	.name = "nt36672_fhdp_dsi_vdo_auo_lcm_drv",
#endif
