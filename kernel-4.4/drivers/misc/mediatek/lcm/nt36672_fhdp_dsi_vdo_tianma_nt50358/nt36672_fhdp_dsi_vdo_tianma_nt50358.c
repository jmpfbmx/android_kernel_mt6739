...
static void lcm_init(void)
{
	...
	if (lcm_dsi_mode == CMD_MODE) {
		...
		LCM_LOGI("nt36672----tps6132----lcm mode = cmd mode :%d----\n", lcm_dsi_mode);
	} else {
		push_table(NULL, init_setting_vdo, sizeof(init_setting_vdo) / sizeof(struct LCM_setting_table), 1);
		LCM_LOGI("nt36672----tps6132----lcm mode = vdo mode :%d----\n", lcm_dsi_mode);
	}
}
...
#if (LCM_DSI_CMD_MODE)
LCM_DRIVER nt36672_fhdp_dsi_cmd_tianma_nt50358_lcm_drv = {
	.name = "nt36672_fhdp_dsi_cmd_tianma_nt50358_drv",
#else
