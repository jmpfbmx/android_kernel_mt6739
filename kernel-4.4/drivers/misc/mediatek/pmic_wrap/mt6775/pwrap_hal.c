...
static signed int _pwrap_init_single(void);
...
static signed int pwrap_wacs2_hal(unsigned int write, unsigned int adr, unsigned int wdata, unsigned int *rdata)
{
	...
	/* Check gauge clock */
	if (write == 1) {
		if ((adr == 0x0430) && (((wdata & 0x0004) >> 2) == 0)) {
...
{
	PWRAPLOG("spi clk set ....MODULE_CLK_SEL[8]:0x%x\n", WRAP_RD32(MODULE_CLK_SEL));
...
static signed int _pwrap_init_dio(unsigned int dio_en)
{
	...
	} while ((GET_WACS2_FSM(rdata) != WACS_FSM_IDLE) || (GET_WACS2_SYNC_IDLE2(rdata) != WACS_SYNC_IDLE));
...
static signed int _pwrap_init_single(void)
{
	...
	ret = pwrap_write_nochk(PMIC_DEW_DIO_EN_ADDR, 0);
	if (ret != 0)
		PWRAPLOG("_pwrap_init_single, write PMIC_DEW_DIO_EN_ADDR fail, ret = 0x%x\n", ret);
...
#ifndef DUAL_PMICS
	WRAP_WR32(PMIC_WRAP_STAUPD_GRPEN, 0x1f4);
#else
	WRAP_WR32(PMIC_WRAP_STAUPD_GRPEN, 0x1fc);
#endif
#if 0
	/* CRC */
#ifdef DUAL_PMICS
...
#ifdef DUAL_PMICS
	WRAP_WR32(PMIC_WRAP_EINT_STA1_ADR, 0x8C36);
#endif

	/* MD ADC Interface */
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_LATEST_ADDR, (MT6355_AUXADC_ADC42 << 16) + MT6355_AUXADC_ADC36);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_WP_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_MDBG_R_PTR_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_0_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_00_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_1_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_01_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_2_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_02_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_3_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_03_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_4_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_04_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_5_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_05_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_6_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_06_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_7_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_07_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_8_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_08_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_9_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_09_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_10_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_10_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_11_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_11_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_12_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_12_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_13_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_13_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_14_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_14_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_15_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_15_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_16_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_16_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_17_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_17_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_18_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_18_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_19_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_19_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_20_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_20_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_21_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_21_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_22_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_22_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_23_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_23_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_24_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_24_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_25_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_25_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_26_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_26_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_27_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_27_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_28_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_28_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_29_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_29_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_30_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_30_ADDR);
	WRAP_WR32(PMIC_WRAP_MD_AUXADC_RDATA_31_ADDR, (MT6355_AUXADC_ADC42 << 16) + PMIC_AUXADC_BUF_OUT_31_ADDR);

	/* GPS Interface */
	/* Internal GPS AUXADC Interface */
	WRAP_WR32(PMIC_WRAP_INT_GPS_AUXADC_CMD_ADDR, (MT6355_AUXADC_RQST1_SET << 16) + MT6355_AUXADC_RQST1_SET);
	WRAP_WR32(PMIC_WRAP_INT_GPS_AUXADC_CMD, (0x0400 << 16) + 0x0100);
	WRAP_WR32(PMIC_WRAP_INT_GPS_AUXADC_RDATA_ADDR, (MT6355_AUXADC_ADC39 << 16) + MT6355_AUXADC_ADC16);
...
static void _pwrap_starve_set(void)
{
	...
	WRAP_WR32(PMIC_WRAP_STARV_COUNTER_11, 0x0417);
	WRAP_WR32(PMIC_WRAP_STARV_COUNTER_12, 0x0413);
	WRAP_WR32(PMIC_WRAP_STARV_COUNTER_13, 0x047c);
	WRAP_WR32(PMIC_WRAP_STARV_COUNTER_14, 0x047c);
	WRAP_WR32(PMIC_WRAP_STARV_COUNTER_15, 0x0740);
	WRAP_WR32(PMIC_WRAP_STARV_COUNTER_16, 0x0740);

}

static void _pwrap_enable(void)
{
	WRAP_WR32(PMIC_WRAP_HIPRIO_ARB_EN, 0x1ffff);
...
static signed int _pwrap_init_sistrobe(int dual_si_sample_settings)
{
	...
	if (dual_si_sample_settings == 1) {
		...
		for (si_dly = 0; si_dly < 8; si_dly++) {
			...
			for (i = 0; i < 1; i++) {
				...
				if ((rdata & 0x7fff) != (test_data[i] & 0x7fff)) {
					PWRAPLOG("si_dly = %x, *RESERVED = %x, rdata = %x\n",
						si_dly, reserved, rdata);
	...
	pwrap_read_nochk(EXT_DEW_READ_TEST, &rdata);
	if (rdata != DEFAULT_VALUE_READ_TEST) {
		PWRAPLOG("dio Read Test Failed, EXT rdata = %x, exp = 0x5aa5\n", rdata);
		return 0x11;
	}
#endif
...
static signed int _pwrap_init_reg_clock(unsigned int regck_sel)
{
	...
	_pwrap_wacs2_nochk(1, PMIC_DEW_RDDMY_NO_ADDR, 0xd, &rdata);
	WRAP_WR32(PMIC_WRAP_RDDMY, 0xd);
	PWRAPLOG("NO_SLV_CLK_1M Set Read Dummy Cycle\n");
#else
	_pwrap_wacs2_nochk(1, PMIC_DEW_RDDMY_NO_ADDR, 0xd, &rdata);
	_pwrap_wacs2_nochk(1, EXT_DEW_RDDMY_NO, 0xd, &rdata);
	WRAP_WR32(PMIC_WRAP_RDDMY, 0x0d0d);
	...
	if (regck_sel == 1) { /* Slave Clock is 18MHz */
		 ...
		 */
		WRAP_WR32(PMIC_WRAP_CSHEXT_WRITE, 0x0404);
		WRAP_WR32(PMIC_WRAP_CSHEXT_READ, 0x0);
		WRAP_WR32(PMIC_WRAP_CSLEXT_WRITE, 0x400);
...
signed int pwrap_init(void)
{
	...
	WRAP_WR32(PMIC_WRAP_HIPRIO_ARB_EN, 0x8000); /* ONLY WACS2 */
	/* Enable WACS2 */
	...
	*/
	...
	WRAP_WR32(PMIC_WRAP_BWC_OPTIONS, WRAP_RD32(PMIC_WRAP_BWC_OPTIONS) | (0x1 << 6));
...
static inline void pwrap_dump_ap_register(void)
{
	...
	WRAP_WR32(PMIC_WRAP_MONITOR_CTRL_0, 0x1); /* Matching mode and Continue recording after interrupt trigger */
	WRAP_WR32(PMIC_WRAP_WACS2_EN, 0x1);
...
static void pwrap_reenable_pmic_logging(void)
{
	...
	/* Enable Single IO mode */
	sub_return = _pwrap_init_single();
	if (sub_return != 0)
		PWRAPLOG("switch to single fail, ret=%x\n", sub_return);
	PWRAPLOG("_pwrap_switch_single ok\n");

	/* Read Last three command */
	pwrap_read_nochk(PMIC_RECORD_CMD0_ADDR, &rdata);
	PWRAPLOG("RECORD_CMD0:  0x%x (Last one command addr)\n", (rdata & 0x3fff));
	pwrap_read_nochk(PMIC_RECORD_WDATA0_ADDR, &rdata);
	PWRAPLOG("RECORD_WDATA0:0x%x (Last one command wdata)\n", rdata);
	pwrap_read_nochk(PMIC_RECORD_CMD1_ADDR, &rdata);
	PWRAPLOG("RECORD_CMD1:  0x%x (Last second command addr)\n", (rdata & 0x3fff));
	pwrap_read_nochk(PMIC_RECORD_WDATA1_ADDR, &rdata);
	PWRAPLOG("RECORD_WDATA1:0x%x (Last second command wdata)\n", rdata);
	pwrap_read_nochk(PMIC_RECORD_CMD2_ADDR, &rdata);
	PWRAPLOG("RECORD_CMD2:  0x%x (Last third command addr)\n", (rdata & 0x3fff));
	pwrap_read_nochk(PMIC_RECORD_WDATA2_ADDR, &rdata);
	PWRAPLOG("RECORD_WDATA2:0x%x (Last third command wdata)\n", rdata);

	/* Enable DIO mode */
	sub_return = _pwrap_init_dio(1);
	if (sub_return != 0)
		PWRAPLOG("switch to dual fail, err=%x, ret=%x\n", 0x11, sub_return);
	PWRAPLOG("_pwrap_switch_dio ok\n");
...
{
	unsigned long flags = 0;
	unsigned int int1_flg = 0;

	PWRAPFUC();
	PWRAPLOG("PMIC_WRAP_INT0_FLG = 0x%x\n", WRAP_RD32(PMIC_WRAP_INT0_FLG));
	PWRAPLOG("PMIC_WRAP_INT1_FLG = 0x%x\n", WRAP_RD32(PMIC_WRAP_INT1_FLG));
	...
	/* Check INT1_FLG Status (bit 28: Monitor Catch a target transaction)*/
	int1_flg = WRAP_RD32(PMIC_WRAP_INT1_FLG);
	if ((int1_flg & 0x10000000) == 0x10000000) {
		PWRAPLOG("Monitor catch a target transaction\n");
		PWRAPLOG("PMIC_WRAP_INT1_FLG: 0x%x\n", int1_flg);
		pwrap_logging_at_isr();
		pwrap_reenable_pmic_logging();
		pwrap_dump_ap_register();
		WRAP_WR32(PMIC_WRAP_INT1_CLR, 0x10000000);
		/* BUG_ON(1); */
	}

/* Check INT1_FLA Status, if wrong status, dump all register info */
	if ((WRAP_RD32(PMIC_WRAP_INT1_FLG) & 0xffffff) != 0) {
		PWRAP_PR_ERR("INT1_FLG status Wrong,value=0x%x\n", WRAP_RD32(PMIC_WRAP_INT1_FLG));
#ifdef CONFIG_MTK_TINYSYS_SSPM_SUPPORT
		pwrap_wacs2_ipi(0x10010000 + 0xD8, 0xffffffff, (WRITE_CMD | WRITE_PMIC_WRAP));
#else
...
#if 0
static int pmic_wrapper_notify_call(struct notifier_block *nb, unsigned long id, void *unused)
{
	switch (id) {
	case NOTIFY_DPIDLE_ENTER:
		while (((WRAP_RD32(PMIC_WRAP_STAUPD_STA) & 0x1c000000) >> 26) != 0)
			;
		WRAP_WR32(PMIC_WRAP_STAUPD_CTRL, 0x0); /* Disable Status Update */
		WRAP_WR32(PMIC_WRAP_STAUPD_GRPEN, 0x004); /* only interrupt */
		WRAP_WR32(PMIC_WRAP_STAUPD_CTRL, 0x5); /* Enable Status Update */
		break;
	case NOTIFY_DPIDLE_LEAVE:
		while (((WRAP_RD32(PMIC_WRAP_STAUPD_STA) & 0x1c000000) >> 26) != 0)
			;
		WRAP_WR32(PMIC_WRAP_STAUPD_CTRL, 0x0); /* Disable Status Update */
		WRAP_WR32(PMIC_WRAP_STAUPD_GRPEN, 0x1f4); /* enable AUXADC */
		WRAP_WR32(PMIC_WRAP_STAUPD_CTRL, 0x5); /* Enable Status Update */
		break;
	default:
		break;
...
static struct notifier_block pmic_wrapper_nb = {
	.notifier_call = pmic_wrapper_notify_call,
};
#endif
...
static int __init pwrap_hal_init(void)
{
	...
	/* mtk_idle_notifier_register(&pmic_wrapper_nb); */
