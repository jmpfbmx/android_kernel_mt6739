...
#ifndef __MMDVFS_CONFIG_MT6758_H__
#define __MMDVFS_CONFIG_MT6758_H__
...
#define MT6758_MMDVFS_OPP_MAX 3    /* Max total MMDVFS opps of the profile support */

/* CLK source configuration */

/* CLK source IDs */
/* Define the internal index of each CLK source*/
#define MT6758_MMDVFS_CLK_TOP_SYSPLL1_D2_CK 0
#define MT6758_MMDVFS_CLK_TOP_UNIVPLL1_D4_CK 1
#define MT6758_MMDVFS_CLK_TOP_MMPLL_D10_CK 2
#define MT6758_MMDVFS_CLK_TOP_MMPLL_D7_CK 3
#define MT6758_MMDVFS_CLK_TOP_UNIVPLL_D5_CK 4
#define MT6758_MMDVFS_CLK_SOURCE_NUM 5

/* CLK Source definiation */
/* Define the clk source description */
struct mmdvfs_clk_source_desc mt6758_mmdvfs_clk_sources_setting[MT6758_MMDVFS_CLK_SOURCE_NUM] = {
		{NULL, "mmdvfs_clk_top_syspll1_d2_ck", 273},
...
struct mmdvfs_clk_hw_map mt6758_mmdvfs_clk_hw_map_setting[MMDVFS_CLK_MUX_NUM] = {
		{ MMDVFS_CLK_CONFIG_NONE, { NULL, "MMDVFS_CLK_MUX_TOP_SMI0_2X_SEL"}, -1, 2,
			{-1, -1},
			{-1, -1}
		},
		{ MMDVFS_CLK_CONFIG_BY_MUX, { NULL, "MMDVFS_CLK_MUX_TOP_MM_SEL"}, -1, 2,
			{-1, -1},
			{MT6758_MMDVFS_CLK_TOP_MMPLL_D7_CK, MT6758_MMDVFS_CLK_TOP_MMPLL_D10_CK}
		},
		{ MMDVFS_CLK_CONFIG_BY_MUX, { NULL, "MMDVFS_CLK_MUX_TOP_CAM_SEL"}, -1, 2,
			{-1, -1},
			{MT6758_MMDVFS_CLK_TOP_MMPLL_D7_CK, MT6758_MMDVFS_CLK_TOP_SYSPLL1_D2_CK}
		},
		{ MMDVFS_CLK_CONFIG_BY_MUX, { NULL, "MMDVFS_CLK_MUX_TOP_IMG_SEL"}, -1, 2,
			{-1, -1},
			{MT6758_MMDVFS_CLK_TOP_MMPLL_D7_CK, MT6758_MMDVFS_CLK_TOP_SYSPLL1_D2_CK}
		},
		{ MMDVFS_CLK_CONFIG_BY_MUX, { NULL, "MMDVFS_CLK_MUX_TOP_VENC_SEL"}, -1, 2,
			{-1, -1},
			{MT6758_MMDVFS_CLK_TOP_UNIVPLL_D5_CK, MT6758_MMDVFS_CLK_TOP_UNIVPLL1_D4_CK}
		},
		{ MMDVFS_CLK_CONFIG_BY_MUX, { NULL, "MMDVFS_CLK_MUX_TOP_VDEC_SEL"}, -1, 2,
			{-1, -1},
			{MT6758_MMDVFS_CLK_TOP_UNIVPLL_D5_CK, MT6758_MMDVFS_CLK_TOP_MMPLL_D10_CK}
		},
...
#define MT6758_MMDVFS_SENSOR_MIN (16000000)
/* A.1 [LP4 2-ch] Scenarios of each MM DVFS Step (force kicker) */
/* OPP 0 scenarios */
#define MT6758_MMDVFS_OPP0_NUM 17
struct mmdvfs_profile mt6758_mmdvfs_opp0_profiles[MT6758_MMDVFS_OPP0_NUM] = {
	{"SMVR", SMI_BWC_SCEN_VR_SLOW, {0, 0, 0}, {0, 0, 0 } },
	{"ICFP", SMI_BWC_SCEN_ICFP, {0, 0, 0}, {0, 0, 0 } },
	{"Full Sensor Capture (ZSD)", SMI_BWC_SCEN_CAM_CP, {MT6758_MMDVFS_SENSOR_MIN, 0, 0}, {0, 0, 0 } },
	...
	{"EIS 4K Feature Recording", SMI_BWC_SCEN_VR,
		{MT6758_MMDVFS_SENSOR_MIN, MMDVFS_CAMERA_MODE_FLAG_EIS_2_0, 0}, {0, 0, 0 } },
...
/* OPP 1 scenarios */
#define MT6758_MMDVFS_OPP1_NUM 0
struct mmdvfs_profile mt6758_mmdvfs_opp1_profiles[MT6758_MMDVFS_OPP1_NUM] = {
};

/* OPP 2 scenarios */
#define MT6758_MMDVFS_OPP2_NUM 14
struct mmdvfs_profile mt6758_mmdvfs_opp2_profiles[MT6758_MMDVFS_OPP2_NUM] = {
	{"Full Sensor Preview (ZSD)", SMI_BWC_SCEN_CAM_PV, {MT6758_MMDVFS_SENSOR_MIN, 0, 0}, {0, 0, 0 } },
	{"Full Sensor Camera Recording", SMI_BWC_SCEN_VR, {MT6758_MMDVFS_SENSOR_MIN, 0, 0}, {0, 0, 0 } },
...
#define MT6758_MMDVFS_SMI_USER_CONTROL_SCEN_MASK (1 << SMI_BWC_SCEN_VP_HIGH_FPS)
...
/* LP4 2-ch */
struct mmdvfs_step_to_profile_mapping mt6758_step_profile[MT6758_MMDVFS_OPP_MAX] = {
		{0, mt6758_mmdvfs_opp0_profiles, MT6758_MMDVFS_OPP0_NUM,
		{OPP_0,
		...
		{1, mt6758_mmdvfs_opp1_profiles, MT6758_MMDVFS_OPP1_NUM,
		{OPP_1,
		...
		{2, mt6758_mmdvfs_opp2_profiles, MT6758_MMDVFS_OPP2_NUM,
		{OPP_2,
		{MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
		MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
		MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1}, MMDVFS_CLK_MUX_NUM
...
#define MT6758_MMDVFS_VOLTAGE_LOW_OPP	2
#define MT6758_MMDVFS_VOLTAGE_HIGH_OPP	1
#define MT6758_MMDVFS_VOLTAGE_DEFAULT_STEP_OPP	-1
#define MT6758_MMDVFS_VOLTAGE_LOW_LOW_OPP 3

int mt6758_mmdvfs_legacy_step_to_opp[MMDVFS_VOLTAGE_COUNT] = {MT6758_MMDVFS_VOLTAGE_LOW_OPP,
	MT6758_MMDVFS_VOLTAGE_HIGH_OPP, MT6758_MMDVFS_VOLTAGE_DEFAULT_STEP_OPP,
	MT6758_MMDVFS_VOLTAGE_LOW_LOW_OPP
};

#define MT6758_MMCLK_OPP0_LEGACY_STEP	MMSYS_CLK_HIGH
#define MT6758_MMCLK_OPP1_LEGACY_STEP	MMSYS_CLK_LOW
/* MMCLK_OPP3 and OPP2 is not used in this configuration */
#define MT6758_MMCLK_OPP2_LEGACY_STEP	MMSYS_CLK_LOW
#define MT6758_MMCLK_OPP3_LEGACY_STEP	MMSYS_CLK_LOW

int mt6758_mmdvfs_mmclk_opp_to_legacy_mmclk_step[MT6758_MMDVFS_OPP_MAX] = {
	MT6758_MMCLK_OPP0_LEGACY_STEP, MT6758_MMCLK_OPP1_LEGACY_STEP,
	MT6758_MMCLK_OPP2_LEGACY_STEP
};


/* Part IV VPU association */
/* There is no VPU DVFS in MT6758 */

/* Part V ISP DVFS configuration */
#define MMDVFS_ISP_THRESHOLD_NUM 2
int mt6758_mmdvs_isp_threshold_setting[MMDVFS_ISP_THRESHOLD_NUM] = {457, 273};
int mt6758_mmdvs_isp_threshold_opp[MMDVFS_ISP_THRESHOLD_NUM] = {MMDVFS_FINE_STEP_OPP0, MMDVFS_FINE_STEP_OPP2};

struct mmdvfs_threshold_setting mt6758_mmdvfs_threshold_settings[MMDVFS_PM_QOS_SUB_SYS_NUM] = {
	{ MMDVFS_PM_QOS_SUB_SYS_CAMERA, mt6758_mmdvs_isp_threshold_setting,
	mt6758_mmdvs_isp_threshold_opp, MMDVFS_ISP_THRESHOLD_NUM, MMDVFS_PMQOS_ISP},
};


#endif /* __MMDVFS_CONFIG_MT6758_H__ */
