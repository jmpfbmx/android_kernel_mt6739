...
struct SMI_SETTING_VALUE smi_profile_setting_larb5_vr[SMI_LARB5_PORT_NUM] = {
	{0x200, 0x8}, {0x204, 0x1}, {0x208, 0x6}, {0x20c, 0x6}, {0x210, 0x1}, {0x214, 0x1}, {0x218, 0x1}, {0x21c, 0x1},
	{0x220, 0x1}, {0x224, 0x1}, {0x228, 0x1}, {0x22c, 0x1}
};

struct SMI_SETTING_VALUE smi_profile_setting_larb6_vr[SMI_LARB6_PORT_NUM] = {
	{0x200, 0x1c}, {0x204, 0x12}, {0x208, 0x2}, {0x20c, 0x2}, {0x210, 0x2}, {0x214, 0x2}, {0x218, 0x2},
	{0x21c, 0x2}, {0x220, 0x2}, {0x224, 0x2}, {0x228, 0x2}, {0x22c, 0x2}, {0x230, 0x4}, {0x234, 0x4}, {0x238, 0x4},
	{0x23c, 0x2}, {0x240, 0x2}, {0x244, 0x1}, {0x248, 0x2}, {0x24c, 0x2}, {0x250, 0x2}
};
...
struct SMI_SETTING_VALUE smi_profile_setting_larb0_init[SMI_LARB0_PORT_NUM] = {
	{0x200, 0x1f}, {0x204, 0x1f}, {0x208, 0x1f}, {0x20c, 0xe}, {0x210, 0x5}, {0x214, 0x5}, {0x218, 0x1f}
};
...
struct SMI_SETTING_VALUE smi_profile_setting_larb5_init[SMI_LARB5_PORT_NUM] = {
	{0x200, 0xc}, {0x204, 0x1}, {0x208, 0x4}, {0x20c, 0x4}, {0x210, 0x1}, {0x214, 0x1}, {0x218, 0x1}, {0x21c, 0x1},
	{0x220, 0x1}, {0x224, 0x1}, {0x228, 0x1}, {0x22c, 0x1}
};

struct SMI_SETTING_VALUE smi_profile_setting_larb6_init[SMI_LARB6_PORT_NUM] = {
	{0x200, 0x1c}, {0x204, 0x14}, {0x208, 0x2}, {0x20c, 0x2}, {0x210, 0x2}, {0x214, 0x2}, {0x218, 0x4},
	{0x21c, 0x2}, {0x220, 0x2}, {0x224, 0x2}, {0x228, 0x2}, {0x22c, 0x2}, {0x230, 0x4}, {0x234, 0x4}, {0x238, 0x4},
	{0x23c, 0x2}, {0x240, 0x2}, {0x244, 0x1}, {0x248, 0x2}, {0x24c, 0x2}, {0x250, 0x2}
};
...
struct SMI_SETTING_VALUE smi_profile_setting_larb0_icfp[SMI_LARB0_PORT_NUM] = {
	{0x200, 0x1f}, {0x204, 0x1f}, {0x208, 0x1f}, {0x20c, 0x5}, {0x210, 0x5}, {0x214, 0x5}, {0x218, 0x1f}
};
...
struct SMI_SETTING_VALUE smi_profile_setting_larb5_icfp[SMI_LARB5_PORT_NUM] = {
	{0x200, 0xD}, {0x204, 0x1}, {0x208, 0x7}, {0x20c, 0xA}, {0x210, 0x1}, {0x214, 0x1}, {0x218, 0x1}, {0x21c, 0x1},
	{0x220, 0x1}, {0x224, 0x1}, {0x228, 0x1}, {0x22c, 0x1}
};

struct SMI_SETTING_VALUE smi_profile_setting_larb6_icfp[SMI_LARB6_PORT_NUM] = {
	{0x200, 0x14}, {0x204, 0x6}, {0x208, 0x2}, {0x20c, 0x2}, {0x210, 0x2}, {0x214, 0x2}, {0x218, 0x2},
	{0x21c, 0x2}, {0x220, 0x2}, {0x224, 0x2}, {0x228, 0x2}, {0x22c, 0x2}, {0x230, 0x4}, {0x234, 0x4}, {0x238, 0x4},
	{0x23c, 0x2}, {0x240, 0x2}, {0x244, 0x1}, {0x248, 0x2}, {0x24c, 0x2}, {0x250, 0x2}
};
