...
struct SMI_SETTING smi_mmu_setting_config = {
	...
	{SMI_MMU_LARB0_SETTING_NUM, SMI_MMU_LARB1_SETTING_NUM, SMI_MMU_LARB2_SETTING_NUM,
		SMI_MMU_LARB3_SETTING_NUM},
	{smi_mmu_larb0_setting, NULL, NULL, NULL}
};
...
struct SMI_SETTING_VALUE smi_profile_setting_common_init[SMI_PROFILE_SETTING_COMMON_INIT_NUM] = {
	{0x220, 0x4},
	{REG_OFFSET_SMI_L1ARB0, 0x1ba5}, {REG_OFFSET_SMI_L1ARB1, 0x15d3}, {REG_OFFSET_SMI_L1ARB2, 0x1000},
	{REG_OFFSET_SMI_L1ARB3, 0x1000}
};

struct SMI_SETTING_VALUE smi_profile_setting_larb0_init[SMI_LARB0_PORT_NUM] = {
	{0x200, 0x1f}, {0x204, 0x1f}, {0x208, 0x1f}, {0x20c, 0x1f}, {0x210, 0x1f}, {0x214, 0x7}, {0x218, 0x7},
	{0x21c, 0x4}, {0x220, 0x4}, {0x224, 0x1f}
};

struct SMI_SETTING_VALUE smi_profile_setting_larb1_init[SMI_LARB1_PORT_NUM] = {
	{0x200, 0xc}, {0x204, 0x1}, {0x208, 0x4}, {0x20c, 0x4}, {0x210, 0x1}, {0x214, 0x1},
	{0x218, 0x1}, {0x21c, 0x1}, {0x220, 0x1}, {0x224, 0x1}
};

struct SMI_SETTING_VALUE smi_profile_setting_larb2_init[SMI_LARB2_PORT_NUM] = {
	{0x200, 0x16}, {0x204, 0x14}, {0x208, 0x2}, {0x20c, 0x2}, {0x210, 0x2}, {0x214, 0x2}, {0x218, 0x2},
	{0x21c, 0x4}, {0x220, 0x4}, {0x224, 0x4}, {0x228, 0x2}, {0x22c, 0x2}, {0x230, 0x2}, {0x234, 0x4},
	{0x238, 0x2}, {0x23c, 0x2}, {0x240, 0x2}, {0x244, 0x2}
};

struct SMI_SETTING_VALUE smi_profile_setting_larb3_init[SMI_LARB3_PORT_NUM] = {
	{0x200, 0x3}, {0x204, 0x1}, {0x208, 0x1}, {0x20c, 0x1}, {0x210, 0x1}, {0x214, 0x5}, {0x218, 0x3},
	{0x21c, 0x1}, {0x220, 0x1}, {0x224, 0x1}, {0x228, 0x6}
};
...
struct SMI_SETTING init_setting_config = {
	...
	{smi_profile_setting_larb0_init, smi_profile_setting_larb1_init, smi_profile_setting_larb2_init,
	 smi_profile_setting_larb3_init}
};
...
struct SMI_SETTING_VALUE smi_profile_setting_common_icfp[SMI_PROFILE_SETTING_COMMON_ICFP_NUM] = {
	{0x220, 0x54},
	{REG_OFFSET_SMI_L1ARB0, 0x1327}, {REG_OFFSET_SMI_L1ARB1, 0x1241}, {REG_OFFSET_SMI_L1ARB2, 0x12E6},
	{REG_OFFSET_SMI_L1ARB3, 0x119E}
};

struct SMI_SETTING_VALUE smi_profile_setting_larb0_icfp[SMI_LARB0_PORT_NUM] = {
	{0x200, 0x1f}, {0x204, 0x1f}, {0x208, 0x1f}, {0x20c, 0xe}, {0x210, 0xe}, {0x214, 0x7}, {0x218, 0x7},
	{0x21c, 0xb}, {0x220, 0x1}, {0x224, 0x1f}
};

struct SMI_SETTING_VALUE smi_profile_setting_larb1_icfp[SMI_LARB1_PORT_NUM] = {
	{0x200, 0x6}, {0x204, 0x1}, {0x208, 0x2}, {0x20c, 0x3}, {0x210, 0x1}, {0x214, 0x1}, {0x218, 0x1},
	{0x21c, 0x1}, {0x220, 0x0}, {0x224, 0x0}
};
...
struct SMI_SETTING icfp_setting_config = {
	...
	{smi_profile_setting_larb0_icfp, smi_profile_setting_larb1_icfp, smi_profile_setting_larb2_icfp,
	 smi_profile_setting_larb3_icfp}
};
