...
#define MT6771_MMDVFS_OPP_MAX 4    /* Max total MMDVFS opps of the profile support */
#define MT6771_MMDVFS_CLK_OPP_MAX 4 /* Max total CLK opps of the profile support */
#define MT6771_MMDVFS_VCORE_OPP_MAX 4 /* Max total CLK opps of the profile support */
...
#define MT6771_MMDVFS_CLK_SOURCE_NUM 5

/* CLK Source definiation */
/* Define the clk source description */
struct mmdvfs_clk_source_desc mt6771_mmdvfs_clk_sources_setting[MT6771_MMDVFS_CLK_SOURCE_NUM] = {
...
struct mmdvfs_clk_hw_map mt6771_mmdvfs_clk_hw_map_setting[MMDVFS_CLK_MUX_NUM] = {
		...
		{ MMDVFS_CLK_CONFIG_BY_MUX, { NULL, "MMDVFS_CLK_MUX_TOP_MM_SEL"}, -1, 2,
			{-1, -1},
			{MT6771_MMDVFS_CLK_MMPLL_D7_CK, MT6771_MMDVFS_CLK_UNIVPLL_D2_D2_CK}
		},
		{ MMDVFS_CLK_CONFIG_BY_MUX, { NULL, "MMDVFS_CLK_MUX_TOP_CAM_SEL"}, -1, 2,
			{-1, -1},
			{MT6771_MMDVFS_CLK_SYSPLL_D2_CK, MT6771_MMDVFS_CLK_SYSPLL_D3_CK}
		},
		{ MMDVFS_CLK_CONFIG_BY_MUX, { NULL, "MMDVFS_CLK_MUX_TOP_IMG_SEL"}, -1, 2,
			{-1, -1},
			{MT6771_MMDVFS_CLK_MMPLL_D6_CK, MT6771_MMDVFS_CLK_SYSPLL_D3_CK}
		},
...
struct mmdvfs_profile_mask qos_apply_profiles[] = {
	...
	{"4K VP", SMI_BWC_SCEN_VP_HIGH_RESOLUTION, MMDVFS_FINE_STEP_OPP0 },	/* VP 4K for opp0 */
	{"4K VP", SMI_BWC_SCEN_VP_HIGH_RESOLUTION, MMDVFS_FINE_STEP_OPP1 },	/* VP 4K for opp1 */
	{"VPU", MMDVFS_SCEN_VPU_KERNEL, MMDVFS_FINE_STEP_OPP0 },	/* VPU */
	{"ICFP", SMI_BWC_SCEN_ICFP, MMDVFS_FINE_STEP_OPP0},	/* ICFP for opp0 */
	{"ICFP", SMI_BWC_SCEN_ICFP, MMDVFS_FINE_STEP_OPP1},	/* ICFP for opp1 */
...
struct mmdvfs_profile mt6771_mmdvfs_opp0_profiles_lp3[MT6771_LP3_MMDVFS_OPP0_NUM] = {
	{"SMVR", SMI_BWC_SCEN_VR_SLOW, {0, 0, 0}, {0, 0, 0 } },
	{"ICFP", SMI_BWC_SCEN_ICFP, {0, 0, 0}, {0, 0, 0 } },
	{"Full Sensor Capture (ZSD)", SMI_BWC_SCEN_CAM_CP, {MT6771_MMDVFS_SENSOR_MIN, 0, 0}, {0, 0, 0 } },
	{"Stereo Feature Preview", SMI_BWC_SCEN_CAM_PV, {0, MMDVFS_CAMERA_MODE_FLAG_STEREO, 0}, {0, 0, 0 } },
...
struct mmdvfs_profile mt6771_mmdvfs_opp1_profiles_lp3[MT6771_LP3_MMDVFS_OPP1_NUM] = {
};

/* OPP 2 scenarios */
#define MT6771_LP3_MMDVFS_OPP2_NUM 0
struct mmdvfs_profile mt6771_mmdvfs_opp2_profiles_lp3[MT6771_LP3_MMDVFS_OPP2_NUM] = {
};

/* OPP 3 scenarios */
#define MT6771_LP3_MMDVFS_OPP3_NUM 13
struct mmdvfs_profile mt6771_mmdvfs_opp3_profiles_lp3[MT6771_LP3_MMDVFS_OPP3_NUM] = {
	{"Full Sensor Preview (ZSD)", SMI_BWC_SCEN_CAM_PV, {MT6771_MMDVFS_SENSOR_MIN, 0, 0}, {0, 0, 0 } },
	{"Full Sensor Camera Recording", SMI_BWC_SCEN_VR, {MT6771_MMDVFS_SENSOR_MIN, 0, 0}, {0, 0, 0 } },
	{"Dual zoom preview", SMI_BWC_SCEN_CAM_PV, {0, MMDVFS_CAMERA_MODE_FLAG_DUAL_ZOOM, 0}, {0, 0, 0 } },
	{"Dual zoom preview (reserved)", SMI_BWC_SCEN_VR,
...
/* LP4 2-ch */
struct mmdvfs_step_to_profile_mapping mt6771_step_profile[MT6771_MMDVFS_OPP_MAX] = {
...
struct mmdvfs_step_to_profile_mapping mt6771_step_profile_3600[MT6771_MMDVFS_OPP_MAX] = {
		{0, mt6771_mmdvfs_opp0_profiles_3600, MT6771_3600_MMDVFS_OPP0_NUM,
		{OPP_0,
		{MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0,
		MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0,
		MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0}, MMDVFS_CLK_MUX_NUM
		...
		{1, mt6771_mmdvfs_opp1_profiles_3600, MT6771_3600_MMDVFS_OPP1_NUM,
		{OPP_1,
		{MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0,
		MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0,
		MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0}, MMDVFS_CLK_MUX_NUM
		...
		{2, mt6771_mmdvfs_opp2_profiles_3600, MT6771_3600_MMDVFS_OPP2_NUM,
		{OPP_2,
		{MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
		MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
		MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1}, MMDVFS_CLK_MUX_NUM
		...
		{3, mt6771_mmdvfs_opp3_profiles_3600, MT6771_3600_MMDVFS_OPP3_NUM,
		{OPP_3,
		{MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
		MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
		MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1}, MMDVFS_CLK_MUX_NUM
...
struct mmdvfs_step_to_profile_mapping mt6771_step_profile_lp3[MT6771_MMDVFS_OPP_MAX] = {
		...
		{1, mt6771_mmdvfs_opp1_profiles_lp3, MT6771_LP3_MMDVFS_OPP1_NUM,
		{OPP_1,
		{MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
		MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
		MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1}, MMDVFS_CLK_MUX_NUM
		...
		{2, mt6771_mmdvfs_opp2_profiles_lp3, MT6771_LP3_MMDVFS_OPP2_NUM,
		{OPP_2,
		{MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
		MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
		MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1}, MMDVFS_CLK_MUX_NUM
		...
		{3, mt6771_mmdvfs_opp3_profiles_lp3, MT6771_LP3_MMDVFS_OPP3_NUM,
		{OPP_3,
		{MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
		MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
		MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1}, MMDVFS_CLK_MUX_NUM
...
int mt6771_mmdvfs_legacy_step_to_opp[MMDVFS_VOLTAGE_COUNT] = {MT6771_MMDVFS_VOLTAGE_LOW_OPP,
	MT6771_MMDVFS_VOLTAGE_HIGH_OPP, MT6771_MMDVFS_VOLTAGE_DEFAULT_STEP_OPP,
