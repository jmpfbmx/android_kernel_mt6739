...
#define MT6739_MMDVFS_OPP_MAX 4    /* Max total MMDVFS opps of the profile support */
#define MT6739_MMDVFS_CLK_OPP_MAX 4 /* Max total CLK opps of the profile support */
#define MT6739_MMDVFS_VCORE_OPP_MAX 4 /* Max total CLK opps of the profile support */
...
#define MT6739_MMDVFS_CLK_SOURCE_NUM 2

/* CLK Source definiation */
/* Define the clk source description */
struct mmdvfs_clk_source_desc mt6739_mmdvfs_clk_sources_setting[MT6739_MMDVFS_CLK_SOURCE_NUM] = {
...
struct mmdvfs_clk_hw_map mt6739_mmdvfs_clk_hw_map_setting[MMDVFS_CLK_MUX_NUM] = {
		{ MMDVFS_CLK_CONFIG_NONE, { NULL, "MMDVFS_CLK_MUX_TOP_SMI0_2X_SEL"}, -1, 2,
			{-1, -1},
			{-1, -1}
		},
		{ MMDVFS_CLK_CONFIG_NONE, { NULL, "MMDVFS_CLK_TOP_MMPLL_CK"}, -1, 2,
			{-1, -1},
			{MT6739_MMDVFS_CLK_TOP_VENCPLL_CK, MT6739_MMDVFS_CLK_TOP_SYSPLL2_D2}
		},
		{ MMDVFS_CLK_CONFIG_NONE, { NULL, "MMDVFS_CLK_MUX_TOP_CAM_SEL"}, -1, 2,
			{-1, -1},
			{-1, -1}
		},
...
struct mmdvfs_profile mt6739_mmdvfs_opp0_profiles[MT6739_MMDVFS_OPP0_NUM] = {
	...
	{"FHD VR/ VSS (VENC)", SMI_BWC_SCEN_VENC, {0, 0, 0}, {1920, 1080, 0} },
...
struct mmdvfs_profile mt6739_mmdvfs_opp3_profiles[MT6739_MMDVFS_OPP3_NUM] = {
	...
	{"EIS 4K Feature Recording", SMI_BWC_SCEN_VR,
		{MT6739_MMDVFS_SENSOR_MIN, MMDVFS_CAMERA_MODE_FLAG_EIS_2_0, 0}, {0, 0, 0 } },
};
...
struct mmdvfs_step_to_profile_mapping mt6739_step_profile[MT6739_MMDVFS_OPP_MAX] = {
...
int mt6739_mmdvfs_legacy_step_to_opp[MMDVFS_VOLTAGE_COUNT] = {MT6739_MMDVFS_VOLTAGE_LOW_OPP,
	MT6739_MMDVFS_VOLTAGE_HIGH_OPP, MT6739_MMDVFS_VOLTAGE_DEFAULT_STEP_OPP,
...
int mt6739_mmdvs_isp_threshold_opp[MMDVFS_ISP_THRESHOLD_NUM] = {MMDVFS_FINE_STEP_OPP0, MMDVFS_FINE_STEP_OPP3};

struct mmdvfs_threshold_setting mt6739_mmdvfs_threshold_settings[MMDVFS_PM_QOS_SUB_SYS_NUM] = {
	{ MMDVFS_PM_QOS_SUB_SYS_CAMERA, mt6739_mmdvs_isp_threshold_setting,
	mt6739_mmdvs_isp_threshold_opp, MMDVFS_ISP_THRESHOLD_NUM, MMDVFS_PMQOS_ISP},
};
