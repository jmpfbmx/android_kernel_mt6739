...
struct SMI_SETTING_VALUE smi_basic_common_setting[SMI_BASIC_COMMON_SETTING_NUM] = {
	{0x100, 0xb},
	{0x228, 0x8 + (0x8 << 6) + (0x8 << 12) + (0x8 << 18)},
	{0x308, 0x8 + (0x8 << 6) + (0x8 << 12) + (0x8 << 18)},
	{0x310, 0x8 + (0x8 << 6) + (0x8 << 12) + (0x8 << 18)},
	{0x318, 0x8 + (0x8 << 6) + (0x8 << 12) + (0x8 << 18)},
	{0x320, 0x8 + (0x8 << 6) + (0x8 << 12) + (0x8 << 18)},
	{0x300, 0x1 + (0x78 << 1) + (0x4 << 8)},
	{0x444, 0x1}
};

struct SMI_SETTING_VALUE smi_basic_larb0_setting[SMI_BASIC_LARB0_SETTING_NUM] = {
	{0x40, 0x1}, {0x70, 0xffe0}, {0x100, 0x7}, {0x104, 0x7}, {0x108, 0x7}, {0x10c, 0x7}, {0x110, 0x7}
};
...
struct SMI_SETTING smi_basic_setting_config = {
	...
	{SMI_BASIC_LARB0_SETTING_NUM, SMI_BASIC_LARB1_SETTING_NUM, SMI_BASIC_LARB2_SETTING_NUM,
		...
		SMI_BASIC_LARB6_SETTING_NUM},
	{smi_basic_larb0_setting, smi_basic_larb1_setting, smi_basic_larb2_setting, smi_basic_larb3_setting,
		smi_basic_larb4_setting, smi_basic_larb5_setting, smi_basic_larb6_setting}
};
...
struct SMI_SETTING smi_mmu_setting_config = {
	...
	{SMI_MMU_LARB0_SETTING_NUM, SMI_MMU_LARB1_SETTING_NUM, SMI_MMU_LARB2_SETTING_NUM,
		...
		SMI_MMU_LARB6_SETTING_NUM},
	{smi_mmu_larb0_setting, NULL, NULL, NULL, NULL, NULL, NULL}
};
...
unsigned long smi_larb0_debug_offset[SMI_LARB0_DEBUG_OFFSET_NUM] = {
	0x0, 0x8, 0xc, 0x10, 0x14, 0x24, 0x40, 0x50, 0x60, 0x70, 0x80, 0x84,
	...
	0x2e0, 0x2e4, 0x2e8, 0x2ec, 0x2f0, 0x2f4, 0x2f8, 0x2fc, 0x400, 0x404, 0x410
};
...
unsigned long smi_common_debug_offset[SMI_COMMON_DEBUG_OFFSET_NUM] = {
	0x100, 0x104, 0x108, 0x10C, 0x110, 0x114, 0x118, 0x11c, 0x120, 0x1a0, 0x1a4, 0x1c0,
	0x220, 0x228, 0x22c, 0x230, 0x234, 0x238, 0x23c,
	0x300, 0x304, 0x308, 0x30c, 0x310, 0x314, 0x318, 0x31c, 0x320, 0x324,
	0x3c0, 0x3c4, 0x400, 0x404, 0x408, 0x40C, 0x410, 0x414, 0x418, 0x41c,
	0x430, 0x434, 0x440, 0x444
};

unsigned long smi_mmsys_debug_offset[SMI_MMSYS_DEBUG_OFFSET_NUM] = {
	0x100, 0x110, 0x140, 0x144, 0x914, 0x918, 0x91c, 0x920, 0x924, 0x928, 0x92c, 0x930
};
...
struct SMI_SETTING_VALUE smi_profile_setting_common_init[SMI_PROFILE_SETTING_COMMON_INIT_NUM] = {
	{0x220, 0x4414},
	{REG_OFFSET_SMI_L1ARB0, 0x0}, {REG_OFFSET_SMI_L1ARB1, 0x0}, {REG_OFFSET_SMI_L1ARB2, 0x0},
	{REG_OFFSET_SMI_L1ARB3, 0x0}, {REG_OFFSET_SMI_L1ARB5, 0x0}, {REG_OFFSET_SMI_L1ARB6, 0x0}
};
...
struct SMI_SETTING_VALUE smi_profile_setting_larb1_init[SMI_LARB1_PORT_NUM] = {
	{0x200, 0xc}, {0x204, 0xc}, {0x208, 0xc}, {0x20c, 0xc}, {0x210, 0xc}, {0x214, 0xc}, {0x218, 0x1}
};
...
struct SMI_SETTING_VALUE smi_profile_setting_larb4_init[SMI_LARB4_PORT_NUM] = {
	{0x200, 0x1}, {0x204, 0x1}, {0x208, 0x1}, {0x20c, 0x1}, {0x210, 0x1}, {0x214, 0x6}, {0x218, 0x4},
	{0x21c, 0x1}, {0x220, 0x1}, {0x224, 0x4}, {0x228, 0x2}
};
...
struct SMI_SETTING_VALUE smi_profile_setting_larb5_init[SMI_LARB5_PORT_NUM] = {
	...
	{0x23c, 0x12}, {0x240, 0x1}, {0x244, 0x1}, {0x248, 0x11}, {0x24c, 0x6}, {0x250, 0xe}, {0x254, 0x1},
...
struct SMI_SETTING_VALUE smi_profile_setting_larb6_init[SMI_LARB6_PORT_NUM] = {
	...
	{0x238, 0x2}, {0x23c, 0x2}, {0x240, 0x2}, {0x244, 0x2}, {0x248, 0x2}, {0x24c, 0x2}, {0x250, 0x1}, {0x254, 0x2},
	{0x258, 0x2}, {0x25c, 0x2}, {0x260, 0x2}, {0x264, 0x1}, {0x268, 0x1}, {0x26c, 0x1}, {0x270, 0x1}, {0x274, 0x1},
	{0x278, 0x1}
};
...
/* ICFP */
#define SMI_PROFILE_SETTING_COMMON_ICFP_NUM 7
...
struct SMI_SETTING_VALUE smi_profile_setting_larb0_icfp[SMI_LARB0_PORT_NUM] = {
	...
	{0x21c, 0xb}, {0x220, 0x1}, {0x224, 0x1f}
};
...
struct SMI_SETTING_VALUE smi_profile_setting_larb4_icfp[SMI_LARB4_PORT_NUM] = {
	{0x200, 0xc}, {0x204, 0x1}, {0x208, 0x1}, {0x20c, 0x1}, {0x210, 0x1}, {0x214, 0x5}, {0x218, 0x3},
	{0x21c, 0x1}, {0x220, 0x1}, {0x224, 0x4}, {0x228, 0x2}
};

struct SMI_SETTING_VALUE smi_profile_setting_larb5_icfp[SMI_LARB5_PORT_NUM] = {
	{0x200, 0x7}, {0x204, 0x1}, {0x208, 0x2}, {0x20c, 0x3}, {0x210, 0x1}, {0x214, 0x1}, {0x218, 0x1}, {0x21c, 0xc},
...
struct SMI_SETTING_VALUE smi_profile_setting_larb6_icfp[SMI_LARB6_PORT_NUM] = {
	{0x200, 0x18}, {0x204, 0x4}, {0x208, 0x8}, {0x20c, 0x6}, {0x210, 0x6}, {0x214, 0x1}, {0x218, 0x4},
	{0x21c, 0x8}, {0x220, 0x2}, {0x224, 0x2}, {0x228, 0x2}, {0x22c, 0x1e}, {0x230, 0x10}, {0x234, 0x1f},
	{0x238, 0x2}, {0x23c, 0x2}, {0x240, 0x2}, {0x244, 0x2}, {0x248, 0x6}, {0x24c, 0x2}, {0x250, 0x1}, {0x254, 0x2},
	{0x258, 0x2}, {0x25c, 0x2}, {0x260, 0x2}, {0x264, 0x1}, {0x268, 0x1}, {0x26c, 0x1}, {0x270, 0x1}, {0x274, 0x1},
	{0x278, 0x1}
};
...
struct SMI_PROFILE_CONFIG smi_profile_config[SMI_PROFILE_CONFIG_NUM] = {
	...
	{SMI_BWC_SCEN_VR, &icfp_setting_config},
	{SMI_BWC_SCEN_SWDEC_VP, &init_setting_config},
	{SMI_BWC_SCEN_VP, &init_setting_config},
	{SMI_BWC_SCEN_VP_HIGH_FPS, &init_setting_config},
	{SMI_BWC_SCEN_VP_HIGH_RESOLUTION, &init_setting_config},
	{SMI_BWC_SCEN_VR_SLOW, &icfp_setting_config},
	{SMI_BWC_SCEN_MM_GPU, &init_setting_config},
	{SMI_BWC_SCEN_WFD, &init_setting_config},
	{SMI_BWC_SCEN_VENC, &icfp_setting_config},
	{SMI_BWC_SCEN_ICFP, &icfp_setting_config},
	{SMI_BWC_SCEN_UI_IDLE, &unuse_setting_config},
	{SMI_BWC_SCEN_VSS, &icfp_setting_config},
