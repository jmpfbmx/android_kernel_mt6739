...
struct SMI_SETTING_VALUE smi_basic_common_setting[SMI_BASIC_COMMON_SETTING_NUM] = {
	{0x100, 0xb}, {0x220, 0x1404},
	{0x228, 0xc + (0xc << 6) + (0xc << 12) + (0xc << 18) + (0xc << 24)},
	{0x22c, 0xc + (0xc << 6) + (0xc << 12)},
	{0x308, 0xc + (0xc << 6) + (0xc << 12) + (0xc << 18) + (0xc << 24)},
	{0x30c, 0xc + (0xc << 6) + (0xc << 12)},
	{0x310, 0xc + (0xc << 6) + (0xc << 12) + (0xc << 18) + (0xc << 24)},
	{0x314, 0xc + (0xc << 6) + (0xc << 12)},
	{0x318, 0xc + (0xc << 6) + (0xc << 12) + (0xc << 18) + (0xc << 24)},
	{0x31c, 0xc + (0xc << 6) + (0xc << 12)},
	{0x320, 0xc + (0xc << 6) + (0xc << 12) + (0xc << 18) + (0xc << 24)},
	{0x324, 0xc + (0xc << 6) + (0xc << 12)},
...
struct SMI_SETTING_VALUE smi_basic_larb0_setting[SMI_BASIC_LARB0_SETTING_NUM] = {
	{0x24, (0x3 << 0) + (0x2 << 4) + (0x2 << 8) + (0x1<<16) + (0x1 << 17) + (0x1 << 18) + (0x3 << 20)},
	{0x40, 0x1},
	{0x80, 0xfffffff0},
...
struct SMI_SETTING_VALUE smi_basic_larb2_setting[SMI_BASIC_LARB2_SETTING_NUM] = {
	{0x24, (0x6 << 0) + (0x5 << 4) + (0x2 << 8) + (0x0 << 16) + (0x0 << 17) + (0x0 << 18) + (0x3 << 20)},
	{0x40, 0x1}
};
...
struct SMI_SETTING smi_basic_setting_config = {
	...
	{SMI_BASIC_LARB0_SETTING_NUM, SMI_BASIC_LARB1_SETTING_NUM, SMI_BASIC_LARB2_SETTING_NUM,
		...
		SMI_BASIC_LARB6_SETTING_NUM, SMI_BASIC_LARB7_SETTING_NUM},
...
struct SMI_SETTING smi_mmu_setting_config = {
	...
	{SMI_MMU_LARB0_SETTING_NUM, SMI_MMU_LARB1_SETTING_NUM, SMI_MMU_LARB2_SETTING_NUM,
		...
		SMI_MMU_LARB6_SETTING_NUM, SMI_MMU_LARB7_SETTING_NUM},
...
unsigned long smi_larb0_debug_offset[SMI_LARB0_DEBUG_OFFSET_NUM] = {
	0x0, 0x8, 0x10, 0x14, 0x24, 0x40, 0x50, 0x60, 0x80, 0x84,
	0xa0, 0xa4, 0xa8, 0xac, 0xb0, 0xb4, 0xb8, 0xbc, 0xc0, 0xc8, 0xcc,
	...
	0x230, 0x234, 0x238, 0x23c, 0x240, 0x244, 0x248, 0x24c, 0x250, 0x254, 0x258, 0x25c,
	0x260, 0x264, 0x268, 0x26c, 0x270, 0x274, 0x278,
...
int smi_larb_debug_offset_num[SMI_LARB_NUM] = {
	...
	SMI_LARB6_DEBUG_OFFSET_NUM, SMI_LARB7_DEBUG_OFFSET_NUM
};
...
unsigned long *smi_larb_debug_offset[SMI_LARB_NUM] = {
	...
	smi_larb6_debug_offset, smi_larb7_debug_offset
};
...
struct SMI_SETTING_VALUE smi_profile_setting_common_init[SMI_PROFILE_SETTING_COMMON_INIT_NUM] = {
	{0x220, 0x1404},
	{REG_OFFSET_SMI_L1ARB0, 0x18bc}, {REG_OFFSET_SMI_L1ARB1, 0x15d3}, {REG_OFFSET_SMI_L1ARB2, 0x1000},
...
struct SMI_SETTING_VALUE smi_profile_setting_larb0_init[SMI_LARB0_PORT_NUM] = {
	{0x200, 0x1f}, {0x204, 0x1f}, {0x208, 0x1f}, {0x20c, 0xe}, {0x210, 0x5}, {0x214, 0x14}, {0x218, 0x1f}
};

struct SMI_SETTING_VALUE smi_profile_setting_larb1_init[SMI_LARB1_PORT_NUM] = {
	{0x200, 0x1f}, {0x204, 0x1f}, {0x208, 0x1f}, {0x20c, 0x9}, {0x210, 0x12}, {0x214, 0x1f}
};

struct SMI_SETTING_VALUE smi_profile_setting_larb2_init[SMI_LARB2_PORT_NUM] = {
	{0x200, 0x9}, {0x204, 0x9}, {0x208, 0x9}
};
...
struct SMI_SETTING_VALUE smi_profile_setting_larb4_init[SMI_LARB4_PORT_NUM] = {
	{0x200, 0x1f}, {0x204, 0x8}, {0x208, 0x2}, {0x20c, 0x1}, {0x210, 0x1}, {0x214, 0x2}, {0x218, 0x1},
	{0x21c, 0x1}, {0x220, 0x1}, {0x224, 0x1}
};

struct SMI_SETTING_VALUE smi_profile_setting_larb5_init[SMI_LARB5_PORT_NUM] = {
	{0x200, 0xd}, {0x204, 0x1}, {0x208, 0x4}, {0x20c, 0x4}, {0x210, 0x1}, {0x214, 0x2}, {0x218, 0x2}, {0x21c, 0xc},
	{0x220, 0x1}, {0x224, 0x12}, {0x228, 0x1}, {0x22c, 0x1}, {0x230, 0x1}, {0x234, 0x1}, {0x238, 0xc},
	{0x23c, 0x12}, {0x240, 0x1}, {0x244, 0x1}, {0x248, 0x4}, {0x24c, 0x4}, {0x250, 0x4}, {0x254, 0x1},
	{0x258, 0x1}, {0x25c, 0x1}, {0x260, 0x1}
};

struct SMI_SETTING_VALUE smi_profile_setting_larb6_init[SMI_LARB6_PORT_NUM] = {
	{0x200, 0x1f}, {0x204, 0x14}, {0x208, 0x2}, {0x20c, 0x2}, {0x210, 0x2}, {0x214, 0x1}, {0x218, 0x10},
	{0x21c, 0x2}, {0x220, 0x2}, {0x224, 0x2}, {0x228, 0x2}, {0x22c, 0x1f}, {0x230, 0x1f}, {0x234, 0x1f},
	{0x238, 0x2}, {0x23c, 0x2}, {0x240, 0x2}, {0x244, 0x2}, {0x248, 0x2}, {0x24c, 0x2}, {0x250, 0x1},
	{0x254, 0x2}, {0x258, 0x2}, {0x25c, 0x2}, {0x260, 0x2}, {0x264, 0x1}, {0x268, 0x1}, {0x26c, 0x1},
	{0x270, 0x1}, {0x274, 0x1}, {0x278, 0x1}
};

struct SMI_SETTING_VALUE smi_profile_setting_larb7_init[SMI_LARB7_PORT_NUM] = {
	{0x200, 0x1}, {0x204, 0x3}, {0x208, 0x1}, {0x20c, 0x1}, {0x210, 0x1}, {0x214, 0x4}, {0x218, 0x2}, {0x21c, 0x3},
	{0x220, 0x3}, {0x224, 0xc}, {0x228, 0xc}
};
...
struct SMI_SETTING init_setting_config = {
	...
	{smi_profile_setting_larb0_init, smi_profile_setting_larb1_init, smi_profile_setting_larb2_init,
	 ...
	 smi_profile_setting_larb6_init, smi_profile_setting_larb7_init}
};

/* VPWFD: video playback scenario, wifi display scenario */
...
struct SMI_SETTING_VALUE smi_profile_setting_common_vp[SMI_PROFILE_SETTING_COMMON_VP_NUM] = {
	{0x220, 0x410},
	{REG_OFFSET_SMI_L1ARB0, 0x16c2}, {REG_OFFSET_SMI_L1ARB1, 0x10e2}, {REG_OFFSET_SMI_L1ARB2, 0x1552},
	{REG_OFFSET_SMI_L1ARB3, 0x1000}, {REG_OFFSET_SMI_L1ARB4, 0x1000}, {REG_OFFSET_SMI_L1ARB5, 0x1196},
	{REG_OFFSET_SMI_L1ARB6, 0x1000}
};

struct SMI_SETTING_VALUE smi_profile_setting_larb0_vp[SMI_LARB0_PORT_NUM] = {
	{0x200, 0x1f}, {0x204, 0x1f}, {0x208, 0x1f}, {0x20c, 0x1}, {0x210, 0xf}, {0x214, 0x7}, {0x218, 0x1f}
};

struct SMI_SETTING_VALUE smi_profile_setting_larb1_vp[SMI_LARB1_PORT_NUM] = {
	{0x200, 0x1f}, {0x204, 0x1f}, {0x208, 0x1f}, {0x20c, 0x7}, {0x210, 0x2}, {0x214, 0x1f}
};
...
struct SMI_SETTING_VALUE smi_profile_setting_larb4_vp[SMI_LARB4_PORT_NUM] = {
	{0x200, 0x1f}, {0x204, 0x8}, {0x208, 0x2}, {0x20c, 0x1}, {0x210, 0x1}, {0x214, 0x3}, {0x218, 0x1},
	{0x21c, 0x1}, {0x220, 0x1}, {0x224, 0x1}
};
...
struct SMI_SETTING_VALUE smi_profile_setting_larb7_vp[SMI_LARB7_PORT_NUM] = {
	{0x200, 0x1}, {0x204, 0x1}, {0x208, 0x1}, {0x20c, 0x1}, {0x210, 0x1}, {0x214, 0x4}, {0x218, 0x2}, {0x21c, 0x3},
	{0x220, 0x3}, {0x224, 0xc}, {0x228, 0x5}
};
...
struct SMI_SETTING vp_setting_config = {
	...
	{smi_profile_setting_larb0_vp, smi_profile_setting_larb1_vp, smi_profile_setting_larb2_vp,
	 ...
	 smi_profile_setting_larb6_vp, smi_profile_setting_larb7_vp}
};

/* VR4K: video recording scenario */
#define SMI_PROFILE_SETTING_COMMON_VR_NUM SMI_COMMON_PORT_NUM

struct SMI_SETTING_VALUE smi_profile_setting_common_vr[SMI_PROFILE_SETTING_COMMON_VR_NUM] = {
	{0x220, 0x140},
	{REG_OFFSET_SMI_L1ARB0, 0x1473}, {REG_OFFSET_SMI_L1ARB1, 0x1000}, {REG_OFFSET_SMI_L1ARB2, 0x1000},
	{REG_OFFSET_SMI_L1ARB3, 0x1486}, {REG_OFFSET_SMI_L1ARB4, 0x1223}, {REG_OFFSET_SMI_L1ARB5, 0x1444},
	{REG_OFFSET_SMI_L1ARB6, 0x1000}
};

struct SMI_SETTING_VALUE smi_profile_setting_larb0_vr[SMI_LARB0_PORT_NUM] = {
	{0x200, 0x1f}, {0x204, 0x1f}, {0x208, 0x1f}, {0x20c, 0x4}, {0x210, 0x5}, {0x214, 0x3}, {0x218, 0x1f}
};
...
struct SMI_SETTING_VALUE smi_profile_setting_larb5_vr[SMI_LARB5_PORT_NUM] = {
	{0x200, 0x7}, {0x204, 0x1}, {0x208, 0x5}, {0x20c, 0x5}, {0x210, 0x1}, {0x214, 0x1}, {0x218, 0x1}, {0x21c, 0x1},
	{0x220, 0x1}, {0x224, 0x1}, {0x228, 0x1}, {0x22c, 0x1}, {0x230, 0x1}, {0x234, 0x1}, {0x238, 0x1},
	{0x23c, 0x1}, {0x240, 0x1}, {0x244, 0x1}, {0x248, 0x1}, {0x24c, 0x1}, {0x250, 0x1}, {0x254, 0x1},
	{0x258, 0x1}, {0x25c, 0x1}, {0x260, 0x1}
};

struct SMI_SETTING_VALUE smi_profile_setting_larb6_vr[SMI_LARB6_PORT_NUM] = {
	{0x200, 0x1f}, {0x204, 0xa}, {0x208, 0x2}, {0x20c, 0x2}, {0x210, 0x2}, {0x214, 0x1}, {0x218, 0x2},
	{0x21c, 0x2}, {0x220, 0x2}, {0x224, 0x2}, {0x228, 0x2}, {0x22c, 0x1f}, {0x230, 0x1f}, {0x234, 0x1f},
	{0x238, 0x2}, {0x23c, 0x2}, {0x240, 0x2}, {0x244, 0x2}, {0x248, 0x2}, {0x24c, 0x2}, {0x250, 0x1},
	{0x254, 0x2}, {0x258, 0x2}, {0x25c, 0x2}, {0x260, 0x2}, {0x264, 0x1}, {0x268, 0x1}, {0x26c, 0x1},
	{0x270, 0x1}, {0x274, 0x1}, {0x278, 0x1}
...
struct SMI_SETTING_VALUE smi_profile_setting_larb7_vr[SMI_LARB7_PORT_NUM] = {
	{0x200, 0x1}, {0x204, 0x3}, {0x208, 0x1}, {0x20c, 0x1}, {0x210, 0x1}, {0x214, 0x4}, {0x218, 0x2}, {0x21c, 0xd},
	{0x220, 0xd}, {0x224, 0xc}, {0x228, 0xf}
};
...
struct SMI_SETTING vr_setting_config = {
	...
	{smi_profile_setting_larb0_vr, smi_profile_setting_larb1_vr, smi_profile_setting_larb2_vr,
	 ...
	 smi_profile_setting_larb6_vr, smi_profile_setting_larb7_vr}
};

/* ICFP: capture scenario */
#define SMI_PROFILE_SETTING_COMMON_ICFP_NUM SMI_COMMON_PORT_NUM

struct SMI_SETTING_VALUE smi_profile_setting_common_icfp[SMI_PROFILE_SETTING_COMMON_ICFP_NUM] = {
	{0x220, 0x140},
	{REG_OFFSET_SMI_L1ARB0, 0x12c1}, {REG_OFFSET_SMI_L1ARB1, 0x1000}, {REG_OFFSET_SMI_L1ARB2, 0x1000},
	{REG_OFFSET_SMI_L1ARB3, 0x1281}, {REG_OFFSET_SMI_L1ARB4, 0x1319}, {REG_OFFSET_SMI_L1ARB5, 0x1131},
	{REG_OFFSET_SMI_L1ARB6, 0x1000}
};

struct SMI_SETTING_VALUE smi_profile_setting_larb0_icfp[SMI_LARB0_PORT_NUM] = {
	{0x200, 0x1f}, {0x204, 0x1f}, {0x208, 0x1f}, {0x20c, 0x5}, {0x210, 0x5}, {0x214, 0x14}, {0x218, 0x1f}
};
...
struct SMI_SETTING_VALUE smi_profile_setting_larb5_icfp[SMI_LARB5_PORT_NUM] = {
	{0x200, 0x8}, {0x204, 0x1}, {0x208, 0x2}, {0x20c, 0x2}, {0x210, 0x1}, {0x214, 0x1}, {0x218, 0x1}, {0x21c, 0xc},
	{0x220, 0x1}, {0x224, 0x12}, {0x228, 0x1}, {0x22c, 0x2}, {0x230, 0x1}, {0x234, 0x1}, {0x238, 0xc},
	{0x23c, 0x12}, {0x240, 0x1}, {0x244, 0x1}, {0x248, 0x4}, {0x24c, 0x4}, {0x250, 0x4}, {0x254, 0x1},
	{0x258, 0x1}, {0x25c, 0x1}, {0x260, 0x1}
};

struct SMI_SETTING_VALUE smi_profile_setting_larb6_icfp[SMI_LARB6_PORT_NUM] = {
	{0x200, 0x14}, {0x204, 0x4}, {0x208, 0x2}, {0x20c, 0x2}, {0x210, 0x2}, {0x214, 0x1}, {0x218, 0x2},
	{0x21c, 0x2}, {0x220, 0x2}, {0x224, 0x2}, {0x228, 0x2}, {0x22c, 0x1f}, {0x230, 0x1f}, {0x234, 0x1f},
	{0x238, 0x2}, {0x23c, 0x2}, {0x240, 0x2}, {0x244, 0x2}, {0x248, 0x2}, {0x24c, 0x2}, {0x250, 0x1},
	{0x254, 0x2}, {0x258, 0x2}, {0x25c, 0x2}, {0x260, 0x2}, {0x264, 0x1}, {0x268, 0x1}, {0x26c, 0x1},
	{0x270, 0x1}, {0x274, 0x1}, {0x278, 0x1}
...
struct SMI_SETTING_VALUE smi_profile_setting_larb7_icfp[SMI_LARB7_PORT_NUM] = {
	{0x200, 0x1}, {0x204, 0x3}, {0x208, 0x1}, {0x20c, 0x1}, {0x210, 0x1}, {0x214, 0x3}, {0x218, 0x2}, {0x21c, 0x3},
	{0x220, 0x3}, {0x224, 0xc}, {0x228, 0xc}
};
...
struct SMI_SETTING icfp_setting_config = {
	...
	{smi_profile_setting_larb0_icfp, smi_profile_setting_larb1_icfp, smi_profile_setting_larb2_icfp,
	 ...
	 smi_profile_setting_larb6_icfp, smi_profile_setting_larb7_icfp}
};
...
struct SMI_SETTING unuse_setting_config = { 0, NULL, {0}, {0} };
...
struct SMI_PROFILE_CONFIG smi_profile_config[SMI_PROFILE_CONFIG_NUM] = {
	...
	{SMI_BWC_SCEN_SWDEC_VP, &vp_setting_config},
	...
	{SMI_BWC_SCEN_VR_SLOW, &vr_setting_config},
	{SMI_BWC_SCEN_MM_GPU, &init_setting_config},
	{SMI_BWC_SCEN_WFD, &vp_setting_config},
	{SMI_BWC_SCEN_VENC, &vr_setting_config},
	{SMI_BWC_SCEN_ICFP, &icfp_setting_config},
	{SMI_BWC_SCEN_UI_IDLE, &unuse_setting_config},
	{SMI_BWC_SCEN_VSS, &vr_setting_config},
	{SMI_BWC_SCEN_FORCE_MMDVFS, &init_setting_config},
	{SMI_BWC_SCEN_HDMI, &unuse_setting_config},
	{SMI_BWC_SCEN_HDMI4K, &unuse_setting_config},
	{SMI_BWC_SCEN_VPMJC, &unuse_setting_config},
	{SMI_BWC_SCEN_N3D, &unuse_setting_config},
	{SMI_BWC_SCEN_CAM_PV, &icfp_setting_config},
	{SMI_BWC_SCEN_CAM_CP, &icfp_setting_config}
};
