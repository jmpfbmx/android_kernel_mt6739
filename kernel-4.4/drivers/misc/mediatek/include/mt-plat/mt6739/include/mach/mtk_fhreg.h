...
#define REG_ARMPLL2_CON0    REG_PLL_NOT_SUPPORT /* not support in Zion */
#define REG_ARMPLL3_CON0    REG_PLL_NOT_SUPPORT /* not support in Zion */
#define REG_CCIPLL_CON0     REG_PLL_NOT_SUPPORT /* not support in Zion */
#define REG_GPUPLL_CON0     REG_PLL_NOT_SUPPORT /* not support in Zion */
#define REG_MPLL_CON0       REG_PLL_NOT_SUPPORT /* not support in Zion */
...
#define REG_VDECPLL_CON0    REG_PLL_NOT_SUPPORT /* not support in Zion */
#define REG_TVDPLL_CON0     REG_PLL_NOT_SUPPORT /* not support in Zion */

/*CON1, DDS value */
#define REG_ARMPLL_CON1     REG_APMIX_ADDR(0x0204)
#define REG_ARMPLL2_CON1    REG_PLL_NOT_SUPPORT /* not support in Zion */
#define REG_ARMPLL3_CON1    REG_PLL_NOT_SUPPORT /* not support in Zion */
#define REG_CCIPLL_CON1     REG_PLL_NOT_SUPPORT /* not support in Zion */
#define REG_GPUPLL_CON1     REG_PLL_NOT_SUPPORT /* not support in Zion */
#define REG_MPLL_CON1       REG_PLL_NOT_SUPPORT /* not support in Zion */
...
#define REG_VDECPLL_CON1    REG_PLL_NOT_SUPPORT /* not support in Zion */
#define REG_TVDPLL_CON1     REG_PLL_NOT_SUPPORT /* not support in Zion */
