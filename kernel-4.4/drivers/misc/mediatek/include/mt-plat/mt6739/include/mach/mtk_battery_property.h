...
//Begin modified by shiqiang.chen.hz for defect 5953611 on 20180211,fixed skip uisoc when normal boot after charging_poweroff .
//#define HWOCV_OLDOCV_DIFF_CHR	800
#define HWOCV_OLDOCV_DIFF_CHR	1500
#define SWOCV_OLDOCV_DIFF	300
//#define SWOCV_OLDOCV_DIFF_CHR	800
#define SWOCV_OLDOCV_DIFF_CHR	1500
//End modified by shiqiang.chen.hz for defect 5953611 on 20180211,fixed skip uisoc when normal boot after charging_poweroff .
...
#define UNIT_FGCURRENT     (305176)		/* mt6357 305.176 uA */
#define UNIT_FGCAR         (10850)		/* charge_lsb 157166 * 2^11 / 3600 */
#define R_VAL_TEMP_2         (1)			/* MT6335 use 3, old chip use 4 */
#define R_VAL_TEMP_3         (3)			/* MT6335 use 3, old chip use 4 */
#define UNIT_TIME          (50)
#define UNIT_FGCAR_ZCV     (157166)     /* unit 2^0 LSB */
#define UNIT_FG_IAVG		(157166)
#define CAR_TO_REG_FACTOR  (0x5c2a)		/* 3600 * 1000 * 1000 / 157166 , for coulomb interrupt */
