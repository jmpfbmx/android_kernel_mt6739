...
#include "../../../../../base/power/cpufreq_v1/src/mach/mt6763/mtk_cpufreq_config.h"
...
extern void notify_cpu_volt_sampler(enum mt_cpu_dvfs_id id, unsigned int volt, int up, int event);
typedef void (*cpuVoltsampler_func) (enum mt_cpu_dvfs_id, unsigned int mv, int up, int event);
