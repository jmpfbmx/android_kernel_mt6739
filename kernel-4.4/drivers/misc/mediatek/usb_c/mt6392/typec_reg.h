...
#define TYPE_C_PHY_RG_0                           0x0000
#define TYPE_C_PHY_RG_CC_RESERVE_CSR              0x0002
#define TYPE_C_VCMP_CTRL                          0x0004
#define TYPE_C_CTRL                               0x0006
#define TYPE_C_CC_SW_CTRL                         0x000A
#define TYPE_C_CC_VOL_PERIODIC_MEAS_VAL           0x000C
#define TYPE_C_CC_VOL_DEBOUCE_CNT_VAL             0x000E
#define TYPE_C_DRP_SRC_CNT_VAL_0                  0x0010
#define TYPE_C_DRP_SNK_CNT_VAL_0                  0x0014
#define TYPE_C_DRP_TRY_CNT_VAL_0                  0x0018
#if !TYPEC_12
#define TYPE_C_DRP_TRY_WAIT_CNT_VAL_0             0x001C
#define TYPE_C_DRP_TRY_WAIT_CNT_VAL_1             0x001E
#endif
#define TYPE_C_CC_SRC_DEFAULT_DAC_VAL             0x0020
#define TYPE_C_CC_SRC_15_DAC_VAL                  0x0022
#define TYPE_C_CC_SRC_30_DAC_VAL                  0x0024
#define TYPE_C_CC_SNK_DAC_VAL_0                   0x0028
#define TYPE_C_CC_SNK_DAC_VAL_1                   0x002A
#define TYPE_C_INTR_EN_0                          0x0030
#define TYPE_C_INTR_EN_2                          0x0034
#define TYPE_C_INTR_0                             0x0038
#define TYPE_C_INTR_2                             0x003C
#define TYPE_C_CC_STATUS                          0x0040
#define TYPE_C_PWR_STATUS                         0x0042
#define TYPE_C_PHY_RG_CC1_RESISTENCE_0            0x0044
#define TYPE_C_PHY_RG_CC1_RESISTENCE_1            0x0046
#define TYPE_C_PHY_RG_CC2_RESISTENCE_0            0x0048
#define TYPE_C_PHY_RG_CC2_RESISTENCE_1            0x004A
#define TYPE_C_CC_SW_FORCE_MODE_ENABLE_0          0x0060
#define TYPE_C_CC_SW_FORCE_MODE_VAL_0             0x0064
#define TYPE_C_CC_SW_FORCE_MODE_VAL_1             0x0066
#define TYPE_C_CC_SW_FORCE_MODE_ENABLE_1          0x0068
#define TYPE_C_CC_SW_FORCE_MODE_VAL_2             0x006C
#define TYPE_C_CC_DAC_CALI_CTRL                   0x0070
#define TYPE_C_CC_DAC_CALI_RESULT                 0x0072
#define TYPE_C_DEBUG_PORT_SELECT_0                0x0080
#define TYPE_C_DEBUG_PORT_SELECT_1                0x0082
#define TYPE_C_DEBUG_MODE_SELECT                  0x0084
#define TYPE_C_DEBUG_OUT_READ_0                   0x0088
#define TYPE_C_DEBUG_OUT_READ_1                   0x008A
#define TYPE_C_SW_DEBUG_PORT_0                    0x008C
#define TYPE_C_SW_DEBUG_PORT_1                    0x008E
#define TYPE_C_FPGA_CTRL                          0x00F0
#define TYPE_C_FPGA_STATUS                        0x00F2
#define TYPE_C_FPGA_HW_VERSION                    0x00F4

/* CC_REG FIELD DEFINITION */
/* TYPE_C_PHY_RG_0 */
#define REG_TYPE_C_PHY_RG_CC_MPX_SEL              (0xff<<8)	/* 15:8 */
#define REG_TYPE_C_PHY_RG_CC_V2I_BYPASS           (0x1<<2)	/* 2:2 */
...
/* TYPE_C_CTRL */
#if TYPEC_12
#define REG_TYPE_C_DA_CC_SACLK_SW_EN              (0x1<<12)	/* 12:12 */
#define REG_TYPE_C_DISABLE_ST_RD_EN               (0x1<<11)	/* 11:11 */
#define REG_TYPE_C_ATTACH_SRC_OPEN_PDDEBOUNCE_EN  (0x1<<10)	/* 10:10 */
#define REG_TYPE_C_PD2CC_DET_DISABLE_EN           (0x1<<9)	/* 9:9 */
#define REG_TYPE_C_ATTACH_SRC_2_TRY_WAIT_SNK_ST_EN (0x1<<8)	/* 8:8 */
#define REG_TYPE_C_TRY_SNK_ST_EN                  (0x1<<7)	/* 7:7 */
...
#else
#define REG_TYPE_C_DA_CC_SACLK_SW_EN              (0x1<<11)	/* 11:11 */
...
/* TYPE_C_INTR_EN_0 */
#if TYPEC_12
#define REG_TYPE_C_CC_ENT_DBG_ACC_SNK_INTR_EN     (0x1<<15)	/* 15:15 */
#define REG_TYPE_C_CC_ENT_DBG_ACC_SRC_INTR_EN     (0x1<<14)	/* 14:14 */
#define REG_TYPE_C_CC_ENT_TRY_WAIT_SRC_INTR_EN    (0x1<<13)	/* 13:13 */
#define REG_TYPE_C_CC_ENT_TRY_SNK_INTR_EN         (0x1<<12)	/* 12:12 */
#define REG_TYPE_C_CC_ENT_ATTACH_WAIT_ACC_INTR_EN (0x1<<11)	/* 11:11 */
#define REG_TYPE_C_CC_ENT_UNATTACH_ACC_INTR_EN    (0x1<<10)	/* 10:10 */
#define REG_TYPE_C_CC_ENT_TRY_WAIT_SNK_INTR_EN    (0x1<<9)	/* 9:9 */
#define REG_TYPE_C_CC_ENT_TRY_SRC_INTR_EN         (0x1<<8)	/* 8:8 */
#define REG_TYPE_C_CC_ENT_ATTACH_WAIT_SNK_INTR_EN (0x1<<7)	/* 7:7 */
#define REG_TYPE_C_CC_ENT_ATTACH_WAIT_SRC_INTR_EN (0x1<<6)	/* 6:6 */
#define REG_TYPE_C_CC_ENT_UNATTACH_SNK_INTR_EN    (0x1<<5)	/* 5:5 */
#define REG_TYPE_C_CC_ENT_UNATTACH_SRC_INTR_EN    (0x1<<4)	/* 4:4 */
#define REG_TYPE_C_CC_ENT_DISABLE_INTR_EN         (0x1<<3)	/* 3:3 */
...
#define REG_TYPE_C_CC_ENT_DBG_ACC_INTR_EN (REG_TYPE_C_CC_ENT_DBG_ACC_SNK_INTR_EN |\
				REG_TYPE_C_CC_ENT_DBG_ACC_SRC_INTR_EN)
#else
...
/* TYPE_C_INTR_0 */
#if TYPEC_12
#define TYPE_C_CC_ENT_DBG_ACC_SNK_INTR            (0x1<<15)	/* 15:15 */
#define TYPE_C_CC_ENT_DBG_ACC_SRC_INTR            (0x1<<14)	/* 14:14 */
#define TYPE_C_CC_ENT_TRY_WAIT_SRC_INTR           (0x1<<13)	/* 13:13 */
#define TYPE_C_CC_ENT_TRY_SNK_INTR                (0x1<<12)	/* 12:12 */
#define TYPE_C_CC_ENT_ATTACH_WAIT_ACC_INTR        (0x1<<11)	/* 11:11 */
#define TYPE_C_CC_ENT_UNATTACH_ACC_INTR           (0x1<<10)	/* 10:10 */
#define TYPE_C_CC_ENT_TRY_WAIT_SNK_INTR           (0x1<<9)	/* 9:9 */
#define TYPE_C_CC_ENT_TRY_SRC_INTR                (0x1<<8)	/* 8:8 */
#define TYPE_C_CC_ENT_ATTACH_WAIT_SNK_INTR        (0x1<<7)	/* 7:7 */
#define TYPE_C_CC_ENT_ATTACH_WAIT_SRC_INTR        (0x1<<6)	/* 6:6 */
#define TYPE_C_CC_ENT_UNATTACH_SNK_INTR           (0x1<<5)	/* 5:5 */
#define TYPE_C_CC_ENT_UNATTACH_SRC_INTR           (0x1<<4)	/* 4:4 */
#define TYPE_C_CC_ENT_DISABLE_INTR                (0x1<<3)	/* 3:3 */
...
#define TYPE_C_CC_ENT_DBG_ACC_INTR (TYPE_C_CC_ENT_DBG_ACC_SNK_INTR | TYPE_C_CC_ENT_DBG_ACC_SRC_INTR)
#else
...
/* TYPE_C_CC_SW_FORCE_MODE_ENABLE_1 */
#define REG_TYPE_C_SW_FORCE_MODE_EN_DA_CC_DAC_GAIN_CAL (0x1<<1)	/* 1:1 */
#define REG_TYPE_C_SW_FORCE_MODE_EN_DA_CC_DAC_CAL (0x1<<0)	/* 0:0 */
/* TYPE_C_CC_SW_FORCE_MODE_VAL_2 */
#define REG_TYPE_C_SW_FORCE_MODE_DA_CC_DAC_GAIN_CAL (0xf<<4)	/* 7:4 */
#define REG_TYPE_C_SW_FORCE_MODE_DA_CC_DAC_CAL    (0xf<<0)	/* 3:0 */

/* TYPE_C_CC_DAC_CALI_CTRL */
#define RO_TYPE_C_DAC_CAL_FAIL                    (0x1<<5)	/* 5:5 */
#define RO_TYPE_C_DAC_CAL_OK                      (0x1<<4)	/* 4:4 */
...
/* TYPE_C_SW_DEBUG_PORT_0 */
#define REG_TYPE_C_SW_DBG_PORT_0                  (0xffff<<0)	/* 15:0 */

/* TYPE_C_SW_DEBUG_PORT_1 */
#define REG_TYPE_C_SW_DBG_PORT_1                  (0xffff<<0)	/* 15:0 */
...
#define TYPE_C_FPGA_AD_CC_VUSB33_RDY              (0x1<<2)	/* 2:2 */
...
#define REG_TYPE_C_PHY_RG_CC_V2I_BYPASS_OFST      (2)
...
/* TYPE_C_CTRL */
#if TYPEC_12
#define REG_TYPE_C_DA_CC_SACLK_SW_EN_OFST         (12)
#define REG_TYPE_C_DISABLE_ST_RD_EN_OFST          (11)
#define REG_TYPE_C_ATTACH_SRC_OPEN_PDDEBOUNCE_EN_OFST (10)
#define REG_TYPE_C_PD2CC_DET_DISABLE_EN_OFST      (9)
#define REG_TYPE_C_ATTACH_SRC_2_TRY_WAIT_SNK_ST_EN_OFST (8)
#define REG_TYPE_C_TRY_SNK_ST_EN_OFST             (7)
...
#else
#define REG_TYPE_C_DA_CC_SACLK_SW_EN_OFST         (11)
...
/* TYPE_C_INTR_EN_0 */
#if TYPEC_12
#define REG_TYPE_C_CC_ENT_DBG_ACC_SNK_INTR_EN_OFST (15)
#define REG_TYPE_C_CC_ENT_DBG_ACC_SRC_INTR_EN_OFST (14)
#define REG_TYPE_C_CC_ENT_TRY_WAIT_SRC_INTR_EN_OFST (13)
#define REG_TYPE_C_CC_ENT_TRY_SNK_INTR_EN_OFST    (12)
#define REG_TYPE_C_CC_ENT_ATTACH_WAIT_ACC_INTR_EN_OFST (11)
#define REG_TYPE_C_CC_ENT_UNATTACH_ACC_INTR_EN_OFST (10)
#define REG_TYPE_C_CC_ENT_TRY_WAIT_SNK_INTR_EN_OFST (9)
#define REG_TYPE_C_CC_ENT_TRY_SRC_INTR_EN_OFST    (8)
#define REG_TYPE_C_CC_ENT_ATTACH_WAIT_SNK_INTR_EN_OFST (7)
#define REG_TYPE_C_CC_ENT_ATTACH_WAIT_SRC_INTR_EN_OFST (6)
#define REG_TYPE_C_CC_ENT_UNATTACH_SNK_INTR_EN_OFST (5)
#define REG_TYPE_C_CC_ENT_UNATTACH_SRC_INTR_EN_OFST (4)
#define REG_TYPE_C_CC_ENT_DISABLE_INTR_EN_OFST    (3)
...
/* TYPE_C_INTR_0 */
#if TYPEC_12
#define TYPE_C_CC_ENT_DBG_ACC_SNK_INTR_OFST       (15)
#define TYPE_C_CC_ENT_DBG_ACC_SRC_INTR_OFST       (14)
#define TYPE_C_CC_ENT_TRY_WAIT_SRC_INTR_OFST      (13)
#define TYPE_C_CC_ENT_TRY_SNK_INTR_OFST           (12)
#define TYPE_C_CC_ENT_ATTACH_WAIT_ACC_INTR_OFST   (11)
#define TYPE_C_CC_ENT_UNATTACH_ACC_INTR_OFST      (10)
#define TYPE_C_CC_ENT_TRY_WAIT_SNK_INTR_OFST      (9)
#define TYPE_C_CC_ENT_TRY_SRC_INTR_OFST           (8)
#define TYPE_C_CC_ENT_ATTACH_WAIT_SNK_INTR_OFST   (7)
#define TYPE_C_CC_ENT_ATTACH_WAIT_SRC_INTR_OFST   (6)
#define TYPE_C_CC_ENT_UNATTACH_SNK_INTR_OFST      (5)
#define TYPE_C_CC_ENT_UNATTACH_SRC_INTR_OFST      (4)
#define TYPE_C_CC_ENT_DISABLE_INTR_OFST           (3)
...
/* TYPE_C_CC_SW_FORCE_MODE_ENABLE_1 */
#define REG_TYPE_C_SW_FORCE_MODE_EN_DA_CC_DAC_GAIN_CAL_OFST (1)
#define REG_TYPE_C_SW_FORCE_MODE_EN_DA_CC_DAC_CAL_OFST (0)

/* TYPE_C_CC_SW_FORCE_MODE_VAL_2 */
#define REG_TYPE_C_SW_FORCE_MODE_DA_CC_DAC_GAIN_CAL_OFST (4)
#define REG_TYPE_C_SW_FORCE_MODE_DA_CC_DAC_CAL_OFST (0)

/* TYPE_C_CC_DAC_CALI_CTRL */
#define RO_TYPE_C_DAC_CAL_FAIL_OFST               (5)
#define RO_TYPE_C_DAC_CAL_OK_OFST                 (4)
...
/* TYPE_C_SW_DEBUG_PORT_0 */
#define REG_TYPE_C_SW_DBG_PORT_0_OFST             (0)

/* TYPE_C_SW_DEBUG_PORT_1 */
#define REG_TYPE_C_SW_DBG_PORT_1_OFST             (0)
...
#define TYPE_C_FPGA_AD_CC_VUSB33_RDY_OFST         (2)
