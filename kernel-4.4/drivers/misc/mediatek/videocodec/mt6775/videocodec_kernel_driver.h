...
#define VCODEC_SET_AV_TASK_GROUP       _IOW(MFV_IOC_MAGIC, 0x36, unsigned int) /* VAL_BOOL_T * */
#define VCODEC_SET_FRAME_INFO          _IOW(MFV_IOC_MAGIC, 0x37, unsigned int) /* VAL_FRAME_INFO_T * */


/* #define MFV_GET_CACHECTRLADDR_CMD  _IOR(MFV_IOC_MAGIC, 0x06, int) */

extern void mmsys_cg_check(void);
extern int smi_debug_bus_hanging_detect_ext2(unsigned short larbs, int show_dump, int output_gce_buffer,
