...
#define DISP_REG_OVL_L0_CON						(0x030UL)
	...
	#define L_CON_FLD_LARC						REG_FLD_MSB_LSB(29, 28)
...
#define DISP_REG_OVL_RDMA0_CTRL					(0x0C0UL)
	...
	#define RDMA0_CTRL_FLD_RMDA_FIFO_USED_SZ		REG_FLD_MSB_LSB(26, 16)
...
#define DISP_REG_OVL_RDMA0_MEM_GMC_S2				(0x1E0UL)
	#define FLD_OVL_RDMA_MEM_GMC2_ISSUE_REQ_THRES		REG_FLD_MSB_LSB(10, 0)
	#define FLD_OVL_RDMA_MEM_GMC2_ISSUE_REQ_THRES_URG	REG_FLD_MSB_LSB(26, 16)
