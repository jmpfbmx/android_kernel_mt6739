...
unsigned int module_list_scenario[DDP_SCENARIO_MAX][DDP_ENING_NUM] = {
	...
	{
		DISP_MODULE_OVL0, DISP_MODULE_COLOR0,
		DISP_MODULE_CCORR0, DISP_MODULE_AAL0, DISP_MODULE_GAMMA0, DISP_MODULE_DITHER0, DISP_MODULE_RDMA0,
	...
	/* DDP_SCENARIO_PRIMARY_RDMA0_COLOR0_DISP */
	{
		...
		DISP_MODULE_GAMMA0, DISP_MODULE_DITHER0, DISP_MODULE_UFOE_VIRTUAL, DISP_MODULE_PWM0, DISP_MODULE_DSI0,
		-1,
	},
	...
	/* DDP_SCENARIO_PRIMARY_ALL */
	{
		...
		DISP_MODULE_DITHER0, DISP_MODULE_UFOE_VIRTUAL, DISP_MODULE_PWM0, DISP_MODULE_DSI0,
		-1,
	},
...
static struct mout_s mout_map[] = {
	...
	/* DITHER0_MOUT */
	{DISP_MODULE_DITHER0,
		{{DISP_MODULE_RDMA0, 1 << 0}, {DISP_MODULE_UFOE_VIRTUAL, 1 << 1},
		{DISP_MODULE_WDMA0, 1 << 2},	{-1, 0} },
		0, 0},
	/*UFOE0_MOUT*/
	{DISP_MODULE_UFOE_VIRTUAL,
		{{DISP_MODULE_DSI0, 1 << 0}, {DISP_MODULE_DBI, 1 << 1},
		{DISP_MODULE_WDMA0, 1 << 2},	{-1, 0} },
		0, 0},
};
...
static struct sel_s sel_out_map[] = {
	...
	{DISP_MODULE_RDMA0,
		...
		DISP_MODULE_DSI0, DISP_MODULE_DBI, -1}, 0, 0},
};
...
static struct sel_s sel_in_map[] = {
	...
	/* UFOE0_SEL */
	{DISP_MODULE_UFOE_VIRTUAL, {DISP_MODULE_RDMA0, DISP_MODULE_DITHER0,
		 -1}, 0, 0},

	/* WDMA_SEL */
	{DISP_MODULE_WDMA0, {DISP_MODULE_OVL0,
		DISP_MODULE_DITHER0, DISP_MODULE_UFOE_VIRTUAL, -1}, 0, 0},

	/* DSI_SEL */
	{DISP_MODULE_DSI0, {DISP_MODULE_UFOE_VIRTUAL, DISP_MODULE_RDMA0,
	 -1}, 0, 0},

	/* DBI_SEL */
	{DISP_MODULE_DBI, {DISP_MODULE_UFOE_VIRTUAL, DISP_MODULE_RDMA0,
	 -1}, 0, 0},
};
...
int ddp_path_init(void)
{
	...
	mout_map[1].reg = (volatile unsigned long *)DISP_REG_CONFIG_DISP_DITHER_MOUT_EN;
	mout_map[2].reg = (volatile unsigned long *)DISP_REG_CONFIG_DISP_UFOE_MOUT_EN;

	/* sel_out */
	sel_out_map[0].reg = (volatile unsigned long *)DISP_REG_CONFIG_DISP_RDMA0_SOUT_SEL_IN;

	/* sel_in */
	sel_in_map[0].reg = (volatile unsigned long *)DISP_REG_CONFIG_DISP_COLOR_SEL_IN;
	sel_in_map[1].reg = (volatile unsigned long *)DISP_REG_CONFIG_DISP_UFOE_SEL_IN;
	sel_in_map[2].reg = (volatile unsigned long *)DISP_REG_CONFIG_DISP_WDMA0_SEL_IN;
	sel_in_map[3].reg = (volatile unsigned long *)DISP_REG_CONFIG_DISP_DSI0_SEL_IN;
	sel_in_map[4].reg = (volatile unsigned long *)DISP_REG_CONFIG_DISP_DBI_SEL_IN;
