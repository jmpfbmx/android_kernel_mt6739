...
#define DBI_COLOR_BASE 30
	enum DBI_LAYER_FORMAT {
		...
		DBI_LAYER_FORMAT_ABGR8888 = DBI_LAYER_FORMAT_ARGB8888 + DBI_COLOR_BASE,
		DBI_LAYER_FORMAT_BGR888 = DBI_LAYER_FORMAT_RGB888 + DBI_COLOR_BASE,
		DBI_LAYER_FORMAT_BGR565 = DBI_LAYER_FORMAT_RGB565 + DBI_COLOR_BASE,
		DBI_LAYER_FORMAT_PABGR8888 = DBI_LAYER_FORMAT_PARGB8888 + DBI_COLOR_BASE,
		DBI_LAYER_FORMAT_xBGR8888 = DBI_LAYER_FORMAT_xRGB8888 + DBI_COLOR_BASE,
	};
	...
	int dbi_enable_irq(enum DISP_MODULE_ENUM module, void *handle, unsigned int enable);
