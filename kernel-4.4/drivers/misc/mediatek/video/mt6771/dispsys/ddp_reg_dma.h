...
#define DISP_REG_RDMA_DBG_OUT2				(DISPSYS_RDMA0_BASE+0x110)
#define DISP_REG_RDMA_DBG_OUT3				(DISPSYS_RDMA0_BASE+0x114)
#define DISP_REG_RDMA_DBG_OUT4				(DISPSYS_RDMA0_BASE+0x118)
#define DISP_REG_RDMA_DBG_OUT5				(DISPSYS_RDMA0_BASE+0x11c)
...
#define DISP_REG_WDMA_FLOW_CTRL_DBG			(DISPSYS_WDMA0_BASE+0x0A0)
	#define FLOW_CTRL_DBG_FLD_WDMA_STATE		REG_FLD_MSB_LSB(9, 0)
	#define FLOW_CTRL_DBG_FLD_SMI_BUSY		REG_FLD_MSB_LSB(29, 28)
...
#define DST_ADDR_OFFSET0_FLD_WDMA_DESTINATION_ADDRESS_OFFSET0	REG_FLD_MSB_LSB(27, 0)
#define DST_ADDR_OFFSET1_FLD_WDMA_DESTINATION_ADDRESS_OFFSET1	REG_FLD_MSB_LSB(27, 0)
#define DST_ADDR_OFFSET2_FLD_WDMA_DESTINATION_ADDRESS_OFFSET2	REG_FLD_MSB_LSB(27, 0)
