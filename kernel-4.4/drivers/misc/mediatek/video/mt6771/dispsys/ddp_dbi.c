...
void ddp_dbi_dump_reg(enum DISP_MODULE_ENUM module)
{
	...
	DDPDUMP("dbi: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x\n",
		...
		0x008, INREG32(module_base + 0x008), 0x00c, INREG32(module_base + 0x00c));
	DDPDUMP("dbi: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x\n",
		0x010, INREG32(module_base + 0x010),
		0x018, INREG32(module_base + 0x018),
		0x01c, INREG32(module_base + 0x01c), 0x020, INREG32(module_base + 0x020));
	DDPDUMP("dbi: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x\n",
		0x028, INREG32(module_base + 0x028),
		0x02c, INREG32(module_base + 0x02c),
		0x030, INREG32(module_base + 0x030), 0x034, INREG32(module_base + 0x034));
	DDPDUMP("dbi: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x\n",
		0x038, INREG32(module_base + 0x038),
		0x03c, INREG32(module_base + 0x03c),
		0x040, INREG32(module_base + 0x040), 0x044, INREG32(module_base + 0x044));
	DDPDUMP("dbi: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x\n",
		0x048, INREG32(module_base + 0x048),
		0x04c, INREG32(module_base + 0x04c),
		0x058, INREG32(module_base + 0x058), 0x060, INREG32(module_base + 0x060));
	DDPDUMP("dbi: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x\n",
		0x064, INREG32(module_base + 0x064),
		0x068, INREG32(module_base + 0x068),
		0x06c, INREG32(module_base + 0x06c), 0x070, INREG32(module_base + 0x070));
	DDPDUMP("dbi: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x\n",
		0x080, INREG32(module_base + 0x080),
		0x084, INREG32(module_base + 0x084),
		0x088, INREG32(module_base + 0x088), 0x090, INREG32(module_base + 0x090));
	DDPDUMP("dbi: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x\n",
		0x094, INREG32(module_base + 0x094),
		0x098, INREG32(module_base + 0x098),
		0x0a8, INREG32(module_base + 0x0a8), 0x0e0, INREG32(module_base + 0x0e0));
	DDPDUMP("dbi: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x\n",
		0x0e4, INREG32(module_base + 0x0e4),
		0x0e8, INREG32(module_base + 0x0e8),
		0x260, INREG32(module_base + 0x260), 0x270, INREG32(module_base + 0x270));
	DDPDUMP("dbi: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x\n",
		0x278, INREG32(module_base + 0x278),
		0x27c, INREG32(module_base + 0x27c),
		0x290, INREG32(module_base + 0x290), 0x294, INREG32(module_base + 0x294));
	DDPDUMP("dbi: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x\n",
		0x298, INREG32(module_base + 0x298),
		0x29c, INREG32(module_base + 0x29c),
		0x300, INREG32(module_base + 0x300), 0x304, INREG32(module_base + 0x304));
	DDPDUMP("dbi: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x\n",
		0x310, INREG32(module_base + 0x310),
		0xe00, INREG32(module_base + 0xe00),
		0xe14, INREG32(module_base + 0xe14), 0xe18, INREG32(module_base + 0xe18));
	DDPDUMP("dbi: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x\n",
		0xe1c, INREG32(module_base + 0xe1c),
		0xe20, INREG32(module_base + 0xe20),
		0xe24, INREG32(module_base + 0xe24), 0xe28, INREG32(module_base + 0xe28));
	DDPDUMP("dbi: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x\n",
		0xe2c, INREG32(module_base + 0xe2c),
		0xe30, INREG32(module_base + 0xe30),
		0xe34, INREG32(module_base + 0xe34), 0xe38, INREG32(module_base + 0xe38));
...
static void lcm_send_cmd(/*enum DISP_MODULE_ENUM module, struct cmdqRecStruct *cmdq, */ unsigned
			 int cmd)
{
...
static void lcm_send_data(/*enum DISP_MODULE_ENUM module, struct cmdqRecStruct *cmdq, */ unsigned
			  int data)
{
...
enum DBI_STATUS _dbi_gpio_pinmux(enum DISP_MODULE_ENUM module, void *cmdq)
{
	...
	if (_dbi_context.dbi_params.ctrl == LCM_CTRL_SERIAL_DBI) {
		...
		DBI_OUTREG32(NULL, gpio_base + 0x3ac, 0x009B0000);	/* GPIO 84,85 */
...
int ddp_dbi_config(enum DISP_MODULE_ENUM module, struct disp_ddp_path_config *config, void *cmdq)
{
	...
	if (_dbi_context.dbi_params.ctrl == LCM_CTRL_SERIAL_DBI) {
		...
		DBI_OUTREGBIT(cmdq, struct DBI_ROI_CADD_REG, DBI_REG->DBI_ROI_CADD, addr, 0x8);
		DBI_OUTREGBIT(cmdq, struct DBI_ROI_DADD_REG, DBI_REG->DBI_ROI_DADD, addr, 0x9);

		/* control the LSCK frequence */
		/* css(chip selection setup time):7,csh(chip selection hold time):7 */
		DBI_OUTREG32(cmdq, &(DBI_REG->SIF_TIMING[0]), 0x00007700);	/* LSCK will be 1/2 of DBI clock */
		...
		DBI_OUTREGBIT(cmdq, struct DBI_SCNF_REG, DBI_REG->DBI_SCNF, SCK_DEF_0, 1);
		...
		if (_dbi_context.dbi_params.serial.wire_num == LCM_DBI_C_3WIRE)
			...
			DBI_OUTREGBIT(cmdq, struct DBI_SCNF_REG, DBI_REG->DBI_SCNF, THREE_WIRE_0, 0);

		DBI_OUTREGBIT(cmdq, struct DBI_SCNF_REG, DBI_REG->DBI_SCNF, SIZE_0, 0);	/* 8bits */
		...
		if (_dbi_context.dbi_params.data_format.color_order == LCM_COLOR_ORDER_RGB) {
			/* DBI_OUTREGBIT(cmdq, struct DBI_ROICON_REG, DBI_REG->DBI_ROICON, RGB_ORDER, 1); //RGB */
			_roi_con.RGB_ORDER = 1;
		} else {
			/* DBI_OUTREGBIT(cmdq, struct DBI_ROICON_REG, DBI_REG->DBI_ROICON, RGB_ORDER, 0); //BGR */
