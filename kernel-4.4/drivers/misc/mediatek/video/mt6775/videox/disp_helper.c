...
static struct {
	...
	{DISP_OPT_ROUND_CORNER_OFFSET, 0, "DISP_OPT_ROUND_CORNER_OFFSET"},
	{DISP_OPT_RPO, 0, "DISP_OPT_RPO"}, /*when enable should enable rsz*/
	{DISP_OPT_RPO_INPUT_CACHE, 0, "DISP_OPT_RPO_INPUT_CACHE"}, /*when enable should enable rsz*/
};
