...
static int disp_probe(struct platform_device *pdev)
{
	...
	DDPWRN("disp driver(1) disp_probe begin\n");
	...
	DDPWRN("disp driver(1) disp_probe end\n");
...
static int __init disp_probe_1(void)
{
	...
	DDPWRN("disp driver(1) disp_probe_1 begin\n");
	...
	if (ret) {
		DDPERR("disp: fail to create mtk_disp node\n");
	...
	DDPWRN("disp driver(1) disp_probe_1 end\n");
