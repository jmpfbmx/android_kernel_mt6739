...
#define DISP_REG_CONFIG_MMSYS_MISC			(DISPSYS_CONFIG_BASE + 0x0F0)
	#define MISC_FLD_WROT1_DISP_RSZ_SHARE_SEL       REG_FLD_MSB_LSB(6, 6)
	#define MISC_FLD_WROT_SHARE_SEL                 REG_FLD_MSB_LSB(5, 5)
	#define MISC_FLD_MMAPB_PROTECT_EN               REG_FLD_MSB_LSB(4, 4)
	#define MISC_FLD_MMAPB_SLICE_EARLY_EN           REG_FLD_MSB_LSB(3, 3)
	#define MISC_FLD_RDMA_VDE_IGNORE_SPLIT_EMPTY    REG_FLD_MSB_LSB(2, 2)
	#define MISC_FLD_DSI1_TE_SEL                    REG_FLD_MSB_LSB(1, 1)
	#define MISC_FLD_SMI_LARB0_TEST_MODE            REG_FLD_MSB_LSB(0, 0)
...
#define DISP_REG_CONFIG_MMSYS_SODI_REQ_MASK		(DISPSYS_CONFIG_BASE + 0x0F8)
	#define RDMA0_PD_MODE_MASK			REG_FLD_MSB_LSB(0, 0)
	#define RDMA0_CG_MODE_MASK			REG_FLD_MSB_LSB(1, 1)
	#define RDMA1_PD_MODE_MASK			REG_FLD_MSB_LSB(2, 2)
	#define RDMA1_CG_MODE_MASK			REG_FLD_MSB_LSB(3, 3)

	#define RDMA0_PD_MODE_VALUE			REG_FLD_MSB_LSB(8, 8)
	#define RDMA0_CG_MODE_VALUE			REG_FLD_MSB_LSB(9, 9)
	#define RDMA1_PD_MODE_VALUE			REG_FLD_MSB_LSB(10, 10)
	#define RDMA1_CG_MODE_VALUE			REG_FLD_MSB_LSB(11, 11)
...
#define DISP_REG_CONFIG_MMSYS_CG_CLR0			(DISPSYS_CONFIG_BASE + 0x108)
	#define MMSYS_CG_FLD_FAKE_ENG				REG_FLD(1, 19)
...
#define DISP_REG_CONFIG_MDP_AAL_MEM_DELSEL		(DISPSYS_CONFIG_BASE + 0x850)
...
#define DISP_REG_CONFIG_DISP_DSI1_SEL_IN			(DISPSYS_CONFIG_BASE + 0xF30)
#define DISP_REG_CONFIG_DISP_RSZ_SEL_IN				(DISPSYS_CONFIG_BASE + 0xF48)
#define DISP_REG_CONFIG_DISP_RDMA0_RSZ_IN_SOUT_SEL_IN	(DISPSYS_CONFIG_BASE + 0xF60)
#define DISP_REG_CONFIG_DISP_RDMA0_RSZ_OUT_SEL_IN	(DISPSYS_CONFIG_BASE + 0xF64)
