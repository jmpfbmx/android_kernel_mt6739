	...
	if (disp_helper_get_option(DISP_OPT_SHADOW_REGISTER)) {
		if (disp_helper_get_option(DISP_OPT_SHADOW_MODE) == 1) {
			...
			DISP_REG_SET_FIELD(handle, WDMA_FORCE_COMMIT,
				idx * DISP_WDMA_INDEX_OFFSET + DISP_REG_WDMA_SHADOW_CTL, 0x1);
			/* bypass shadow */
			DISP_REG_SET_FIELD(handle, WDMA_BYPASS_SHADOW,
				idx * DISP_WDMA_INDEX_OFFSET + DISP_REG_WDMA_SHADOW_CTL, 0x0);
		...
		DISP_REG_SET_FIELD(handle, WDMA_READ_WORK_REG,
			idx * DISP_WDMA_INDEX_OFFSET + DISP_REG_WDMA_SHADOW_CTL, 0x0);
	}
...
void wdma_dump_golden_setting(enum DISP_MODULE_ENUM module)
{
	...
	DDPDUMP("WDMA_SMI_CON:\n[3:0]:%x [4:4]:%x [7:5]:%x [15:8]:%x [19:16]:%u [23:20]:%u [27:24]:%u\n",
			DISP_REG_GET_FIELD(SMI_CON_FLD_THRESHOLD, idx_offst + DISP_REG_WDMA_SMI_CON),
			DISP_REG_GET_FIELD(SMI_CON_FLD_SLOW_ENABLE, idx_offst + DISP_REG_WDMA_SMI_CON),
			DISP_REG_GET_FIELD(SMI_CON_FLD_SLOW_LEVEL, idx_offst + DISP_REG_WDMA_SMI_CON),
			DISP_REG_GET_FIELD(SMI_CON_FLD_SLOW_COUNT, idx_offst + DISP_REG_WDMA_SMI_CON),
			DISP_REG_GET_FIELD(SMI_CON_FLD_SMI_Y_REPEAT_NUM, idx_offst + DISP_REG_WDMA_SMI_CON),
			DISP_REG_GET_FIELD(SMI_CON_FLD_SMI_U_REPEAT_NUM, idx_offst + DISP_REG_WDMA_SMI_CON),
			DISP_REG_GET_FIELD(SMI_CON_FLD_SMI_V_REPEAT_NUM, idx_offst + DISP_REG_WDMA_SMI_CON));
	DDPDUMP("WDMA_BUF_CON1:\n[31]:%x [30]:%x [28]:%x [8:0]%d\n",
			DISP_REG_GET_FIELD(BUF_CON1_FLD_ULTRA_ENABLE, idx_offst + DISP_REG_WDMA_BUF_CON1),
			DISP_REG_GET_FIELD(BUF_CON1_FLD_PRE_ULTRA_ENABLE, idx_offst + DISP_REG_WDMA_BUF_CON1),
			DISP_REG_GET_FIELD(BUF_CON1_FLD_FRAME_END_ULTRA, idx_offst + DISP_REG_WDMA_BUF_CON1),
			DISP_REG_GET_FIELD(BUF_CON1_FLD_FIFO_PSEUDO_SIZE, idx_offst + DISP_REG_WDMA_BUF_CON1));
	DDPDUMP("WDMA_BUF_CON5:\n[9:0]:%d [25:16]:%d\n",
			DISP_REG_GET_FIELD(BUF_CON_FLD_PRE_ULTRA_LOW, idx_offst + DISP_REG_WDMA_BUF_CON5),
			DISP_REG_GET_FIELD(BUF_CON_FLD_ULTRA_LOW, idx_offst + DISP_REG_WDMA_BUF_CON5));
	DDPDUMP("WDMA_BUF_CON6:\n[9:0]:%d [25:16]:%d\n",
			DISP_REG_GET_FIELD(BUF_CON_FLD_PRE_ULTRA_HIGH, idx_offst + DISP_REG_WDMA_BUF_CON6),
			DISP_REG_GET_FIELD(BUF_CON_FLD_ULTRA_HIGH, idx_offst + DISP_REG_WDMA_BUF_CON6));
	DDPDUMP("WDMA_BUF_CON7:\n[9:0]:%d [25:16]:%d\n",
			DISP_REG_GET_FIELD(BUF_CON_FLD_PRE_ULTRA_LOW, idx_offst + DISP_REG_WDMA_BUF_CON7),
			DISP_REG_GET_FIELD(BUF_CON_FLD_ULTRA_LOW, idx_offst + DISP_REG_WDMA_BUF_CON7));
	DDPDUMP("WDMA_BUF_CON8:\n[9:0]:%d [25:16]:%d\n",
			DISP_REG_GET_FIELD(BUF_CON_FLD_PRE_ULTRA_HIGH, idx_offst + DISP_REG_WDMA_BUF_CON8),
			DISP_REG_GET_FIELD(BUF_CON_FLD_ULTRA_HIGH, idx_offst + DISP_REG_WDMA_BUF_CON8));
	DDPDUMP("WDMA_BUF_CON9:\n[9:0]:%d [25:16]:%d\n",
			DISP_REG_GET_FIELD(BUF_CON_FLD_PRE_ULTRA_LOW, idx_offst + DISP_REG_WDMA_BUF_CON9),
			DISP_REG_GET_FIELD(BUF_CON_FLD_ULTRA_LOW, idx_offst + DISP_REG_WDMA_BUF_CON9));
	DDPDUMP("WDMA_BUF_CON10:\n[9:0]:%d [25:16]:%d\n",
			DISP_REG_GET_FIELD(BUF_CON_FLD_PRE_ULTRA_HIGH, idx_offst + DISP_REG_WDMA_BUF_CON10),
			DISP_REG_GET_FIELD(BUF_CON_FLD_ULTRA_HIGH, idx_offst + DISP_REG_WDMA_BUF_CON10));
	DDPDUMP("WDMA_BUF_CON11:\n[9:0]:%d [25:16]:%d\n",
			DISP_REG_GET_FIELD(BUF_CON_FLD_PRE_ULTRA_LOW, idx_offst + DISP_REG_WDMA_BUF_CON11),
			DISP_REG_GET_FIELD(BUF_CON_FLD_ULTRA_LOW, idx_offst + DISP_REG_WDMA_BUF_CON11));
	DDPDUMP("WDMA_BUF_CON12:\n[9:0]:%d [25:16]:%d\n",
			DISP_REG_GET_FIELD(BUF_CON_FLD_PRE_ULTRA_HIGH, idx_offst + DISP_REG_WDMA_BUF_CON12),
			DISP_REG_GET_FIELD(BUF_CON_FLD_ULTRA_HIGH, idx_offst + DISP_REG_WDMA_BUF_CON12));
	DDPDUMP("WDMA_BUF_CON13:\n[9:0]:%d [25:16]:%d\n",
			DISP_REG_GET_FIELD(BUF_CON_FLD_PRE_ULTRA_LOW, idx_offst + DISP_REG_WDMA_BUF_CON13),
			DISP_REG_GET_FIELD(BUF_CON_FLD_ULTRA_LOW, idx_offst + DISP_REG_WDMA_BUF_CON13));
	DDPDUMP("WDMA_BUF_CON14:\n[9:0]:%d [25:16]:%d\n",
			DISP_REG_GET_FIELD(BUF_CON_FLD_PRE_ULTRA_HIGH, idx_offst + DISP_REG_WDMA_BUF_CON14),
			DISP_REG_GET_FIELD(BUF_CON_FLD_ULTRA_HIGH, idx_offst + DISP_REG_WDMA_BUF_CON14));
	DDPDUMP("WDMA_BUF_CON15:\n[9:0]:%d [25:16]:%d\n",
			DISP_REG_GET_FIELD(BUF_CON_FLD_PRE_ULTRA_LOW, idx_offst + DISP_REG_WDMA_BUF_CON15),
			DISP_REG_GET_FIELD(BUF_CON_FLD_ULTRA_LOW, idx_offst + DISP_REG_WDMA_BUF_CON15));
	DDPDUMP("WDMA_BUF_CON16:\n[9:0]:%d [25:16]:%d\n",
			DISP_REG_GET_FIELD(BUF_CON_FLD_PRE_ULTRA_HIGH, idx_offst + DISP_REG_WDMA_BUF_CON16),
			DISP_REG_GET_FIELD(BUF_CON_FLD_ULTRA_HIGH, idx_offst + DISP_REG_WDMA_BUF_CON16));
	DDPDUMP("WDMA_BUF_CON17:\n[0]:%d [25:16]:%d\n",
			DISP_REG_GET_FIELD(BUF_CON17_FLD_WDMA_DVFS_EN, idx_offst + DISP_REG_WDMA_BUF_CON17),
			DISP_REG_GET_FIELD(BUF_CON17_FLD_DVFS_TH_Y, idx_offst + DISP_REG_WDMA_BUF_CON17));
	DDPDUMP("WDMA_BUF_CON18:\n[9:0]:%d [25:16]:%d\n",
			DISP_REG_GET_FIELD(BUF_CON18_FLD_DVFS_TH_U, idx_offst + DISP_REG_WDMA_BUF_CON18),
			DISP_REG_GET_FIELD(BUF_CON18_FLD_DVFS_TH_V, idx_offst + DISP_REG_WDMA_BUF_CON18));
	DDPDUMP("WDMA_DRS_CON0:\n[0]:%d [25:16]:%d\n",
			DISP_REG_GET_FIELD(WDMA_DRS_EN, idx_offst + DISP_REG_WDMA_DRS_CON0),
			DISP_REG_GET_FIELD(BUF_DRS_FLD_ENTER_DRS_TH_Y, idx_offst + DISP_REG_WDMA_DRS_CON0));
	DDPDUMP("WDMA_DRS_CON1:\n[9:0]:%d [25:16]:%d\n",
			DISP_REG_GET_FIELD(BUF_DRS_FLD_ENTER_DRS_TH_U, idx_offst + DISP_REG_WDMA_DRS_CON1),
			DISP_REG_GET_FIELD(BUF_DRS_FLD_ENTER_DRS_TH_V, idx_offst + DISP_REG_WDMA_DRS_CON1));
	DDPDUMP("WDMA_DRS_CON2:\n[25:16]:%d\n",
			DISP_REG_GET_FIELD(BUF_DRS_FLD_LEAVE_DRS_TH_Y, idx_offst + DISP_REG_WDMA_DRS_CON2));
	DDPDUMP("WDMA_DRS_CON3:\n[9:0]:%d [25:16]:%d\n",
			DISP_REG_GET_FIELD(BUF_DRS_FLD_LEAVE_DRS_TH_U, idx_offst + DISP_REG_WDMA_DRS_CON3),
			DISP_REG_GET_FIELD(BUF_DRS_FLD_LEAVE_DRS_TH_V, idx_offst + DISP_REG_WDMA_DRS_CON3));
	DDPDUMP("WDMA_BUF_CON3:\n[8:0]:%d [25:16]:%d\n",
			DISP_REG_GET_FIELD(BUF_CON3_FLD_ISSUE_REQ_TH_Y, idx_offst + DISP_REG_WDMA_BUF_CON3),
			DISP_REG_GET_FIELD(BUF_CON3_FLD_ISSUE_REQ_TH_U, idx_offst + DISP_REG_WDMA_BUF_CON3));
	DDPDUMP("WDMA_BUF_CON4:\n[8:0]:%d\n",
			DISP_REG_GET_FIELD(BUF_CON4_FLD_ISSUE_REQ_TH_V, idx_offst + DISP_REG_WDMA_BUF_CON4));
}
...
void wdma_dump_analysis(enum DISP_MODULE_ENUM module)
{
	...
	DDPDUMP("wdma%d:en=%d,w=%d,h=%d,clip=(%d,%d,%dx%d),pitch=(W=%d,UV=%d),addr=(0x%x,0x%x,0x%x),fmt=%s\n",
...
void wdma_dump_reg(enum DISP_MODULE_ENUM module)
{
	if (disp_helper_get_option(DISP_OPT_REG_PARSER_RAW_DUMP)) {
		unsigned int idx = wdma_index(module);
		unsigned long module_base = DISPSYS_WDMA0_BASE + idx * DISP_WDMA_INDEX_OFFSET;
		    ...
		    unsigned int is_primary_flag, void *cmdq)
{
	...
	unsigned int fifo_pseudo_size = 360;
...
static inline int wdma_switch_to_sec(enum DISP_MODULE_ENUM module, void *handle)
{
	...
	if (wdma_is_sec[wdma_idx] == 0) {
		...
		/* mmprofile_log_ex(ddp_mmp_get_events()->svp_module[module], MMPROFILE_FLAG_PULSE, wdma_idx, 1); */
	}
...
int wdma_switch_to_nonsec(enum DISP_MODULE_ENUM module, void *handle)
{
	...
	if (wdma_is_sec[wdma_idx] == 1) {
		...
		/* mmprofile_log_ex(ddp_mmp_get_events()->svp_module[module], MMPROFILE_FLAG_PULSE, wdma_idx, 0); */
	}
