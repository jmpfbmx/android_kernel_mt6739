...
#ifndef _DDP_REG_RSZ_H_
#define _DDP_REG_RSZ_H_
...
#define DISP_REG_PAT2_GEN_COLOR0		(0x208)
	#define FLD_RSZ_REG2_COLOR_V			REG_FLD_MSB_LSB(23, 16)
	#define FLD_RSZ_REG2_COLOR_U			REG_FLD_MSB_LSB(15, 8)
	#define FLD_RSZ_REG2_COLOR_Y			REG_FLD_MSB_LSB(7, 0)

#define DISP_REG_PAT2_GEN_COLOR1		(0x20c)
	#define FLD_RSZ_REG2_COLOR_A			REG_FLD_MSB_LSB(7, 0)

#define DISP_REG_PAT2_GEN_POS			(0x214)
	#define FLD_RSZ_REG2_POS_Y				REG_FLD_MSB_LSB(28, 16)
	#define FLD_RSZ_REG2_POS_X				REG_FLD_MSB_LSB(12, 0)

#define DISP_REG_PAT2_GEN_CURSOR_RB0	(0x218)
	#define FLD_RSZ_REG2_RB_CURSOR_U		REG_FLD_MSB_LSB(23, 16)
	#define FLD_RSZ_REG2_RB_CURSOR_Y		REG_FLD_MSB_LSB(7, 0)

#define DISP_REG_PAT2_GEN_CURSOR_RB1	(0x21C)
	#define FLD_RSZ_REG2_RB_CURSOR_A		REG_FLD_MSB_LSB(23, 16)
	#define FLD_RSZ_REG2_RB_CURSOR_V		REG_FLD_MSB_LSB(7, 0)
