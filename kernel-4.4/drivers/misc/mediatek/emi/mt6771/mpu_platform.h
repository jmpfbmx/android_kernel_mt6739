...
static const struct mst_tbl_entry mst_tbl[] = {
	...
	{.master = MT6771_M2_AXI_MST_HW_VDEC_MC_EXT, .port = 2, .id_mask = 0x1FFC,
		.id_val = 0x380,
		.note = "",
		.name = "MT6771_M2_AXI_MST_HW_VDEC_MC_EXT"},
	{.master = MT6771_M2_AXI_MST_HW_VDEC_PP_EXT, .port = 2, .id_mask = 0x1FFC,
		.id_val = 0x384,
		.note = "",
		.name = "MT6771_M2_AXI_MST_HW_VDEC_PP_EXT"},
	{.master = MT6771_M2_AXI_MST_HW_VDEC_VLD_EXT, .port = 2, .id_mask = 0x1FFC,
		.id_val = 0x388,
		.note = "",
		.name = "MT6771_M2_AXI_MST_HW_VDEC_VLD_EXT"},
	{.master = MT6771_M2_AXI_MST_HW_VDEC_AVC_MV_EXT, .port = 2, .id_mask = 0x1FFC,
		.id_val = 0x38C,
		.note = "",
		.name = "MT6771_M2_AXI_MST_HW_VDEC_AVC_MV_EXT"},
	{.master = MT6771_M2_AXI_MST_HW_VDEC_PRED_RD_EXT, .port = 2, .id_mask = 0x1FFC,
		.id_val = 0x390,
		.note = "",
		.name = "MT6771_M2_AXI_MST_HW_VDEC_PRED_RD_EXT"},
	{.master = MT6771_M2_AXI_MST_HW_VDEC_PRED_WR_EXT, .port = 2, .id_mask = 0x1FFC,
		.id_val = 0x394,
		.note = "",
		.name = "MT6771_M2_AXI_MST_HW_VDEC_PRED_WR_EXT"},
	{.master = MT6771_M2_AXI_MST_HW_VDEC_PPWRAP_EXT, .port = 2, .id_mask = 0x1FFC,
		.id_val = 0x398,
		.note = "",
	...
	{.master = MT6771_M2_AXI_MST_VENC_RCPU_HW_VDEC_MC_EXT, .port = 2, .id_mask = 0x1FFC,
		.id_val = 0x80,
		.note = "",
	...
	{.master = MT6771_M2_AXI_MST_VENC_BSDMA_HW_VDEC_PP_EXT, .port = 2, .id_mask = 0x1FFC,
		.id_val = 0x88,
		.note = "",
		.name = "MT6771_M2_AXI_MST_VENC_BSDMA_HW_VDEC_PP_EXT"},
	{.master = MT6771_M2_AXI_MST_VENC_SV_COMV_HW_VDEC_PRED_WR_EXT, .port = 2, .id_mask = 0x1FFC,
		.id_val = 0x8C,
		.note = "",
		.name = "MT6771_M2_AXI_MST_VENC_SV_COMV_HW_VDEC_PRED_WR_EXT"},
	{.master = MT6771_M2_AXI_MST_VENC_RD_COMV_HW_VDEC_PRED_RD_EXT, .port = 2, .id_mask = 0x1FFC,
		.id_val = 0x90,
		.note = "",
	...
	{.master = MT6771_M2_AXI_MST_VENC_CUR_LUMA_HW_VDEC_VLD_EXT, .port = 2, .id_mask = 0x1FFC,
		.id_val = 0x9C,
		.note = "",
		.name = "MT6771_M2_AXI_MST_VENC_CUR_LUMA_HW_VDEC_VLD_EXT"},
	{.master = MT6771_M2_AXI_MST_VENC_CUR_CHROMA_HW_VDEC_PPWRAP_EXT, .port = 2, .id_mask = 0x1FFC,
		.id_val = 0xA0,
		.note = "",
		.name = "MT6771_M2_AXI_MST_VENC_CUR_CHROMA_HW_VDEC_PPWRAP_EXT"},
	{.master = MT6771_M2_AXI_MST_VENC_REF_LUMA_HW_VDEC_AVC_MV_EXT, .port = 2, .id_mask = 0x1FFC,
		.id_val = 0xA4,
		.note = "",
		.name = "MT6771_M2_AXI_MST_VENC_REF_LUMA_HW_VDEC_AVC_MV_EXT"},
	{.master = MT6771_M2_AXI_MST_VENC_REF_CHROMA, .port = 2, .id_mask = 0x1FFC,
		.id_val = 0xA8,
		.note = "",
	...
	{.master = MT6771_M5_AXI_MST_HW_VDEC_MC_EXT, .port = 5, .id_mask = 0x1FFC,
		.id_val = 0x380,
		.note = "",
		.name = "MT6771_M5_AXI_MST_HW_VDEC_MC_EXT"},
	{.master = MT6771_M5_AXI_MST_HW_VDEC_PP_EXT, .port = 5, .id_mask = 0x1FFC,
		.id_val = 0x384,
		.note = "",
		.name = "MT6771_M5_AXI_MST_HW_VDEC_PP_EXT"},
	{.master = MT6771_M5_AXI_MST_HW_VDEC_VLD_EXT, .port = 5, .id_mask = 0x1FFC,
		.id_val = 0x388,
		.note = "",
		.name = "MT6771_M5_AXI_MST_HW_VDEC_VLD_EXT"},
	{.master = MT6771_M5_AXI_MST_HW_VDEC_AVC_MV_EXT, .port = 5, .id_mask = 0x1FFC,
		.id_val = 0x38C,
		.note = "",
		.name = "MT6771_M5_AXI_MST_HW_VDEC_AVC_MV_EXT"},
	{.master = MT6771_M5_AXI_MST_HW_VDEC_PRED_RD_EXT, .port = 5, .id_mask = 0x1FFC,
		.id_val = 0x390,
		.note = "",
		.name = "MT6771_M5_AXI_MST_HW_VDEC_PRED_RD_EXT"},
	{.master = MT6771_M5_AXI_MST_HW_VDEC_PRED_WR_EXT, .port = 5, .id_mask = 0x1FFC,
		.id_val = 0x394,
		.note = "",
		.name = "MT6771_M5_AXI_MST_HW_VDEC_PRED_WR_EXT"},
	{.master = MT6771_M5_AXI_MST_HW_VDEC_PPWRAP_EXT, .port = 5, .id_mask = 0x1FFC,
		.id_val = 0x398,
		.note = "",
	...
	{.master = MT6771_M5_AXI_MST_VENC_RCPU_HW_VDEC_MC_EXT, .port = 5, .id_mask = 0x1FFC,
		.id_val = 0x80,
		.note = "",
	...
	{.master = MT6771_M5_AXI_MST_VENC_BSDMA_HW_VDEC_PP_EXT, .port = 5, .id_mask = 0x1FFC,
		.id_val = 0x88,
		.note = "",
		.name = "MT6771_M5_AXI_MST_VENC_BSDMA_HW_VDEC_PP_EXT"},
	{.master = MT6771_M5_AXI_MST_VENC_SV_COMV_HW_VDEC_PRED_WR_EXT, .port = 5, .id_mask = 0x1FFC,
		.id_val = 0x8C,
		.note = "",
		.name = "MT6771_M5_AXI_MST_VENC_SV_COMV_HW_VDEC_PRED_WR_EXT"},
	{.master = MT6771_M5_AXI_MST_VENC_RD_COMV_HW_VDEC_PRED_RD_EXT, .port = 5, .id_mask = 0x1FFC,
		.id_val = 0x90,
		.note = "",
	...
	{.master = MT6771_M5_AXI_MST_VENC_CUR_LUMA_HW_VDEC_VLD_EXT, .port = 5, .id_mask = 0x1FFC,
		.id_val = 0x9C,
		.note = "",
		.name = "MT6771_M5_AXI_MST_VENC_CUR_LUMA_HW_VDEC_VLD_EXT"},
	{.master = MT6771_M5_AXI_MST_VENC_CUR_CHROMA_HW_VDEC_PPWRAP_EXT, .port = 5, .id_mask = 0x1FFC,
		.id_val = 0xA0,
		.note = "",
		.name = "MT6771_M5_AXI_MST_VENC_CUR_CHROMA_HW_VDEC_PPWRAP_EXT"},
	{.master = MT6771_M5_AXI_MST_VENC_REF_LUMA_HW_VDEC_AVC_MV_EXT, .port = 5, .id_mask = 0x1FFC,
		.id_val = 0xA4,
		.note = "",
		.name = "MT6771_M5_AXI_MST_VENC_REF_LUMA_HW_VDEC_AVC_MV_EXT"},
	{.master = MT6771_M5_AXI_MST_VENC_REF_CHROMA, .port = 5, .id_mask = 0x1FFC,
		.id_val = 0xA8,
		.note = "",
	...
	{.master = MT6771_M3_AXI_MST_USIP_0_DCACHE, .port = 3, .id_mask = 0x1E1F,
		.id_val = 0x6,
		.note = "",
		.name = "MT6771_M3_AXI_MST_USIP_0_DCACHE"},
	{.master = MT6771_M3_AXI_MST_USIP_0_DNOCACHE, .port = 3, .id_mask = 0x1E1F,
		.id_val = 0xA,
		.note = "",
	...
	{.master = MT6771_M3_AXI_MST_USIP_1_DCACHE, .port = 3, .id_mask = 0x1E1F,
		.id_val = 0x16,
		.note = "",
		.name = "MT6771_M3_AXI_MST_USIP_1_DCACHE"},
	{.master = MT6771_M3_AXI_MST_USIP_1_DNOCACHE, .port = 3, .id_mask = 0x1E1F,
		.id_val = 0x1A,
		.note = "",
