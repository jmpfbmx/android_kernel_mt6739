...
#define PINS_OFFSET_EEM          (PINS_OFFSET_GPU_DVFS + PINS_SIZE_GPU_DVFS)
#define PINS_OFFSET_TST1         (PINS_OFFSET_EEM + PINS_SIZE_EEM)
...
#define PINS_OFFSET_PMIC         (PINS_OFFSET_SPM_SUSPEND + PINS_SIZE_SPM_SUSPEND)
#define PINS_OFFSET_PPM          (PINS_OFFSET_PMIC + PINS_SIZE_PMIC)
#define PINS_OFFSET_THERMAL      (PINS_OFFSET_PPM + PINS_SIZE_PPM)
#define PINS_MBOX1_USED          (PINS_OFFSET_THERMAL + PINS_SIZE_THERMAL)
...
#define PINR_OFFSET_EEM          (PINR_OFFSET_GPU_DVFS + PINR_SIZE_GPU_DVFS)
#define PINR_OFFSET_TST1         (PINR_OFFSET_EEM + PINR_SIZE_EEM)
