...
struct _pin_send send_pintable[] = {
	...
	{{{0} }, {0}, 0, PINS_OFFSET_EEM,  PINS_SIZE_EEM, 0, 1, 0, 0, 0, 0},  /* EEM */
...
struct _pin_recv recv_pintable[] = {
	...
	{NULL, 2, PINR_OFFSET_EEM, PINR_SIZE_EEM, 0, 1, 0, 0, 0},             /* EEM */
...
struct _mbox_info mbox_table[IPI_MBOX_TOTAL] = {
	...
	{6, 10, PINS_MBOX1_USED, 2, 0}, /* mbox 1 for send */
	{0, 4, PINR_MBOX2_USED, 1, 0},  /* mbox 2 for recv */
	{0, 0, 0, 0, 0}, /* mbox 3 */
};
