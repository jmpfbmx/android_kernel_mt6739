...
/* mutex_send, sema_ack, mbox, slot, size, async, retdata, lock, polling, unused, prdata */
struct _pin_send send_pintable[] = {
	{{{0} }, {0}, 0, PINS_OFFSET_PLATFORM, PINS_SIZE_PLATFORM, 0, 1, 0, 0, 0, 0}, /* Platform */
	{{{0} }, {0}, 0, PINS_OFFSET_CPU_DVFS, PINS_SIZE_CPU_DVFS, 0, 1, 1, 1, 0, 0}, /* CPU DVFS */
	{{{0} }, {0}, 0, PINS_OFFSET_QOS, PINS_SIZE_QOS, 0, 1, 1, 1, 0, 0}, /* QOS */
	{{{0} }, {0}, 0, PINS_OFFSET_TST1, PINS_SIZE_TST1, 0, 1, 0, 0, 0, 0}, /* TST1 */
	{{{0} }, {0}, 0, PINS_OFFSET_FHCTL,  PINS_SIZE_FHCTL, 0, 1, 1, 1, 0, 0},  /* FHCTL */
	/*====================================================================*/
	...
	{{{0} }, {0}, 1, PINS_OFFSET_PMIC,  PINS_SIZE_PMIC, 0, 1, 1, 1, 0, 0},  /* PMIC */
	{{{0} }, {0}, 1, PINS_OFFSET_PPM,  PINS_SIZE_PPM, 0, 1, 1, 1, 0, 0},  /* PPM */
	{{{0} }, {0}, 1, PINS_OFFSET_THERMAL,  PINS_SIZE_THERMAL, 0, 1, 0, 0, 0, 0},  /* Thermal */
	{{{0} }, {0}, 1, PINS_OFFSET_UPOWER,  PINS_SIZE_UPOWER, 0, 1, 1, 1, 0, 0},  /* UPower */
 /*====================================================================*/
};
...
struct _pin_recv recv_pintable[] = {
	...
	{NULL, 2, PINR_OFFSET_QOS, PINR_SIZE_QOS, 0, 1, 0, 0, 0},   /* QOS */
	{NULL, 2, PINR_OFFSET_TST1, PINR_SIZE_TST1, 0, 1, 0, 0, 0},   /* TST1 */
};
