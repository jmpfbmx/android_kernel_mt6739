...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K3P8SP_SENSOR_ID,	/* record sensor id defined in kd_imgsensor.h */
...
static SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	...
	{4608, 3456, 0, 0, 4608, 3456, 4608, 3456, 0000, 0000, 4608, 3456, 0, 0, 4608, 3456},	/* capture */
	{4608, 3456, 0, 0, 4608, 3456, 4608, 3456, 0000, 0000, 4608, 3456, 0, 0, 4608, 3456},	/* video */
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PDAF_DATA:	/*get cal data from eeprom*/
		...
		s5k3p8_read_otp_pdaf_data((kal_uint16)(*feature_data),
