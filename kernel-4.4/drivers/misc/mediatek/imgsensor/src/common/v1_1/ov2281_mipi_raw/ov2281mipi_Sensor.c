...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV2281MIPI_SENSOR_ID,	/* record sensor id defined in Kd_imgsensor.h */
	...
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW8_Gb,	/* sensor output first pixel color */
#else
...
static struct imgsensor_struct imgsensor = {
	...
	/* iris pattern mode or not. KAL_FALSE for in iris pattern mode, KAL_TRUE for normal output */
...
{2592, 1944, 0, 0, 1952, 1088, 1952, 1088, 0, 0, 1952, 1088, 1, 0, 1920, 1080},	/* Preview */
{2592, 1944, 0, 0, 2592, 1944, 2592, 1944, 0, 0, 2592, 1944, 1, 0, 2560, 1920},	/* capture */
{2592, 1944, 0, 0, 2592, 1944, 1296, 972, 0, 0, 1296, 972, 1, 0, 1280, 960},	/* video */
{2592, 1944, 0, 0, 2592, 1944, 644, 480, 0, 0, 644, 480, 1, 0, 640, 480},	/* hight speed video */
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			...
			LOG_INF("Read sensor id fail, i2c id: 0x%x, sensor id: 0x%x\n",
				imgsensor.i2c_write_id, *sensor_id);
			retry--;
		} while (retry > 0);
		i++;
