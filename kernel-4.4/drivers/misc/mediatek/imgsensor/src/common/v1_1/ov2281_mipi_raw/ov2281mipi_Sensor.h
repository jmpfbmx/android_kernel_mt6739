...
#ifndef _OV2281MIPI_SENSOR_H_
#define _OV2281MIPI_SENSOR_H_
...
struct imgsensor_struct {
	...
	kal_bool iris_pattern;	/* record iris pattern mode or not */
...
struct imgsensor_info_struct {
	...
	/* capture for PIP 24fps relative information, capture1 mode must use
	 *same framelength, linelength with Capture mode for shutter calculate
	 */
	...
	/* legacy, should be auto mode always*/
