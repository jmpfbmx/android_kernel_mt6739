...
//for test 
extern void ov13855_otp_cali(void);
extern void ov13855_pdaf_cali(void);
extern int OV13855_OTP_Flag;
extern int OV13855_pdaf_Flag;
int m_bpc_select=0;
...
{{ 4256, 3152,  0, 8, 4256, 3144, 2128, 1572, 8, 2, 2112, 1568, 0, 0, 2112, 1568}, // Preview 
 { 4256, 3152,  0, 8, 4232, 3144, 4232, 3144, 16, 8, 4224, 3136, 0, 0, 4224, 3136}, // capture 
 { 4256, 3152,  0, 8, 4232, 3144, 4232, 3144, 16, 8, 4224, 3136, 0, 0, 4224, 3136}, // video
 { 4256, 3152, 64, 64, 4192, 3088, 1048, 772, 4, 4, 1024, 768, 0, 0, 1024, 768},// hight speed video  video
 { 4256, 3152,  0, 8, 4256, 3144, 2128, 1572, 8, 2, 2112, 1568, 0, 0, 2112, 1568}};// slim video 
#if 0
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = return_sensor_id();
			...
			ov13855_otp_cali();
			ov13855_pdaf_cali();
			sprintf(Back_Camera_Name,"OV13855:Q_tech:1300"); 
		#ifdef TARGET_BUILD_MMITEST
			if((OV13855_OTP_Flag==1)&&(OV13855_pdaf_Flag==1))
			{
