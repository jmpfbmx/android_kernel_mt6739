 /************************************************* 
Copyright (C), MediaTek Inc.2010 
File name:ov13855mipiraw_Sensor.h
Author: MTK 
Version: 1.0
Date: 2017/08/14
Description: CMOS sensor header file
History: 1.0 Added by zhanyong.yin for XR 5157125 on 2017/08/14
*************************************************/
#ifndef _OV13855MIPIRAW_SENSOR_H
#define _OV13855MIPIRAW_SENSOR_H
...
typedef enum{
 ...
 OV13855_R2A,
 OV13855_MAX,
}OV13855_CHIP_VER_ENUM;

extern int iReadRegI2C(u8 *a_pSendData , u16 a_sizeSendData, u8 * a_pRecvData, u16 a_sizeRecvData, u16 i2cId);
extern int iWriteRegI2C(u8 *a_pSendData , u16 a_sizeSendData, u16 i2cId);
//extern int read_otp_pdaf_data(kal_uint16 addr, BYTE* data, kal_uint32 size);
