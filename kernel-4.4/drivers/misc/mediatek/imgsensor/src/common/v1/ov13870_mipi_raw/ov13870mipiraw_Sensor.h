...
struct imgsensor_info_struct {
	...
	kal_uint8 i2c_addr_table[5];	/* record sensor support all write id addr, only supprt 4, must end with 0xff */
...
extern int iReadRegI2CTiming(u8 *a_pSendData, u16 a_sizeSendData, u8 *a_pRecvData, u16 a_sizeRecvData, u16 i2cId,
			     u16 timing);
