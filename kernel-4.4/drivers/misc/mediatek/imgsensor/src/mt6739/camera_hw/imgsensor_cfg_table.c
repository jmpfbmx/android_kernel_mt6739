...
struct IMGSENSOR_HW_CFG imgsensor_custom_config[] = {
	{
		...
		IMGSENSOR_I2C_DEV_0,
		{
			...
			//Begin added by zhanyong.yin for XR5424731 on 2017/10/19
			{IMGSENSOR_HW_ID_GPIO, IMGSENSOR_HW_PIN_AF},
			//End added by zhanyong.yin for XR5424731 on 2017/10/19
...
/*begin, modify by zhijun.fu for mclk & pdn delay_time on 2017-12-08*/
/* add by Jimfu for hi846 ,main imgsensor */
#if defined(A3A_HI1333_MIPI_RAW)
	{
...
#endif
#if defined(HI846_BRODSANDS_MIPI_RAW)
	{
		SENSOR_DRVNAME_HI846_BRODSANDS_MIPI_RAW,
		{
			{PDN, Vol_Low, 0},
			{RST, Vol_Low, 0},
			{DOVDD, Vol_1800, 0},
...
#endif
/* add by Jimfu for sub imgsensor */
...
#if defined(GC5025_CXT_MIPI_RAW)
	{
		SENSOR_DRVNAME_GC5025_CXT_MIPI_RAW,
		{
			{PDN, Vol_Low, 0},
			{RST, Vol_Low, 0},
			{DOVDD, Vol_1800, 0},
...
#if defined(A3A_GC5025_MIPI_RAW)
	{
...
#endif
/*end, modify by zhijun.fu for mclk & pdn delay_time on 2017-12-08*/
