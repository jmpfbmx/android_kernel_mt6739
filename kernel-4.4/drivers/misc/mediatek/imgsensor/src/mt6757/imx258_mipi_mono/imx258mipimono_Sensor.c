...
#include "imx258mipimono_Sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "IMX258_camera_sensor MONO"
...
static kal_uint16 imx258_type;	/*0x00=HDR type, 0x10=binning type */
...
kal_uint16 IMX258MIPI_sensorGainMapping_mono[IMX258MIPI_MaxGainIndex][2] = {
	{64, 0},
	{65, 8},
	{66, 16},
	{67, 25},
...
static void custom2_setting(void)
{
	...
	if (imx258_type == IMX258_HDR_TYPE || imx258_type == IMX258_MONO_TYPE) {
		write_cmos_sensor(0x7BCD, 0x00);
		write_cmos_sensor(0x94DC, 0x20);
		write_cmos_sensor(0x94DD, 0x20);
		write_cmos_sensor(0x94DE, 0x20);
			   ...
			   MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	sensor_info->FrameTimeDelayFrame = imgsensor_info.frame_time_delay_frame;	/* The delay frame of setting
											 * frame length
											 */
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PDAF_DATA:
		...
		read_imx258_eeprom((kal_uint16) (*feature_data),
