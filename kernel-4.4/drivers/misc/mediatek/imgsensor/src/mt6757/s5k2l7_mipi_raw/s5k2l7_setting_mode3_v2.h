...
#define _S5K2L7_MODE3_V2_SENSOR_INFO_                                                                                  \
static imgsensor_info_struct _imgsensor_info_m3_v2 =                                                                   \
{                                                                                                                      \
...
#define _SET_MODE3_V2_SENSOR_INFO_AND_WINSIZE_ do {                                                     \
	memcpy((void *)&imgsensor_info, (void *)&_imgsensor_info_m3_v2, sizeof(imgsensor_info_struct)); \
	memcpy((void *)&imgsensor_winsize_info, (void *)&_imgsensor_winsize_info_m3_v2,                 \
...
#define _S5K2L7_MODE3_PREVIEW_MODULE_V2_ do {          \
	...
	write_cmos_sensor_twobyte(0X30A6, 0X0008);     \
	write_cmos_sensor_twobyte(0X30A8, 0X0000);     \
	write_cmos_sensor_twobyte(0X30AA, 0X07E0);     \
...
#define _S5K2L7_MODE3_CAPTURE_MODULE_V2_ do {          \
	...
	write_cmos_sensor_twobyte(0X309A, 0X0102);     \
	write_cmos_sensor_twobyte(0X30BC, 0X0131);     \
	write_cmos_sensor_twobyte(0X30A6, 0X0010);     \
	write_cmos_sensor_twobyte(0X30A8, 0X0002);     \
	write_cmos_sensor_twobyte(0X30AA, 0X0FC0);     \
...
#define _S5K2L7_MODE3_HS_VIDEO_MODULE_V2_ do {         \
	...
	write_cmos_sensor_twobyte(0X030C, 0X0001);     \
	write_cmos_sensor_twobyte(0X030E, 0X0004);     \
	write_cmos_sensor_twobyte(0X0310, 0X00BD);     \
	write_cmos_sensor_twobyte(0X0312, 0X0001);     \
	write_cmos_sensor_twobyte(0X030A, 0X0001);     \
	write_cmos_sensor_twobyte(0X0308, 0X0008);     \
	...
	write_cmos_sensor_twobyte(0X30AA, 0X0540);     \
	write_cmos_sensor_twobyte(0X30AC, 0X00BD);     \
	write_cmos_sensor_twobyte(0X30A0, 0X0000);     \
	write_cmos_sensor_twobyte(0X30A4, 0X0000);     \
	write_cmos_sensor_twobyte(0X6A0C, 0X002F);     \
