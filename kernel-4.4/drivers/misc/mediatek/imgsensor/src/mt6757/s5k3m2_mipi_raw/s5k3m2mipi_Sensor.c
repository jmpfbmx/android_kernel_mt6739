...
#define LOG_2 \
LOG_INF("preview 2096*1552@30fps,1260Mbps/lane; video 4192*3104@30fps,1260Mbps/lane; capture 13M@30fps,1260Mbps/lane\n")
/* #define LOG_DBG(format, args...) xlog_printk(ANDROID_LOG_DEBUG ,PFX, "[%S] " format, __FUNCTION__, ##args) */

#define LOG_INF(fmt, args...)   pr_debug(PFX "[%s] " fmt, __func__, ##args)
#define LOGE(fmt, args...)   pr_debug(PFX "[%s] " fmt, __func__, ##args)
...
static SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
	...
	{4192, 3104, 720, 528, 2752, 2048, 688, 512, 0000, 0000, 688, 512, 0, 0, 688, 512},	/* hight video 120 */
...
static SET_PD_BLOCK_INFO_T imgsensor_pd_info = {
	...
	.i4SubBlkH = 16,
	.i4PosL = {
		{20, 23}, {72, 23}, {36, 27}, {56, 27}, {24, 43}, {68, 43}, {40, 47}, {52, 47},
		{40, 55}, {52, 55}, {24, 59}, {68, 59}, {36, 75}, {56, 75}, {20, 79}, {72, 79}
	},
	.i4PosR = {
		{20, 27}, {72, 27}, {36, 31}, {56, 31}, {24, 39}, {68, 39}, {40, 43}, {52, 43},
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PDAF_DATA:
		...
		read_3m2_eeprom((kal_uint16) (*feature_data),
