...
#define LOG_2 LOG_INF("pre 1280*960@30fps,864Mbps; vid 1280*960@30fps,864Mbps; cap 5M@30fps,864Mbps\n")
...
static imgsensor_info_struct imgsensor_info = {
	...
	/*SENSOR_OUTPUT_FORMAT_RAW_B, SENSOR_OUTPUT_FORMAT_RAW_Gr,*/
	.mclk = 24,
...
static void set_shutter_frame_length(kal_uint16 shutter, kal_uint16 frame_length)
{
	...
	/* Update Shutter */
	/*/write_cmos_sensor(0x0104, 0x01);*/ /*roup hold*/
	write_cmos_sensor(0x0202, shutter >> 8);
	write_cmos_sensor(0x0203, shutter & 0xFF);
	/*write_cmos_sensor(0x0104, 0x00);*/ /*group hold*/
