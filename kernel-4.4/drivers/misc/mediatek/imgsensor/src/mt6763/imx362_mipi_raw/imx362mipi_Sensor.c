...
static imgsensor_info_struct imgsensor_info = {
	.sensor_id = IMX362_SENSOR_ID,	/* IMX362MIPI_SENSOR_ID, record sensor id defined in kd_imgsensor.h */
	...
	.i2c_addr_table = {0x21, 0x34, 0xff},	/* record sensor support all write id addr,
...
static kal_uint16 imx362_type;	/*0x00=HDR type, 0x10=binning type */
...
static SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
	...
	{4032, 2272, 0, 0, 4032, 2272, 4032, 2272, 0000, 0000, 4032, 2272, 0, 0, 4032, 2272}
};				/* slim video */
	...
	if (write_cmos_sensor(0x0A02, 0x7F) == 0) {
		...
		while (retry--) {
			if (read_cmos_sensor(0x0A01) == 0x01) {
				...
				return (kal_uint16) ((read_cmos_sensor(0x0A24) << 4) |
						     (read_cmos_sensor(0x0A25) >> 4));
			}
		}
	}
...
static void preview_setting(void)
{
	...
	LOG_INF("preview E %ld %ld %ld\n", sizeof(preview_setting_array), sizeof(i2c_write_array),
		sizeof(preview_setting_array) / sizeof(i2c_write_array));
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PDAF_DATA:
		...
		/* read_IMX362_eeprom((kal_uint16 )(*feature_data),
