...
static struct task_struct *vendor_init_task;
...
{ 5184,  3880,  0,  0,  5184,  3880,  2592,  1940,  0000,  0000,  2592,  1940,  0,  0,  2592,  1940},/*Preview*/
#if USE_REMOSAIC
{ 5184,  3880,  0,  0,  5184,  3880,  5184,  3880,  0000,  0000,  5184,  3880,  0,  0,  5184,  3880}, /* remosic*/
#else
{ 2592,  1940,  0,  0,  2592,  1940,  2592,  1940,  0000,  0000,  2592,  1940,  0,  0,  2592,  1940}, /* capture*/
#endif
{ 5184,  3880,  0,  0,  5184,  3880,  2592,  1940,  0000,  0000,  2592,  1940,  0,  0,  2592,  1940}, /* video */
{ 5184,  3880,  0,  0,  5184,  3880,  2592,  1940,  0000,  0000,  2592,  1940,  0,  0,  2592,  1940}, /*hs video*/
{ 5184,  3880,  0,  0,  5184,  3880,  2592,  1940,  0000,  0000,  2592,  1940,  0,  0,  2592,  1940}, /* slim video*/
};
...
static void sensor_init(void)
{
	...
	write_cmos_sensor_8(0x3C7E, 0x02);
	write_cmos_sensor_8(0x3C7F, 0x06);
	...
	write_cmos_sensor_8(0x6204, 0xC6);
	write_cmos_sensor_8(0x620E, 0x27);
	write_cmos_sensor_8(0x6210, 0x69);
	write_cmos_sensor_8(0x6211, 0xD6);
	write_cmos_sensor_8(0x6213, 0x01);
	write_cmos_sensor_8(0x6215, 0x5A);
	write_cmos_sensor_8(0x6216, 0x75);
	write_cmos_sensor_8(0x6218, 0x5A);
	write_cmos_sensor_8(0x6219, 0x75);
	write_cmos_sensor_8(0x6220, 0x06);
	...
	write_cmos_sensor_8(0x622E, 0xB0);
	write_cmos_sensor_8(0x6231, 0x71);
	write_cmos_sensor_8(0x6234, 0x06);
	write_cmos_sensor_8(0x6236, 0x46);
	write_cmos_sensor_8(0x6237, 0x46);
	write_cmos_sensor_8(0x6239, 0x0C);
	write_cmos_sensor_8(0x623C, 0x19);
	write_cmos_sensor_8(0x623F, 0x32);
	write_cmos_sensor_8(0x6240, 0x71);
	write_cmos_sensor_8(0x6242, 0x64);
	write_cmos_sensor_8(0x6243, 0x44);
	write_cmos_sensor_8(0x6245, 0xB0);
	write_cmos_sensor_8(0x6246, 0xA8);
	write_cmos_sensor_8(0x6248, 0x71);
	write_cmos_sensor_8(0x624B, 0x06);
	write_cmos_sensor_8(0x624D, 0x46);
	write_cmos_sensor_8(0x625C, 0xC9);
	write_cmos_sensor_8(0x625F, 0x92);
	write_cmos_sensor_8(0x6262, 0x26);
	write_cmos_sensor_8(0x6264, 0x46);
	write_cmos_sensor_8(0x6265, 0x46);
	...
	write_cmos_sensor_8(0x6271, 0x68);
	write_cmos_sensor_8(0x6273, 0xC8);
	write_cmos_sensor_8(0x6276, 0x91);
	write_cmos_sensor_8(0x6279, 0x27);
	write_cmos_sensor_8(0x627B, 0x46);
	write_cmos_sensor_8(0x627C, 0x55);
	write_cmos_sensor_8(0x627F, 0x95);
	write_cmos_sensor_8(0x6282, 0x84);
	write_cmos_sensor_8(0x6283, 0x40);
	write_cmos_sensor_8(0x6284, 0x00);
	write_cmos_sensor_8(0x6285, 0x00);
	write_cmos_sensor_8(0x6286, 0x08);
	write_cmos_sensor_8(0x6287, 0xC0);
	write_cmos_sensor_8(0x6288, 0x00);
	write_cmos_sensor_8(0x6289, 0x00);
	write_cmos_sensor_8(0x628A, 0x1B);
	write_cmos_sensor_8(0x628B, 0x80);
	write_cmos_sensor_8(0x628C, 0x20);
	write_cmos_sensor_8(0x628E, 0x35);
	write_cmos_sensor_8(0x628F, 0x00);
	write_cmos_sensor_8(0x6290, 0x50);
	write_cmos_sensor_8(0x6291, 0x00);
	write_cmos_sensor_8(0x6292, 0x14);
	write_cmos_sensor_8(0x6293, 0x00);
	write_cmos_sensor_8(0x6294, 0x00);
	write_cmos_sensor_8(0x6296, 0x54);
	write_cmos_sensor_8(0x6297, 0x00);
	write_cmos_sensor_8(0x6298, 0x00);
	write_cmos_sensor_8(0x6299, 0x01);
	write_cmos_sensor_8(0x629A, 0x10);
	write_cmos_sensor_8(0x629B, 0x01);
	write_cmos_sensor_8(0x629C, 0x00);
	write_cmos_sensor_8(0x629D, 0x03);
	write_cmos_sensor_8(0x629E, 0x50);
	write_cmos_sensor_8(0x629F, 0x05);
	write_cmos_sensor_8(0x62A0, 0x00);
	write_cmos_sensor_8(0x62B1, 0x00);
	write_cmos_sensor_8(0x62B2, 0x00);
	write_cmos_sensor_8(0x62B3, 0x00);
	write_cmos_sensor_8(0x62B5, 0x00);
	write_cmos_sensor_8(0x62B6, 0x00);
	write_cmos_sensor_8(0x62B7, 0x00);
	write_cmos_sensor_8(0x62B8, 0x00);
	write_cmos_sensor_8(0x62B9, 0x00);
	write_cmos_sensor_8(0x62BA, 0x00);
	write_cmos_sensor_8(0x62BB, 0x00);
	write_cmos_sensor_8(0x62BC, 0x00);
	write_cmos_sensor_8(0x62BD, 0x00);
	write_cmos_sensor_8(0x62BE, 0x00);
	write_cmos_sensor_8(0x62BF, 0x00);
	write_cmos_sensor_8(0x62D0, 0x0C);
	write_cmos_sensor_8(0x62D1, 0x00);
	write_cmos_sensor_8(0x62D2, 0x00);
	write_cmos_sensor_8(0x62D4, 0x40);
	write_cmos_sensor_8(0x62D5, 0x00);
	write_cmos_sensor_8(0x62D6, 0x00);
	write_cmos_sensor_8(0x62D7, 0x00);
	write_cmos_sensor_8(0x62D8, 0xD8);
	write_cmos_sensor_8(0x62D9, 0x00);
	write_cmos_sensor_8(0x62DA, 0x00);
	write_cmos_sensor_8(0x62DB, 0x02);
	write_cmos_sensor_8(0x62DC, 0xB0);
	write_cmos_sensor_8(0x62DD, 0x03);
	write_cmos_sensor_8(0x62DE, 0x00);
	write_cmos_sensor_8(0x62EF, 0x14);
	write_cmos_sensor_8(0x62F0, 0x00);
	write_cmos_sensor_8(0x62F1, 0x00);
	write_cmos_sensor_8(0x62F3, 0x58);
	write_cmos_sensor_8(0x62F4, 0x00);
	write_cmos_sensor_8(0x62F5, 0x00);
	write_cmos_sensor_8(0x62F6, 0x01);
	write_cmos_sensor_8(0x62F7, 0x20);
	write_cmos_sensor_8(0x62F8, 0x00);
	write_cmos_sensor_8(0x62F9, 0x00);
	write_cmos_sensor_8(0x62FA, 0x03);
	write_cmos_sensor_8(0x62FB, 0x80);
	write_cmos_sensor_8(0x62FC, 0x00);
	write_cmos_sensor_8(0x62FD, 0x00);
	write_cmos_sensor_8(0x62FE, 0x04);
	write_cmos_sensor_8(0x62FF, 0x60);
	write_cmos_sensor_8(0x6300, 0x04);
	write_cmos_sensor_8(0x6301, 0x00);
	write_cmos_sensor_8(0x6302, 0x09);
	write_cmos_sensor_8(0x6303, 0x00);
	write_cmos_sensor_8(0x6304, 0x0C);
	write_cmos_sensor_8(0x6305, 0x00);
	write_cmos_sensor_8(0x6306, 0x1B);
	write_cmos_sensor_8(0x6307, 0x80);
	write_cmos_sensor_8(0x6308, 0x30);
	write_cmos_sensor_8(0x630A, 0x38);
	write_cmos_sensor_8(0x630B, 0x00);
	write_cmos_sensor_8(0x630C, 0x60);
	write_cmos_sensor_8(0x630E, 0x14);
	write_cmos_sensor_8(0x630F, 0x00);
	write_cmos_sensor_8(0x6310, 0x00);
	write_cmos_sensor_8(0x6312, 0x58);
	write_cmos_sensor_8(0x6313, 0x00);
	write_cmos_sensor_8(0x6314, 0x00);
	write_cmos_sensor_8(0x6315, 0x01);
	write_cmos_sensor_8(0x6316, 0x18);
	write_cmos_sensor_8(0x6317, 0x01);
	write_cmos_sensor_8(0x6318, 0x80);
	write_cmos_sensor_8(0x6319, 0x03);
	write_cmos_sensor_8(0x631A, 0x60);
	write_cmos_sensor_8(0x631B, 0x06);
	write_cmos_sensor_8(0x631C, 0x00);
	write_cmos_sensor_8(0x632D, 0x0E);
	write_cmos_sensor_8(0x632E, 0x00);
	write_cmos_sensor_8(0x632F, 0x00);
	write_cmos_sensor_8(0x6331, 0x44);
	write_cmos_sensor_8(0x6332, 0x00);
	write_cmos_sensor_8(0x6333, 0x00);
	write_cmos_sensor_8(0x6334, 0x00);
	write_cmos_sensor_8(0x6335, 0xE8);
	write_cmos_sensor_8(0x6336, 0x00);
	write_cmos_sensor_8(0x6337, 0x00);
	write_cmos_sensor_8(0x6338, 0x02);
	write_cmos_sensor_8(0x6339, 0xF0);
	write_cmos_sensor_8(0x633A, 0x00);
	write_cmos_sensor_8(0x633B, 0x00);
	write_cmos_sensor_8(0x634C, 0x0C);
	write_cmos_sensor_8(0x634D, 0x00);
	write_cmos_sensor_8(0x634E, 0x00);
	write_cmos_sensor_8(0x6350, 0x40);
	write_cmos_sensor_8(0x6351, 0x00);
	write_cmos_sensor_8(0x6352, 0x00);
	write_cmos_sensor_8(0x6353, 0x00);
	write_cmos_sensor_8(0x6354, 0xD8);
	write_cmos_sensor_8(0x6355, 0x00);
	write_cmos_sensor_8(0x6356, 0x00);
	write_cmos_sensor_8(0x6357, 0x02);
	write_cmos_sensor_8(0x6358, 0xB0);
	write_cmos_sensor_8(0x6359, 0x04);
	write_cmos_sensor_8(0x635A, 0x00);
	write_cmos_sensor_8(0x636B, 0x00);
	write_cmos_sensor_8(0x636C, 0x00);
	write_cmos_sensor_8(0x636D, 0x00);
	write_cmos_sensor_8(0x636F, 0x00);
	write_cmos_sensor_8(0x6370, 0x00);
	write_cmos_sensor_8(0x6371, 0x00);
	write_cmos_sensor_8(0x6372, 0x00);
	write_cmos_sensor_8(0x6373, 0x00);
	write_cmos_sensor_8(0x6374, 0x00);
	write_cmos_sensor_8(0x6375, 0x00);
	write_cmos_sensor_8(0x6376, 0x00);
	write_cmos_sensor_8(0x6377, 0x00);
	write_cmos_sensor_8(0x6378, 0x00);
	write_cmos_sensor_8(0x6379, 0x00);
	write_cmos_sensor_8(0x637A, 0x13);
	...
	write_cmos_sensor_8(0x9004, 0x0D);
	...
	write_cmos_sensor_8(0x9208, 0x62);
	write_cmos_sensor_8(0x9209, 0x2C);
	write_cmos_sensor_8(0x920A, 0x62);
	write_cmos_sensor_8(0x920B, 0x2F);
	write_cmos_sensor_8(0x920C, 0x6A);
	write_cmos_sensor_8(0x920D, 0x23);
	write_cmos_sensor_8(0x920E, 0x71);
	write_cmos_sensor_8(0x920F, 0x08);
	write_cmos_sensor_8(0x9210, 0x71);
	write_cmos_sensor_8(0x9211, 0x09);
	write_cmos_sensor_8(0x9212, 0x71);
	write_cmos_sensor_8(0x9213, 0x0B);
	write_cmos_sensor_8(0x9214, 0x6A);
	write_cmos_sensor_8(0x9215, 0x0F);
	write_cmos_sensor_8(0x9216, 0x71);
	write_cmos_sensor_8(0x9217, 0x07);
	write_cmos_sensor_8(0x9218, 0x71);
	write_cmos_sensor_8(0x9219, 0x03);
	...
	write_cmos_sensor_8(0x9395, 0x65);
	write_cmos_sensor_8(0x9397, 0x5A);
	write_cmos_sensor_8(0x9399, 0x05);
	write_cmos_sensor_8(0x939B, 0x05);
	write_cmos_sensor_8(0x939D, 0x05);
	write_cmos_sensor_8(0x939F, 0x05);
	write_cmos_sensor_8(0x93A1, 0x05);
	write_cmos_sensor_8(0x93A3, 0x05);
	write_cmos_sensor_8(0xB3F1, 0x80);
	write_cmos_sensor_8(0xB3F2, 0x0E);
	write_cmos_sensor_8(0xBC40, 0x03);
	write_cmos_sensor_8(0xBC82, 0x07);
	write_cmos_sensor_8(0xBC83, 0xB0);
	write_cmos_sensor_8(0xBC84, 0x0D);
	write_cmos_sensor_8(0xBC85, 0x08);
	write_cmos_sensor_8(0xE0A6, 0x0A);
...
static void preview_setting(void)
{
	...
	write_cmos_sensor_8(0x0342, 0x1B);
	write_cmos_sensor_8(0x0343, 0x40);
	write_cmos_sensor_8(0x0340, 0x07);
	write_cmos_sensor_8(0x0341, 0xD4);
	...
	write_cmos_sensor_8(0x0348, 0x14);
	write_cmos_sensor_8(0x0349, 0x3F);
	write_cmos_sensor_8(0x034A, 0x0F);
	...
	write_cmos_sensor_8(0x040C, 0x0A);
	write_cmos_sensor_8(0x040D, 0x20);
	write_cmos_sensor_8(0x040E, 0x07);
	write_cmos_sensor_8(0x040F, 0x94);
	write_cmos_sensor_8(0x034C, 0x0A);
	write_cmos_sensor_8(0x034D, 0x20);
	write_cmos_sensor_8(0x034E, 0x07);
	write_cmos_sensor_8(0x034F, 0x94);
	...
	write_cmos_sensor_8(0x0820, 0x09);
	write_cmos_sensor_8(0x0821, 0xC4);
	...
	write_cmos_sensor_8(0x3C00, 0x74);
	write_cmos_sensor_8(0x3C01, 0x5F);
	write_cmos_sensor_8(0x3C02, 0x73);
	write_cmos_sensor_8(0x3C03, 0x64);
	write_cmos_sensor_8(0x3C04, 0x54);
	write_cmos_sensor_8(0x3C05, 0xA8);
	write_cmos_sensor_8(0x3C06, 0xE4);
	write_cmos_sensor_8(0x3C07, 0x00);
	write_cmos_sensor_8(0x3C08, 0x00);
	write_cmos_sensor_8(0x3C09, 0x01);
	write_cmos_sensor_8(0x3C0A, 0x14);
	write_cmos_sensor_8(0x3C0B, 0x01);
	...
	write_cmos_sensor_8(0x3F78, 0x04);
	write_cmos_sensor_8(0x3F79, 0x74);
	write_cmos_sensor_8(0x3F7A, 0x04);
	write_cmos_sensor_8(0x3F7B, 0x24);
	write_cmos_sensor_8(0x562B, 0x0A);
	write_cmos_sensor_8(0x562D, 0x0C);
	write_cmos_sensor_8(0x5617, 0x0A);
	write_cmos_sensor_8(0x9104, 0x04);
...
static void capture_setting(kal_uint16 currefps, kal_bool stream_on)
{
	...
	write_cmos_sensor_8(0x0343, 0x40);
	write_cmos_sensor_8(0x0340, 0x15);
	write_cmos_sensor_8(0x0341, 0x04);
	write_cmos_sensor_8(0x0344, 0x00);
	write_cmos_sensor_8(0x0345, 0x00);
	write_cmos_sensor_8(0x0346, 0x00);
	write_cmos_sensor_8(0x0347, 0x00);
	...
	write_cmos_sensor_8(0x040A, 0x00);
	write_cmos_sensor_8(0x040B, 0x00);
	write_cmos_sensor_8(0x040C, 0x14);
	write_cmos_sensor_8(0x040D, 0x40);
	write_cmos_sensor_8(0x040E, 0x0F);
	write_cmos_sensor_8(0x040F, 0x28);
	write_cmos_sensor_8(0x034C, 0x14);
	write_cmos_sensor_8(0x034D, 0x40);
	write_cmos_sensor_8(0x034E, 0x0F);
	write_cmos_sensor_8(0x034F, 0x28);
	write_cmos_sensor_8(0x0301, 0x05);
	write_cmos_sensor_8(0x0303, 0x02);
	write_cmos_sensor_8(0x0305, 0x04);
	write_cmos_sensor_8(0x0306, 0x01);
	write_cmos_sensor_8(0x0307, 0x4E);
	write_cmos_sensor_8(0x030B, 0x01);
	write_cmos_sensor_8(0x030D, 0x0C);
	write_cmos_sensor_8(0x030E, 0x03);
	write_cmos_sensor_8(0x030F, 0x84);
	write_cmos_sensor_8(0x0310, 0x01);
	write_cmos_sensor_8(0x0820, 0x1C);
	write_cmos_sensor_8(0x0821, 0x20);
	write_cmos_sensor_8(0x0822, 0x00);
	write_cmos_sensor_8(0x0823, 0x00);
	write_cmos_sensor_8(0xBC41, 0x01);
	write_cmos_sensor_8(0x0106, 0x00);
	...
	write_cmos_sensor_8(0x3C01, 0x4A);
	write_cmos_sensor_8(0x3C02, 0x73);
	write_cmos_sensor_8(0x3C03, 0x64);
	write_cmos_sensor_8(0x3C04, 0x34);
	write_cmos_sensor_8(0x3C05, 0x88);
	write_cmos_sensor_8(0x3C06, 0xD2);
	write_cmos_sensor_8(0x3C07, 0x00);
	write_cmos_sensor_8(0x3C08, 0x00);
	write_cmos_sensor_8(0x3C09, 0x01);
	write_cmos_sensor_8(0x3C0A, 0x14);
	write_cmos_sensor_8(0x3C0B, 0x01);
	write_cmos_sensor_8(0x3C0C, 0x01);
	write_cmos_sensor_8(0x3F14, 0x01);
	write_cmos_sensor_8(0x3F17, 0x00);
	write_cmos_sensor_8(0x3F3C, 0x01);
	write_cmos_sensor_8(0x3F78, 0x01);
	write_cmos_sensor_8(0x3F79, 0xF4);
	write_cmos_sensor_8(0x3F7A, 0x02);
	write_cmos_sensor_8(0x3F7B, 0xDA);
	write_cmos_sensor_8(0x562B, 0x32);
	write_cmos_sensor_8(0x562D, 0x34);
	write_cmos_sensor_8(0x5617, 0x32);
	write_cmos_sensor_8(0x9104, 0x04);
	write_cmos_sensor_8(0x0202, 0x14);
	write_cmos_sensor_8(0x0203, 0xF0);
	write_cmos_sensor_8(0x0204, 0x00);
	write_cmos_sensor_8(0x0205, 0x00);
	write_cmos_sensor_8(0x020E, 0x01);
	write_cmos_sensor_8(0x020F, 0x00);
...
/* Add by LiuBin for register device info at 20160616 */
		if (deviceInfo_register_value == 0x00) {
			register_imgsensor_deviceinfo("Cam_f", DEVICE_VERSION_IMX376, imgsensor_info.module_id);
...
static kal_uint32 open(void)
{
	...
	LOG_INF("preview 1280*960@30fps,864Mbps/lane; video 1280*960@30fps,864Mbps/lane;\n");
