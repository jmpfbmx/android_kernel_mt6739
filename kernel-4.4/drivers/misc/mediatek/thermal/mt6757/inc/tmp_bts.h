...
#define BTS_TAP_OVER_CRITICAL_LOW	4251000		/* base on 100K NTC temp default value -40 deg */
#define BTS_RAP_PULL_UP_VOLTAGE		1800		/* 1.8V ,pull up voltage */
#define BTS_RAP_NTC_TABLE		6		/* default is NTCG104EF104F(100K) */
#define BTS_RAP_ADC_CHANNEL		AUX_IN0_NTC	/* default is 0 */

#define BTSMDPA_RAP_PULL_UP_R		390000		/* 390K,pull up resister */
#define BTSMDPA_TAP_OVER_CRITICAL_LOW	4251000		/* base on 100K NTC temp default value -40 deg */
#define BTSMDPA_RAP_PULL_UP_VOLTAGE	1800		/* 1.8V ,pull up voltage */
#define BTSMDPA_RAP_NTC_TABLE		6		/* default is NTCG104EF104F(100K) */
