...
int bts_cur_temp = 1;
int AP_temperature;/*Added by rongxiao.deng for task 5860212 on 2018.01.08*/
...
int mtkts_bts_get_hw_temp(void)
{
	...
	AP_temperature = t_ret;/*Added by rongxiao.deng for task 5860212 on 2018.01.08*/
	pr_info("%s: AP_temperature=%d .\n", __func__,AP_temperature);	//added by shiqiang.chen.hz on 20180125, add get_hw_bts_temp log
	t_ret = t_ret * 1000;
