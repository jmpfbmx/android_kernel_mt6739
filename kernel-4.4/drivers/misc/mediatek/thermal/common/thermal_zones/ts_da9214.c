...
static int tsda9214_bind(struct thermal_zone_device *thermal, struct thermal_cooling_device *cdev)
{
	...
	if (mtk_thermal_zone_bind_cooling_device(thermal, table_val, cdev)) {
		tsda9214_dprintk("[tsda9214_bind] error binding cooling dev\n");
		return -EINVAL;
	}

	tsda9214_dprintk("[tsda9214_bind] binding OK, %d\n", table_val);
	return 0;
}
			    ...
			    struct thermal_cooling_device *cdev)
{
	...
	tsda9214_dprintk("[tsda9214_unbind] unbinding OK\n");
	return 0;
}
...
static int tsda9214_register_thermal(void)
{
	tsda9214_dprintk("[tsda9214_register_thermal]\n");
...
static void tsda9214_unregister_thermal(void)
{
	tsda9214_dprintk("[tsda9214_unregister_thermal]\n");
...
static int __init tsda9214_init(void)
{
	...
	tsda9214_dprintk("tsda9214_init: Start\n");

	/* return 1 means with 6311, else return 0 */
	if (is_da9214_exist() == 0) {
		tsda9214_dprintk("tsda9214_init: Buck is not exist\n");
		return err;
	}
...
{
	tsda9214_dprintk("[tsda9214_exit]\n");
	tsda9214_unregister_thermal();
	tsda9214_unregister_cooler();
}
