...
{
//task5424643 added by jia.zhang for usb2uart flag control start
    if(!oem_enable_uart) {
        in_uart_mode = false;
        return false;
    }
//task5424643 added by jia.zhang for usb2uart flag control end
...
int usb2jtag_usb_init(void)
{
	...
	node = of_find_compatible_node(NULL, NULL, "mediatek,mt6739-usb20");
	if (!node) {
...
//Begin added by zhanyong.yin for XR5424731 on 2017/10/23
    USBPHY_CLR32(0x4, 0x100);
	USBPHY_SET32(0x4, 0x600);
	USBPHY_CLR32(0x4, 0x1000);
	USBPHY_SET32(0x4, 0x6000);
//End added by zhanyong.yin for XR5424731 on 2017/10/23
