...
/*      Address Mask    Golden Setting Value */
	...
	0x1092, 0x0004, 0x0004,/* BUCK_VGPU_OP_CFG */
	...
	0x1730, 0x0003, 0x0000,/* LDO_VMIPI_CON0 */
	0x1732, 0x000F, 0x0001,/* LDO_VMIPI_OP_EN */
	...
	0x17AA, 0x0003, 0x0000,/* LDO_VTCXO24_CON0 */
	0x17AC, 0x000F, 0x0001,/* LDO_VTCXO24_OP_EN */
	...
	0x18F2, 0x000A, 0x0002,/* LDO_VSRAM_GPU_OP_EN */
	0x18F8, 0x0002, 0x0002,/* LDO_VSRAM_GPU_OP_CFG */
	0x1908, 0x0001, 0x0000,/* LDO_VSRAM_MD_CON0 */
	0x1912, 0x0002, 0x0000,/* LDO_VSRAM_MD_OP_EN */
	0x2000, 0x3FF8, 0x06D8,/* DCXO_CW00 */
	0x2008, 0x0003, 0x0001,/* DCXO_CW02 */
	0x201A, 0x3F00, 0x0000,/* DCXO_CW11 */
	0x3370, 0x0001, 0x0001,/* AUXADC_IMP_CG0 */
...
const unsigned int *AP_PMIC_REG_gs_suspend = AP_PMIC_REG_gs_suspend_data;

unsigned int AP_PMIC_REG_gs_suspend_len = 315;
...
/*      Address Mask    Golden Setting Value */
	...
	0x1690, 0x0001, 0x0001,/* LDO_VEMC_CON0 */
...
unsigned int AP_PMIC_REG_gs_deepidle___lp_mp3_32kless_len = 312;

const unsigned int AP_PMIC_REG_gs_sodi3p0_data[] = {
/*      Address Mask    Golden Setting Value */
	0x0400, 0x0008, 0x0008,/* TOP_CKPDN_CON0 */
	0x040C, 0x0032, 0x0032,/* TOP_CKPDN_CON2 */
	0x0412, 0x0024, 0x0020,/* TOP_CKPDN_CON3 */
...
const unsigned int *AP_PMIC_REG_gs_sodi3p0 = AP_PMIC_REG_gs_sodi3p0_data;

unsigned int AP_PMIC_REG_gs_sodi3p0_len = 318;

const unsigned int AP_PMIC_REG_gs_deepidle___lp_mp3_data[] = {
/*      Address Mask    Golden Setting Value */
	0x0400, 0x0008, 0x0008,/* TOP_CKPDN_CON0 */
	0x040C, 0x0032, 0x0032,/* TOP_CKPDN_CON2 */
	0x0412, 0x0024, 0x0020,/* TOP_CKPDN_CON3 */
...
const unsigned int *AP_PMIC_REG_gs_deepidle___lp_mp3 = AP_PMIC_REG_gs_deepidle___lp_mp3_data;

unsigned int AP_PMIC_REG_gs_deepidle___lp_mp3_len = 312;
...
unsigned int AP_PMIC_REG_gs_sodi3p0_32kless_len = 318;
...
unsigned int AP_PMIC_REG_gs_suspend_32kless_len = 315;
