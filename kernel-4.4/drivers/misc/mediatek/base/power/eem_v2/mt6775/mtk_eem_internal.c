...
struct eem_det eem_detector_cci = {
		...
		.VBOOT		= CPU_CCI_VBOOT_VAL, /* 10uV */
		.VMAX		= CPU_CCI_VMAX_VAL,
		.VMIN		= CPU_CCI_VMIN_VAL,
...
struct eem_det eem_detectors[NR_EEM_DET] = {
	...
	[EEM_DET_B] = {
		...
		.ctrl_id	= EEM_CTRL_B,
		.features	= FEA_INIT01 | FEA_INIT02 | FEA_MON,
		.max_freq_khz	= 2483000,
		.VBOOT		= CPU_B_VBOOT_VAL, /* 10uV */
		.VMAX		= CPU_B_VMAX_VAL,
		.VMIN		= CPU_B_VMIN_VAL,
		.eem_v_base	= EEM_V_BASE,
		.eem_step	= EEM_STEP,
