...
#define EEMEN_MODE_DISABLE	(0x00000000)
#define EEMEN_MODE_INIT1	(0x00000001)
#define EEMEN_MODE_MONITOR	(0x00000002)
#define EEMEN_MODE_INIT2	(0x00000005)

#define EEMEN_MODE_SECURE_0	(0x00000000)
#define EEMEN_MODE_SECURE_1	(0x00000010)
#define EEMEN_MODE_SECURE_2	(0x00000020)
#define EEMEN_MODE_SECURE_3	(0x00000030)
#define EEMEN_MODE_SECURE_4	(0x00000040)
#define EEMEN_MODE_SECURE_NONE	(0x000000F0)
...
#define EEM_CTL0_THERMAL_MUX_EN0		(BIT(0))
#define EEM_CTL0_THERMAL_MUX_EN1		(BIT(1))
#define EEM_CTL0_THERMAL_MUX_EN2		(BIT(2))
#define EEM_CTL0_THERMAL_MUX_EN3		(BIT(3))
