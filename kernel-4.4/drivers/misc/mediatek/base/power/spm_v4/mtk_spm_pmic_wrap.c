...
static struct pmic_wrap_setting pw = {
	...
	.set[PMIC_WRAP_PHASE_ALLINONE] = {
		._[CMD_0]    = {MT6356_BUCK_VCORE_ELR0, VOLT_TO_PMIC_VAL(70000),},
		._[CMD_1]    = {MT6356_BUCK_VCORE_ELR0, VOLT_TO_PMIC_VAL(80000),},
		._[CMD_2]    = {0, 0,},
		._[CMD_3]    = {0, 0,},
		._[CMD_4]    = {MT6356_LDO_VSRAM_CON3, _BITS_(14:8, VOLT_TO_PMIC_VAL(80000)),},
		._[CMD_5]    = {MT6356_LDO_VSRAM_CON3, _BITS_(14:8, VOLT_TO_PMIC_VAL(90000)),},
