...
static ssize_t show_pwr_ctrl(int id, const struct pwr_ctrl *pwrctrl, char *buf)
{
	...
	p += sprintf(p, "ccif2_md_event_mask_b = 0x%zx\n",
			mt_secure_call(MTK_SIP_KERNEL_SPM_GET_PWR_CTRL_ARGS,
				id, PWR_CCIF2_MD_EVENT_MASK_B, 0));
	p += sprintf(p, "ccif2_ap_event_mask_b = 0x%zx\n",
			mt_secure_call(MTK_SIP_KERNEL_SPM_GET_PWR_CTRL_ARGS,
				id, PWR_CCIF2_AP_EVENT_MASK_B, 0));
	p += sprintf(p, "ccif3_md_event_mask_b = 0x%zx\n",
			mt_secure_call(MTK_SIP_KERNEL_SPM_GET_PWR_CTRL_ARGS,
				id, PWR_CCIF3_MD_EVENT_MASK_B, 0));
	p += sprintf(p, "ccif3_ap_event_mask_b = 0x%zx\n",
			mt_secure_call(MTK_SIP_KERNEL_SPM_GET_PWR_CTRL_ARGS,
				id, PWR_CCIF3_AP_EVENT_MASK_B, 0));
	p += sprintf(p, "md_srcclkena_0_infra_mask_b = 0x%zx\n",
			mt_secure_call(MTK_SIP_KERNEL_SPM_GET_PWR_CTRL_ARGS,
				id, PWR_MD_SRCCLKENA_0_INFRA_MASK_B, 0));
	p += sprintf(p, "md_srcclkena_1_infra_mask_b = 0x%zx\n",
	...
	p += sprintf(p, "ddren_scp_apsrc_req_mask_b = 0x%zx\n",
			mt_secure_call(MTK_SIP_KERNEL_SPM_GET_PWR_CTRL_ARGS,
				id, PWR_DDREN_SCP_APSRC_REQ_MASK_B, 0));
	p += sprintf(p, "disp0_ddren_mask_b = 0x%zx\n",
			mt_secure_call(MTK_SIP_KERNEL_SPM_GET_PWR_CTRL_ARGS,
				id, PWR_DISP0_DDREN_MASK_B, 0));
	p += sprintf(p, "disp1_ddren_mask_b = 0x%zx\n",
			mt_secure_call(MTK_SIP_KERNEL_SPM_GET_PWR_CTRL_ARGS,
				id, PWR_DISP1_DDREN_MASK_B, 0));
	p += sprintf(p, "gce_ddren_mask_b = 0x%zx\n",
			mt_secure_call(MTK_SIP_KERNEL_SPM_GET_PWR_CTRL_ARGS,
				id, PWR_GCE_DDREN_MASK_B, 0));
	p += sprintf(p, "ddren_emi_self_refresh_ch0_mask_b = 0x%zx\n",
			mt_secure_call(MTK_SIP_KERNEL_SPM_GET_PWR_CTRL_ARGS,
				id, PWR_DDREN_EMI_SELF_REFRESH_CH0_MASK_B, 0));
	p += sprintf(p, "ddren_emi_self_refresh_ch1_mask_b = 0x%zx\n",
	...
	p += sprintf(p, "ddren2_scp_apsrc_req_mask_b = 0x%zx\n",
			mt_secure_call(MTK_SIP_KERNEL_SPM_GET_PWR_CTRL_ARGS,
				id, PWR_DDREN2_SCP_APSRC_REQ_MASK_B, 0));
	p += sprintf(p, "disp0_ddren2_mask_b = 0x%zx\n",
			mt_secure_call(MTK_SIP_KERNEL_SPM_GET_PWR_CTRL_ARGS,
				id, PWR_DISP0_DDREN2_MASK_B, 0));
	p += sprintf(p, "disp1_ddren2_mask_b = 0x%zx\n",
			mt_secure_call(MTK_SIP_KERNEL_SPM_GET_PWR_CTRL_ARGS,
				id, PWR_DISP1_DDREN2_MASK_B, 0));
	p += sprintf(p, "gce_ddren2_mask_b = 0x%zx\n",
			mt_secure_call(MTK_SIP_KERNEL_SPM_GET_PWR_CTRL_ARGS,
				id, PWR_GCE_DDREN2_MASK_B, 0));
	p += sprintf(p, "ddren2_emi_self_refresh_ch0_mask_b = 0x%zx\n",
			mt_secure_call(MTK_SIP_KERNEL_SPM_GET_PWR_CTRL_ARGS,
				id, PWR_DDREN2_EMI_SELF_REFRESH_CH0_MASK_B, 0));
	p += sprintf(p, "ddren2_emi_self_refresh_ch1_mask_b = 0x%zx\n",
	...
	p += sprintf(p, "mp1_cpu1_wfi_en = 0x%zx\n",
			mt_secure_call(MTK_SIP_KERNEL_SPM_GET_PWR_CTRL_ARGS,
				id, PWR_MP1_CPU1_WFI_EN, 0));
	/* MP1_CPU2_WFI_EN */
	p += sprintf(p, "mp1_cpu2_wfi_en = 0x%zx\n",
			mt_secure_call(MTK_SIP_KERNEL_SPM_GET_PWR_CTRL_ARGS,
				id, PWR_MP1_CPU2_WFI_EN, 0));
	/* MP0_CPU3_WFI_EN */
...
static ssize_t store_pwr_ctrl(int id, struct pwr_ctrl *pwrctrl, const char *buf, size_t count)
{
	...
	if (!strcmp(cmd, pwr_ctrl_str[PWR_PCM_FLAGS])) {
		...
		mt_secure_call(MTK_SIP_KERNEL_SPM_PWR_CTRL_ARGS,
				id, PWR_CONN_SRCCLKENA_SEL_MASK, val);
	} else if (!strcmp(cmd, pwr_ctrl_str[PWR_SPM_APSRC_REQ])) {
		pwrctrl->spm_apsrc_req = val;
		mt_secure_call(MTK_SIP_KERNEL_SPM_PWR_CTRL_ARGS,
				id, PWR_SPM_APSRC_REQ, val);
...
static ssize_t store_pwr_ctrl(int id, struct pwr_ctrl *pwrctrl, const char *buf, size_t count)
{
	...
	if (!strcmp(cmd, pwr_ctrl_str[PWR_PCM_FLAGS])) {
		...
		mt_secure_call(MTK_SIP_KERNEL_SPM_PWR_CTRL_ARGS,
				id, PWR_WDT_DISABLE, val);
	} else if (!strcmp(cmd, pwr_ctrl_str[PWR_WFI_OP])) { /* SPM_AP_STANDBY_CON */
		pwrctrl->wfi_op = val;
		mt_secure_call(MTK_SIP_KERNEL_SPM_PWR_CTRL_ARGS,
				id, PWR_WFI_OP, val);
	} else if (!strcmp(cmd, pwr_ctrl_str[PWR_MP0_CPUTOP_IDLE_MASK])) {
		...
		mt_secure_call(MTK_SIP_KERNEL_SPM_PWR_CTRL_ARGS,
				id, PWR_CONN_APSRC_SEL, val);
	} else if (!strcmp(cmd, pwr_ctrl_str[PWR_SPM_APSRC_REQ])) { /* SPM_SRC_REQ */
		pwrctrl->spm_apsrc_req = val;
		mt_secure_call(MTK_SIP_KERNEL_SPM_PWR_CTRL_ARGS,
				id, PWR_SPM_APSRC_REQ, val);
	} else if (!strcmp(cmd, pwr_ctrl_str[PWR_SPM_F26M_REQ])) {
		...
		mt_secure_call(MTK_SIP_KERNEL_SPM_PWR_CTRL_ARGS,
				id, PWR_CPU_MD_DVFS_SOP_FORCE_ON, val);
	} else if (!strcmp(cmd, pwr_ctrl_str[PWR_CSYSPWREQ_MASK])) { /* SPM_SRC_MASK */
		pwrctrl->csyspwreq_mask = val;
		mt_secure_call(MTK_SIP_KERNEL_SPM_PWR_CTRL_ARGS,
			id, PWR_CSYSPWREQ_MASK, val);
	} else if (!strcmp(cmd, pwr_ctrl_str[PWR_CCIF0_MD_EVENT_MASK_B])) {
		...
		mt_secure_call(MTK_SIP_KERNEL_SPM_PWR_CTRL_ARGS,
				id, PWR_UFS_INFRA_REQ_MASK_B, val);
	} else if (!strcmp(cmd, pwr_ctrl_str[PWR_SRCCLKENI_INFRA_MASK_B])) {
		pwrctrl->srcclkeni_infra_mask_b = val;
		mt_secure_call(MTK_SIP_KERNEL_SPM_PWR_CTRL_ARGS,
				id, PWR_SRCCLKENI_INFRA_MASK_B, val);
		...
		mt_secure_call(MTK_SIP_KERNEL_SPM_PWR_CTRL_ARGS,
				id, PWR_VDEC_REQ_MASK_B, val);
	} else if (!strcmp(cmd, pwr_ctrl_str[PWR_MD_DDR_EN_0_MASK_B])) { /* SPM_SRC2_MASK */
		pwrctrl->md_ddr_en_0_mask_b = val;
		mt_secure_call(MTK_SIP_KERNEL_SPM_PWR_CTRL_ARGS,
				id, PWR_MD_DDR_EN_0_MASK_B, val);
	} else if (!strcmp(cmd, pwr_ctrl_str[PWR_MD_DDR_EN_1_MASK_B])) {
		...
		mt_secure_call(MTK_SIP_KERNEL_SPM_PWR_CTRL_ARGS,
				id, PWR_DDREN_EMI_SELF_REFRESH_CH1_MASK_B, val);
	} else if (!strcmp(cmd, pwr_ctrl_str[PWR_SPM_WAKEUP_EVENT_MASK])) { /* SPM_WAKEUP_EVENT_MASK */
		pwrctrl->spm_wakeup_event_mask = val;
		mt_secure_call(MTK_SIP_KERNEL_SPM_PWR_CTRL_ARGS,
				id, PWR_SPM_WAKEUP_EVENT_MASK, val);
	} else if (!strcmp(cmd, pwr_ctrl_str[PWR_SPM_WAKEUP_EVENT_EXT_MASK])) { /* SPM_WAKEUP_EVENT_EXT_MASK */
		pwrctrl->spm_wakeup_event_ext_mask = val;
		mt_secure_call(MTK_SIP_KERNEL_SPM_PWR_CTRL_ARGS,
				id, PWR_SPM_WAKEUP_EVENT_EXT_MASK, val);
	} else if (!strcmp(cmd, pwr_ctrl_str[PWR_MD_DDR_EN_2_0_MASK_B])) { /* SPM_SRC3_MASK */
		pwrctrl->md_ddr_en_2_0_mask_b = val;
		mt_secure_call(MTK_SIP_KERNEL_SPM_PWR_CTRL_ARGS,
				id, PWR_MD_DDR_EN_2_0_MASK_B, val);
	} else if (!strcmp(cmd, pwr_ctrl_str[PWR_MD_DDR_EN_2_1_MASK_B])) {
		...
		mt_secure_call(MTK_SIP_KERNEL_SPM_PWR_CTRL_ARGS,
				id, PWR_DDREN2_EMI_SELF_REFRESH_CH1_MASK_B, val);
	} else if (!strcmp(cmd, pwr_ctrl_str[PWR_MP0_CPU0_WFI_EN])) { /* MP0_CPU0_WFI_EN */
		pwrctrl->mp0_cpu0_wfi_en = val;
		mt_secure_call(MTK_SIP_KERNEL_SPM_PWR_CTRL_ARGS,
				id, PWR_MP0_CPU0_WFI_EN, val);
	} else if (!strcmp(cmd, pwr_ctrl_str[PWR_MP0_CPU1_WFI_EN])) { /* MP0_CPU1_WFI_EN */
		pwrctrl->mp0_cpu1_wfi_en = val;
		mt_secure_call(MTK_SIP_KERNEL_SPM_PWR_CTRL_ARGS,
				id, PWR_MP0_CPU1_WFI_EN, val);
	} else if (!strcmp(cmd, pwr_ctrl_str[PWR_MP0_CPU2_WFI_EN])) { /* MP0_CPU2_WFI_EN */
		pwrctrl->mp0_cpu2_wfi_en = val;
		mt_secure_call(MTK_SIP_KERNEL_SPM_PWR_CTRL_ARGS,
				id, PWR_MP0_CPU2_WFI_EN, val);
	} else if (!strcmp(cmd, pwr_ctrl_str[PWR_MP0_CPU3_WFI_EN])) { /* MP0_CPU3_WFI_EN */
		pwrctrl->mp0_cpu3_wfi_en = val;
		mt_secure_call(MTK_SIP_KERNEL_SPM_PWR_CTRL_ARGS,
				id, PWR_MP0_CPU3_WFI_EN, val);
	} else if (!strcmp(cmd, pwr_ctrl_str[PWR_MP1_CPU0_WFI_EN])) { /* MP1_CPU0_WFI_EN */
		pwrctrl->mp1_cpu0_wfi_en = val;
		mt_secure_call(MTK_SIP_KERNEL_SPM_PWR_CTRL_ARGS,
				id, PWR_MP1_CPU0_WFI_EN, val);
	} else if (!strcmp(cmd, pwr_ctrl_str[PWR_MP1_CPU1_WFI_EN])) { /* MP1_CPU1_WFI_EN */
		pwrctrl->mp1_cpu1_wfi_en = val;
		mt_secure_call(MTK_SIP_KERNEL_SPM_PWR_CTRL_ARGS,
				id, PWR_MP1_CPU1_WFI_EN, val);
	} else if (!strcmp(cmd, pwr_ctrl_str[PWR_MP1_CPU2_WFI_EN])) { /* MP1_CPU2_WFI_EN */
		pwrctrl->mp1_cpu2_wfi_en = val;
		mt_secure_call(MTK_SIP_KERNEL_SPM_PWR_CTRL_ARGS,
				id, PWR_MP1_CPU2_WFI_EN, val);
	} else if (!strcmp(cmd, pwr_ctrl_str[PWR_MP1_CPU3_WFI_EN])) { /* MP1_CPU3_WFI_EN */
		pwrctrl->mp1_cpu3_wfi_en = val;
		mt_secure_call(MTK_SIP_KERNEL_SPM_PWR_CTRL_ARGS,
				id, PWR_MP1_CPU3_WFI_EN, val);
	}
