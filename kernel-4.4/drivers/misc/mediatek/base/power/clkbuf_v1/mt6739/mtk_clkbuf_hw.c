...
{
// Begin added by shiqiang.chen.hz for task 5597245 on 20171117,add fc8180 dtv driver.
#ifdef CONFIG_FC8180_DTV
	clk_buf_ctrl_internal(CLK_BUF_NFC, true);
#else
// End added by shiqiang.chen.hz for task 5597245 on 20171117,add fc8180 dtv driver.
