...
extern int hps_get_cpu_num_base(enum hps_base_type type,
				unsigned int *little_cpu_ptr,
				unsigned int *big_cpu_ptr);

extern int hps_set_cpu_num_base(enum hps_base_type type,
				unsigned int little_cpu,
				unsigned int big_cpu);

extern int hps_get_cpu_num_limit(enum hps_limit_type type,
				 unsigned int *little_cpu_ptr,
				 unsigned int *big_cpu_ptr);

extern int hps_set_cpu_num_limit(enum hps_limit_type type,
				 unsigned int little_cpu,
				 unsigned int big_cpu);
