...
#define R12EXT_DVFSRC_ALL_STATE               (1U << 8)
#define R12EXT_DVFSRC_LEVEL_STATE_0           (1U << 9)
#define R12EXT_DVFSRC_LEVEL_STATE_1           (1U << 10)
#define R12EXT_DVFSRC_LEVEL_STATE_2           (1U << 11)
#define R12EXT_DVFSRC_LEVEL_STATE_3           (1U << 12)
#define R12EXT_DVFSRC_LEVEL_STATE_4           (1U << 13)
#define R12EXT_DVFSRC_LEVEL_STATE_5           (1U << 14)
#define R12EXT_DVFSRC_LEVEL_STATE_6           (1U << 15)
#define R12EXT_DDREN_WAKE                     (1U << 16)
#define R12EXT_DDREN_SLEEP                    (1U << 17)
...
#define R12EXT_DVFS_LEVEL0_STATE              (1U << 24)
#define R12EXT_DVFS_LEVEL1_STATE              (1U << 25)
#define R12EXT_DVFS_LEVEL2_STATE              (1U << 26)
#define R12EXT_DVFS_LEVEL3_STATE              (1U << 27)
#define R12EXT_DVFS_LEVEL4_STATE              (1U << 28)
...
#define R13_DVFSRC_LEVEL_STATE_6              (1U << 30)
#define R13_DVFSRC_ALL_STATE                  (1U << 31)
