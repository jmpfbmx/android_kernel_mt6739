...
#include "sleep_def_mt6763.h"
#include "pcm_def_mt6763.h"
...
#define UFS_SRCCLKENA_MASK_B_LSB            (1U << 20)      /* 1b */
#define UFS_VRF18_REQ_MASK_B_LSB            (1U << 21)      /* 1b */
...
#define SPM_SWINT_STA_LSB                   (1U << 4)       /* 10b */
...
#define UFS_SRAM_ISOINT_B_LSB               (1U << 10)      /* 1b */
#define UFS_SRAM_CKISO_LSB                  (1U << 11)      /* 1b */
