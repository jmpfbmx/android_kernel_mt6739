...
/* UDI pin mux ADDR */
/* 1. Write 0x1000_5330 = 0x30300000 to switch TCK, TMS pins */
/* 2. Write 0x1000_5340 = 0x00000333 to switch TDI, NTRST, TDO pins */
...
#define UDIPIN_UDI_MUX1_VALUE		(0x30300000)
