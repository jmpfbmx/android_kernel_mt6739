...
enum {
	...
	IDX_SP_VCORE_LPM,           /* 3 */
	IDX_SP_VCORE_ULPM,          /* 4 */
	IDX_SP_VCORE_RESERVE,       /* 5 */
	IDX_SP_VPROC_PWR_ON = 0xC,  /* C */
	IDX_SP_VPROC_SHUTDOWN,      /* D */
	NR_IDX_SP,
};
enum {
	...
	IDX_DI_VCORE_LPM,           /* 3 */
	IDX_DI_VCORE_ULPM,          /* 4 */
	IDX_DI_VCORE_RESERVE,       /* 5 */
	IDX_DI_SRCCLKEN_IN2_NORMAL, /* 6 */
	IDX_DI_SRCCLKEN_IN2_SLEEP,  /* 7 */
	IDX_DI_VPROC_NORMAL = 0xC,  /* C */
	IDX_DI_VPROC_SLEEP,         /* D */
	NR_IDX_DI,
};
