...
enum {
	PWR_STATUS_C2K_SHIFT = 6,
	PWR_STATUS_MD_SHIFT = 7,
	PWR_STATUS_CONN_SHIFT = 10
};

enum {
	PWR_STATUS_C2K	= (1 << PWR_STATUS_C2K_SHIFT),
	PWR_STATUS_MD	= (1 << PWR_STATUS_MD_SHIFT),
	PWR_STATUS_CONN	= (1 << PWR_STATUS_CONN_SHIFT),
};
