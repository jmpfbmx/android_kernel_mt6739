...
const PMU_FLAG_TABLE_ENTRY pmu_flags_table[] = {
	...
	PMIC_ENTRY(PMIC_TOP0_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_TOP0_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_TOP0_ESP),
	...
	PMIC_ENTRY(PMIC_TOP1_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_TOP1_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_TOP1_ESP),
	...
	PMIC_ENTRY(PMIC_RG_CLKSQ_IN_SEL_VA28),
	PMIC_ENTRY(PMIC_RG_CLKSQ_IN_SEL_VA28_SWCTRL),
	PMIC_ENTRY(PMIC_TOP_CLKSQ_RSV),
	PMIC_ENTRY(PMIC_DA_CLKSQ_EN_VA28),
	...
	PMIC_ENTRY(PMIC_DA_CLKSQ_EN_VDIG28),
	...
	PMIC_ENTRY(PMIC_RG_RTC_SEC_MDB_DCM_SW_EN),
	PMIC_ENTRY(PMIC_RG_RTC_SEC_MDB_DCM_SW_MODE),
	PMIC_ENTRY(PMIC_RG_RTC_MDB_DCM_SW_EN),
	PMIC_ENTRY(PMIC_RG_RTC_MDB_DCM_SW_MODE),
	...
	PMIC_ENTRY(PMIC_RG_DEB_EINT_AUD_CLK_MOSI),
	PMIC_ENTRY(PMIC_INT_EINT_CON5_SET),
	PMIC_ENTRY(PMIC_INT_EINT_CON5_CLR),
	...
	PMIC_ENTRY(PMIC_TOP1_ELR_LEN),
	PMIC_ENTRY(PMIC_RG_TOP1_RSV0),
	PMIC_ENTRY(PMIC_RG_TOP1_RSV1),
	PMIC_ENTRY(PMIC_EFUSE_OSC_MODE),
	PMIC_ENTRY(PMIC_TOPA0_ANA_ID),
	PMIC_ENTRY(PMIC_TOPA0_DIG_ID),
	PMIC_ENTRY(PMIC_TOPA0_ANA_MINOR_REV),
	PMIC_ENTRY(PMIC_TOPA0_ANA_MAJOR_REV),
	PMIC_ENTRY(PMIC_TOPA0_DIG_MINOR_REV),
	PMIC_ENTRY(PMIC_TOPA0_DIG_MAJOR_REV),
	PMIC_ENTRY(PMIC_TOPA0_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_TOPA0_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_TOPA0_ESP),
	...
	PMIC_ENTRY(PMIC_SPISLV_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_SPISLV_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_SPISLV_ESP),
	PMIC_ENTRY(PMIC_RG_SLP_RW_EN),
	PMIC_ENTRY(PMIC_RG_EN_RECORD),
	PMIC_ENTRY(PMIC_RG_MDB_BRIDGE_SWRST),
	PMIC_ENTRY(PMIC_RG_MDB_BRIDGE_BYPASS_MODE),
	...
	PMIC_ENTRY(PMIC_PSC_TOP_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_PSC_TOP_SW_MAJOR_REV),
	...
	PMIC_ENTRY(PMIC_RG_INT_EN_PCHR_CM_VINC),
	PMIC_ENTRY(PMIC_RG_INT_EN_PCHR_CM_VDEC),
	...
	PMIC_ENTRY(PMIC_RG_INT_MASK_PCHR_CM_VINC),
	PMIC_ENTRY(PMIC_RG_INT_MASK_PCHR_CM_VDEC),
	...
	PMIC_ENTRY(PMIC_RG_INT_STATUS_PCHR_CM_VINC),
	PMIC_ENTRY(PMIC_RG_INT_STATUS_PCHR_CM_VDEC),
	...
	PMIC_ENTRY(PMIC_RG_INT_RAW_STATUS_PCHR_CM_VINC),
	PMIC_ENTRY(PMIC_RG_INT_RAW_STATUS_PCHR_CM_VDEC),
	...
	PMIC_ENTRY(PMIC_STRUP_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_STRUP_SW_MAJOR_REV),
	...
	PMIC_ENTRY(PMIC_PSEQ_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_PSEQ_SW_MAJOR_REV),
	...
	PMIC_ENTRY(PMIC_STRUP_CON5_RSV0),
	...
	PMIC_ENTRY(PMIC_RG_STRUP_CON15_RSV),
	...
	PMIC_ENTRY(PMIC_PCHR_DIG_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_PCHR_DIG_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_PCHR_DIG_ESP),
	PMIC_ENTRY(PMIC_PCHR_DIG_REG_ID),
	...
	PMIC_ENTRY(PMIC_PCHR_CM_VINC_STATUS),
	PMIC_ENTRY(PMIC_PCHR_CM_VDEC_STATUS),
	...
	PMIC_ENTRY(PMIC_RG_PCHR_APP2),
	PMIC_ENTRY(PMIC_RG_PCHR_APP1),
	...
	PMIC_ENTRY(PMIC_PCHR_MACRO_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_PCHR_MACRO_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_PCHR_MACRO_ESP),
	PMIC_ENTRY(PMIC_PCHR_MACRO_REG_ID),
	...
	PMIC_ENTRY(PMIC_RG_CM_VDEC_HPRD1),
	PMIC_ENTRY(PMIC_RG_CM_VDEC_HPRD2),
	PMIC_ENTRY(PMIC_RG_CM_VDEC_HPRD3),
	PMIC_ENTRY(PMIC_RG_CM_VDEC_HPRD4),
	PMIC_ENTRY(PMIC_RG_CM_VDEC_HPRD5),
	PMIC_ENTRY(PMIC_RG_CM_VDEC_HPRD6),
	PMIC_ENTRY(PMIC_RG_CM_VINC_HPRD1),
	PMIC_ENTRY(PMIC_RG_CM_VINC_HPRD2),
	PMIC_ENTRY(PMIC_RG_CM_VINC_HPRD3),
	PMIC_ENTRY(PMIC_RG_CM_VINC_HPRD4),
	PMIC_ENTRY(PMIC_RG_CM_VINC_HPRD5),
	PMIC_ENTRY(PMIC_RG_CM_VINC_HPRD6),
	PMIC_ENTRY(PMIC_RG_CM_LPRD),
	PMIC_ENTRY(PMIC_RG_CM_CS_VTHL),
	PMIC_ENTRY(PMIC_RG_CM_CS_VTHH),
	PMIC_ENTRY(PMIC_RG_CM_VINC_TRIG),
	PMIC_ENTRY(PMIC_RG_CM_VDEC_TRIG),
	...
	PMIC_ENTRY(PMIC_BM_TOP_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_BM_TOP_SW_MAJOR_REV),
	...
	PMIC_ENTRY(PMIC_RG_FGADC_32K_CK_SEL),
	...
	PMIC_ENTRY(PMIC_RG_PMU26M_CK_DIV_PDN),
	PMIC_ENTRY(PMIC_RG_BM_INTRP_CK_PDN),
	PMIC_ENTRY(PMIC_RG_BM_INTRP_PRE_OC_CK_PDN),
	...
	PMIC_ENTRY(PMIC_RG_BM_TOP_CKSEL_CON0_RSV),
	...
	PMIC_ENTRY(PMIC_RG_BM_TOP_RSV1),
	PMIC_ENTRY(PMIC_RG_BM_TOP_RSV2),
	PMIC_ENTRY(PMIC_RG_BM_TOP_RSV3),
	PMIC_ENTRY(PMIC_BM_TOP_ELR_LEN),
	PMIC_ENTRY(PMIC_BM_TOP_ELR0_RSV),
	...
	PMIC_ENTRY(PMIC_FGADC_ANA_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_FGADC_ANA_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_FGADC_ANA_ESP),
	PMIC_ENTRY(PMIC_RG_FGANALOGTEST_3_1),
	PMIC_ENTRY(PMIC_RG_FGINTMODE),
	PMIC_ENTRY(PMIC_RG_SPARE),
	PMIC_ENTRY(PMIC_FGADC_ANA_TEST_CON0_RSV),
	...
	PMIC_ENTRY(PMIC_FGADC_ANA_ID),
	PMIC_ENTRY(PMIC_FGADC_DIG_ID),
	PMIC_ENTRY(PMIC_FGADC_ANA_MINOR_REV),
	PMIC_ENTRY(PMIC_FGADC_ANA_MAJOR_REV),
	PMIC_ENTRY(PMIC_FGADC_DIG_MINOR_REV),
	PMIC_ENTRY(PMIC_FGADC_DIG_MAJOR_REV),
	PMIC_ENTRY(PMIC_FGADC_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_FGADC_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_FGADC_ESP),
	...
	PMIC_ENTRY(PMIC_FGADC_TEST_CON0_RSV),
	...
	PMIC_ENTRY(PMIC_BAT_ANA_ANA_ID),
	PMIC_ENTRY(PMIC_BAT_ANA_DIG_ID),
	PMIC_ENTRY(PMIC_BAT_ANA_ANA_MINOR_REV),
	PMIC_ENTRY(PMIC_BAT_ANA_ANA_MAJOR_REV),
	PMIC_ENTRY(PMIC_BAT_ANA_DIG_MINOR_REV),
	PMIC_ENTRY(PMIC_BAT_ANA_DIG_MAJOR_REV),
	PMIC_ENTRY(PMIC_BAT_ANA_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_BAT_ANA_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_BAT_ANA_ESP),
	...
	PMIC_ENTRY(PMIC_BATON_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_BATON_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_BATON_ESP),
	...
	PMIC_ENTRY(PMIC_BIF_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_BIF_SW_MAJOR_REV),
	...
	PMIC_ENTRY(PMIC_HK_TOP_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_HK_TOP_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_HK_TOP_ESP),
	PMIC_ENTRY(PMIC_HK_TOP_CLK_OFFSET),
	PMIC_ENTRY(PMIC_HK_TOP_RST_OFFSET),
	PMIC_ENTRY(PMIC_HK_TOP_INT_OFFSET),
	PMIC_ENTRY(PMIC_HK_TOP_INT_LEN),
	...
	PMIC_ENTRY(PMIC_RG_INT_EN_TYPEC_H_MAX),
	PMIC_ENTRY(PMIC_RG_INT_EN_TYPEC_H_MIN),
	PMIC_ENTRY(PMIC_RG_INT_EN_TYPEC_L_MAX),
	PMIC_ENTRY(PMIC_RG_INT_EN_TYPEC_L_MIN),
	...
	PMIC_ENTRY(PMIC_RG_INT_MASK_TYPEC_H_MAX),
	PMIC_ENTRY(PMIC_RG_INT_MASK_TYPEC_H_MIN),
	PMIC_ENTRY(PMIC_RG_INT_MASK_TYPEC_L_MAX),
	PMIC_ENTRY(PMIC_RG_INT_MASK_TYPEC_L_MIN),
	...
	PMIC_ENTRY(PMIC_RG_INT_STATUS_TYPEC_H_MAX),
	PMIC_ENTRY(PMIC_RG_INT_STATUS_TYPEC_H_MIN),
	PMIC_ENTRY(PMIC_RG_INT_STATUS_TYPEC_L_MAX),
	PMIC_ENTRY(PMIC_RG_INT_STATUS_TYPEC_L_MIN),
	...
	PMIC_ENTRY(PMIC_RG_INT_RAW_STATUS_TYPEC_H_MAX),
	PMIC_ENTRY(PMIC_RG_INT_RAW_STATUS_TYPEC_H_MIN),
	PMIC_ENTRY(PMIC_RG_INT_RAW_STATUS_TYPEC_L_MAX),
	PMIC_ENTRY(PMIC_RG_INT_RAW_STATUS_TYPEC_L_MIN),
	...
	PMIC_ENTRY(PMIC_AUXADC_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_AUXADC_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_AUXADC_ESP),
	...
	PMIC_ENTRY(PMIC_AUXADC_DIG_1_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_AUXADC_DIG_1_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_AUXADC_DIG_1_ESP),
	...
	PMIC_ENTRY(PMIC_AUXADC_ADC_OUT_TYPEC_H),
	PMIC_ENTRY(PMIC_AUXADC_ADC_RDY_TYPEC_H),
	PMIC_ENTRY(PMIC_AUXADC_ADC_OUT_TYPEC_L),
	PMIC_ENTRY(PMIC_AUXADC_ADC_RDY_TYPEC_L),
	...
	PMIC_ENTRY(PMIC_AUXADC_ADC_BUSY_IN_TYPEC_H),
	PMIC_ENTRY(PMIC_AUXADC_ADC_BUSY_IN_TYPEC_L),
	...
	PMIC_ENTRY(PMIC_AUXADC_DIG_2_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_AUXADC_DIG_2_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_AUXADC_DIG_2_ESP),
	...
	PMIC_ENTRY(PMIC_AUXADC_TYPEC_H_DEBT_MAX),
	PMIC_ENTRY(PMIC_AUXADC_TYPEC_H_DEBT_MIN),
	PMIC_ENTRY(PMIC_AUXADC_TYPEC_H_DET_PRD_15_0),
	PMIC_ENTRY(PMIC_AUXADC_TYPEC_H_DET_PRD_19_16),
	PMIC_ENTRY(PMIC_AUXADC_TYPEC_H_VOLT_MAX),
	PMIC_ENTRY(PMIC_AUXADC_TYPEC_H_IRQ_EN_MAX),
	PMIC_ENTRY(PMIC_AUXADC_TYPEC_H_EN_MAX),
	PMIC_ENTRY(PMIC_AUXADC_TYPEC_H_MAX_IRQ_B),
	PMIC_ENTRY(PMIC_AUXADC_TYPEC_H_VOLT_MIN),
	PMIC_ENTRY(PMIC_AUXADC_TYPEC_H_IRQ_EN_MIN),
	PMIC_ENTRY(PMIC_AUXADC_TYPEC_H_EN_MIN),
	PMIC_ENTRY(PMIC_AUXADC_TYPEC_H_MIN_IRQ_B),
	PMIC_ENTRY(PMIC_AUXADC_TYPEC_H_DEBOUNCE_COUNT_MAX),
	PMIC_ENTRY(PMIC_AUXADC_TYPEC_H_DEBOUNCE_COUNT_MIN),
	PMIC_ENTRY(PMIC_RG_AUXADC_TYPEC_H_CK_SW_MODE),
	PMIC_ENTRY(PMIC_RG_AUXADC_TYPEC_H_CK_SW_EN),
	PMIC_ENTRY(PMIC_AUXADC_TYPEC_L_DEBT_MAX),
	PMIC_ENTRY(PMIC_AUXADC_TYPEC_L_DEBT_MIN),
	PMIC_ENTRY(PMIC_AUXADC_TYPEC_L_DET_PRD_15_0),
	PMIC_ENTRY(PMIC_AUXADC_TYPEC_L_DET_PRD_19_16),
	PMIC_ENTRY(PMIC_AUXADC_TYPEC_L_VOLT_MAX),
	PMIC_ENTRY(PMIC_AUXADC_TYPEC_L_IRQ_EN_MAX),
	PMIC_ENTRY(PMIC_AUXADC_TYPEC_L_EN_MAX),
	PMIC_ENTRY(PMIC_AUXADC_TYPEC_L_MAX_IRQ_B),
	PMIC_ENTRY(PMIC_AUXADC_TYPEC_L_VOLT_MIN),
	PMIC_ENTRY(PMIC_AUXADC_TYPEC_L_IRQ_EN_MIN),
	PMIC_ENTRY(PMIC_AUXADC_TYPEC_L_EN_MIN),
	PMIC_ENTRY(PMIC_AUXADC_TYPEC_L_MIN_IRQ_B),
	PMIC_ENTRY(PMIC_AUXADC_TYPEC_L_DEBOUNCE_COUNT_MAX),
	PMIC_ENTRY(PMIC_AUXADC_TYPEC_L_DEBOUNCE_COUNT_MIN),
	PMIC_ENTRY(PMIC_RG_AUXADC_TYPEC_L_CK_SW_MODE),
	PMIC_ENTRY(PMIC_RG_AUXADC_TYPEC_L_CK_SW_EN),
	PMIC_ENTRY(PMIC_AUXADC_DIG_2_ELR_LEN),
	...
	PMIC_ENTRY(PMIC_SCK_TOP_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_SCK_TOP_SW_MAJOR_REV),
	...
	PMIC_ENTRY(PMIC_RG_RTC_MDB_DCM_CK_N),
	PMIC_ENTRY(PMIC_RG_RTC_SEC_MDB_DCM_CK_N),
	...
	PMIC_ENTRY(PMIC_DCXO_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_DCXO_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_DCXO_ESP),
	...
	PMIC_ENTRY(PMIC_RTC_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_RTC_SW_MAJOR_REV),
	...
	PMIC_ENTRY(PMIC_RTC_EOSC32_OPT),
	...
	PMIC_ENTRY(PMIC_EOSC_CALI_ANA_ID),
	PMIC_ENTRY(PMIC_EOSC_CALI_DIG_ID),
	PMIC_ENTRY(PMIC_EOSC_CALI_ANA_MINOR_REV),
	PMIC_ENTRY(PMIC_EOSC_CALI_ANA_MAJOR_REV),
	PMIC_ENTRY(PMIC_EOSC_CALI_DIG_MINOR_REV),
	PMIC_ENTRY(PMIC_EOSC_CALI_DIG_MAJOR_REV),
	PMIC_ENTRY(PMIC_EOSC_CALI_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_EOSC_CALI_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_EOSC_CALI_ESP),
	...
	PMIC_ENTRY(PMIC_RTC_SEC_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_RTC_SEC_SW_MAJOR_REV),
	...
	PMIC_ENTRY(PMIC_BUCK_TOP_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_BUCK_TOP_SW_MAJOR_REV),
	...
	PMIC_ENTRY(PMIC_BUCK_TOP_CLK_CON0_RSV),
	...
	PMIC_ENTRY(PMIC_BUCK_TOP_CLK_HWEN_CON0_RSV),
	...
	PMIC_ENTRY(PMIC_RG_BUCK_VS2_FREQ_SEL),
	PMIC_ENTRY(PMIC_RG_BUCK_VPA_FREQ_SEL),
	PMIC_ENTRY(PMIC_RG_RST_CON0_RSV),
	PMIC_ENTRY(PMIC_RG_BUCK_TOP_RST_CON0_SET),
	PMIC_ENTRY(PMIC_RG_BUCK_TOP_RST_CON0_CLR),
	...
	PMIC_ENTRY(PMIC_RG_BUCK_TOP_INT_CON0_SET),
	PMIC_ENTRY(PMIC_RG_BUCK_TOP_INT_CON0_CLR),
	...
	PMIC_ENTRY(PMIC_BUCK_VPROC_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_BUCK_VPROC_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_BUCK_VPROC_ESP),
	...
	PMIC_ENTRY(PMIC_BUCK_VCORE_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_BUCK_VCORE_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_BUCK_VCORE_ESP),
	...
	PMIC_ENTRY(PMIC_BUCK_VMODEM_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_BUCK_VMODEM_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_BUCK_VMODEM_ESP),
	...
	PMIC_ENTRY(PMIC_BUCK_VS1_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_BUCK_VS1_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_BUCK_VS1_ESP),
	...
	PMIC_ENTRY(PMIC_BUCK_VS2_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_BUCK_VS2_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_BUCK_VS2_ESP),
	...
	PMIC_ENTRY(PMIC_BUCK_VPA_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_BUCK_VPA_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_BUCK_VPA_ESP),
	...
	PMIC_ENTRY(PMIC_BUCK_ANA_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_BUCK_ANA_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_BUCK_ANA_ESP),
	...
	PMIC_ENTRY(PMIC_LDO_TOP_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_LDO_TOP_SW_MAJOR_REV),
	...
	PMIC_ENTRY(PMIC_RG_LDO_VAUD28_CK_SW_EN),
	PMIC_ENTRY(PMIC_RG_LDO_VAUD28_OSC_SEL_DIS),
	PMIC_ENTRY(PMIC_RG_LDO_VDRAM_CK_SW_MODE),
	PMIC_ENTRY(PMIC_RG_LDO_VDRAM_CK_SW_EN),
	PMIC_ENTRY(PMIC_RG_LDO_VDRAM_OSC_SEL_DIS),
	...
	PMIC_ENTRY(PMIC_RG_LDO_VSRAM_OTHERS_CK_SW_EN),
	...
	PMIC_ENTRY(PMIC_RG_LDO_VAUX18_CK_SW_EN),
	PMIC_ENTRY(PMIC_RG_LDO_VAUX18_OSC_SEL_DIS),
	PMIC_ENTRY(PMIC_RG_LDO_VUSB_CK_SW_MODE),
	PMIC_ENTRY(PMIC_RG_LDO_VUSB_CK_SW_EN),
	PMIC_ENTRY(PMIC_RG_LDO_VUSB_OSC_SEL_DIS),
	...
	PMIC_ENTRY(PMIC_RG_LDO_VCAMD_CK_SW_EN),
	PMIC_ENTRY(PMIC_RG_LDO_VCAMD_OSC_SEL_DIS),
	...
	PMIC_ENTRY(PMIC_RG_LDO_VIBR_CK_SW_EN),
	PMIC_ENTRY(PMIC_RG_LDO_VIBR_OSC_SEL_DIS),
	...
	PMIC_ENTRY(PMIC_RG_LDO_VRF18_CK_SW_EN),
	PMIC_ENTRY(PMIC_RG_LDO_VRF18_OSC_SEL_DIS),
	...
	PMIC_ENTRY(PMIC_RG_LDO_VCAMA_CK_SW_EN),
	PMIC_ENTRY(PMIC_RG_LDO_VCAMA_OSC_SEL_DIS),
	PMIC_ENTRY(PMIC_RG_LDO_TOP_SWRST),
	PMIC_ENTRY(PMIC_RG_LDO_GON_SWRST),
	PMIC_ENTRY(PMIC_RG_LDO_GOFF0_SWRST),
	PMIC_ENTRY(PMIC_RG_LDO_GOFF1_SWRST),
	PMIC_ENTRY(PMIC_RG_LDO_MULTIUSER_SWRST),
	PMIC_ENTRY(PMIC_RG_LDO_FOURUSER_SWRST),
	PMIC_ENTRY(PMIC_RG_LDO_VSRAM_SWRST),
	PMIC_ENTRY(PMIC_RG_LDO_VRTC_SWRST),
	PMIC_ENTRY(PMIC_RG_LDO_ANA_SWRST),
	PMIC_ENTRY(PMIC_LDO_SWRST_CON0_SET),
	PMIC_ENTRY(PMIC_LDO_SWRST_CON0_CLR),
	...
	PMIC_ENTRY(PMIC_RG_LDO_CTL_FLAG_EN),
	...
	PMIC_ENTRY(PMIC_LDO_GON_ANA_ID),
	PMIC_ENTRY(PMIC_LDO_GON_DIG_ID),
	PMIC_ENTRY(PMIC_LDO_GON_ANA_MINOR_REV),
	PMIC_ENTRY(PMIC_LDO_GON_ANA_MAJOR_REV),
	PMIC_ENTRY(PMIC_LDO_GON_DIG_MINOR_REV),
	PMIC_ENTRY(PMIC_LDO_GON_DIG_MAJOR_REV),
	PMIC_ENTRY(PMIC_LDO_GON_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_LDO_GON_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_LDO_GON_ESP),
	PMIC_ENTRY(PMIC_RG_LDO_GON_RSV0),
	PMIC_ENTRY(PMIC_RG_LDO_GON_RSV1),
	...
	PMIC_ENTRY(PMIC_RG_LDO_VAUX18_ON_OP),
	PMIC_ENTRY(PMIC_RG_LDO_VAUX18_LP_OP),
	...
	PMIC_ENTRY(PMIC_RG_LDO_VAUD28_ON_OP),
	PMIC_ENTRY(PMIC_RG_LDO_VAUD28_LP_OP),
	...
	PMIC_ENTRY(PMIC_RG_LDO_VDRAM_ON_OP),
	PMIC_ENTRY(PMIC_RG_LDO_VDRAM_LP_OP),
	...
	PMIC_ENTRY(PMIC_RG_LDO_VA12_ULP_EN),
	PMIC_ENTRY(PMIC_RG_LDO_VA12_T1),
	PMIC_ENTRY(PMIC_RG_LDO_VA12_T2),
	PMIC_ENTRY(PMIC_DA_VA12_ULP_EN),
	PMIC_ENTRY(PMIC_RG_LDO_VIO28_ULP_EN),
	PMIC_ENTRY(PMIC_RG_LDO_VIO28_T1),
	PMIC_ENTRY(PMIC_RG_LDO_VIO28_T2),
	PMIC_ENTRY(PMIC_DA_VIO28_ULP_EN),
	...
	PMIC_ENTRY(PMIC_LDO_GOFF0_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_LDO_GOFF0_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_LDO_GOFF0_ESP),
	PMIC_ENTRY(PMIC_RG_LDO_GOFF0_RSV0),
	PMIC_ENTRY(PMIC_RG_LDO_GOFF0_RSV1),
	...
	PMIC_ENTRY(PMIC_RG_LDO_VRF18_ON_OP),
	PMIC_ENTRY(PMIC_RG_LDO_VRF18_LP_OP),
	...
	PMIC_ENTRY(PMIC_DA_VMIPI_MODE),
	PMIC_ENTRY(PMIC_RG_LDO_VMIPI_STBTD),
	PMIC_ENTRY(PMIC_DA_VMIPI_STB),
	PMIC_ENTRY(PMIC_DA_VMIPI_EN),
	PMIC_ENTRY(PMIC_RG_LDO_VMIPI_OCFB_EN),
	PMIC_ENTRY(PMIC_DA_VMIPI_OCFB_EN),
	PMIC_ENTRY(PMIC_RG_LDO_VMIPI_DUMMY_LOAD),
	PMIC_ENTRY(PMIC_DA_VMIPI_DUMMY_LOAD),
	...
	PMIC_ENTRY(PMIC_RG_LDO_VCAMA_ON_OP),
	PMIC_ENTRY(PMIC_RG_LDO_VCAMA_LP_OP),
	...
	PMIC_ENTRY(PMIC_RG_LDO_VCAMD_ON_OP),
	PMIC_ENTRY(PMIC_RG_LDO_VCAMD_LP_OP),
	...
	PMIC_ENTRY(PMIC_LDO_GOFF1_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_LDO_GOFF1_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_LDO_GOFF1_ESP),
	PMIC_ENTRY(PMIC_RG_LDO_GOFF1_RSV0),
	PMIC_ENTRY(PMIC_RG_LDO_GOFF1_RSV1),
	...
	PMIC_ENTRY(PMIC_RG_LDO_VIBR_ON_OP),
	PMIC_ENTRY(PMIC_RG_LDO_VIBR_LP_OP),
	...
	PMIC_ENTRY(PMIC_RG_LDO_VIBR_THER_SDN_EN),
	...
	PMIC_ENTRY(PMIC_LDO_MULTIUSER_ANA_ID),
	PMIC_ENTRY(PMIC_LDO_MULTIUSER_DIG_ID),
	PMIC_ENTRY(PMIC_LDO_MULTIUSER_ANA_MINOR_REV),
	PMIC_ENTRY(PMIC_LDO_MULTIUSER_ANA_MAJOR_REV),
	PMIC_ENTRY(PMIC_LDO_MULTIUSER_DIG_MINOR_REV),
	PMIC_ENTRY(PMIC_LDO_MULTIUSER_DIG_MAJOR_REV),
	PMIC_ENTRY(PMIC_LDO_MULTIUSER_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_LDO_MULTIUSER_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_LDO_MULTIUSER_ESP),
	PMIC_ENTRY(PMIC_RG_LDO_MULTIUSER_RSV0),
	PMIC_ENTRY(PMIC_RG_LDO_MULTIUSER_RSV1),
	...
	PMIC_ENTRY(PMIC_RG_LDO_VUSB_ON_OP),
	PMIC_ENTRY(PMIC_RG_LDO_VUSB_LP_OP),
	...
	PMIC_ENTRY(PMIC_RG_LDO_VLDO28_ULP_EN),
	PMIC_ENTRY(PMIC_RG_LDO_VLDO28_T1),
	PMIC_ENTRY(PMIC_RG_LDO_VLDO28_T2),
	PMIC_ENTRY(PMIC_DA_VLDO28_ULP_EN),
	PMIC_ENTRY(PMIC_RG_LDO_VUSB_ULP_EN),
	PMIC_ENTRY(PMIC_RG_LDO_VUSB_T1),
	PMIC_ENTRY(PMIC_RG_LDO_VUSB_T2),
	PMIC_ENTRY(PMIC_DA_VUSB_ULP_EN),
	PMIC_ENTRY(PMIC_LDO_FOURUSER_ANA_ID),
	PMIC_ENTRY(PMIC_LDO_FOURUSER_DIG_ID),
	PMIC_ENTRY(PMIC_LDO_FOURUSER_ANA_MINOR_REV),
	PMIC_ENTRY(PMIC_LDO_FOURUSER_ANA_MAJOR_REV),
	PMIC_ENTRY(PMIC_LDO_FOURUSER_DIG_MINOR_REV),
	PMIC_ENTRY(PMIC_LDO_FOURUSER_DIG_MAJOR_REV),
	PMIC_ENTRY(PMIC_LDO_FOURUSER_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_LDO_FOURUSER_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_LDO_FOURUSER_ESP),
	PMIC_ENTRY(PMIC_RG_LDO_FOURUSER_RSV0),
	PMIC_ENTRY(PMIC_RG_LDO_FOURUSER_RSV1),
	...
	PMIC_ENTRY(PMIC_LDO_VSRAM_ANA_ID),
	PMIC_ENTRY(PMIC_LDO_VSRAM_DIG_ID),
	PMIC_ENTRY(PMIC_LDO_VSRAM_ANA_MINOR_REV),
	PMIC_ENTRY(PMIC_LDO_VSRAM_ANA_MAJOR_REV),
	PMIC_ENTRY(PMIC_LDO_VSRAM_DIG_MINOR_REV),
	PMIC_ENTRY(PMIC_LDO_VSRAM_DIG_MAJOR_REV),
	PMIC_ENTRY(PMIC_LDO_VSRAM_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_LDO_VSRAM_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_LDO_VSRAM_ESP),
	PMIC_ENTRY(PMIC_RG_DIG_VSRAM_RSV0),
	PMIC_ENTRY(PMIC_RG_DIG_VSRAM_RSV1),
	...
	PMIC_ENTRY(PMIC_RG_LDO_VSRAM_OTHERS_ON_OP),
	PMIC_ENTRY(PMIC_RG_LDO_VSRAM_OTHERS_LP_OP),
	...
	PMIC_ENTRY(PMIC_RG_LDO_STB_MAX),
	PMIC_ENTRY(PMIC_RG_LDO_VSLEEP_SRC0),
	PMIC_ENTRY(PMIC_RG_LDO_VSLEEP_SRC1),
	PMIC_ENTRY(PMIC_RG_LDO_R2R_SRC0),
	PMIC_ENTRY(PMIC_RG_LDO_R2R_SRC1),
	PMIC_ENTRY(PMIC_RG_LDO_LP_SEQ_COUNT),
	PMIC_ENTRY(PMIC_RG_LDO_ON_SEQ_COUNT),
	...
	PMIC_ENTRY(PMIC_LDO_VSRAM_ELR_LEN),
	PMIC_ENTRY(PMIC_RG_LDO_VSRAM_PROC_VOSEL),
	PMIC_ENTRY(PMIC_RG_LDO_VSRAM_OTHERS_VOSEL_RO),
	...
	PMIC_ENTRY(PMIC_LDO_VRTC_ANA_ID),
	PMIC_ENTRY(PMIC_LDO_VRTC_DIG_ID),
	PMIC_ENTRY(PMIC_LDO_VRTC_ANA_MINOR_REV),
	PMIC_ENTRY(PMIC_LDO_VRTC_ANA_MAJOR_REV),
	PMIC_ENTRY(PMIC_LDO_VRTC_DIG_MINOR_REV),
	PMIC_ENTRY(PMIC_LDO_VRTC_DIG_MAJOR_REV),
	PMIC_ENTRY(PMIC_LDO_VRTC_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_LDO_VRTC_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_LDO_VRTC_ESP),
	PMIC_ENTRY(PMIC_RG_LDO_VRTC_RSV0),
	PMIC_ENTRY(PMIC_RG_LDO_VRTC_RSV1),
	PMIC_ENTRY(PMIC_RG_VRTC_EN),
	PMIC_ENTRY(PMIC_DA_VRTC_EN),
	PMIC_ENTRY(PMIC_LDO_ANA_ANA_ID),
	PMIC_ENTRY(PMIC_LDO_ANA_DIG_ID),
	PMIC_ENTRY(PMIC_LDO_ANA_ANA_MINOR_REV),
	PMIC_ENTRY(PMIC_LDO_ANA_ANA_MAJOR_REV),
	PMIC_ENTRY(PMIC_LDO_ANA_DIG_MINOR_REV),
	PMIC_ENTRY(PMIC_LDO_ANA_DIG_MAJOR_REV),
	PMIC_ENTRY(PMIC_LDO_ANA_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_LDO_ANA_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_LDO_ANA_ESP),
	PMIC_ENTRY(PMIC_RG_VCAMA_VOCAL),
	PMIC_ENTRY(PMIC_RG_VCAMA_VOSEL),
	PMIC_ENTRY(PMIC_RGS_VCAMA_CAL_INDI),
	PMIC_ENTRY(PMIC_RG_VCAMA_NDIS_EN),
	PMIC_ENTRY(PMIC_RG_VCAMA_STB_SEL),
	PMIC_ENTRY(PMIC_RG_VCAMA_RSV),
	PMIC_ENTRY(PMIC_RG_VCAMA_VOS_CAL_EN),
	...
	PMIC_ENTRY(PMIC_RG_VAUD28_VOSEL),
	PMIC_ENTRY(PMIC_RGS_VAUD28_CAL_INDI),
	PMIC_ENTRY(PMIC_RG_VAUD28_NDIS_EN),
	PMIC_ENTRY(PMIC_RG_VAUD28_STB_SEL),
	PMIC_ENTRY(PMIC_RG_VAUD28_RSV),
	PMIC_ENTRY(PMIC_RG_VAUD28_VOS_CAL_EN),
	PMIC_ENTRY(PMIC_RG_VAUX18_VOCAL),
	PMIC_ENTRY(PMIC_RG_VAUX18_VOSEL),
	PMIC_ENTRY(PMIC_RGS_VAUX18_CAL_INDI),
	PMIC_ENTRY(PMIC_RG_VAUX18_NDIS_EN),
	PMIC_ENTRY(PMIC_RG_VAUX18_STB_SEL),
	PMIC_ENTRY(PMIC_RG_VAUX18_RSV),
	PMIC_ENTRY(PMIC_RG_VAUX18_VOS_CAL_EN),
	...
	PMIC_ENTRY(PMIC_RGS_VIBR_CAL_INDI),
	PMIC_ENTRY(PMIC_RG_VIBR_NDIS_EN),
	PMIC_ENTRY(PMIC_RG_VIBR_STB_SEL),
	PMIC_ENTRY(PMIC_RG_VIBR_RSV),
	PMIC_ENTRY(PMIC_RG_VIBR_VOS_CAL_EN),
	...
	PMIC_ENTRY(PMIC_RGS_VRF18_CAL_INDI),
	PMIC_ENTRY(PMIC_RG_VRF18_NDIS_EN),
	PMIC_ENTRY(PMIC_RG_VRF18_STB_SEL),
	PMIC_ENTRY(PMIC_RG_VRF18_RSV),
	PMIC_ENTRY(PMIC_RG_VRF18_VOS_CAL_EN),
	...
	PMIC_ENTRY(PMIC_RGS_VDRAM_CAL_INDI),
	PMIC_ENTRY(PMIC_RG_VDRAM_NDIS_EN),
	PMIC_ENTRY(PMIC_RG_VDRAM_STB_SEL),
	PMIC_ENTRY(PMIC_RG_VDRAM_RSV),
	PMIC_ENTRY(PMIC_RG_VDRAM_VOS_CAL_EN),
	...
	PMIC_ENTRY(PMIC_RGS_VCAMD_CAL_INDI),
	PMIC_ENTRY(PMIC_RG_VCAMD_NDIS_EN),
	PMIC_ENTRY(PMIC_RG_VCAMD_STB_SEL),
	PMIC_ENTRY(PMIC_RG_VCAMD_RSV),
	PMIC_ENTRY(PMIC_RG_VCAMD_VOS_CAL_EN),
	PMIC_ENTRY(PMIC_LDO_ANA_ELR_LEN),
	PMIC_ENTRY(PMIC_RG_VCAMA_VOTRIM),
	PMIC_ENTRY(PMIC_RG_VCAMA_OC_TRIM),
	...
	PMIC_ENTRY(PMIC_RG_VAUD28_OC_TRIM),
	...
	PMIC_ENTRY(PMIC_XPP_TOP_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_XPP_TOP_SW_MAJOR_REV),
	...
	PMIC_ENTRY(PMIC_RG_TYPE_C_CC_CK_PDN),
	PMIC_ENTRY(PMIC_RG_TYPE_C_CSR_CK_PDN),
	PMIC_ENTRY(PMIC_RG_XPP_RSV0_CK_PDN),
	PMIC_ENTRY(PMIC_RG_XPP_RSV1_CK_PDN),
	PMIC_ENTRY(PMIC_XPP_TOP_CKPDN_CON0_SET),
	PMIC_ENTRY(PMIC_XPP_TOP_CKPDN_CON0_CLR),
	PMIC_ENTRY(PMIC_RG_DRV_ISINK_CK_CKSEL),
	PMIC_ENTRY(PMIC_RG_TYPE_C_CC_CK_CKSEL),
	PMIC_ENTRY(PMIC_XPP_CKSEL_CON0_RSV),
	PMIC_ENTRY(PMIC_XPP_TOP_CKSEL_CON0_SET),
	PMIC_ENTRY(PMIC_XPP_TOP_CKSEL_CON0_CLR),
	PMIC_ENTRY(PMIC_XPP_CKDIVSEL_CON0_RSV),
	PMIC_ENTRY(PMIC_XPP_TOP_CKDIVSEL_CON0_SET),
	PMIC_ENTRY(PMIC_XPP_TOP_CKDIVSEL_CON0_CLR),
	PMIC_ENTRY(PMIC_XPP_CKHWEN_CON0_RSV),
	PMIC_ENTRY(PMIC_XPP_TOP_CKHWEN_CON0_SET),
	PMIC_ENTRY(PMIC_XPP_TOP_CKHWEN_CON0_CLR),
	PMIC_ENTRY(PMIC_RG_DRIVER_BL_RST),
	PMIC_ENTRY(PMIC_RG_DRIVER_CI_RST),
	PMIC_ENTRY(PMIC_RG_XPP_RSV0_RST),
	PMIC_ENTRY(PMIC_RG_XPP_RSV1_RST),
	PMIC_ENTRY(PMIC_RG_TYPE_C_RST),
	...
	PMIC_ENTRY(PMIC_RG_DRIVER_ANA_BANK_RST),
	PMIC_ENTRY(PMIC_RG_TYPE_C_BANK_RST),
	PMIC_ENTRY(PMIC_XPP_TOP_RST_BANK_CON0_SET),
	PMIC_ENTRY(PMIC_XPP_TOP_RST_BANK_CON0_CLR),
	PMIC_ENTRY(PMIC_RG_INT_EN_TYPE_C_CC_IRQ),
	PMIC_ENTRY(PMIC_RG_INT_EN_XPP_RSV0),
	PMIC_ENTRY(PMIC_RG_INT_EN_XPP_RSV1),
	PMIC_ENTRY(PMIC_XPP_TOP_INT_CON0_SET),
	PMIC_ENTRY(PMIC_XPP_TOP_INT_CON0_CLR),
	PMIC_ENTRY(PMIC_RG_INT_MASK_TYPE_C_CC_IRQ),
	PMIC_ENTRY(PMIC_RG_INT_MASK_XPP_RSV0),
	PMIC_ENTRY(PMIC_RG_INT_MASK_XPP_RSV1),
	PMIC_ENTRY(PMIC_XPP_TOP_INT_MASK_CON0_SET),
	PMIC_ENTRY(PMIC_XPP_TOP_INT_MASK_CON0_CLR),
	PMIC_ENTRY(PMIC_RG_INT_STATUS_TYPE_C_CC_IRQ),
	PMIC_ENTRY(PMIC_RG_INT_STATUS_XPP_RSV0),
	PMIC_ENTRY(PMIC_RG_INT_STATUS_XPP_RSV1),
	PMIC_ENTRY(PMIC_RG_INT_RAW_STATUS_TYPE_C_CC_IRQ),
	PMIC_ENTRY(PMIC_RG_INT_RAW_STATUS_XPP_RSV0),
	PMIC_ENTRY(PMIC_RG_INT_RAW_STATUS_XPP_RSV1),
	PMIC_ENTRY(PMIC_XPP_TOP_POLARITY),
	...
	PMIC_ENTRY(PMIC_DRIVER_BL_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_DRIVER_BL_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_DRIVER_BL_ESP),
	...
	PMIC_ENTRY(PMIC_ISINK_PHASE0_DLY_TC),
	...
	PMIC_ENTRY(PMIC_ISINK_CH0_PWM_MODE),
	...
	PMIC_ENTRY(PMIC_DRIVER_CI_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_DRIVER_CI_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_DRIVER_CI_ESP),
	PMIC_ENTRY(PMIC_CHRIND_DIM_FSEL),
	PMIC_ENTRY(PMIC_CHRIND_DIM_DUTY),
	PMIC_ENTRY(PMIC_CHRIND_RSV1),
	...
	PMIC_ENTRY(PMIC_DRIVER_DL_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_DRIVER_DL_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_DRIVER_DL_ESP),
	...
	PMIC_ENTRY(PMIC_DRIVER_ANA_ANA_ID),
	PMIC_ENTRY(PMIC_DRIVER_ANA_DIG_ID),
	PMIC_ENTRY(PMIC_DRIVER_ANA_ANA_MINOR_REV),
	PMIC_ENTRY(PMIC_DRIVER_ANA_ANA_MAJOR_REV),
	PMIC_ENTRY(PMIC_DRIVER_ANA_DIG_MINOR_REV),
	PMIC_ENTRY(PMIC_DRIVER_ANA_DIG_MAJOR_REV),
	PMIC_ENTRY(PMIC_DRIVER_ANA_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_DRIVER_ANA_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_DRIVER_ANA_ESP),
	...
	PMIC_ENTRY(PMIC_DRIVER_ANA_ELR_LEN),
	PMIC_ENTRY(PMIC_RG_ISINK_TRIM_BIAS),
	PMIC_ENTRY(PMIC_TYPE_C_ANA_ID),
	PMIC_ENTRY(PMIC_TYPE_C_DIG_ID),
	PMIC_ENTRY(PMIC_TYPE_C_ANA_MINOR_REV),
	PMIC_ENTRY(PMIC_TYPE_C_ANA_MAJOR_REV),
	PMIC_ENTRY(PMIC_TYPE_C_DIG_MINOR_REV),
	PMIC_ENTRY(PMIC_TYPE_C_DIG_MAJOR_REV),
	PMIC_ENTRY(PMIC_TYPE_C_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_TYPE_C_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_TYPE_C_ESP),
	PMIC_ENTRY(PMIC_TYPE_C_PHY_RG_CC_RP_SEL),
	PMIC_ENTRY(PMIC_REG_TYPE_C_PHY_RG_CC_V2I_BYPASS),
	PMIC_ENTRY(PMIC_REG_TYPE_C_PHY_RG_CC_REFG_SEL),
	PMIC_ENTRY(PMIC_REG_TYPE_C_PHY_RG_CC_MPX_SEL),
	PMIC_ENTRY(PMIC_REG_TYPE_C_PHY_RG_CC_RESERVE),
	PMIC_ENTRY(PMIC_REG_TYPE_C_VCMP_CC2_SW_SEL_ST_CNT_VAL),
	PMIC_ENTRY(PMIC_REG_TYPE_C_VCMP_BIAS_EN_ST_CNT_VAL),
	PMIC_ENTRY(PMIC_REG_TYPE_C_VCMP_DAC_EN_ST_CNT_VAL),
	PMIC_ENTRY(PMIC_REG_TYPE_C_PORT_SUPPORT_ROLE),
	PMIC_ENTRY(PMIC_REG_TYPE_C_ADC_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_ACC_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_AUDIO_ACC_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_DEBUG_ACC_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_TRY_SRC_ST_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_TRY_SNK_ST_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_ATTACH_SRC_2_TRY_WAIT_SNK_ST_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_PD2CC_DET_DISABLE_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_ATTACH_SRC_OPEN_PDDEBOUNCE_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_DISABLE_ST_RD_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_DA_CC_SACLK_SW_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_TRY_WAIT_SRC2ATTACH_SRC_DEB_SEL),
	PMIC_ENTRY(PMIC_W1_TYPE_C_SW_ENT_DISABLE_CMD),
	PMIC_ENTRY(PMIC_W1_TYPE_C_SW_ENT_UNATCH_SRC_CMD),
	PMIC_ENTRY(PMIC_W1_TYPE_C_SW_ENT_UNATCH_SNK_CMD),
	PMIC_ENTRY(PMIC_W1_TYPE_C_SW_PR_SWAP_INDICATE_CMD),
	PMIC_ENTRY(PMIC_W1_TYPE_C_SW_VCONN_SWAP_INDICATE_CMD),
	PMIC_ENTRY(PMIC_W1_TYPE_C_SW_ADC_RESULT_MET_VRD_DEFAULT_CMD),
	PMIC_ENTRY(PMIC_W1_TYPE_C_SW_ADC_RESULT_MET_VRD_15_CMD),
	PMIC_ENTRY(PMIC_W1_TYPE_C_SW_ADC_RESULT_MET_VRD_30_CMD),
	PMIC_ENTRY(PMIC_TYPE_C_SW_VBUS_PRESENT),
	PMIC_ENTRY(PMIC_TYPE_C_SW_DA_DRIVE_VCONN_EN),
	PMIC_ENTRY(PMIC_TYPE_C_SW_VBUS_DET_DIS),
	PMIC_ENTRY(PMIC_TYPE_C_SW_CC_DET_DIS),
	PMIC_ENTRY(PMIC_TYPE_C_SW_PD_EN),
	PMIC_ENTRY(PMIC_W1_TYPE_C_SW_ENT_SNK_PWR_REDETECT_CMD),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_VOL_PERIODIC_MEAS_VAL),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_VOL_CC_DEBOUNCE_CNT_VAL),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_VOL_PD_DEBOUNCE_CNT_VAL),
	PMIC_ENTRY(PMIC_REG_TYPE_C_DRP_SRC_CNT_VAL_0),
	PMIC_ENTRY(PMIC_REG_TYPE_C_DRP_SNK_CNT_VAL_0),
	PMIC_ENTRY(PMIC_REG_TYPE_C_DRP_TRY_CNT_VAL_0),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_SRC_VOPEN_DEFAULT_DAC_VAL),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_SRC_VRD_DEFAULT_DAC_VAL),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_SRC_VOPEN_15_DAC_VAL),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_SRC_VRD_15_DAC_VAL),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_SRC_VOPEN_30_DAC_VAL),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_SRC_VRD_30_DAC_VAL),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_SNK_VRP30_DAC_VAL),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_SNK_VRP15_DAC_VAL),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_SNK_VRPUSB_DAC_VAL),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_ENT_ATTACH_SRC_INTR_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_ENT_ATTACH_SNK_INTR_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_ENT_AUDIO_ACC_INTR_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_ENT_DISABLE_INTR_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_ENT_UNATTACH_SRC_INTR_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_ENT_UNATTACH_SNK_INTR_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_ENT_ATTACH_WAIT_SRC_INTR_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_ENT_ATTACH_WAIT_SNK_INTR_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_ENT_TRY_SRC_INTR_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_ENT_TRY_WAIT_SNK_INTR_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_ENT_UNATTACH_ACC_INTR_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_ENT_ATTACH_WAIT_ACC_INTR_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_ENT_TRY_SNK_INTR_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_ENT_TRY_WAIT_SRC_INTR_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_ENT_DBG_ACC_SRC_INTR_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_ENT_DBG_ACC_SNK_INTR_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_ENT_SNK_PWR_IDLE_INTR_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_ENT_SNK_PWR_DEFAULT_INTR_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_ENT_SNK_PWR_15_INTR_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_ENT_SNK_PWR_30_INTR_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_CC_ENT_SNK_PWR_REDETECT_INTR_EN),
	PMIC_ENTRY(PMIC_TYPE_C_CC_ENT_ATTACH_SRC_INTR),
	PMIC_ENTRY(PMIC_TYPE_C_CC_ENT_ATTACH_SNK_INTR),
	PMIC_ENTRY(PMIC_TYPE_C_CC_ENT_AUDIO_ACC_INTR),
	PMIC_ENTRY(PMIC_TYPE_C_CC_ENT_DISABLE_INTR),
	PMIC_ENTRY(PMIC_TYPE_C_CC_ENT_UNATTACH_SRC_INTR),
	PMIC_ENTRY(PMIC_TYPE_C_CC_ENT_UNATTACH_SNK_INTR),
	PMIC_ENTRY(PMIC_TYPE_C_CC_ENT_ATTACH_WAIT_SRC_INTR),
	PMIC_ENTRY(PMIC_TYPE_C_CC_ENT_ATTACH_WAIT_SNK_INTR),
	PMIC_ENTRY(PMIC_TYPE_C_CC_ENT_TRY_SRC_INTR),
	PMIC_ENTRY(PMIC_TYPE_C_CC_ENT_TRY_WAIT_SNK_INTR),
	PMIC_ENTRY(PMIC_TYPE_C_CC_ENT_UNATTACH_ACC_INTR),
	PMIC_ENTRY(PMIC_TYPE_C_CC_ENT_ATTACH_WAIT_ACC_INTR),
	PMIC_ENTRY(PMIC_TYPE_C_CC_ENT_TRY_SNK_INTR),
	PMIC_ENTRY(PMIC_TYPE_C_CC_ENT_TRY_WAIT_SRC_INTR),
	PMIC_ENTRY(PMIC_TYPE_C_CC_ENT_DBG_ACC_SRC_INTR),
	PMIC_ENTRY(PMIC_TYPE_C_CC_ENT_DBG_ACC_SNK_INTR),
	PMIC_ENTRY(PMIC_TYPE_C_CC_ENT_SNK_PWR_IDLE_INTR),
	PMIC_ENTRY(PMIC_TYPE_C_CC_ENT_SNK_PWR_DEFAULT_INTR),
	PMIC_ENTRY(PMIC_TYPE_C_CC_ENT_SNK_PWR_15_INTR),
	PMIC_ENTRY(PMIC_TYPE_C_CC_ENT_SNK_PWR_30_INTR),
	PMIC_ENTRY(PMIC_TYPE_C_CC_ENT_SNK_PWR_REDETECT_INTR),
	PMIC_ENTRY(PMIC_RO_TYPE_C_CC_ST),
	PMIC_ENTRY(PMIC_RO_TYPE_C_ROUTED_CC),
	PMIC_ENTRY(PMIC_RO_TYPE_C_CC_SNK_PWR_ST),
	PMIC_ENTRY(PMIC_RO_TYPE_C_CC_PWR_ROLE),
	PMIC_ENTRY(PMIC_RO_TYPE_C_DRIVE_VCONN_CAPABLE),
	PMIC_ENTRY(PMIC_RO_TYPE_C_AD_CC_CMP_OUT),
	PMIC_ENTRY(PMIC_RO_DA_CC_TYPEC_SYS_RSTB),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_EN_DA_CC_RCC1),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_EN_DA_CC_RCC2),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_EN_DA_CC_LEV_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_EN_DA_CC_SW_SEL),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_EN_DA_CC_BIAS_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_EN_DA_CC_LPF_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_EN_DA_CC_ADCSW_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_EN_DA_CC_SASW_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_EN_DA_CC_DAC_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_EN_DA_CC_SACLK),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_EN_DA_CC_DAC_IN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_EN_DA_CC_TYPEC_SYS_RSTB),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_DA_CC_RPCC1_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_DA_CC_RDCC1_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_DA_CC_RACC1_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_DA_CC_RPCC2_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_DA_CC_RDCC2_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_DA_CC_RACC2_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_DA_CC_LEV_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_DA_CC_SW_SEL),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_DA_CC_BIAS_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_DA_CC_LPF_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_DA_CC_ADCSW_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_DA_CC_SASW_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_DA_CC_DAC_EN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_DA_CC_SACLK),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_DA_CC_TYPEC_SYS_RSTB),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_DA_CC_DAC_IN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_EN_DA_CC_DAC_CAL),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_EN_DA_CC_DAC_GAIN_CAL),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_DA_CC_DAC_CAL),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_FORCE_MODE_DA_CC_DAC_GAIN_CAL),
	PMIC_ENTRY(PMIC_TYPE_C_DAC_CAL_START),
	PMIC_ENTRY(PMIC_REG_TYPE_C_DAC_CAL_STAGE),
	PMIC_ENTRY(PMIC_RO_TYPE_C_DAC_CAL_OK),
	PMIC_ENTRY(PMIC_RO_TYPE_C_DAC_CAL_FAIL),
	PMIC_ENTRY(PMIC_RO_DA_CC_DAC_CAL),
	PMIC_ENTRY(PMIC_RO_DA_CC_DAC_GAIN_CAL),
	PMIC_ENTRY(PMIC_REG_TYPE_C_DBG_PORT_SEL_0),
	PMIC_ENTRY(PMIC_REG_TYPE_C_DBG_PORT_SEL_1),
	PMIC_ENTRY(PMIC_REG_TYPE_C_DBG_MOD_SEL),
	PMIC_ENTRY(PMIC_RO_TYPE_C_DBG_OUT_READ_0),
	PMIC_ENTRY(PMIC_RO_TYPE_C_DBG_OUT_READ_1),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_DBG_PORT_0),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SW_DBG_PORT_1),
	PMIC_ENTRY(PMIC_TYPE_C_ELR_LEN),
	PMIC_ENTRY(PMIC_REG_TYPE_C_PHY_RG_CC1_RPDE),
	PMIC_ENTRY(PMIC_REG_TYPE_C_PHY_DA_CC_DAC_CAL),
	PMIC_ENTRY(PMIC_REG_TYPE_C_PHY_RG_CC1_RP15),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SPARE_ELR_0),
	PMIC_ENTRY(PMIC_REG_TYPE_C_PHY_RG_CC1_RP3),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SPARE_ELR_1),
	PMIC_ENTRY(PMIC_REG_TYPE_C_PHY_RG_CC1_RD),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SPARE_ELR_2),
	PMIC_ENTRY(PMIC_REG_TYPE_C_PHY_RG_CC2_RPDE),
	PMIC_ENTRY(PMIC_REG_TYPE_C_PHY_DA_CC_DAC_GAIN_CAL),
	PMIC_ENTRY(PMIC_REG_TYPE_C_PHY_RG_CC2_RP15),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SPARE_ELR_3),
	PMIC_ENTRY(PMIC_REG_TYPE_C_PHY_RG_CC2_RP3),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SPARE_ELR_4),
	PMIC_ENTRY(PMIC_REG_TYPE_C_PHY_RG_CC2_RD),
	PMIC_ENTRY(PMIC_REG_TYPE_C_SPARE_ELR_5),
	...
	PMIC_ENTRY(PMIC_AUD_TOP_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_AUD_TOP_SW_MAJOR_REV),
	...
	PMIC_ENTRY(PMIC_AUDIO_DIG_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_AUDIO_DIG_SW_MAJOR_REV),
	...
	PMIC_ENTRY(PMIC_PDN_BUCKOSC_CTL),
	PMIC_ENTRY(PMIC_PDN_ADC_CTL),
	PMIC_ENTRY(PMIC_PDN_DAC_CTL),
	PMIC_ENTRY(PMIC_PDN_AFE_CTL),
	PMIC_ENTRY(PMIC_AFE_3P25M_PHASE_SEL_CTL),
	PMIC_ENTRY(PMIC_AFE_6P5M_PHASE_SEL_CTL),
	PMIC_ENTRY(PMIC_AFE_13M_PHASE_SEL_CTL),
	PMIC_ENTRY(PMIC_PDN_ADC_HIRES_CTL),
	PMIC_ENTRY(PMIC_AFE_CK_DIV_RST_CTL),
	PMIC_ENTRY(PMIC_FIFO_AUTO_RST_CTL),
	...
	PMIC_ENTRY(PMIC_RG_MTKAIF_RXIF_DELAY_DATA),
	PMIC_ENTRY(PMIC_RG_MTKAIF_RXIF_DELAY_CYCLE),
	...
	PMIC_ENTRY(PMIC_DA_AUDVOWCLK_BUCKOSC_DIV),
	...
	PMIC_ENTRY(PMIC_DA_AUDVOWCLK_BUCKOSC_PDN),
	PMIC_ENTRY(PMIC_AUDIO_DIG_CFG),
	PMIC_ENTRY(PMIC_ADDA_AUD_PAD_TOP_CFG),
	...
	PMIC_ENTRY(PMIC_AUDENC_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_AUDENC_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_AUDENC_ESP),
	...
	PMIC_ENTRY(PMIC_RG_AUDGLBMADLPWEN),
	...
	PMIC_ENTRY(PMIC_RG_AUDSPAREVA28),
	PMIC_ENTRY(PMIC_RG_AUDSPAREVA18),
	PMIC_ENTRY(PMIC_RG_AUDENCSPAREVA28),
	...
	PMIC_ENTRY(PMIC_RG_ACCDETSPAREVA28),
	...
	PMIC_ENTRY(PMIC_AUDDEC_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_AUDDEC_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_AUDDEC_ESP),
	...
	PMIC_ENTRY(PMIC_RG_AUDHPDIFFINPBIASADJ_VAUDP15),
	PMIC_ENTRY(PMIC_RG_AUDHPLFCOMPRESSEL_VAUDP15),
	PMIC_ENTRY(PMIC_RG_AUDHPHFCOMPRESSEL_VAUDP15),
	PMIC_ENTRY(PMIC_RG_AUDHPHFCOMPBUFGAINSEL_VAUDP15),
	PMIC_ENTRY(PMIC_RG_AUDHPCOMP_EN_VAUDP15),
	...
	PMIC_ENTRY(PMIC_AUDZCD_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_AUDZCD_SW_MAJOR_REV),
	PMIC_ENTRY(PMIC_AUDZCD_ESP),
	...
	PMIC_ENTRY(PMIC_ACCDET_SW_MINOR_REV),
	PMIC_ENTRY(PMIC_ACCDET_SW_MAJOR_REV),
	...
	PMIC_ENTRY(PMIC_ACCDET_EINT_EN),
	...
	PMIC_ENTRY(PMIC_ACCDET_EINT_CMPOUT_SW),
	...
	PMIC_ENTRY(PMIC_ACCDET_EINT_CMP_EN_SW),
	...
	PMIC_ENTRY(PMIC_ACCDET_ELR_LEN),
	PMIC_ENTRY(PMIC_RG_ACCDET_OFFSET_CAL),
	PMIC_ENTRY(PMIC_RG_ACCDET_RES),
	PMIC_ENTRY(PMIC_RG_ACCDET_AD),
	PMIC_ENTRY(PMIC_RG_ACCDET_DB),
	PMIC_ENTRY(PMIC_RG_ACCDET_BC),
};
