...
void dvt_mutex_dump_reg(void)
{
	...
	DPI_DVT_LOG_W("MUTEX:0x030=0x%08x,0x02c=0x%08x,0x040=0x%08x,0x048=0x%08x\n",
	...
	DPI_DVT_LOG_W("MUTEX:0x050=0x%08x,0x04c=0x%08x,0x060=0x%08x,0x068=0x%08x\n",
	...
	DPI_DVT_LOG_W("MUTEX:0x070=0x%08x,0x06c=0x%08x,0x080=0x%08x,0x088=0x%08x\n",
	...
	DPI_DVT_LOG_W("MUTEX:0x090=0x%08x,0x08c=0x%08x,0x0a0=0x%08x,0x0a8=0x%08x\n",
	...
	DPI_DVT_LOG_W("MUTEX:0x0b0=0x%08x,0x0ac=0x%08x,0x0c0=0x%08x,0x0c8=0x%08x\n",
	...
	DPI_DVT_LOG_W("MUTEX:0x0d0=0x%08x,0x0cc=0x%08x,0x200=0x%08x\n",
...
/**********************************K2 LONG PATH Start***************************************/
/* OVL0 -> OVL0_MOUT -> OVL0_2L -> OVL0_2L_MOUT -> DISP_PATH0_SEL -> DISP_RDMA0 -> DISP_RDMA0_RSZ_IN_SOUT */
/* DISP_RDMA0_RSZ_OUT_SEL -> DISP_RDMA0_SOUT -> COLOR0 -> DISP_COLOR_OUT_SEL -> CCORR0 -> AAL0 -> GAMMA0 */
/* DITHER0 -> DITHER0_MOUT -> DPI0_SEL -> DPI0_SEL_SOUT -> DPI0_THP_LMT -> DPI0  */
...
/* OVL1_2L -> OVL1_2L_MOUT -> OVL_TO_WDMA_SEL -> DISP_WDMA0_PRE_SEL -> DISP_TO_WDMA */
/* DISP_WDMA0_SEL -> DISP_WDMA0 */
...
int dvt_mutex_set_ovl1_2l_dpi(unsigned int mutex_id, void *handle)
{
	...
	/* OVL1_2L -> OVL1_2L_MOUT -> DISP_RDMA1 -> DISP_RDMA1_SOUT -> DPI0_SEL -> DPI0_SEL_SOUT */
	/* DPI0_THP_LMT -> DPI0 */
