...
#define DW9800W_CTRL_REG         0x02
#define DW9800W_DACMSB_REG       0x03
#define DW9800W_DACLSB_REG       0x04
...
static int s4AF_WriteReg(u16 a_u2Data)
{
	...
	printk("[DW9800AF]  s4DW9800AF_write reg %d\n", a_u2Data);
    if (i4RetValue < 0)
    {
