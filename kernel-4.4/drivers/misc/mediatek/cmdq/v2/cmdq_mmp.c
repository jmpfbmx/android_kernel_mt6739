...
void cmdq_mmp_init(void)
{
	...
	if (CMDQ_MMP_events.CMDQ == 0) {
		...
		CMDQ_MMP_events.warning = mmprofile_register_event(CMDQ_MMP_events.CMDQ, "warning");
		CMDQ_MMP_events.loopBeat = mmprofile_register_event(CMDQ_MMP_events.CMDQ, "loopIRQ");

		CMDQ_MMP_events.autoRelease_add =
		    mmprofile_register_event(CMDQ_MMP_events.CMDQ, "autoRelease_add");
		CMDQ_MMP_events.autoRelease_done =
		    mmprofile_register_event(CMDQ_MMP_events.CMDQ, "autoRelease_done");
		CMDQ_MMP_events.consume_add =
		    mmprofile_register_event(CMDQ_MMP_events.CMDQ, "consume_add");
		CMDQ_MMP_events.consume_done =
		    mmprofile_register_event(CMDQ_MMP_events.CMDQ, "consume_done");
		...
		CMDQ_MMP_events.MDP_reset =
		    mmprofile_register_event(CMDQ_MMP_events.CMDQ, "MDP_reset");
