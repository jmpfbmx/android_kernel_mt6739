...
struct DVE_REQUEST_STRUCT {
	...
	enum DPE_FRAME_STATUS_ENUM DveFrameStatus[_SUPPORT_MAX_DPE_FRAME_REQUEST_];
...
struct DVE_REQUEST_RING_STRUCT {
	...
	struct DVE_REQUEST_STRUCT DVEReq_Struct[_SUPPORT_MAX_DPE_REQUEST_RING_SIZE_];
};
...
struct WMFE_REQUEST_STRUCT {
	...
	signed int FrameWRIdx;	/* Frame write Index */
	signed int FrameRDIdx;	/* Frame read Index */
	enum DPE_FRAME_STATUS_ENUM WmfeFrameStatus[_SUPPORT_MAX_DPE_FRAME_REQUEST_];
...
struct WMFE_REQUEST_RING_STRUCT {
	...
	signed int ReadIdx;		/* read which request index */
	signed int HWProcessIdx;	/* HWWriteIdx */
	struct WMFE_REQUEST_STRUCT WMFEReq_Struct[_SUPPORT_MAX_DPE_REQUEST_RING_SIZE_];
};
				      ...
				      enum DPE_PROCESS_ID_ENUM whichReq, int ProcessID)
{
	...
	if (stus & DPE_DVE_INT_ST) {
		...
		LOG_INF(" WaitIRQ Err,type:%d,urNum:%d,sta:%d,whReq:%d,PID:0x%x, RdReqIdx:%d\n",
...
static bool ConfigDVEFrameByReqIdx(signed int ReqIdx)
{
	...
	return MTRUE;
#else
	LOG_INF("ConfigDVEFrameByReqIdx don't support this mode.!!\n");
	return MFALSE;
#endif
}
...
static bool ConfigDVERequest(signed int ReqIdx)
{
	...
	return MTRUE;
#else
	LOG_INF("ConfigDVERequest don't support this mode.!!\n");
	return MFALSE;
#endif
}
...
static bool ConfigWMFERequest(signed int ReqIdx)
{
	...
	if (g_WMFE_ReqRing.WMFEReq_Struct[ReqIdx].RequestState == DPE_REQUEST_STATE_PENDING) {
		...
		LOG_INF("ConfigWMFERequest state machine error!!, ReqIdx:%d, RequestState:%d\n",
...
static signed int ConfigDVEHW(struct DPE_DVEConfig *pDveConfig)
{
	...
	cmdqRecWrite(handle, DPE_DVE_SMTH_DV_CTRL_HW, pDveConfig->DPE_DVE_SMTH_DV_CTRL,
		     CMDQ_REG_MASK);
	cmdqRecWrite(handle, DPE_DVE_ORD_CTRL_HW, pDveConfig->DPE_DVE_ORD_CTRL_0, CMDQ_REG_MASK);
	cmdqRecWrite(handle, DPE_DVE_ORD_CTRL_1_HW, pDveConfig->DPE_DVE_ORD_CTRL_1, CMDQ_REG_MASK);
	...
	cmdqRecWrite(handle, DPE_DVE_ORD_AS_MASK_0_HW, pDveConfig->DPE_DVE_ORD_AS_MASK_0, CMDQ_REG_MASK);
	cmdqRecWrite(handle, DPE_DVE_ORD_AS_MASK_1_HW, pDveConfig->DPE_DVE_ORD_AS_MASK_1, CMDQ_REG_MASK);
	cmdqRecWrite(handle, DPE_DVE_ORD_AS_MASK_2_HW, pDveConfig->DPE_DVE_ORD_AS_MASK_2, CMDQ_REG_MASK);
	cmdqRecWrite(handle, DPE_DVE_ORD_AS_MASK_3_HW, pDveConfig->DPE_DVE_ORD_AS_MASK_3, CMDQ_REG_MASK);

	cmdqRecWrite(handle, DPE_DVE_ORD_REF_MASK_A_0_HW, pDveConfig->DPE_DVE_ORD_REF_MASK_A_0, CMDQ_REG_MASK);
	cmdqRecWrite(handle, DPE_DVE_ORD_REF_MASK_A_1_HW, pDveConfig->DPE_DVE_ORD_REF_MASK_A_1, CMDQ_REG_MASK);
	cmdqRecWrite(handle, DPE_DVE_ORD_REF_MASK_A_2_HW, pDveConfig->DPE_DVE_ORD_REF_MASK_A_2, CMDQ_REG_MASK);
	cmdqRecWrite(handle, DPE_DVE_ORD_REF_MASK_A_3_HW, pDveConfig->DPE_DVE_ORD_REF_MASK_A_3, CMDQ_REG_MASK);
	cmdqRecWrite(handle, DPE_DVE_ORD_REF_MASK_A_4_HW, pDveConfig->DPE_DVE_ORD_REF_MASK_A_4, CMDQ_REG_MASK);
	cmdqRecWrite(handle, DPE_DVE_ORD_REF_MASK_A_5_HW, pDveConfig->DPE_DVE_ORD_REF_MASK_A_5, CMDQ_REG_MASK);
	cmdqRecWrite(handle, DPE_DVE_ORD_REF_MASK_A_6_HW, pDveConfig->DPE_DVE_ORD_REF_MASK_A_6, CMDQ_REG_MASK);

	cmdqRecWrite(handle, DPE_DVE_ORD_REF_MASK_B_0_HW, pDveConfig->DPE_DVE_ORD_REF_MASK_B_0, CMDQ_REG_MASK);
	cmdqRecWrite(handle, DPE_DVE_ORD_REF_MASK_B_1_HW, pDveConfig->DPE_DVE_ORD_REF_MASK_B_1, CMDQ_REG_MASK);
	cmdqRecWrite(handle, DPE_DVE_ORD_REF_MASK_B_2_HW, pDveConfig->DPE_DVE_ORD_REF_MASK_B_2, CMDQ_REG_MASK);
	cmdqRecWrite(handle, DPE_DVE_ORD_REF_MASK_B_3_HW, pDveConfig->DPE_DVE_ORD_REF_MASK_B_3, CMDQ_REG_MASK);
	cmdqRecWrite(handle, DPE_DVE_ORD_REF_MASK_B_4_HW, pDveConfig->DPE_DVE_ORD_REF_MASK_B_4, CMDQ_REG_MASK);
	cmdqRecWrite(handle, DPE_DVE_ORD_REF_MASK_B_5_HW, pDveConfig->DPE_DVE_ORD_REF_MASK_B_5, CMDQ_REG_MASK);
	cmdqRecWrite(handle, DPE_DVE_ORD_REF_MASK_B_6_HW, pDveConfig->DPE_DVE_ORD_REF_MASK_B_6, CMDQ_REG_MASK);

	cmdqRecWrite(handle, DPE_DVE_ORD_REF_MASK_C_0_HW, pDveConfig->DPE_DVE_ORD_REF_MASK_C_0, CMDQ_REG_MASK);
	cmdqRecWrite(handle, DPE_DVE_ORD_REF_MASK_C_1_HW, pDveConfig->DPE_DVE_ORD_REF_MASK_C_1, CMDQ_REG_MASK);
	cmdqRecWrite(handle, DPE_DVE_ORD_REF_MASK_C_2_HW, pDveConfig->DPE_DVE_ORD_REF_MASK_C_2, CMDQ_REG_MASK);
	cmdqRecWrite(handle, DPE_DVE_ORD_REF_MASK_C_3_HW, pDveConfig->DPE_DVE_ORD_REF_MASK_C_3, CMDQ_REG_MASK);
	cmdqRecWrite(handle, DPE_DVE_ORD_REF_MASK_C_4_HW, pDveConfig->DPE_DVE_ORD_REF_MASK_C_4, CMDQ_REG_MASK);
	cmdqRecWrite(handle, DPE_DVE_ORD_REF_MASK_C_5_HW, pDveConfig->DPE_DVE_ORD_REF_MASK_C_5, CMDQ_REG_MASK);
	cmdqRecWrite(handle, DPE_DVE_ORD_REF_MASK_C_6_HW, pDveConfig->DPE_DVE_ORD_REF_MASK_C_6, CMDQ_REG_MASK);

	cmdqRecWrite(handle, DPE_DVE_ORD_REF_MASK_D_0_HW, pDveConfig->DPE_DVE_ORD_REF_MASK_D_0, CMDQ_REG_MASK);
	cmdqRecWrite(handle, DPE_DVE_ORD_REF_MASK_D_1_HW, pDveConfig->DPE_DVE_ORD_REF_MASK_D_1, CMDQ_REG_MASK);
	cmdqRecWrite(handle, DPE_DVE_ORD_REF_MASK_D_2_HW, pDveConfig->DPE_DVE_ORD_REF_MASK_D_2, CMDQ_REG_MASK);
	cmdqRecWrite(handle, DPE_DVE_ORD_REF_MASK_D_3_HW, pDveConfig->DPE_DVE_ORD_REF_MASK_D_3, CMDQ_REG_MASK);
	cmdqRecWrite(handle, DPE_DVE_ORD_REF_MASK_D_4_HW, pDveConfig->DPE_DVE_ORD_REF_MASK_D_4, CMDQ_REG_MASK);
	...
	DPE_WR32(DPE_DVE_ORD_REF_MASK_A_0_REG, pDveConfig->DPE_DVE_ORD_REF_MASK_A_0);
	DPE_WR32(DPE_DVE_ORD_REF_MASK_A_1_REG, pDveConfig->DPE_DVE_ORD_REF_MASK_A_1);
	DPE_WR32(DPE_DVE_ORD_REF_MASK_A_2_REG, pDveConfig->DPE_DVE_ORD_REF_MASK_A_2);
	DPE_WR32(DPE_DVE_ORD_REF_MASK_A_3_REG, pDveConfig->DPE_DVE_ORD_REF_MASK_A_3);
	DPE_WR32(DPE_DVE_ORD_REF_MASK_A_4_REG, pDveConfig->DPE_DVE_ORD_REF_MASK_A_4);
	DPE_WR32(DPE_DVE_ORD_REF_MASK_A_5_REG, pDveConfig->DPE_DVE_ORD_REF_MASK_A_5);
	DPE_WR32(DPE_DVE_ORD_REF_MASK_A_6_REG, pDveConfig->DPE_DVE_ORD_REF_MASK_A_6);

	DPE_WR32(DPE_DVE_ORD_REF_MASK_B_0_REG, pDveConfig->DPE_DVE_ORD_REF_MASK_B_0);
	DPE_WR32(DPE_DVE_ORD_REF_MASK_B_1_REG, pDveConfig->DPE_DVE_ORD_REF_MASK_B_1);
	DPE_WR32(DPE_DVE_ORD_REF_MASK_B_2_REG, pDveConfig->DPE_DVE_ORD_REF_MASK_B_2);
	DPE_WR32(DPE_DVE_ORD_REF_MASK_B_3_REG, pDveConfig->DPE_DVE_ORD_REF_MASK_B_3);
	DPE_WR32(DPE_DVE_ORD_REF_MASK_B_4_REG, pDveConfig->DPE_DVE_ORD_REF_MASK_B_4);
	DPE_WR32(DPE_DVE_ORD_REF_MASK_B_5_REG, pDveConfig->DPE_DVE_ORD_REF_MASK_B_5);
	DPE_WR32(DPE_DVE_ORD_REF_MASK_B_6_REG, pDveConfig->DPE_DVE_ORD_REF_MASK_B_6);

	DPE_WR32(DPE_DVE_ORD_REF_MASK_C_0_REG, pDveConfig->DPE_DVE_ORD_REF_MASK_C_0);
	DPE_WR32(DPE_DVE_ORD_REF_MASK_C_1_REG, pDveConfig->DPE_DVE_ORD_REF_MASK_C_1);
	DPE_WR32(DPE_DVE_ORD_REF_MASK_C_2_REG, pDveConfig->DPE_DVE_ORD_REF_MASK_C_2);
	DPE_WR32(DPE_DVE_ORD_REF_MASK_C_3_REG, pDveConfig->DPE_DVE_ORD_REF_MASK_C_3);
	DPE_WR32(DPE_DVE_ORD_REF_MASK_C_4_REG, pDveConfig->DPE_DVE_ORD_REF_MASK_C_4);
	DPE_WR32(DPE_DVE_ORD_REF_MASK_C_5_REG, pDveConfig->DPE_DVE_ORD_REF_MASK_C_5);
	DPE_WR32(DPE_DVE_ORD_REF_MASK_C_6_REG, pDveConfig->DPE_DVE_ORD_REF_MASK_C_6);

	DPE_WR32(DPE_DVE_ORD_REF_MASK_D_0_REG, pDveConfig->DPE_DVE_ORD_REF_MASK_D_0);
	DPE_WR32(DPE_DVE_ORD_REF_MASK_D_1_REG, pDveConfig->DPE_DVE_ORD_REF_MASK_D_1);
	DPE_WR32(DPE_DVE_ORD_REF_MASK_D_2_REG, pDveConfig->DPE_DVE_ORD_REF_MASK_D_2);
	DPE_WR32(DPE_DVE_ORD_REF_MASK_D_3_REG, pDveConfig->DPE_DVE_ORD_REF_MASK_D_3);
	DPE_WR32(DPE_DVE_ORD_REF_MASK_D_4_REG, pDveConfig->DPE_DVE_ORD_REF_MASK_D_4);
	DPE_WR32(DPE_DVE_ORD_REF_MASK_D_5_REG, pDveConfig->DPE_DVE_ORD_REF_MASK_D_5);
	DPE_WR32(DPE_DVE_ORD_REF_MASK_D_6_REG, pDveConfig->DPE_DVE_ORD_REF_MASK_D_6);
...
static signed int ConfigWMFEHW(struct DPE_WMFEConfig *pWmfeCfg)
{
	...
	for (i = 0; i < pWmfeCfg->WmfeCtrlSize; i++) {
		...
		if (WMFE_ENABLE == (pWmfeCfg->WmfeCtrl[i].WMFE_CTRL & WMFE_ENABLE)) {
			...
			wmfe_mask_mode = wmfe_mask_mode | ((pWmfeCfg->WmfeCtrl[i].WMFE_MASK_MODE & 0x1) << i);
			wmfe_mask_value = (pWmfeCfg->WmfeCtrl[i].WMFE_MASK_VALUE & 0xff);
		}
	}
...
static signed int DPE_ReadReg(struct DPE_REG_IO_STRUCT *pRegIo)
{
	...
	if ((pRegIo->pData == NULL) || (pRegIo->Count == 0) || (pRegIo->Count > (DPE_REG_RANGE>>2))) {
		LOG_INF("DPE_ReadReg pRegIo->pData is NULL, Count:%d!!", pRegIo->Count);
		Ret = -EFAULT;
		goto EXIT;
	}
	pData = kmalloc((pRegIo->Count) * sizeof(struct DPE_REG_STRUCT), GFP_KERNEL);
	if (pData == NULL) {
		LOG_INF("ERROR: DPE_ReadReg kmalloc failed, cnt:%d\n", pRegIo->Count);
		Ret = -ENOMEM;
		goto EXIT;
	}
	pTmpData = pData;
	if (copy_from_user(pData, (void *)pRegIo->pData, (pRegIo->Count) * sizeof(struct DPE_REG_STRUCT)) == 0) {
		...
		pData = pTmpData;
		if (copy_to_user((void *)pRegIo->pData, pData, (pRegIo->Count) * sizeof(struct DPE_REG_STRUCT)) != 0) {
...
static signed int DPE_WriteRegToHw(struct DPE_REG_STRUCT *pReg, unsigned int Count)
{
	signed int Ret = 0;
	unsigned int i;
	bool dbgWriteReg;
...
static signed int DPE_WriteReg(struct DPE_REG_IO_STRUCT *pRegIo)
{
	...
	/* pData = (unsigned char*)kmalloc((pRegIo->Count)*sizeof(DPE_REG_STRUCT), GFP_ATOMIC); */
	pData = kmalloc((pRegIo->Count) * sizeof(struct DPE_REG_STRUCT), GFP_KERNEL);
	if (pData == NULL) {
	...
	/*  */
	if (copy_from_user
	    (pData, (void __user *)(pRegIo->pData), pRegIo->Count * sizeof(struct DPE_REG_STRUCT)) != 0) {
...
static signed int DPE_WaitIrq(struct DPE_WAIT_IRQ_STRUCT *WaitIrq)
{
	...
	if (Timeout == 0) {
		...
		LOG_INF("ERRRR Timeout!Timeout(%d)Clear(%d),Type(%d),IrqSta(0x%08X), WaitSta(0x%08X)\n",
			WaitIrq->Timeout, WaitIrq->Clear, WaitIrq->Type, irqStatus, WaitIrq->Status);
		LOG_INF("urKey(%d),whReq(%d),PID(%d)\n", WaitIrq->UserKey, whichReq, WaitIrq->ProcessID);
		LOG_INF("DveIrqCnt(0x%08X),WmfeIrqCnt(0x%08X),WriteReqIdx(0x%08X),ReadReqIdx(0x%08X)\n",
		DPEInfo.IrqInfo.DveIrqCnt, DPEInfo.IrqInfo.WmfeIrqCnt, DPEInfo.WriteReqIdx, DPEInfo.ReadReqIdx);
		...
		if (WaitIrq->Clear == DPE_IRQ_WAIT_CLEAR) {
			...
			if (WaitIrq->Status & DPE_DVE_INT_ST) {
				...
				LOG_INF("DPE_IRQ_WAIT_CLEAR Error, Type(%d), WaitStatus(0x%08X)",
...
static long DPE_ioctl(struct file *pFile, unsigned int Cmd, unsigned long Param)
{
	...
	case DPE_READ_REGISTER:
		{
			if (copy_from_user(&RegIo, (void *)Param, sizeof(struct DPE_REG_IO_STRUCT)) == 0) {
	...
	case DPE_WAIT_IRQ:
		{
			if (copy_from_user(&IrqInfo, (void *)Param, sizeof(struct DPE_WAIT_IRQ_STRUCT)) ==
			    0) {
				/*  */
				...
				if (copy_to_user
				    ((void *)Param, &IrqInfo, sizeof(struct DPE_WAIT_IRQ_STRUCT)) != 0) {
					LOG_INF("copy_to_user failed\n");
					Ret = -EFAULT;
				}
			} else {
	...
	case DPE_CLEAR_IRQ:
		{
			if (copy_from_user(&ClearIrq, (void *)Param, sizeof(struct DPE_CLEAR_IRQ_STRUCT))
			    == 0) {
	...
	case DPE_DVE_ENQUE_REQ:
		...
		if (copy_from_user(&dpe_DveReq, (void *)Param, sizeof(struct DPE_DVERequest)) == 0) {
			...
			if (copy_from_user
			    (g_DveEnqueReq_Struct.DveFrameConfig, (void *)dpe_DveReq.m_pDpeConfig,
			     dpe_DveReq.m_ReqNum * sizeof(struct DPE_DVEConfig)) != 0) {
			...
			if (DPE_REQUEST_STATE_EMPTY ==
				...
				for (idx = 0; idx < dpe_DveReq.m_ReqNum; idx++) {
					...
					&g_DveEnqueReq_Struct.DveFrameConfig[idx], sizeof(struct DPE_DVEConfig));
				}
				...
				g_DVE_RequestRing.WriteIdx = (WIdx + 1) % _SUPPORT_MAX_DPE_REQUEST_RING_SIZE_;
					gDveCnt++;
					if ((gDveCnt == 1) && (g_DVE_RequestRing.DVEReq_Struct[DveWriteIdx].RequestState
						== DPE_REQUEST_STATE_PENDING)) {
						g_DVE_RequestRing.DVEReq_Struct[DveWriteIdx].RequestState
						= DPE_REQUEST_STATE_RUNNING;
						bDveFound = MTRUE;
					} else {
						LOG_INF("DVE en req ste error!!, ReqIdx:%d, ReqState:%d, CfgCnt:%d\n",
						DveWriteIdx, g_DVE_RequestRing.DVEReq_Struct[DveWriteIdx].RequestState,
						gDveCnt);
					}
			} else {
				LOG_INF("No DVE Buf! WriteIdx(%d),ReqSta(%d),FrameWRIdx(%d),enqReqNum(%d)\n",
			...
			if (copy_from_user(&dpe_DveReq, (void *)Param, sizeof(struct DPE_DVERequest)) == 0) {
				...
				for (idx = 0; idx < dequeNum; idx++) {
					if (DPE_FRAME_STATUS_FINISHED ==
						...
						LOG_INF("DVE!idx(%d),deqNum(%d),ReadIdx,(%d),FRDIdx(%d),DveFSta(%d)\n",
				...
				if (copy_to_user((void *)Param, &dpe_DveReq, sizeof(struct DPE_DVERequest))
				    != 0) {
	...
	case DPE_WMFE_ENQUE_REQ:
		...
		if (copy_from_user(&dpe_WmfeReq, (void *)Param, sizeof(struct DPE_WMFERequest)) ==
		    0) {
			...
			if (copy_from_user
			    (g_WmfeEnqueReq_Struct.WmfeFrameConfig,
			     ...
			     dpe_WmfeReq.m_ReqNum * sizeof(struct DPE_WMFEConfig)) != 0) {
			...
			if (DPE_REQUEST_STATE_EMPTY ==
				...
				for (idx = 0; idx < dpe_WmfeReq.m_ReqNum; idx++) {
					...
					&g_WmfeEnqueReq_Struct.WmfeFrameConfig[idx], sizeof(struct DPE_WMFEConfig));
				}
				...
				LOG_INF("No Empty WMFE Buf!WriteIdx(%d),ReqSta(%d),FWRIdx(%d),enqReqNum(%d)\n",
				     WIdx,
				     g_WMFE_ReqRing.WMFEReq_Struct[WIdx].RequestState,
			...
			if (copy_from_user(&dpe_WmfeReq, (void *)Param, sizeof(struct DPE_WMFERequest)) ==
				...
				for (idx = 0; idx < dequeNum; idx++) {
					if (DPE_FRAME_STATUS_FINISHED ==
						...
						LOG_INF("WMFE!idx(%d),deqNum(%d),ReadIdx,(%d),FRDIdx(%d),FSts(%d)\n",
				...
				if (copy_to_user
				    ((void *)Param, &dpe_WmfeReq, sizeof(struct DPE_WMFERequest)) != 0) {
...
static int compat_get_DPE_read_register_data(struct compat_DPE_REG_IO_STRUCT __user *data32,
...
static int compat_put_DPE_read_register_data(struct compat_DPE_REG_IO_STRUCT __user *data32,
					     struct DPE_REG_IO_STRUCT __user *data)
{
	compat_uint_t count;
	/*compat_uptr_t uptr;*/
...
static int compat_get_DPE_dve_enque_req_data(struct compat_DPE_DVERequest __user *data32,
...
static int compat_put_DPE_dve_enque_req_data(struct compat_DPE_DVERequest __user *data32,
					     struct DPE_DVERequest __user *data)
{
	compat_uint_t count;
	/*compat_uptr_t uptr;*/
...
static int compat_get_DPE_dve_deque_req_data(struct compat_DPE_DVERequest __user *data32,
					     struct DPE_DVERequest __user *data)
{
	compat_uint_t count;
	compat_uptr_t uptr;
...
static int compat_put_DPE_dve_deque_req_data(struct compat_DPE_DVERequest __user *data32,
					     struct DPE_DVERequest __user *data)
{
	compat_uint_t count;
	/*compat_uptr_t uptr;*/
...
static int compat_get_DPE_wmfe_enque_req_data(struct compat_DPE_WMFERequest __user *data32,
...
static int compat_put_DPE_wmfe_enque_req_data(struct compat_DPE_WMFERequest __user *data32,
					      struct DPE_WMFERequest __user *data)
{
	compat_uint_t count;
	/*compat_uptr_t uptr;*/
...
static int compat_get_DPE_wmfe_deque_req_data(struct compat_DPE_WMFERequest __user *data32,
					      struct DPE_WMFERequest __user *data)
{
	compat_uint_t count;
	compat_uptr_t uptr;
...
static int compat_put_DPE_wmfe_deque_req_data(struct compat_DPE_WMFERequest __user *data32,
					      struct DPE_WMFERequest __user *data)
{
	compat_uint_t count;
	/*compat_uptr_t uptr;*/
...
static signed int DPE_open(struct inode *pInode, struct file *pFile)
{
	...
	pFile->private_data = kmalloc(sizeof(struct DPE_USER_INFO_STRUCT), GFP_ATOMIC);
	if (pFile->private_data == NULL) {
...
static signed int DPE_mmap(struct file *pFile, struct vm_area_struct *pVma)
{
	...
	case DPE_BASE_HW:
		if (length > DPE_REG_RANGE) {
			LOG_INF("mmap range error :module:0x%x length(0x%lx),DPE_REG_RANGE(0x%x)!",
...
static signed int DPE_probe(struct platform_device *pDev)
{
	...
	if (nr_DPE_devs == 1) {
		...
		dpe_clk.CG_IMGSYS_DPE = devm_clk_get(&pDev->dev, "DPE_CG_IMG_DPE");
...
static void DPE_ScheduleDveWork(struct work_struct *data)
{
	...
	if (bResulst == MTRUE) {
		...
		if (gDveCnt > 0) {
			...
			if (DveWriteIdx < 0)
				DveWriteIdx = DveWriteIdx + _SUPPORT_MAX_DPE_REQUEST_RING_SIZE_;

			if (g_DVE_RequestRing.DVEReq_Struct[DveWriteIdx].RequestState == DPE_REQUEST_STATE_PENDING) {
				g_DVE_RequestRing.DVEReq_Struct[DveWriteIdx].RequestState = DPE_REQUEST_STATE_RUNNING;
				bFound = MTRUE;
			} else {
				LOG_INF("DPE_ScheduleDveWork  state machine error!!, DveWriteIdx:%d, RequestState:%d\n",
				DveWriteIdx, g_DVE_RequestRing.DVEReq_Struct[DveWriteIdx].RequestState);
			}
		}
	}
