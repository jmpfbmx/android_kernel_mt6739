...
#define CAM_A_BASE_HW   0x18004000
#define CAM_B_BASE_HW   0x18005000
#define CAMSV_0_BASE_HW 0x18050000
#define CAMSV_1_BASE_HW 0x18051000
#define CAMSV_2_BASE_HW 0x18052000
#define CAMSV_3_BASE_HW 0x18053000
#define CAMSV_4_BASE_HW 0x18054000
#define CAMSV_5_BASE_HW 0x18055000
#define DIP_A_BASE_HW   0x15022000
#define UNI_A_BASE_HW   0x18003000
#define SENINF_BASE_HW  0x18040000
#define MIPI_RX_BASE_HW 0x10400000
#define GPIO_BASE_HW    0x10410000
#define GPIO_BASE_HW2   0x10420000
...
#define ISP_P2_BUFQUE_CTRL     _IOWR(ISP_MAGIC, ISP_CMD_P2_BUFQUE_CTRL, struct ISP_P2_BUFQUE_STRUCT)
