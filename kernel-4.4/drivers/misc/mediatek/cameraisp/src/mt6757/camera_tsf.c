...
#define TSFO_ERR_STAT_HW              (TSF_BASE_HW + 0x128)
#define TSFI_ERR_STAT_HW              (TSF_BASE_HW + 0x130)
#define DMA_DEBUG_SEL_HW              (TSF_BASE_HW + 0x14C)
...
#define TSFO_ERR_STAT_REG             (ISP_TSF_BASE + 0x128)
#define TSFI_ERR_STAT_REG             (ISP_TSF_BASE + 0x130)
#define DMA_DEBUG_SEL_REG             (ISP_TSF_BASE + 0x14C)
