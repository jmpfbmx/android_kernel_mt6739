...
TRACE_EVENT(ISP_Pass1_CAM_enter,
	TP_PROTO(int imgo_en, int rrzo_en, int imgo_bpp, int rrzo_bpp, int imgo_w_in_byte, int imgo_h_in_byte,
		int rrzo_w_in_byte, int rrzo_h_in_byte, int rrz_src_w, int rrz_src_h, int rrz_dst_w, int rrz_dst_h,
		int rrz_hori_step, int rrz_vert_step),
	TP_ARGS(imgo_en, rrzo_en, imgo_bpp, rrzo_bpp, imgo_w_in_byte, imgo_h_in_byte, rrzo_w_in_byte, rrzo_h_in_byte,
		rrz_src_w, rrz_src_h, rrz_dst_w, rrz_dst_h, rrz_hori_step, rrz_vert_step),
	TP_STRUCT__entry(
		__field(int, imgo_en)
		__field(int, rrzo_en)
	...
	TP_printk("imgo_en=%d, rrzo_en=%d, imgo_bpp=%d, rrzo_bpp=%d, imgo_xsize=%d, imgo_ysize=%d\n"
		"rrzo_xsize=%d, rrzo_ysize=%d, rrz_src_w=%d, rrz_src_h=%d, rrz_dst_w=%d\n"
		"rrz_dst_h=%d, rrz_hori_step=%d, rrz_vert_step=%d\n",
		__entry->imgo_en,
		__entry->rrzo_en,
		__entry->imgo_bpp,
		__entry->rrzo_bpp,
