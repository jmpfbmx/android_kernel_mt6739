...
#define OWE_OCC_INT_ST				((unsigned int)1<<1)
#define OWE_WMFE_INT_ST				((unsigned int)1<<2)
...
enum OWE_IRQ_CLEAR_ENUM {
	...
	OWE_IRQ_WAIT_CLEAR,		/*wait the signal and clear it, avoid the hw executime is too s hort.  */
...
#ifdef CONFIG_COMPAT
#define COMPAT_OWE_WRITE_REGISTER	_IOWR(OWE_MAGIC, OWE_CMD_WRITE_REG, struct compat_OWE_REG_IO_STRUCT)
#define COMPAT_OWE_READ_REGISTER	_IOWR(OWE_MAGIC, OWE_CMD_READ_REG, struct compat_OWE_REG_IO_STRUCT)

#define COMPAT_OWE_OCC_ENQUE_REQ	_IOWR(OWE_MAGIC, OWE_CMD_OCC_ENQUE_REQ, struct compat_OWE_OCCRequest)
#define COMPAT_OWE_OCC_DEQUE_REQ	_IOWR(OWE_MAGIC, OWE_CMD_OCC_DEQUE_REQ, struct compat_OWE_OCCRequest)

#define COMPAT_OWE_WMFE_ENQUE_REQ	_IOWR(OWE_MAGIC, OWE_CMD_WMFE_ENQUE_REQ, struct compat_OWE_WMFERequest)
#define COMPAT_OWE_WMFE_DEQUE_REQ	_IOWR(OWE_MAGIC, OWE_CMD_WMFE_DEQUE_REQ, struct compat_OWE_WMFERequest)
