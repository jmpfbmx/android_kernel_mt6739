...
static void __init mt_gpt_init(struct device_node *node)
{
	...
	/* Init GPT3 as 32K free-run counter */
	request_gpt(GPT3, GPT_FREE_RUN, GPT_CLK_SRC_RTC, GPT_CLK_DIV_1, 0, NULL, 0);
}
...
/************************************************************************************************/
CLOCKSOURCE_OF_DECLARE(mtk_apxgpt, "mediatek,mt6757-timer", mt_gpt_init);
