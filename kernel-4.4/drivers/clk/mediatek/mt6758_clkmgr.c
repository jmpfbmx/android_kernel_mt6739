...
#define ARMPLL3_PWR_CON0           (clk_apmixed_base + 0x33C)
/*CCIPLL*/
...
{
	pr_err("[ARMPLL1_CON0]=0x%08x\n", clk_readl(ARMPLL1_CON0));
	pr_err("[ARMPLL1_CON1]=0x%08x\n", clk_readl(ARMPLL1_CON1));
	pr_err("[MP0_PLL_DIV_CFG]=0x%08x\n", clk_readl(MP0_PLL_DIV_CFG));
	pr_err("[CCF] ARMPLL1(M): %d\n", mt_get_abist_freq(35));
	pr_err("[ARMPLL2_CON0]=0x%08x\n", clk_readl(ARMPLL2_CON0));
	pr_err("[ARMPLL2_CON1]=0x%08x\n", clk_readl(ARMPLL2_CON1));
	pr_err("[MP1_PLL_DIV_CFG]=0x%08x\n", clk_readl(MP1_PLL_DIV_CFG));
	pr_err("[CCF] ARMPLL2(L): %d\n", mt_get_abist_freq(34));
	pr_err("[ARMPLL3_CON0]=0x%08x\n", clk_readl(ARMPLL3_CON0));
	pr_err("[ARMPLL3_CON1]=0x%08x\n", clk_readl(ARMPLL3_CON1));
	pr_err("[MP2_PLL_DIV_CFG]=0x%08x\n", clk_readl(MP2_PLL_DIV_CFG));
	pr_err("[CCF] ARMPLL3(B): %d\n", mt_get_abist_freq(36));
	pr_err("[CCIPLL_CON0]=0x%08x\n", clk_readl(CCIPLL_CON0));
	pr_err("[CCIPLL_CON1]=0x%08x\n", clk_readl(CCIPLL_CON1));
	pr_err("[BUS_PLL_DIV_CFG]=0x%08x\n", clk_readl(BUS_PLL_DIV_CFG));
