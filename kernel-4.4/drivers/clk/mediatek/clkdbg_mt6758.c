...
static struct regbase rb[] = {
	...
	[ipusys]   = REGBASE_V(0x18800000, ipusys),
...
static struct clkdbg_ops clkdbg_mt6758_ops = {
...
static int __init clkdbg_mt6758_init(void)
{
	if (!of_machine_is_compatible("mediatek,mt6758"))
		return -ENODEV;

	init_regbase();

	init_custom_cmds();
	set_clkdbg_ops(&clkdbg_mt6758_ops);
...
device_initcall(clkdbg_mt6758_init);
