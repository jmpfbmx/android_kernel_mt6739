...
#define AFE_ADD6A_UL_SRC_MON0       (AFE_BASE + 0x0ae4)
...
#define AFE_HDMI_OUT_BASE_MSB       (AFE_BASE + 0x0ba4)
#define AFE_HDMI_OUT_CUR_MSB        (AFE_BASE + 0x0ba8)
#define AFE_HDMI_OUT_END_MSB        (AFE_BASE + 0x0bac)
