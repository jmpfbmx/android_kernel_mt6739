...
#ifndef AUDIO_MT6775_SOUND_H
#define AUDIO_MT6775_SOUND_H
...
#define Dl1_DATA2_MAX_BUFFER_SIZE     (48*1024)
#define Dl1_DATA2_MIN_PERIOD_SIZE       1
#define Dl1_DATA2_MAX_PERIOD_SIZE     Dl1_DATA2_MAX_BUFFER_SIZE
...
#define UL2_MAX_BUFFER_SIZE     (48*1024)
...
#define AUDIO_SRAM_PLAYBACK_FULL_SIZE	(1024 * 48)
#define AUDIO_SRAM_PLAYBACK_PARTIAL_SIZE	(1024 * 48)
