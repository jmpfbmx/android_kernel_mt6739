...
void Afe_Log_Print(void)
{
	...
	pr_debug("AFE_ADDA_ULCF_CFG_02_01        = 0x%x\n", Afe_Get_Reg(AFE_ADDA_ULCF_CFG_02_01));
	pr_debug("AFE_ADDA_ULCF_CFG_04_03        = 0x%x\n", Afe_Get_Reg(AFE_ADDA_ULCF_CFG_04_03));
	pr_debug("AFE_ADDA_ULCF_CFG_06_05        = 0x%x\n", Afe_Get_Reg(AFE_ADDA_ULCF_CFG_06_05));
	pr_debug("AFE_ADDA_ULCF_CFG_08_07        = 0x%x\n", Afe_Get_Reg(AFE_ADDA_ULCF_CFG_08_07));
	pr_debug("AFE_ADDA_ULCF_CFG_10_09        = 0x%x\n", Afe_Get_Reg(AFE_ADDA_ULCF_CFG_10_09));
	pr_debug("AFE_ADDA_ULCF_CFG_12_11        = 0x%x\n", Afe_Get_Reg(AFE_ADDA_ULCF_CFG_12_11));
	pr_debug("AFE_ADDA_ULCF_CFG_14_13        = 0x%x\n", Afe_Get_Reg(AFE_ADDA_ULCF_CFG_14_13));
	pr_debug("AFE_ADDA_ULCF_CFG_16_15        = 0x%x\n", Afe_Get_Reg(AFE_ADDA_ULCF_CFG_16_15));
	pr_debug("AFE_ADDA_ULCF_CFG_18_17        = 0x%x\n", Afe_Get_Reg(AFE_ADDA_ULCF_CFG_18_17));
	pr_debug("AFE_ADDA_ULCF_CFG_20_19        = 0x%x\n", Afe_Get_Reg(AFE_ADDA_ULCF_CFG_20_19));
	pr_debug("AFE_ADDA_ULCF_CFG_22_21        = 0x%x\n", Afe_Get_Reg(AFE_ADDA_ULCF_CFG_22_21));
	pr_debug("AFE_ADDA_ULCF_CFG_24_23        = 0x%x\n", Afe_Get_Reg(AFE_ADDA_ULCF_CFG_24_23));
	pr_debug("AFE_ADDA_ULCF_CFG_26_25        = 0x%x\n", Afe_Get_Reg(AFE_ADDA_ULCF_CFG_26_25));
	pr_debug("AFE_ADDA_ULCF_CFG_28_27        = 0x%x\n", Afe_Get_Reg(AFE_ADDA_ULCF_CFG_28_27));
	pr_debug("AFE_ADDA_ULCF_CFG_30_29        = 0x%x\n", Afe_Get_Reg(AFE_ADDA_ULCF_CFG_30_29));
	...
	pr_debug("AFE_ASRC_CON12                 = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON12));
...
ssize_t AudDrv_Reg_Dump(char *buffer, int size)
{
	...
	n += scnprintf(buffer + n, size - n, "AFE_ADDA_IIR_COEF_10_09 = 0x%x\n",
		       Afe_Get_Reg(AFE_ADDA_IIR_COEF_10_09));
	n += scnprintf(buffer + n, size - n, "AFE_ADDA_ULCF_CFG_02_01 = 0x%x\n",
		       Afe_Get_Reg(AFE_ADDA_ULCF_CFG_02_01));
	n += scnprintf(buffer + n, size - n, "AFE_ADDA_ULCF_CFG_04_03 = 0x%x\n",
		       Afe_Get_Reg(AFE_ADDA_ULCF_CFG_04_03));
	n += scnprintf(buffer + n, size - n, "AFE_ADDA_ULCF_CFG_06_05 = 0x%x\n",
		       Afe_Get_Reg(AFE_ADDA_ULCF_CFG_06_05));
	n += scnprintf(buffer + n, size - n, "AFE_ADDA_ULCF_CFG_08_07 = 0x%x\n",
		       Afe_Get_Reg(AFE_ADDA_ULCF_CFG_08_07));
	n += scnprintf(buffer + n, size - n, "AFE_ADDA_ULCF_CFG_10_09 = 0x%x\n",
		       Afe_Get_Reg(AFE_ADDA_ULCF_CFG_10_09));
	n += scnprintf(buffer + n, size - n, "AFE_ADDA_ULCF_CFG_12_11 = 0x%x\n",
		       Afe_Get_Reg(AFE_ADDA_ULCF_CFG_12_11));
	n += scnprintf(buffer + n, size - n, "AFE_ADDA_ULCF_CFG_14_13 = 0x%x\n",
		       Afe_Get_Reg(AFE_ADDA_ULCF_CFG_14_13));
	n += scnprintf(buffer + n, size - n, "AFE_ADDA_ULCF_CFG_16_15 = 0x%x\n",
		       Afe_Get_Reg(AFE_ADDA_ULCF_CFG_16_15));
	n += scnprintf(buffer + n, size - n, "AFE_ADDA_ULCF_CFG_18_17 = 0x%x\n",
		       Afe_Get_Reg(AFE_ADDA_ULCF_CFG_18_17));
	n += scnprintf(buffer + n, size - n, "AFE_ADDA_ULCF_CFG_20_19 = 0x%x\n",
		       Afe_Get_Reg(AFE_ADDA_ULCF_CFG_20_19));
	n += scnprintf(buffer + n, size - n, "AFE_ADDA_ULCF_CFG_22_21 = 0x%x\n",
		       Afe_Get_Reg(AFE_ADDA_ULCF_CFG_22_21));
	n += scnprintf(buffer + n, size - n, "AFE_ADDA_ULCF_CFG_24_23 = 0x%x\n",
		       Afe_Get_Reg(AFE_ADDA_ULCF_CFG_24_23));
	n += scnprintf(buffer + n, size - n, "AFE_ADDA_ULCF_CFG_26_25 = 0x%x\n",
		       Afe_Get_Reg(AFE_ADDA_ULCF_CFG_26_25));
	n += scnprintf(buffer + n, size - n, "AFE_ADDA_ULCF_CFG_28_27 = 0x%x\n",
		       Afe_Get_Reg(AFE_ADDA_ULCF_CFG_28_27));
	n += scnprintf(buffer + n, size - n, "AFE_ADDA_ULCF_CFG_30_29 = 0x%x\n",
		       Afe_Get_Reg(AFE_ADDA_ULCF_CFG_30_29));
	...
	n += scnprintf(buffer + n, size - n, "AFE_SRAM_DELSEL_CON3 = 0x%x\n",
		       Afe_Get_Reg(AFE_SRAM_DELSEL_CON3));
	n += scnprintf(buffer + n, size - n, "AFE_ASRC_CON12 = 0x%x\n",
		       Afe_Get_Reg(AFE_ASRC_CON12));
	...
	n += scnprintf(buffer + n, size - n, "AFE_AWB2_CUR_MSB = 0x%x\n",
		       Afe_Get_Reg(AFE_AWB2_CUR_MSB));
	n += scnprintf(buffer + n, size - n, "AFE_ADDA6_IIR_COEF_02_01 = 0x%x\n",
		       Afe_Get_Reg(AFE_ADDA6_IIR_COEF_02_01));
	n += scnprintf(buffer + n, size - n, "AFE_ADDA6_IIR_COEF_04_03 = 0x%x\n",
		       Afe_Get_Reg(AFE_ADDA6_IIR_COEF_04_03));
	n += scnprintf(buffer + n, size - n, "AFE_ADDA6_IIR_COEF_06_05 = 0x%x\n",
		       Afe_Get_Reg(AFE_ADDA6_IIR_COEF_06_05));
	n += scnprintf(buffer + n, size - n, "AFE_ADDA6_IIR_COEF_08_07 = 0x%x\n",
		       Afe_Get_Reg(AFE_ADDA6_IIR_COEF_08_07));
	n += scnprintf(buffer + n, size - n, "AFE_ADDA6_IIR_COEF_10_09 = 0x%x\n",
		       Afe_Get_Reg(AFE_ADDA6_IIR_COEF_10_09));
	...
	n += scnprintf(buffer + n, size - n, "AFE_MEMIF_MON24 = 0x%x\n",
		       Afe_Get_Reg(AFE_MEMIF_MON24));
	n += scnprintf(buffer + n, size - n, "AFE_GENERAL1_ASRC_2CH_CON0 = 0x%x\n",
		       Afe_Get_Reg(AFE_GENERAL1_ASRC_2CH_CON0));
	n += scnprintf(buffer + n, size - n, "AFE_GENERAL1_ASRC_2CH_CON1 = 0x%x\n",
		       Afe_Get_Reg(AFE_GENERAL1_ASRC_2CH_CON1));
	n += scnprintf(buffer + n, size - n, "AFE_GENERAL1_ASRC_2CH_CON2 = 0x%x\n",
		       Afe_Get_Reg(AFE_GENERAL1_ASRC_2CH_CON2));
	n += scnprintf(buffer + n, size - n, "AFE_GENERAL1_ASRC_2CH_CON3 = 0x%x\n",
		       Afe_Get_Reg(AFE_GENERAL1_ASRC_2CH_CON3));
	n += scnprintf(buffer + n, size - n, "AFE_GENERAL1_ASRC_2CH_CON4 = 0x%x\n",
		       Afe_Get_Reg(AFE_GENERAL1_ASRC_2CH_CON4));
	n += scnprintf(buffer + n, size - n, "AFE_GENERAL1_ASRC_2CH_CON5 = 0x%x\n",
		       Afe_Get_Reg(AFE_GENERAL1_ASRC_2CH_CON5));
	n += scnprintf(buffer + n, size - n, "AFE_GENERAL1_ASRC_2CH_CON6 = 0x%x\n",
		       Afe_Get_Reg(AFE_GENERAL1_ASRC_2CH_CON6));
	n += scnprintf(buffer + n, size - n, "AFE_GENERAL1_ASRC_2CH_CON7 = 0x%x\n",
		       Afe_Get_Reg(AFE_GENERAL1_ASRC_2CH_CON7));
	n += scnprintf(buffer + n, size - n, "AFE_GENERAL1_ASRC_2CH_CON8 = 0x%x\n",
		       Afe_Get_Reg(AFE_GENERAL1_ASRC_2CH_CON8));
	n += scnprintf(buffer + n, size - n, "AFE_GENERAL1_ASRC_2CH_CON9 = 0x%x\n",
		       Afe_Get_Reg(AFE_GENERAL1_ASRC_2CH_CON9));
	n += scnprintf(buffer + n, size - n, "AFE_GENERAL1_ASRC_2CH_CON10 = 0x%x\n",
		       Afe_Get_Reg(AFE_GENERAL1_ASRC_2CH_CON10));
	n += scnprintf(buffer + n, size - n, "AFE_GENERAL1_ASRC_2CH_CON12 = 0x%x\n",
		       Afe_Get_Reg(AFE_GENERAL1_ASRC_2CH_CON12));
	n += scnprintf(buffer + n, size - n, "AFE_GENERAL1_ASRC_2CH_CON13 = 0x%x\n",
		       Afe_Get_Reg(AFE_GENERAL1_ASRC_2CH_CON13));
	n += scnprintf(buffer + n, size - n, "GENERAL_ASRC_MODE = 0x%x\n",
		       Afe_Get_Reg(GENERAL_ASRC_MODE));
	n += scnprintf(buffer + n, size - n, "GENERAL_ASRC_EN_ON = 0x%x\n",
		       Afe_Get_Reg(GENERAL_ASRC_EN_ON));
	n += scnprintf(buffer + n, size - n, "AFE_GENERAL2_ASRC_2CH_CON0 = 0x%x\n",
		       Afe_Get_Reg(AFE_GENERAL2_ASRC_2CH_CON0));
	n += scnprintf(buffer + n, size - n, "AFE_GENERAL2_ASRC_2CH_CON1 = 0x%x\n",
		       Afe_Get_Reg(AFE_GENERAL2_ASRC_2CH_CON1));
	n += scnprintf(buffer + n, size - n, "AFE_GENERAL2_ASRC_2CH_CON2 = 0x%x\n",
		       Afe_Get_Reg(AFE_GENERAL2_ASRC_2CH_CON2));
	n += scnprintf(buffer + n, size - n, "AFE_GENERAL2_ASRC_2CH_CON3 = 0x%x\n",
		       Afe_Get_Reg(AFE_GENERAL2_ASRC_2CH_CON3));
	n += scnprintf(buffer + n, size - n, "AFE_GENERAL2_ASRC_2CH_CON4 = 0x%x\n",
		       Afe_Get_Reg(AFE_GENERAL2_ASRC_2CH_CON4));
	n += scnprintf(buffer + n, size - n, "AFE_GENERAL2_ASRC_2CH_CON5 = 0x%x\n",
		       Afe_Get_Reg(AFE_GENERAL2_ASRC_2CH_CON5));
	n += scnprintf(buffer + n, size - n, "AFE_GENERAL2_ASRC_2CH_CON6 = 0x%x\n",
		       Afe_Get_Reg(AFE_GENERAL2_ASRC_2CH_CON6));
	n += scnprintf(buffer + n, size - n, "AFE_GENERAL2_ASRC_2CH_CON7 = 0x%x\n",
		       Afe_Get_Reg(AFE_GENERAL2_ASRC_2CH_CON7));
	n += scnprintf(buffer + n, size - n, "AFE_GENERAL2_ASRC_2CH_CON8 = 0x%x\n",
		       Afe_Get_Reg(AFE_GENERAL2_ASRC_2CH_CON8));
	n += scnprintf(buffer + n, size - n, "AFE_GENERAL2_ASRC_2CH_CON9 = 0x%x\n",
		       Afe_Get_Reg(AFE_GENERAL2_ASRC_2CH_CON9));
	n += scnprintf(buffer + n, size - n, "AFE_GENERAL2_ASRC_2CH_CON10 = 0x%x\n",
		       Afe_Get_Reg(AFE_GENERAL2_ASRC_2CH_CON10));
	n += scnprintf(buffer + n, size - n, "AFE_GENERAL2_ASRC_2CH_CON12 = 0x%x\n",
		       Afe_Get_Reg(AFE_GENERAL2_ASRC_2CH_CON12));
	n += scnprintf(buffer + n, size - n, "AFE_GENERAL2_ASRC_2CH_CON13 = 0x%x\n",
		       Afe_Get_Reg(AFE_GENERAL2_ASRC_2CH_CON13));
...
void platform_gpio_power_adjustment(void)
{
	...
	*pad_gpio3 = (*pad_gpio3 & (~mask)) | value;
	...
	pr_debug("%s(), gpio1 = %u, gpio2 = %u, gpio3 = %u", __func__,
...
static bool platform_set_dpd_module(bool enable)
{
	...
	pr_debug("%s, efuse_on = %d, enable = %d\n", __func__,
			dpd_param.efuse_on, enable);
	pr_debug("%s, a2_lch, a3_lch = 0x%x, 0x%x; a2_rch, a3_rch = 0x%x, 0x%x\n", __func__,
