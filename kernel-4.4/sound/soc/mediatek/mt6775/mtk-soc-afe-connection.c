...
const unsigned int mConnectionReg_1[Soc_Aud_InterConnectionOutput_Num_Output] = {
...
bool SetDl1Data2ToI2s3(unsigned int ConnectionState)
{
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I19,
			Soc_Aud_InterConnectionOutput_O00);
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I20,
			Soc_Aud_InterConnectionOutput_O01);
	return true;
}
...
bool SetDl1Data2ToI2s1Dac(unsigned int ConnectionState)
{
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I19,
			Soc_Aud_InterConnectionOutput_O03);
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I20,
...
bool SetDl1Data2ToI2s1Dac2(unsigned int ConnectionState)
{
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I19,
			Soc_Aud_InterConnectionOutput_O28);
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I20,
...
bool SetDl1Data2ToAwb(unsigned int ConnectionState)
{
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I19,
			Soc_Aud_InterConnectionOutput_O05);
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I20,
...
bool SetI2s2ToModem1OutCh4(unsigned int ConnectionState)
{
...
bool SetI2s2Ch2ToAwb(unsigned int ConnectionState)
{
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I26,
			Soc_Aud_InterConnectionOutput_O05);
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I26,
...
bool SetConnsysToVul2Data(unsigned int ConnectionState)
{
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I34,
...
bool SetAdcRchToI2s3(unsigned int ConnectionState)
{
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I04,
			Soc_Aud_InterConnectionOutput_O00);
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I04,
...
bool SetAdcRchToI2s1Dac(unsigned int ConnectionState)
{
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I04,
			Soc_Aud_InterConnectionOutput_O03);
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I04,
...
bool SetAdcRchToI2s1Dac2(unsigned int ConnectionState)
{
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I04,
			Soc_Aud_InterConnectionOutput_O28);
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I04,
...
bool SetAdc2ToVul(unsigned int ConnectionState)
{
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I17,
			Soc_Aud_InterConnectionOutput_O09);
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I18,
...
bool SetAdc2ToModem2OutCh3(unsigned int ConnectionState)
{
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I17,
...
static const struct connection_link_t mConnectionLink[] = {
	{Soc_Aud_AFE_IO_Block_MEM_DL1, Soc_Aud_AFE_IO_Block_I2S3, SetDl1ToI2s3},
	{Soc_Aud_AFE_IO_Block_MEM_DL1_DATA2, Soc_Aud_AFE_IO_Block_I2S3, SetDl1Data2ToI2s3},
	...
	{Soc_Aud_AFE_IO_Block_MEM_DL1_DATA2, Soc_Aud_AFE_IO_Block_I2S1_DAC, SetDl1Data2ToI2s1Dac},
	...
	{Soc_Aud_AFE_IO_Block_MEM_DL1_DATA2, Soc_Aud_AFE_IO_Block_I2S1_DAC_2, SetDl1Data2ToI2s1Dac2},
	...
	{Soc_Aud_AFE_IO_Block_MEM_DL1_DATA2, Soc_Aud_AFE_IO_Block_MEM_AWB, SetDl1Data2ToAwb},
	...
	{Soc_Aud_AFE_IO_Block_I2S_CONNSYS, Soc_Aud_AFE_IO_Block_MEM_VUL2, SetConnsysToVul2Data},
	...
	{Soc_Aud_AFE_IO_Block_MEM_DL1_CH1, Soc_Aud_AFE_IO_Block_MODEM_PCM_1_O_CH4, SetDl1Ch1ToModem1OutCh4},
	...
	{Soc_Aud_AFE_IO_Block_ADDA_UL_RCH, Soc_Aud_AFE_IO_Block_I2S3, SetAdcRchToI2s3},
	{Soc_Aud_AFE_IO_Block_ADDA_UL_RCH, Soc_Aud_AFE_IO_Block_I2S1_DAC, SetAdcRchToI2s1Dac},
	{Soc_Aud_AFE_IO_Block_ADDA_UL_RCH, Soc_Aud_AFE_IO_Block_I2S1_DAC_2, SetAdcRchToI2s1Dac2},
	...
	{Soc_Aud_AFE_IO_Block_MODEM_PCM_2_I_CH1, Soc_Aud_AFE_IO_Block_MEM_AWB, SetModem2InCh1ToAwb},
	{Soc_Aud_AFE_IO_Block_MODEM_PCM_1_I_CH1, Soc_Aud_AFE_IO_Block_MEM_AWB, SetModem1InCh1ToAwb},
	...
	{Soc_Aud_AFE_IO_Block_I2S2, Soc_Aud_AFE_IO_Block_MEM_AWB, SetI2s2Ch2ToAwb},
