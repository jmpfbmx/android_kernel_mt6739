...
/* Internal sram */
#define AFE_INTERNAL_SRAM_PHY_BASE  (0x10c01000L)
#define AFE_INTERNAL_SRAM_VIR_BASE  (AUDIO_HW_VIRTUAL_BASE - 0x70000+0x8000)
#define AFE_INTERNAL_SRAM_NORMAL_SIZE  (0xFF00) /* 63k, for normal mode */
#define AFE_INTERNAL_SRAM_COMPACT_SIZE (0x15400) /* 85k, for compact mode */
...
#define AFE_MAXLENGTH             (AFE_BASE + 0x0ddf)
...
#define AFE_ADDA_ULCF_CFG_02_01   (AFE_BASE + 0x02a4)
#define AFE_ADDA_ULCF_CFG_04_03   (AFE_BASE + 0x02a8)
#define AFE_ADDA_ULCF_CFG_06_05   (AFE_BASE + 0x02ac)
#define AFE_ADDA_ULCF_CFG_08_07   (AFE_BASE + 0x02b0)
#define AFE_ADDA_ULCF_CFG_10_09   (AFE_BASE + 0x02b4)
#define AFE_ADDA_ULCF_CFG_12_11   (AFE_BASE + 0x02b8)
#define AFE_ADDA_ULCF_CFG_14_13   (AFE_BASE + 0x02bc)
#define AFE_ADDA_ULCF_CFG_16_15   (AFE_BASE + 0x02c0)
#define AFE_ADDA_ULCF_CFG_18_17   (AFE_BASE + 0x02c4)
#define AFE_ADDA_ULCF_CFG_20_19   (AFE_BASE + 0x02c8)
#define AFE_ADDA_ULCF_CFG_22_21   (AFE_BASE + 0x02cc)
#define AFE_ADDA_ULCF_CFG_24_23   (AFE_BASE + 0x02d0)
#define AFE_ADDA_ULCF_CFG_26_25   (AFE_BASE + 0x02d4)
#define AFE_ADDA_ULCF_CFG_28_27   (AFE_BASE + 0x02d8)
#define AFE_ADDA_ULCF_CFG_30_29   (AFE_BASE + 0x02dc)
...
#define AFE_ASRC_CON12            (AFE_BASE + 0x0cb0)
#define AFE_ASRC_CON13            (AFE_BASE + 0x0cb4)
...
#define AFE_IRQ_ACC1_CNT          (AFE_BASE + 0x05f0)
#define AFE_IRQ_ACC2_CNT          (AFE_BASE + 0x05f4)
#define AFE_IRQ_ACC1_CNT_MON1     (AFE_BASE + 0x05f8)
#define AFE_IRQ_ACC2_CNT_MON      (AFE_BASE + 0x05fc)
#define AFE_ADDA2_TOP_CON0        (AFE_REG_UNDEFINED)
...
#define AFE_DAI2_BASE_MSB         (AFE_BASE + 0x08c0)
#define AFE_DAI2_END_MSB          (AFE_BASE + 0x08c8)
#define AFE_DAI2_CUR_MSB          (AFE_BASE + 0x08cc)
#define AFE_IRQ_ACC1_CNT_MON2     (AFE_BASE + 0x08f8)
...
#define AFE_CONN19_1              (AFE_BASE + 0x094c)
#define AFE_CONN20_1              (AFE_BASE + 0x0950)
...
#define AFE_CONN40                (AFE_BASE + 0x09c4)
#define AFE_CONN41                (AFE_BASE + 0x09c8)
#define AFE_CONN42                (AFE_BASE + 0x09cc)
#define AFE_CONN39_1              (AFE_BASE + 0x09e0)
#define AFE_CONN40_1              (AFE_BASE + 0x09e4)
#define AFE_CONN41_1              (AFE_BASE + 0x09e8)
#define AFE_CONN42_1              (AFE_BASE + 0x09ec)
#define AFE_I2S_CON4              (AFE_BASE + 0x09f8)
#define AFE_ADDA6_TOP_CON0        (AFE_BASE + 0x0a80)
...
#define AFE_ADDA6_SRC_DEBUG_MON1  (AFE_BASE + 0x0a94)
#define AFE_ADDA6_NEWIF_CFG0      (AFE_BASE + 0x0a98)
#define AFE_ADDA6_ULCF_CFG_02_01  (AFE_BASE + 0x0aa0)
#define AFE_ADDA6_ULCF_CFG_04_03  (AFE_BASE + 0x0aa4)
#define AFE_ADDA6_ULCF_CFG_06_05  (AFE_BASE + 0x0aa8)
#define AFE_ADDA6_ULCF_CFG_08_07  (AFE_BASE + 0x0aac)
#define AFE_ADDA6_ULCF_CFG_10_09  (AFE_BASE + 0x0ab0)
#define AFE_ADDA6_ULCF_CFG_12_11  (AFE_BASE + 0x0ab4)
#define AFE_ADDA6_ULCF_CFG_14_13  (AFE_BASE + 0x0ab8)
#define AFE_ADDA6_ULCF_CFG_16_15  (AFE_BASE + 0x0abc)
#define AFE_ADDA6_ULCF_CFG_18_17  (AFE_BASE + 0x0ac0)
#define AFE_ADDA6_ULCF_CFG_20_19  (AFE_BASE + 0x0ac4)
#define AFE_ADDA6_ULCF_CFG_22_21  (AFE_BASE + 0x0ac8)
#define AFE_ADDA6_ULCF_CFG_24_23  (AFE_BASE + 0x0acc)
#define AFE_ADDA6_ULCF_CFG_26_25  (AFE_BASE + 0x0ad0)
#define AFE_ADDA6_ULCF_CFG_28_27  (AFE_BASE + 0x0ad4)
#define AFE_ADDA6_ULCF_CFG_30_29  (AFE_BASE + 0x0ad8)
#define AFE_CONN43                (AFE_BASE + 0x0af8)
#define AFE_CONN43_1              (AFE_BASE + 0x0afc)
#define AFE_ADDA6_UL_CIC_SRC_CON0 (AFE_BASE + 0x0cc0)
#define AFE_ADDA6_UL_CIC_SRC_CON1 (AFE_BASE + 0x0cc4)
#define AFE_ADDA6_NEWIF_CFG2      (AFE_BASE + 0x0adc)
...
#define AFE_VUL_D2_BASE_MSB       (AFE_BASE + 0x0b80)
#define AFE_VUL_D2_END_MSB        (AFE_BASE + 0x0b88)
#define AFE_VUL_D2_CUR_MSB        (AFE_BASE + 0x0b8c)
#define AFE_DL3_BASE_MSB          (AFE_BASE + 0x0b90)
#define AFE_DL3_CUR_MSB           (AFE_BASE + 0x0b94)
#define AFE_DL3_END_MSB           (AFE_BASE + 0x0b98)
#define AFE_HDMI_BASE_MSB         (AFE_BASE + 0x0ba4)
#define AFE_HDMI_CUR_MSB          (AFE_BASE + 0x0ba8)
#define AFE_HDMI_END_MSB          (AFE_BASE + 0x0bac)
...
#define AFE_ASRC_CONNSYS_CON13            (AFE_BASE + 0x0c88)/*AFE_ASRC_2CH_CON2*/
#define AFE_ASRC_CONNSYS_CON14             (AFE_BASE + 0x0c8c)/*AFE_ASRC_2CH_CON3*/
#define AFE_ASRC_CONNSYS_CON15             (AFE_BASE + 0x0c90)/*AFE_ASRC_2CH_CON4*/
#define AFE_ASRC_CONNSYS_CON16             (AFE_BASE + 0x0c94)/*AFE_ASRC_2CH_CON5*/
#define AFE_ASRC_CONNSYS_CON17             (AFE_BASE + 0x0c98)/*AFE_ASRC_2CH_CON6*/
#define AFE_ASRC_CONNSYS_CON18             (AFE_BASE + 0x0c9c)/*AFE_ASRC_2CH_CON7*/
#define AFE_ASRC_CONNSYS_CON19            (AFE_BASE + 0x0ca0)/*AFE_ASRC_2CH_CON8*/
#define AFE_ASRC_CONNSYS_CON20             (AFE_BASE + 0x0ca4)/*AFE_ASRC_2CH_CON9*/
#define AFE_ASRC_CONNSYS_CON21            (AFE_BASE + 0x0ca8)/*AFE_ASRC_2CH_CON10*/
...
#define AFE_GENERAL1_ASRC_2CH_CON0           (AFE_BASE + 0x0e80)
#define AFE_GENERAL1_ASRC_2CH_CON1           (AFE_BASE + 0x0e84)
#define AFE_GENERAL1_ASRC_2CH_CON2           (AFE_BASE + 0x0e88)
#define AFE_GENERAL1_ASRC_2CH_CON3           (AFE_BASE + 0x0e8c)
#define AFE_GENERAL1_ASRC_2CH_CON4           (AFE_BASE + 0x0e90)
#define AFE_GENERAL1_ASRC_2CH_CON5           (AFE_BASE + 0x0e94)
#define AFE_GENERAL1_ASRC_2CH_CON6           (AFE_BASE + 0x0e98)
#define AFE_GENERAL1_ASRC_2CH_CON7           (AFE_BASE + 0x0e9c)
#define AFE_GENERAL1_ASRC_2CH_CON8           (AFE_BASE + 0x0ea0)
#define AFE_GENERAL1_ASRC_2CH_CON9           (AFE_BASE + 0x0ea4)
#define AFE_GENERAL1_ASRC_2CH_CON10          (AFE_BASE + 0x0ea8)
#define AFE_GENERAL1_ASRC_2CH_CON12          (AFE_BASE + 0x0eb0)
#define AFE_GENERAL1_ASRC_2CH_CON13          (AFE_BASE + 0x0eb4)
#define GENERAL_ASRC_MODE                    (AFE_BASE + 0x0eb8)
#define GENERAL_ASRC_EN_ON                   (AFE_BASE + 0x0ebc)
#define AFE_GENERAL2_ASRC_2CH_CON0           (AFE_BASE + 0x0f00)
#define AFE_GENERAL2_ASRC_2CH_CON1           (AFE_BASE + 0x0f04)
#define AFE_GENERAL2_ASRC_2CH_CON2           (AFE_BASE + 0x0f08)
#define AFE_GENERAL2_ASRC_2CH_CON3           (AFE_BASE + 0x0f0c)
#define AFE_GENERAL2_ASRC_2CH_CON4           (AFE_BASE + 0x0f10)
#define AFE_GENERAL2_ASRC_2CH_CON5           (AFE_BASE + 0x0f14)
#define AFE_GENERAL2_ASRC_2CH_CON6           (AFE_BASE + 0x0f18)
#define AFE_GENERAL2_ASRC_2CH_CON7           (AFE_BASE + 0x0f1c)
#define AFE_GENERAL2_ASRC_2CH_CON8           (AFE_BASE + 0x0f20)
#define AFE_GENERAL2_ASRC_2CH_CON9           (AFE_BASE + 0x0f24)
#define AFE_GENERAL2_ASRC_2CH_CON10          (AFE_BASE + 0x0f28)
#define AFE_GENERAL2_ASRC_2CH_CON12          (AFE_BASE + 0x0f30)
#define AFE_GENERAL2_ASRC_2CH_CON13          (AFE_BASE + 0x0f34)
