...
enum audio_analog_device_sample_rate_type {
...
enum audio_analog_mux {
	AUDIO_ANALOG_MUX_DEVICE,
	AUDIO_ANALOG_MUX_VOLUME,
	AUDIO_ANALOG_MUX
};

enum audio_analog_input {
	AUDIO_ANALOG_INPUT_OPEN = 0,
	AUDIO_ANALOG_INPUT_ADC,
