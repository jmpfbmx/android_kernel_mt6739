...
#define AFE_DL_SRC2_CON0_H           ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x0002))
#define AFE_DL_SRC2_CON0_L           ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x0004))
...
#define AFE_AUDIO_TOP_CON0           ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x0014))
...
#define AFE_UP8X_FIFO_CFG0           ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x002c))
#define AFE_UP8X_FIFO_LOG_MON0       ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x002e))
#define AFE_UP8X_FIFO_LOG_MON1       ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x0030))
#define AFE_DL_DC_COMP_CFG0          ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x0032))
#define AFE_DL_DC_COMP_CFG1          ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x0034))
#define AFE_DL_DC_COMP_CFG2          ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x0036))
#define AFE_PMIC_NEWIF_CFG0          ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x0038))
#define AFE_PMIC_NEWIF_CFG1          ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x003a))
#define AFE_PMIC_NEWIF_CFG2          ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x003c))
#define AFE_PMIC_NEWIF_CFG3          ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x003e))
...
#if 0
#define AFE_ADDA2_UP8X_FIFO_LOG_MON0 ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x004c))
#define AFE_ADDA2_UP8X_FIFO_LOG_MON1 ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x004e))
#define AFE_ADDA2_PMIC_NEWIF_CFG0    ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x0050))
#define AFE_ADDA2_PMIC_NEWIF_CFG1    ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x0052))
#define AFE_ADDA2_PMIC_NEWIF_CFG2    ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x0054))
#define AFE_ADC_ASYNC_FIFO_CFG       ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x0058))
#endif
...
#define AFE_VOW_SN_INI_CFG           ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x0088))
#define AFE_VOW_TGEN_CFG0            ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x008a))
#define AFE_VOW_POSDIV_CFG0          ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x008c))
...
#define AFE_VOW_PERIODIC_CFG0        ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x00a0))
#define AFE_VOW_PERIODIC_CFG1        ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x00a2))
#define AFE_VOW_PERIODIC_CFG2        ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x00a4))
#define AFE_VOW_PERIODIC_CFG3        ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x00a6))
#define AFE_VOW_PERIODIC_CFG4        ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x00a8))
#define AFE_VOW_PERIODIC_CFG5        ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x00aa))
#define AFE_VOW_PERIODIC_CFG6        ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x00ac))
#define AFE_VOW_PERIODIC_CFG7        ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x00ae))
#define AFE_VOW_PERIODIC_CFG8        ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x00b0))
#define AFE_VOW_PERIODIC_CFG9        ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x00b2))
#define AFE_VOW_PERIODIC_CFG10       ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x00b4))
#define AFE_VOW_PERIODIC_CFG11       ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x00b6))
#define AFE_VOW_PERIODIC_CFG12       ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x00b8))
#define AFE_VOW_PERIODIC_CFG13       ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x00ba))
#define AFE_VOW_PERIODIC_CFG14       ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x00bc))
#define AFE_VOW_PERIODIC_CFG15       ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x00be))
#define AFE_VOW_PERIODIC_CFG16       ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x00c0))
#define AFE_VOW_PERIODIC_CFG17       ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x00c2))
#define AFE_VOW_PERIODIC_CFG18       ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x00c4))
#define AFE_VOW_PERIODIC_CFG19       ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x00c6))
#define AFE_VOW_PERIODIC_CFG20       ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x00c8))
#define AFE_VOW_PERIODIC_CFG21       ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x00ca))
#define AFE_VOW_PERIODIC_CFG22       ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x00cc))
#define AFE_VOW_PERIODIC_CFG23       ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x00ce))
#define AFE_VOW_PERIODIC_MON0        ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x00d0))
#define AFE_VOW_PERIODIC_MON1        ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x00d2))
...
#define AFE_RGS_NLE_R_CFG0           ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x011a))
#define AFE_RGS_NLE_R_CFG1           ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x011c))
#define AFE_RGS_NLE_R_CFG2           ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x011e))
#define AFE_RGS_NLE_R_CFG3           ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x0120))
#define AFE_RGS_NLE_L_CFG0           ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x0122))
#define AFE_RGS_NLE_L_CFG1           ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x0124))
#define AFE_RGS_NLE_L_CFG2           ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x0126))
#define AFE_RGS_NLE_L_CFG3           ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x0128))
#define AUD_TOP_CFG                  ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x0130))
#define AFE_DL_DC_COMP_CFG3          ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x0136))
#define AFE_DL_DC_COMP_CFG4          ((unsigned int)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x0138))
...
#define TOP_BUCK_ANACK_FREQ_SEL_CON0_SET   ((unsigned int)(PMIC_REG_BASE + 0x043e))
#define TOP_BUCK_ANACK_FREQ_SEL_CON0_CLR   ((unsigned int)(PMIC_REG_BASE + 0x0440))
#define TOP_BUCK_ANACK_FREQ_SEL_CON1       ((unsigned int)(PMIC_REG_BASE + 0x0442))
#define TOP_BUCK_ANACK_FREQ_SEL_CON1_SET   ((unsigned int)(PMIC_REG_BASE + 0x0444))
#define TOP_BUCK_ANACK_FREQ_SEL_CON1_CLR   ((unsigned int)(PMIC_REG_BASE + 0x0446))
