...
void Ana_Log_Print(void)
{
	...
	pr_debug("AUDRC_TUNE_MON1	       = 0x%x\n", Ana_Get_Reg(AUDRC_TUNE_MON1));
	...
	pr_debug("AFE_AMIC_ARRAY_CFG	       = 0x%x\n", Ana_Get_Reg(AFE_AMIC_ARRAY_CFG));
	pr_debug("AFE_DMIC_ARRAY_CFG	       = 0x%x\n", Ana_Get_Reg(AFE_DMIC_ARRAY_CFG));
	...
	pr_debug("AFE_ADDA6_UL_SRC_CON1_L      = 0x%x\n", Ana_Get_Reg(AFE_ADDA6_UL_SRC_CON1_L));
	pr_debug("AFE_ADDA6_UL_SRC_TOP_CON0_H  = 0x%x\n", Ana_Get_Reg(AFE_ADDA6_UL_SRC_TOP_CON0_H));
	pr_debug("AFE_ADDA6_UL_SRC_TOP_CON0_L  = 0x%x\n", Ana_Get_Reg(AFE_ADDA6_UL_SRC_TOP_CON0_L));
	pr_debug("AFE_ADDA6_PMIC_NEWIF_CFG1    = 0x%x\n", Ana_Get_Reg(AFE_ADDA6_PMIC_NEWIF_CFG1));
	pr_debug("AUD_TOP_CFG		       = 0x%x\n", Ana_Get_Reg(AUD_TOP_CFG));
	pr_debug("AFE_DCCLK_CFG2	       = 0x%x\n", Ana_Get_Reg(AFE_DCCLK_CFG2));
	pr_debug("AFE_DCCLK_CFG3	       = 0x%x\n", Ana_Get_Reg(AFE_DCCLK_CFG3));
	...
	pr_debug("AUDENC_ANA_CON17 = 0x%x\n", Ana_Get_Reg(AUDENC_ANA_CON17));
	pr_debug("AUDENC_ANA_CON18 = 0x%x\n", Ana_Get_Reg(AUDENC_ANA_CON18));
	pr_debug("AUDENC_ANA_CON19 = 0x%x\n", Ana_Get_Reg(AUDENC_ANA_CON19));
	pr_debug("AUDENC_ANA_CON20 = 0x%x\n", Ana_Get_Reg(AUDENC_ANA_CON20));
	pr_debug("AUDENC_ANA_CON21 = 0x%x\n", Ana_Get_Reg(AUDENC_ANA_CON21));
	pr_debug("AUDENC_ANA_CON22 = 0x%x\n", Ana_Get_Reg(AUDENC_ANA_CON22));
	pr_debug("AUDENC_ANA_CON23 = 0x%x\n", Ana_Get_Reg(AUDENC_ANA_CON23));
	pr_debug("AUDENC_ANA_CON24 = 0x%x\n", Ana_Get_Reg(AUDENC_ANA_CON24));
	pr_debug("AUDENC_ANA_CON25 = 0x%x\n", Ana_Get_Reg(AUDENC_ANA_CON25));
	pr_debug("AUDENC_ANA_CON26 = 0x%x\n", Ana_Get_Reg(AUDENC_ANA_CON26));
	...
	pr_debug("GPIO_MODE1 = 0x%x\n", Ana_Get_Reg(GPIO_MODE1));
	...
	pr_debug("LDO_VA25_CON0 = 0x%x\n", Ana_Get_Reg(LDO_VA25_CON0));
	pr_debug("LDO_VA25_OP_EN = 0x%x\n", Ana_Get_Reg(LDO_VA25_OP_EN));
	pr_debug("-Ana_Log_Print\n");
}
...
int Ana_Debug_Read(char *buffer, const int size)
{
	...
	n += scnprintf(buffer + n, size - n, "AUDRC_TUNE_MON0 = 0x%x\n",
			Ana_Get_Reg(AUDRC_TUNE_MON0));
	n += scnprintf(buffer + n, size - n, "AUDRC_TUNE_MON1 = 0x%x\n",
			Ana_Get_Reg(AUDRC_TUNE_MON1));
	...
	n += scnprintf(buffer + n, size - n, "AFE_ADDA2_PMIC_NEWIF_CFG2 = 0x%x\n",
			Ana_Get_Reg(AFE_ADDA2_PMIC_NEWIF_CFG2));
	n += scnprintf(buffer + n, size - n, "AFE_AMIC_ARRAY_CFG = 0x%x\n",
			Ana_Get_Reg(AFE_AMIC_ARRAY_CFG));
	n += scnprintf(buffer + n, size - n, "AFE_DMIC_ARRAY_CFG = 0x%x\n",
			Ana_Get_Reg(AFE_DMIC_ARRAY_CFG));
	...
	n += scnprintf(buffer + n, size - n, "AFE_ADDA6_UL_SRC_CON0_L = 0x%x\n",
			Ana_Get_Reg(AFE_ADDA6_UL_SRC_CON0_L));
	n += scnprintf(buffer + n, size - n, "AFE_ADDA6_UL_SRC_CON1_H = 0x%x\n",
			Ana_Get_Reg(AFE_ADDA6_UL_SRC_CON1_H));
	n += scnprintf(buffer + n, size - n, "AFE_ADDA6_UL_SRC_CON1_L = 0x%x\n",
			Ana_Get_Reg(AFE_ADDA6_UL_SRC_CON1_L));
	n += scnprintf(buffer + n, size - n, "AFE_ADDA6_UL_SRC_TOP_CON0_H = 0x%x\n",
			Ana_Get_Reg(AFE_ADDA6_UL_SRC_TOP_CON0_H));
	n += scnprintf(buffer + n, size - n, "AFE_ADDA6_UL_SRC_TOP_CON0_L = 0x%x\n",
			Ana_Get_Reg(AFE_ADDA6_UL_SRC_TOP_CON0_L));
	n += scnprintf(buffer + n, size - n, "AFE_ADDA6_PMIC_NEWIF_CFG1 = 0x%x\n",
			Ana_Get_Reg(AFE_ADDA6_PMIC_NEWIF_CFG1));
	n += scnprintf(buffer + n, size - n, "AUD_TOP_CFG = 0x%x\n",
			Ana_Get_Reg(AUD_TOP_CFG));
	n += scnprintf(buffer + n, size - n, "AFE_DCCLK_CFG2 = 0x%x\n",
			Ana_Get_Reg(AFE_DCCLK_CFG2));
	n += scnprintf(buffer + n, size - n, "AFE_DCCLK_CFG3 = 0x%x\n",
			Ana_Get_Reg(AFE_DCCLK_CFG3));
	...
	n += scnprintf(buffer + n, size - n, "AUDENC_ANA_CON16 = 0x%x\n",
			Ana_Get_Reg(AUDENC_ANA_CON16));
	n += scnprintf(buffer + n, size - n, "AUDENC_ANA_CON17 = 0x%x\n",
			Ana_Get_Reg(AUDENC_ANA_CON17));
	n += scnprintf(buffer + n, size - n, "AUDENC_ANA_CON18 = 0x%x\n",
			Ana_Get_Reg(AUDENC_ANA_CON18));
	n += scnprintf(buffer + n, size - n, "AUDENC_ANA_CON19 = 0x%x\n",
			Ana_Get_Reg(AUDENC_ANA_CON19));
	n += scnprintf(buffer + n, size - n, "AUDENC_ANA_CON20 = 0x%x\n",
			Ana_Get_Reg(AUDENC_ANA_CON20));
	n += scnprintf(buffer + n, size - n, "AUDENC_ANA_CON21 = 0x%x\n",
			Ana_Get_Reg(AUDENC_ANA_CON21));
	n += scnprintf(buffer + n, size - n, "AUDENC_ANA_CON22 = 0x%x\n",
			Ana_Get_Reg(AUDENC_ANA_CON22));
	n += scnprintf(buffer + n, size - n, "AUDENC_ANA_CON23 = 0x%x\n",
			Ana_Get_Reg(AUDENC_ANA_CON23));
	n += scnprintf(buffer + n, size - n, "AUDENC_ANA_CON24 = 0x%x\n",
			Ana_Get_Reg(AUDENC_ANA_CON24));
	n += scnprintf(buffer + n, size - n, "AUDENC_ANA_CON25 = 0x%x\n",
			Ana_Get_Reg(AUDENC_ANA_CON25));
	n += scnprintf(buffer + n, size - n, "AUDENC_ANA_CON26 = 0x%x\n",
			Ana_Get_Reg(AUDENC_ANA_CON26));
	...
	n += scnprintf(buffer + n, size - n, "TOP_CKPDN_CON0  = 0x%x\n",
		       Ana_Get_Reg(TOP_CKPDN_CON0));
	n += scnprintf(buffer + n, size - n, "GPIO_MODE1  = 0x%x\n",
		       Ana_Get_Reg(GPIO_MODE1));
	...
	n += scnprintf(buffer + n, size - n, "LDO_VA18_CON3  = 0x%x\n",
		       Ana_Get_Reg(LDO_VA18_CON3));
	n += scnprintf(buffer + n, size - n, "LDO_VA25_CON0  = 0x%x\n",
		       Ana_Get_Reg(LDO_VA25_CON0));
	n += scnprintf(buffer + n, size - n, "LDO_VA25_OP_EN  = 0x%x\n",
		       Ana_Get_Reg(LDO_VA25_OP_EN));
	return n;
}
