...
struct bus_t {
	 ...
	 * IKE_SA update hook.
	 *
	 * @param ike_sa	IKE_SA coming t
	 * @param type 0:pcscf
	 */
	void (*ike_update)(bus_t *this, ike_sa_t *ike_sa, int type);
	 ...
	 *
	 * @param child_sa	CHILD_SA coming t
	 * @param type 0:pcscf
	 */
	void (*child_update)(bus_t *this, child_sa_t *child_sa, int type);
