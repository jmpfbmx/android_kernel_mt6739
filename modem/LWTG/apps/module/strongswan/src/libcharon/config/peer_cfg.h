...
struct peer_cfg_t {
	...
	/**
	*  get CERTREQ payload critical bit
	*@return        TRUE to enable critical bit
	*/
	bool (*get_certreq_critical) (peer_cfg_t *this);

	/**
	*  whether enable pcscf restore feature
	*@return        TRUE to enable pcscf restore
	*/
	bool (*get_pcscf_restore) (peer_cfg_t *this);

	/**
	*  whether enable emergency indication
	*@return        TRUE to enable emergency
	*/
	bool (*get_is_emergency) (peer_cfg_t *this);

	/**
	*  whether enable device_identity feature
	*@return        TRUE to enable device_identity feature
	*/
	bool (*get_device_identity) (peer_cfg_t *this);

	/**
	*  Initiate IKEv2 reauthentication with a make-before-break instead of a break-before-make scheme.
	*
	* @return		TRUE to make before break
	*               FALSE to break before make
	*/
	bool (*get_reauth_mbb) (peer_cfg_t *this);
	...
	/**
	 * Add a PCSCF IP to request as initiator.
	 *
	 * @param pcscf			pcscf IP to request, may be %any or %any6
	 */
	...
	/**
	 * Create an enumerator over pcscfs to request.
	 *
	 * The returned enumerator enumerates over IPs added with add_pcscf().
	 *
	 * @return				enumerator over host_t*
	 */
	 ...
	 * Set wod configs
	 */
	void (*set_wod_options)(peer_cfg_t *this, char *imei, char *vif,
							...
							bool pcscf_restore, bool is_emergency,
							bool device_identity, bool reauth_mbb,
                            u_int32_t detach_time);
	char* (*get_imei)(peer_cfg_t *this);
	char* (*get_vif) (peer_cfg_t *this);
	u_int16_t (*get_cust_cp_pcscf4)(peer_cfg_t *this);
	u_int16_t (*get_cust_cp_pcscf6)(peer_cfg_t *this);
	u_int16_t (*get_cust_cp_imei)(peer_cfg_t *this);
	bool (*use_cfg_vip)(peer_cfg_t *this);
	bool (*use_wdrv_keepalive)(peer_cfg_t *this);
	u_int32_t (*get_keepalive_time)(peer_cfg_t *this);
	u_int32_t (*get_oos_time)(peer_cfg_t *this);
	u_int32_t (*get_retrans_time)(peer_cfg_t *this);
	u_int16_t (*get_retrans_tries)(peer_cfg_t *this);
	u_int16_t (*get_retrans_base)(peer_cfg_t *this);
	bool (*send_init_contact) (peer_cfg_t *this);
	bool (*send_eap_only) (peer_cfg_t *this);
	bool (*use_hashandurl) (peer_cfg_t *this);
	bool (*use_ocsp) (peer_cfg_t *this);
	bool (*do_addrchg_reauth) (peer_cfg_t *this);
	u_int (*get_fast_reauth) (peer_cfg_t *this);
	bool (*dpd_noreply) (peer_cfg_t *this);
	bool (*skip_check_id) (peer_cfg_t *this);
	bool (*skip_check_cert) (peer_cfg_t *this);
	bool (*server_nocert) (peer_cfg_t *this);
	u_int32_t (*get_detach_time)(peer_cfg_t *this);
};
