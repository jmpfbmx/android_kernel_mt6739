...
static const token_info_t token_info[] =
{
	...
	{ ARG_ENUM, offsetof(starter_conn_t, pcscf_restore),LST_bool                   },
	{ ARG_ENUM, offsetof(starter_conn_t, is_emergency),LST_bool                    },
	{ ARG_ENUM, offsetof(starter_conn_t, device_identity),LST_bool                 },
	{ ARG_ENUM, offsetof(starter_conn_t, reauth_mbb), LST_bool                     },
	...
	{ ARG_ENUM, offsetof(starter_conn_t, dpd_noreply), LST_bool                    },
	...
	{ ARG_STR,  offsetof(starter_conn_t, iface), NULL                              },
	{ ARG_TIME, offsetof(starter_conn_t, keepalive_delay), NULL                    },
	{ ARG_TIME, offsetof(starter_conn_t, retrans_to), NULL                         },
	{ ARG_UINT, offsetof(starter_conn_t, retrans_tries), NULL                      },
	{ ARG_UINT, offsetof(starter_conn_t, retrans_base), NULL                       },
	{ ARG_ENUM, offsetof(starter_conn_t, no_init_contact), LST_bool                },
	{ ARG_ENUM, offsetof(starter_conn_t, no_eap_only), LST_bool                    },
	{ ARG_ENUM, offsetof(starter_conn_t, hashandurl), LST_bool                     },
	{ ARG_ENUM, offsetof(starter_conn_t, ocsp), LST_bool                           },
	{ ARG_ENUM, offsetof(starter_conn_t, skip_check_id), LST_bool                  },
	{ ARG_ENUM, offsetof(starter_conn_t, skip_check_cert), LST_bool                },
	{ ARG_ENUM, offsetof(starter_conn_t, server_nocert), LST_bool                  },
	{ ARG_ENUM, offsetof(starter_conn_t, use_cfg_vip), LST_bool                    },
	{ ARG_TIME, offsetof(starter_conn_t, oos_timeout), NULL                        },
	{ ARG_ENUM, offsetof(starter_conn_t, wdrv_keepalive), LST_bool                 },
	{ ARG_ENUM, offsetof(starter_conn_t, addrchg_reauth), LST_bool                 },
	{ ARG_UINT, offsetof(starter_conn_t, fast_reauth), NULL                        },
	{ ARG_ENUM, offsetof(starter_conn_t, encrkey_display), LST_bool                },
	{ ARG_ENUM, offsetof(starter_conn_t, wshark_filedump), LST_bool                },
	{ ARG_TIME, offsetof(starter_conn_t, detach_timeout), NULL                     },
	...
	{ ARG_UINT, offsetof(starter_end_t, ikeport_natt), NULL                        },
	{ ARG_STR,  offsetof(starter_end_t, subnet), NULL                              },
	{ ARG_MISC, 0, NULL  /* KW_PROTOPORT */                                        },
	{ ARG_STR,  offsetof(starter_end_t, sourceip), NULL                            },
	{ ARG_STR,  offsetof(starter_end_t, pcscf), NULL                               },
	{ ARG_STR,  offsetof(starter_end_t, imei), NULL                                },
	{ ARG_STR,  offsetof(starter_end_t, sourceif), NULL                            },
	{ ARG_STR,  offsetof(starter_end_t, intnetmask), NULL                          },
	{ ARG_STR,  offsetof(starter_end_t, intsubnet), NULL                           },
	...
	{ ARG_STR,  offsetof(starter_end_t, idr_apn), NULL                             },
	...
	{ ARG_UINT, offsetof(starter_end_t, cust_cp_pcscf4), NULL                      },
	{ ARG_UINT, offsetof(starter_end_t, cust_cp_pcscf6), NULL                      },
	{ ARG_UINT, offsetof(starter_end_t, cust_cp_imei), NULL                        },
	{ ARG_ENUM, offsetof(starter_end_t, force_tsi_64), LST_bool                    },
	{ ARG_ENUM, offsetof(starter_end_t, force_tsi_full), LST_bool                  },
