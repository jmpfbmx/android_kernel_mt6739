...
static const char ike_defaults[] = "aes128-sha1-modp1024!";
...
/*this is handled in arcg.c*/
	...
	cfg->conn_default.reauth_mbb = TRUE;
	cfg->conn_default.pcscf_restore = FALSE;
	cfg->conn_default.is_emergency = FALSE;
	cfg->conn_default.device_identity = FALSE;
	...
	cfg->conn_default.addrchg_reauth        = TRUE;
	cfg->conn_default.detach_timeout        =  10; /* seconds */
	...
	cfg->conn_default.left.ikeport_natt = 4500;
	cfg->conn_default.right.ikeport_natt = 4500;
	cfg->conn_default.left.cust_cp_pcscf4 = 20;
	cfg->conn_default.left.cust_cp_pcscf6 = 21;
	cfg->conn_default.right.cust_cp_pcscf4 = 20;
	cfg->conn_default.right.cust_cp_pcscf6 = 21;
